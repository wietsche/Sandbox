...
public class TPaloCubeListBeginJava
{
  ...
  protected final String TEXT_29 = NL + "int NB_CUBES";
  ...
  protected final String TEXT_72 = ");" + NL + "" + NL + "if(pDB_";
  protected final String TEXT_73 = " == null){" + NL + "\t throw new RuntimeException (\"Database '\" + ";
  protected final String TEXT_74 = " + \"' not found. exiting...\");" + NL + "}" + NL + NL;
  protected final String TEXT_75 = NL + "\tlog.info(\"";
  protected final String TEXT_76 = " - Listing cubes from server.\");";
  protected final String TEXT_77 = NL + "for(int i_";
  protected final String TEXT_78 = "=0;i_";
  protected final String TEXT_79 = "<4;i_";
  protected final String TEXT_80 = "++){" + NL + "\torg.talend.jpalo.palocubes pCUBs_";
  protected final String TEXT_81 = " = pDB_";
  protected final String TEXT_82 = ".getCubes(i_";
  protected final String TEXT_83 = ");" + NL + "\tfor(int j_";
  protected final String TEXT_84 = "=0;j_";
  protected final String TEXT_85 = "< pCUBs_";
  protected final String TEXT_86 = ".getNumberOfCubes();j_";
  protected final String TEXT_87 = "++){" + NL + "\t\torg.talend.jpalo.palocube pCUB_";
  protected final String TEXT_88 = "=pCUBs_";
  protected final String TEXT_89 = ".getCube(j_";
  protected final String TEXT_90 = ");" + NL + "\t\tNB_CUBES";
  protected final String TEXT_91 = "++;";
  protected final String TEXT_92 = "\t\t" + NL + "\t\t\t";
  protected final String TEXT_93 = ".cube_id=pCUB_";
  protected final String TEXT_94 = ".getCubeId();" + NL + "\t\t\t";
  protected final String TEXT_95 = ".cube_name=pCUB_";
  protected final String TEXT_96 = ".getName();" + NL + "\t\t\t";
  protected final String TEXT_97 = ".cube_dimensions=pCUB_";
  protected final String TEXT_98 = ".getNumberOfDimensions();" + NL + "\t\t\t";
  protected final String TEXT_99 = ".cube_cells=pCUB_";
  protected final String TEXT_100 = ".getNumberOfCells();" + NL + "\t\t\t";
  protected final String TEXT_101 = ".cube_filled_cells=pCUB_";
  protected final String TEXT_102 = ".getNumberOfFilledCells();" + NL + "\t\t\t";
  protected final String TEXT_103 = ".cube_status=pCUB_";
  protected final String TEXT_104 = ".getCubeStatus();" + NL + "\t\t\t";
  protected final String TEXT_105 = ".cube_type=pCUB_";
  protected final String TEXT_106 = ".getCubeType();";
  protected final String TEXT_107 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_108 = "_CUBEID\", pCUB_";
  protected final String TEXT_109 = ".getCubeId());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_110 = "_CUBENAME\", pCUB_";
  protected final String TEXT_111 = ".getName());" + NL + "\t\t";
