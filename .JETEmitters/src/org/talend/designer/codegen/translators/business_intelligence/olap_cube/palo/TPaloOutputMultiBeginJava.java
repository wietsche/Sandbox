...
public class TPaloOutputMultiBeginJava
{
  ...
  protected final String TEXT_72 = ".getCubes(org.talend.jpalo.palocubes.CUBE_";
  protected final String TEXT_73 = ").getCube(";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + "\t\t\t\t\tjava.util.ArrayList<org.talend.jpalo.paloelements> alPaloElements_";
  protected final String TEXT_76 = "= new java.util.ArrayList<org.talend.jpalo.paloelements>();" + NL + "\t\t\t\t\tfor(org.talend.jpalo.palodimension plDim_";
  protected final String TEXT_77 = " : pCB_";
  protected final String TEXT_78 = ".getDimensions().getDimensions()){" + NL + "\t\t\t\t\t\talPaloElements_";
  protected final String TEXT_79 = ".add(plDim_";
  protected final String TEXT_80 = ".getElements());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\torg.talend.jpalo.palodatamulti plDT_";
  protected final String TEXT_81 = " = new org.talend.jpalo.palodatamulti(pConn_";
  protected final String TEXT_82 = ", pDB_";
  protected final String TEXT_83 = ", ";
  protected final String TEXT_84 = ", ";
  protected final String TEXT_85 = ",alPaloElements_";
  protected final String TEXT_86 = ");" + NL + "\t\t\t\t\tString[] strArrToAdd_";
  protected final String TEXT_87 = " = new String[";
  protected final String TEXT_88 = "];";
  protected final String TEXT_89 = NL + "int iNbOfProcessedRows_";
