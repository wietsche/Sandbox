...
public class TPaloCheckElementsBeginJava
{
  ...
  protected final String TEXT_70 = ");" + NL + "\torg.talend.jpalo.palocube pCB_";
  protected final String TEXT_71 = " = pDB_";
  protected final String TEXT_72 = ".getCubes(org.talend.jpalo.palocubes.CUBE_NORMAL).getCube(";
  protected final String TEXT_73 = ");" + NL;
  protected final String TEXT_74 = NL + "\t\t\t\tList<String>[] lsElements_";
  protected final String TEXT_75 = ";" + NL + "\t\t\t\tList<String>[] lsElementsReplace_";
  protected final String TEXT_76 = ";" + NL + "\t\t\t\torg.talend.jpalo.palodimensions pDIMs_";
  protected final String TEXT_77 = " = pCB_";
  protected final String TEXT_78 = ".getDimensions();" + NL + "\t\t\t\tlsElements_";
  protected final String TEXT_79 = " = new List[pCB_";
  protected final String TEXT_80 = ".getDimensions().getNumberOfDimensions()];" + NL + "\t\t\t\tfor(int i=0;i<pDIMs_";
  protected final String TEXT_81 = ".getNumberOfDimensions();i++){" + NL + "\t\t\t\t\torg.talend.jpalo.palodimension pDIM_";
  protected final String TEXT_82 = " = pDIMs_";
  protected final String TEXT_83 = ".getDimension(i);" + NL + "\t\t\t\t\tlsElements_";
  protected final String TEXT_84 = "[i] = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\tfor(org.talend.jpalo.paloelement pELM_";
  protected final String TEXT_85 = " : pDIM_";
  protected final String TEXT_86 = ".getElements().getElements()){" + NL + "\t\t\t\t\t\tlsElements_";
  protected final String TEXT_87 = "[i].add(pELM_";
  protected final String TEXT_88 = ".getName());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}";
  protected final String TEXT_89 = NL + "\tint iNbOfCheckedRows_";
  protected final String TEXT_90 = " = 0;" + NL + "\tboolean bRejectRow_";
  protected final String TEXT_91 = " = false;" + NL + "\tStringBuilder sbErrorText_";
  protected final String TEXT_92 = " = new StringBuilder();" + NL + "\tint iErrorCounter_";
