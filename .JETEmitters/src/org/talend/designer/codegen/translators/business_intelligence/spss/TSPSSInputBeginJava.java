...
public class TSPSSInputBeginJava
{
  ...
  protected final String TEXT_31 = "_sp = new org.talend.jspss.spss();" + NL + "\torg.talend.jspss.spssfile ";
  protected final String TEXT_32 = "_sf = ";
  protected final String TEXT_33 = "_sp.openFile(";
  protected final String TEXT_34 = ");";
  protected final String TEXT_35 = "\t" + NL + "\t";
  protected final String TEXT_36 = "_sf.setWithLabelTranslation(true);";
  protected final String TEXT_37 = NL + "\torg.talend.jspss.spssrecord ";
  protected final String TEXT_38 = "_sr;";
  protected final String TEXT_39 = NL + "    \tlog.info(\"";
  protected final String TEXT_40 = " - Retrieving records from data\");";
  protected final String TEXT_41 = NL + "\twhile(!";
  protected final String TEXT_42 = "_sf.isEOF()){" + NL + "\t\t\tnb_line_";
  protected final String TEXT_43 = " ++;" + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_45 = " - Retrieving the record \" + nb_line_";
