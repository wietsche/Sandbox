...
public class TFileInputMSXMLEndJava
{
  ...
  protected final String TEXT_31 = NL + "\ttry {" + NL + "\t\tlooper_";
  protected final String TEXT_32 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "\t";
  protected final String TEXT_33 = NL + "\t\tthrow e;" + NL + "\t";
  protected final String TEXT_34 = NL + "\t\tlog.error(\"";
  protected final String TEXT_35 = " - \" + e.getMessage());" + NL + "\t";
