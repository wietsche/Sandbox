...
public class THDFSRenameBeginJava
{
  ...
  protected final String TEXT_97 = " = 0;" + NL + "\t" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_98 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_99 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_100 = "_";
  protected final String TEXT_101 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_102 = "_";
  protected final String TEXT_103 = ".put(";
  protected final String TEXT_104 = ",";
  protected final String TEXT_105 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_106 = ".add(map_";
  protected final String TEXT_107 = "_";
  protected final String TEXT_108 = ");       " + NL + "\t";
  protected final String TEXT_109 = "\t" + NL + "" + NL + "\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_110 = " : list_";
