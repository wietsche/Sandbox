...
public class TFileInputMSPositionalEndJava
{
  ...
  protected final String TEXT_32 = NL + "\t\t" + NL + "\t\tif(limit_";
  protected final String TEXT_33 = " != -1 && nb_line_";
  protected final String TEXT_34 = " >= limit_";
  protected final String TEXT_35 = "){" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "\treader_";
  protected final String TEXT_36 = ".close();" + NL + "\treader_";
  protected final String TEXT_37 = " = null;" + NL + "\tglobalMap.put(\"";
  ...
  protected final String TEXT_42 = "_NB_LINE_UNKOWN_HEADER_TYPES\", nb_line_unknownHeader_";
  protected final String TEXT_43 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_44 = "_NB_LINE_PARSE_ERRORS\", nb_line_parseError_";
