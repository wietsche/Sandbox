...
public class TFileOutputMSXMLBeginJava {
  ...
  protected final String TEXT_55 = ");" + NL + "" + NL + "class OrderHelper_";
  protected final String TEXT_56 = " {" + NL + "    java.util.Map<String,Boolean> recalculateOrderMap = new java.util.HashMap<String,Boolean>();" + NL + "\tjava.util.Map<String,Integer> orderMap = new java.util.HashMap<String,Integer>();" + NL + "\tjava.util.Map<String,Boolean> tailAppendMap = new java.util.HashMap<String,Boolean>();" + NL + "\t" + NL + "\tboolean need_recalculate(String field) {" + NL + "\t\tBoolean result = recalculateOrderMap.get(field);" + NL + "\t\treturn result == null ? true : result;" + NL + "\t}" + NL + "\t" + NL + "\tboolean tailAppend(String field) {" + NL + "\t\tBoolean result = tailAppendMap.get(field);" + NL + "\t\treturn result == null ? false : result;" + NL + "\t}" + NL + "\t" + NL + "\tint order(String field) {" + NL + "\t\tInteger order = orderMap.get(field);" + NL + "\t\treturn order == null ? 0 : order;" + NL + "\t}" + NL + "\t" + NL + "\tvoid fillRecalculateOrderMap(String field,Boolean value) {" + NL + "\t\trecalculateOrderMap.put(field,value);" + NL + "\t}" + NL + "\t" + NL + "\tvoid fillTailAppendMap(String field,Boolean value) {" + NL + "\t\ttailAppendMap.put(field,value);" + NL + "\t}" + NL + "\t" + NL + "\tvoid setOrder(String field,Integer order) {" + NL + "\t\torderMap.put(field,order);" + NL + "\t}" + NL + "}" + NL + "" + NL + "final OrderHelper_";
  protected final String TEXT_57 = " orderHelper_";
  protected final String TEXT_58 = " = new OrderHelper_";
  ...
  protected final String TEXT_72 = NL + "    \t\tFormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = "), ";
  protected final String TEXT_75 = ",";
  protected final String TEXT_76 = ")\t\t\t\t\t\t";
  protected final String TEXT_77 = NL + "            String.valueOf(";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = ")";
  protected final String TEXT_80 = NL + "            FormatterUtils.format_Date(";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = ")";
  protected final String TEXT_84 = NL + "\t\t\t";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = NL + "\t\t\tString.valueOf(";
  ...
  protected final String TEXT_96 = NL + "\t\torg.dom4j.Element ";
  protected final String TEXT_97 = "_";
  protected final String TEXT_98 = " = org.dom4j.DocumentHelper.createElement(qname_";
  protected final String TEXT_99 = "_";
  protected final String TEXT_100 = ");";
  protected final String TEXT_101 = NL + "\t\torg.dom4j.Element ";
  ...
  protected final String TEXT_136 = "\",org.dom4j.DocumentHelper.createElement(qname_";
  protected final String TEXT_137 = "_";
  protected final String TEXT_138 = "));";
  protected final String TEXT_139 = NL + "\t\tnameToElement_";
  protected final String TEXT_140 = ".put(\"";
  protected final String TEXT_141 = "\",";
  protected final String TEXT_142 = ".addElement(\"";
  protected final String TEXT_143 = "\"));";
  protected final String TEXT_144 = NL + "\t\tnameToElement_";
  protected final String TEXT_145 = ".put(\"";
  protected final String TEXT_146 = "\",";
  protected final String TEXT_147 = ".addElement(\"";
  protected final String TEXT_148 = "\"));";
  protected final String TEXT_149 = NL + "\t\tnameToElement_";
  protected final String TEXT_150 = ".put(\"subTreeRootParent\",";
  protected final String TEXT_151 = ");";
  protected final String TEXT_152 = NL + "\t\tnameToElement_";
  protected final String TEXT_153 = ".put(\"subTreeRootParent\",null);";
  protected final String TEXT_154 = NL + "\t\tnameToElement_";
  protected final String TEXT_155 = ".put(\"subTreeRootParent\",root_";
  protected final String TEXT_156 = "_";
  protected final String TEXT_157 = ");";
  protected final String TEXT_158 = NL + "\t\tnameToElement_";
  protected final String TEXT_159 = ".put(\"root_";
  protected final String TEXT_160 = "\",root_";
  protected final String TEXT_161 = "_";
  protected final String TEXT_162 = ");";
  protected final String TEXT_163 = NL + "\t\tnameToElement_";
  protected final String TEXT_164 = ".put(\"subTreeRootParent\",tempElem);";
  protected final String TEXT_165 = NL + "\t\tnameToElement_";
  protected final String TEXT_166 = ".put(\"doc\",doc_";
  protected final String TEXT_167 = ");";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + "\t\t\tclass TalendXMLGenerateTool_";
  protected final String TEXT_170 = "_";
  protected final String TEXT_171 = " {";
  protected final String TEXT_172 = NL + "\t\t\t}";
  protected final String TEXT_173 = NL + "\t\t\t\tpublic void generateDocument_";
  protected final String TEXT_174 = "() throws java.lang.Exception{";
  protected final String TEXT_175 = NL + "\t\t\t\t}" + NL + "\t\t\t\tpublic void generateDocument_";
  protected final String TEXT_176 = "() throws java.lang.Exception{";
  protected final String TEXT_177 = NL + "\t\t\tTalendXMLGenerateTool_";
  protected final String TEXT_178 = "_";
  protected final String TEXT_179 = " talendXMLGenerateTool_";
  protected final String TEXT_180 = "_";
  protected final String TEXT_181 = " = new TalendXMLGenerateTool_";
  protected final String TEXT_182 = "_";
  protected final String TEXT_183 = "();";
  protected final String TEXT_184 = NL + "\t\t\t\t\ttalendXMLGenerateTool_";
  protected final String TEXT_185 = "_";
  protected final String TEXT_186 = ".generateDocument_";
  protected final String TEXT_187 = "();";
  protected final String TEXT_188 = NL;
  protected final String TEXT_189 = NL + "\t\t\t";
  protected final String TEXT_190 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_191 = "\",";
  protected final String TEXT_192 = ".getNamespaceForPrefix(\"";
  ...
  protected final String TEXT_200 = NL + "\t\torg.dom4j.QName qname_";
  ...
  protected final String TEXT_206 = NL + "\t\t" + NL + "\t\tif(orderHelper_";
  protected final String TEXT_207 = ".need_recalculate(\"";
  protected final String TEXT_208 = "\")) {" + NL + "\t\t\tjava.util.List<org.dom4j.Element> allElements_";
  protected final String TEXT_209 = "_";
  protected final String TEXT_210 = " = ";
  protected final String TEXT_211 = ".elements();" + NL + "\t\t\tint order_";
  protected final String TEXT_212 = " = allElements_";
  protected final String TEXT_213 = "_";
  protected final String TEXT_214 = ".size();" + NL + "\t\t\t" + NL + "    \t\tjava.util.List<org.dom4j.Element> elements_";
  protected final String TEXT_215 = "_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ".elements(qname_";
  protected final String TEXT_218 = "_";
  protected final String TEXT_219 = ");" + NL + "    \t\tint app_size_";
  protected final String TEXT_220 = " = elements_";
  protected final String TEXT_221 = "_";
  protected final String TEXT_222 = ".size();" + NL + "    \t\t" + NL + "    \t\tif(app_size_";
  protected final String TEXT_223 = " > 0){" + NL + "    \t\t\torder_";
  protected final String TEXT_224 = " = 1 + allElements_";
  protected final String TEXT_225 = "_";
  protected final String TEXT_226 = ".indexOf(elements_";
  protected final String TEXT_227 = "_";
  protected final String TEXT_228 = ".get(app_size_";
  protected final String TEXT_229 = "-1));" + NL + "    \t\t}else{";
  protected final String TEXT_230 = NL + "    \t\t\torg.dom4j.QName qname_sibling_";
  protected final String TEXT_231 = "_";
  protected final String TEXT_232 = "_";
  protected final String TEXT_233 = " = org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_234 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_235 = "\",\"";
  protected final String TEXT_236 = "\"));" + NL + "    \t\t\torg.dom4j.Element sibling_";
  protected final String TEXT_237 = "_";
  protected final String TEXT_238 = "_";
  protected final String TEXT_239 = " = ";
  protected final String TEXT_240 = ".element(qname_sibling_";
  protected final String TEXT_241 = "_";
  protected final String TEXT_242 = "_";
  protected final String TEXT_243 = ");" + NL + "    \t\t\tint index_sibling_";
  protected final String TEXT_244 = "_";
  protected final String TEXT_245 = "_";
  protected final String TEXT_246 = " = allElements_";
  protected final String TEXT_247 = "_";
  protected final String TEXT_248 = ".indexOf(sibling_";
  protected final String TEXT_249 = "_";
  protected final String TEXT_250 = "_";
  protected final String TEXT_251 = ");" + NL + "    \t\t\tif(index_sibling_";
  protected final String TEXT_252 = "_";
  protected final String TEXT_253 = "_";
  protected final String TEXT_254 = " > -1) {" + NL + "    \t\t\t\torder_";
  protected final String TEXT_255 = " = index_sibling_";
  protected final String TEXT_256 = "_";
  protected final String TEXT_257 = "_";
  protected final String TEXT_258 = ";" + NL + "    \t\t\t} else {";
  protected final String TEXT_259 = NL + "\t\t\t\t}";
  protected final String TEXT_260 = NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif(order_";
  protected final String TEXT_261 = " == allElements_";
  protected final String TEXT_262 = "_";
  protected final String TEXT_263 = ".size()) {" + NL + "\t\t\t\torderHelper_";
  protected final String TEXT_264 = ".fillTailAppendMap(\"";
  protected final String TEXT_265 = "\",true);" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\torderHelper_";
  protected final String TEXT_266 = ".setOrder(\"";
  protected final String TEXT_267 = "\",order_";
  protected final String TEXT_268 = ");" + NL + "\t\t\torderHelper_";
  protected final String TEXT_269 = ".fillRecalculateOrderMap(\"";
  protected final String TEXT_270 = "\",false);" + NL + "\t\t} else {" + NL + "\t\t\tint order_";
  protected final String TEXT_271 = " = orderHelper_";
  protected final String TEXT_272 = ".order(\"";
  protected final String TEXT_273 = "\");" + NL + "\t\t\torderHelper_";
  protected final String TEXT_274 = ".setOrder(\"";
  protected final String TEXT_275 = "\",++order_";
  protected final String TEXT_276 = ");" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tif(orderHelper_";
  protected final String TEXT_277 = ".tailAppend(\"";
  protected final String TEXT_278 = "\")) {" + NL + "\t\t\t";
  protected final String TEXT_279 = ".add(";
  protected final String TEXT_280 = ");" + NL + "\t\t} else {" + NL + "\t\t\t";
  protected final String TEXT_281 = ".elements().add(orderHelper_";
  protected final String TEXT_282 = ".order(\"";
  protected final String TEXT_283 = "\"),";
  protected final String TEXT_284 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_285 = NL + "\t\tif (";
  protected final String TEXT_286 = ".getNamespaceForPrefix(\"";
  protected final String TEXT_287 = "\") == null) {";
  protected final String TEXT_288 = NL + "        } else {" + NL + "        \t";
  protected final String TEXT_289 = NL + "        }";
  protected final String TEXT_290 = NL + "\t\t";
  protected final String TEXT_291 = NL + "\t\t";
  protected final String TEXT_292 = NL + "\t\tif(";
  protected final String TEXT_293 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_294 = " .parseAndAdd(";
  protected final String TEXT_295 = ",";
  protected final String TEXT_296 = ");" + NL + "\t\t}";
  protected final String TEXT_297 = NL + "\t\telse{" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_298 = " .parseAndAdd(";
  protected final String TEXT_299 = ",\"\");" + NL + "\t\t\t";
  protected final String TEXT_300 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_301 = NL + "\t\tif(";
  protected final String TEXT_302 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_303 = " .setText(";
  protected final String TEXT_304 = ",";
  protected final String TEXT_305 = ");" + NL + "\t\t}";
  protected final String TEXT_306 = NL + "\t\telse{" + NL + "\t\t\t";
  protected final String TEXT_307 = ".setText(\"\");" + NL + "\t\t\t";
  protected final String TEXT_308 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_309 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_310 = ".parseAndAdd(";
  protected final String TEXT_311 = ",\"";
  protected final String TEXT_312 = "\");" + NL;
  protected final String TEXT_313 = NL + "\t\tif(";
  protected final String TEXT_314 = "!=null){";
  protected final String TEXT_315 = NL + "\t\t\t";
  protected final String TEXT_316 = ".addAttribute(\"";
  protected final String TEXT_317 = "\",";
  protected final String TEXT_318 = ");";
  protected final String TEXT_319 = NL + "\t\t\t";
  protected final String TEXT_320 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_321 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_322 = "\",\"";
  protected final String TEXT_323 = "\")),";
  protected final String TEXT_324 = ");";
  protected final String TEXT_325 = NL + "\t\t}";
  protected final String TEXT_326 = NL + "\t\t\t";
  protected final String TEXT_327 = ".addAttribute(\"";
  protected final String TEXT_328 = "\", \"";
  protected final String TEXT_329 = "\");";
  protected final String TEXT_330 = NL + "\t\t\t";
  protected final String TEXT_331 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_332 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_333 = "\",\"";
  protected final String TEXT_334 = "\")),\"";
  protected final String TEXT_335 = "\");";
  protected final String TEXT_336 = NL + "\t\tif(";
  protected final String TEXT_337 = "!=null){" + NL + "\t\t\t";
  protected final String TEXT_338 = ".addNamespace(\"";
  protected final String TEXT_339 = "\",TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_340 = "));";
  protected final String TEXT_341 = NL + "        \t";
  protected final String TEXT_342 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_343 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_344 = "))));";
  protected final String TEXT_345 = NL + "\t\t}";
  protected final String TEXT_346 = NL + "\t\t\t";
  protected final String TEXT_347 = ".addNamespace(\"";
  protected final String TEXT_348 = "\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_349 = "\"));";
  protected final String TEXT_350 = NL + "        \t";
  protected final String TEXT_351 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_352 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_353 = "\"))));";
  protected final String TEXT_354 = "true";
  protected final String TEXT_355 = " && (";
  protected final String TEXT_356 = "(";
  protected final String TEXT_357 = "==null && ";
  protected final String TEXT_358 = " == null) || (true &&";
  protected final String TEXT_359 = NL + "\t";
  protected final String TEXT_360 = "!=null" + NL + " && ";
  protected final String TEXT_361 = ".getText()!=null" + NL + " &&";
  protected final String TEXT_362 = ".getText().equals(";
  protected final String TEXT_363 = ")";
  protected final String TEXT_364 = ")";
  protected final String TEXT_365 = NL + ")";
  protected final String TEXT_366 = " && (";
  protected final String TEXT_367 = "!=null" + NL + " && ";
  protected final String TEXT_368 = ".getText()!=null" + NL + " && ";
  protected final String TEXT_369 = ".getText().equals(\"";
  protected final String TEXT_370 = "\")" + NL + " )";
  protected final String TEXT_371 = " && (";
  protected final String TEXT_372 = "(";
  protected final String TEXT_373 = "==null && ";
  protected final String TEXT_374 = ".attribute(";
  protected final String TEXT_375 = ") == null) || (true && ";
  protected final String TEXT_376 = ".attribute(";
  protected final String TEXT_377 = ")!=null" + NL + "&& ";
  protected final String TEXT_378 = ".attribute(";
  protected final String TEXT_379 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_380 = ".attribute(";
  protected final String TEXT_381 = ").getText().equals(";
  protected final String TEXT_382 = ")";
  protected final String TEXT_383 = ")";
  protected final String TEXT_384 = ")";
  protected final String TEXT_385 = " && (";
  protected final String TEXT_386 = ".attribute(";
  protected final String TEXT_387 = ")!=null" + NL + "&& ";
  protected final String TEXT_388 = ".attribute(";
  protected final String TEXT_389 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_390 = ".attribute(";
  protected final String TEXT_391 = ").getText().equals(\"";
  protected final String TEXT_392 = "\")" + NL + " )";
  protected final String TEXT_393 = NL;
  protected final String TEXT_394 = ".element(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_395 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_396 = "\",\"";
  protected final String TEXT_397 = "\")))";
  protected final String TEXT_398 = ".element(\"";
  protected final String TEXT_399 = "\")";
  protected final String TEXT_400 = NL + "TalendWrapTool_";
  protected final String TEXT_401 = " talendWrapTool_";
  protected final String TEXT_402 = " = new TalendWrapTool_";
  protected final String TEXT_403 = "();";
  protected final String TEXT_404 = NL + "class TalendWrapTool_";
  protected final String TEXT_405 = " {";
  protected final String TEXT_406 = NL + "}";
  protected final String TEXT_407 = NL + "nb_line_";
  protected final String TEXT_408 = "++;";
  protected final String TEXT_409 = NL + "public void create";
  protected final String TEXT_410 = "Doc(";
  protected final String TEXT_411 = "Struct ";
  protected final String TEXT_412 = ") throws java.lang.Exception {";
  protected final String TEXT_413 = NL + "talendWrapTool_";
  protected final String TEXT_414 = ".create";
  protected final String TEXT_415 = "Doc(";
  protected final String TEXT_416 = ");";
  protected final String TEXT_417 = NL + "java.util.List<java.util.List<String>> groupbyList_";
  protected final String TEXT_418 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "final java.util.Map<String,String> valueMap_";
  protected final String TEXT_419 = " = new java.util.HashMap<String,String>();" + NL + "boolean isXML10Char_";
  protected final String TEXT_420 = " = true;" + NL + "" + NL + "// sort group root element for judgement of group" + NL + "java.util.List<org.dom4j.Element> groupElementList_";
  protected final String TEXT_421 = " = new java.util.ArrayList<org.dom4j.Element>();" + NL + "org.dom4j.Element root4Group_";
  protected final String TEXT_422 = " = null;";
  protected final String TEXT_423 = NL + "org.dom4j.Element root_";
  protected final String TEXT_424 = "_";
  protected final String TEXT_425 = " = null;" + NL + "//used to judge branch root tags" + NL + "boolean needRoot_";
  protected final String TEXT_426 = "_";
  protected final String TEXT_427 = "  = true;" + NL + "//namespace support" + NL + "java.util.Map<String,String> uriToPrefixForDefaultNamespace_";
  protected final String TEXT_428 = "_";
  protected final String TEXT_429 = " = new java.util.HashMap<String,String>();" + NL + "java.util.Map<String,String> prefixToUriForNamespace_";
  protected final String TEXT_430 = "_";
  protected final String TEXT_431 = " = new java.util.HashMap<String,String>();";
  protected final String TEXT_432 = NL + "\tvoid putValue_";
  protected final String TEXT_433 = "_";
  protected final String TEXT_434 = "(final ";
  protected final String TEXT_435 = "Struct ";
  protected final String TEXT_436 = "){";
  protected final String TEXT_437 = NL + "\t\tvalueMap_";
  protected final String TEXT_438 = ".put(\"";
  protected final String TEXT_439 = "\", ";
  protected final String TEXT_440 = ");" + NL + "\t\tif(isXML10Char_";
  protected final String TEXT_441 = ") {" + NL + "\t\t\tisXML10Char_";
  protected final String TEXT_442 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_443 = ");" + NL + "\t\t}";
  protected final String TEXT_444 = NL + "\t}";
  protected final String TEXT_445 = NL + "\t}";
  protected final String TEXT_446 = NL + "\t" + NL + "\tvalueMap_";
  protected final String TEXT_447 = ".clear();" + NL + "\t";
  protected final String TEXT_448 = NL + "\t";
  protected final String TEXT_449 = NL + "\tputValue_";
  protected final String TEXT_450 = "_";
  protected final String TEXT_451 = "(";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL + "\t\t\tvalueMap_";
  protected final String TEXT_454 = ".put(\"";
  protected final String TEXT_455 = "\", ";
  protected final String TEXT_456 = ");" + NL + "\t\t\tif(isXML10Char_";
  protected final String TEXT_457 = ") {" + NL + "\t\t\t\tisXML10Char_";
  protected final String TEXT_458 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_459 = ");" + NL + "\t\t\t}";
  protected final String TEXT_460 = NL + "\t";
  protected final String TEXT_461 = NL + "\t";
  protected final String TEXT_462 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_463 = "_";
  protected final String TEXT_464 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_465 = "_";
  protected final String TEXT_466 = " = false;";
  ...
  protected final String TEXT_472 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_473 = "_";
  protected final String TEXT_474 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_475 = "_";
  protected final String TEXT_476 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_477 = "_";
  protected final String TEXT_478 = " = doc_";
  protected final String TEXT_479 = ".createXPath(\"";
  protected final String TEXT_480 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_481 = "_";
  protected final String TEXT_482 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_483 = "_";
  protected final String TEXT_484 = ");" + NL + "\t\troot_";
  protected final String TEXT_485 = "_";
  protected final String TEXT_486 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_487 = "_";
  protected final String TEXT_488 = ".selectSingleNode(doc_";
  protected final String TEXT_489 = ");" + NL + "\t\tif(!DocumentHelper.isMatchAtRoot(root_";
  protected final String TEXT_490 = "_";
  protected final String TEXT_491 = ",prefixToUriForNamespace_";
  protected final String TEXT_492 = "_";
  protected final String TEXT_493 = ")) {" + NL + "\t\t\tSystem.err.println(\"warn:::the pre input source content is empty!\");" + NL + "\t\t\t";
  protected final String TEXT_494 = NL + "\t\t\t";
  protected final String TEXT_495 = NL + "\t\t\troot_";
  protected final String TEXT_496 = "_";
  protected final String TEXT_497 = " = (org.dom4j.Element)xpath_";
  protected final String TEXT_498 = "_";
  protected final String TEXT_499 = ".selectSingleNode(doc_";
  protected final String TEXT_500 = ");" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_501 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_502 = "_";
  protected final String TEXT_503 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_504 = "_";
  protected final String TEXT_505 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_506 = "_";
  protected final String TEXT_507 = " = doc_";
  protected final String TEXT_508 = ".createXPath(\"";
  protected final String TEXT_509 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_510 = "_";
  protected final String TEXT_511 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_512 = "_";
  protected final String TEXT_513 = ");" + NL + "\t\troot_";
  protected final String TEXT_514 = "_";
  protected final String TEXT_515 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_516 = "_";
  protected final String TEXT_517 = ".selectSingleNode(doc_";
  protected final String TEXT_518 = ");" + NL + "\t\t";
  protected final String TEXT_519 = NL + "\t\t";
  protected final String TEXT_520 = NL + "\t\troot_";
  protected final String TEXT_521 = "_";
  protected final String TEXT_522 = " = ";
  protected final String TEXT_523 = ";" + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_524 = NL + "\t}";
  protected final String TEXT_525 = NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_526 = "\t\t" + NL + "\t\tboolean bl_";
  protected final String TEXT_527 = "= false;//true:find the insert node;false:not";
  protected final String TEXT_528 = NL + "\t\tif(bl_";
  protected final String TEXT_529 = "==false){" + NL + "\t\t\tjava.util.List<org.dom4j.Element> listNodes= ";
  protected final String TEXT_530 = ".elements();" + NL + "\t\t\tif(listNodes!=null && listNodes.size()>0){" + NL + "\t\t\t\tint j=0;" + NL + "\t\t\t\tfor(j=0;j<listNodes.size();j++){" + NL + "\t\t\t\t\torg.dom4j.Element tempElem =listNodes.get(j);" + NL + "\t\t\t\t\tjava.util.Map<String,String> currentDeclaredNamespacesMapping = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\t\t\tif(DocumentHelper.compareNodes(\"";
  protected final String TEXT_532 = "\",tempElem,uriToPrefixForDefaultNamespace_";
  protected final String TEXT_533 = "_";
  protected final String TEXT_534 = ",currentDeclaredNamespacesMapping,";
  protected final String TEXT_535 = "false";
  protected final String TEXT_536 = "true";
  protected final String TEXT_537 = ")){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_538 = "){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_539 = NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(j>=listNodes.size()){" + NL + "\t\t\t\t\tbl_";
  protected final String TEXT_540 = "=true;" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbl_";
  protected final String TEXT_541 = "=true;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif(bl_";
  protected final String TEXT_542 = "==true){";
  protected final String TEXT_543 = NL + "\t\t}";
  protected final String TEXT_544 = NL + "\t// build loop xml tree";
...
class GenerateToolByDom4j{
    ...
    stringBuffer.append(tool.connName + "_" + currEleName);
