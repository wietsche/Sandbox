...
public class THDFSCompareMainJava
{
  ...
  protected final String TEXT_96 = NL + "\tboolean result_";
  protected final String TEXT_97 = " = true;" + NL + "\t" + NL + "\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_98 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_99 = ");" + NL + "\torg.apache.hadoop.fs.Path ref_path_";
  protected final String TEXT_100 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_101 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_102 = NL + "\tlong fileLength_";
  protected final String TEXT_103 = " = fs_";
  protected final String TEXT_104 = ".getFileStatus(path_";
  protected final String TEXT_105 = ").getLen();" + NL + "\tlong fileRefLength_";
  protected final String TEXT_106 = " = fs_";
  protected final String TEXT_107 = ".getFileStatus(ref_path_";
  protected final String TEXT_108 = ").getLen();" + NL + "\tif(fileLength_";
  protected final String TEXT_109 = " != fileRefLength_";
  protected final String TEXT_110 = ")" + NL + "\t{" + NL + "\t\tresult_";
  protected final String TEXT_111 = " = false;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_112 = NL + "\tif (result_";
  protected final String TEXT_113 = ")" + NL + "\t{" + NL + "\t\torg.apache.hadoop.fs.FSDataInputStream file_is_";
  protected final String TEXT_114 = " = fs_";
  protected final String TEXT_115 = ".open(path_";
  protected final String TEXT_116 = ");" + NL + "\t\torg.apache.hadoop.fs.FSDataInputStream file_ref_is_";
  protected final String TEXT_117 = " = fs_";
  protected final String TEXT_118 = ".open(ref_path_";
  protected final String TEXT_119 = ");" + NL + "\t";
  protected final String TEXT_120 = NL + "\t\tjava.io.BufferedReader file_";
  protected final String TEXT_121 = " = new java.io.BufferedReader(new java.io.InputStreamReader(file_is_";
  protected final String TEXT_122 = ",";
  protected final String TEXT_123 = "));" + NL + "\t\tjava.io.BufferedReader fileRef_";
  protected final String TEXT_124 = " = new java.io.BufferedReader(new java.io.InputStreamReader(file_ref_is_";
  protected final String TEXT_125 = ",";
  protected final String TEXT_126 = "));" + NL + "\t\tString content_";
  protected final String TEXT_127 = " = null,contentRef_";
  protected final String TEXT_128 = " = null;" + NL + "\t\twhile((content_";
  protected final String TEXT_129 = " = file_";
  protected final String TEXT_130 = ".readLine()) != null && (contentRef_";
  protected final String TEXT_131 = " = fileRef_";
  protected final String TEXT_132 = ".readLine()) != null)" + NL + "\t\t{" + NL + "\t\t\tif(content_";
  protected final String TEXT_133 = ".compareTo(contentRef_";
  protected final String TEXT_134 = ") != 0)" + NL + "\t\t\t{" + NL + "\t\t\t\tresult_";
  protected final String TEXT_135 = " = false;" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t// Check if files has a different number of lines:" + NL + "\t\tif(content_";
  protected final String TEXT_136 = " == null){" + NL + "\t\t    // This step is done in case of the while upper ignore second part:" + NL + "\t\t    contentRef_";
  protected final String TEXT_137 = " = fileRef_";
  protected final String TEXT_138 = ".readLine();" + NL + "\t\t}" + NL + "\t\tif(content_";
  protected final String TEXT_139 = " != null || contentRef_";
  protected final String TEXT_140 = " != null){" + NL + "\t\t    result_";
  protected final String TEXT_141 = " = false;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tfile_";
  protected final String TEXT_142 = ".close();" + NL + "\t\tfileRef_";
  protected final String TEXT_143 = ".close();" + NL + "\t\t";
  protected final String TEXT_144 = NL + "    \tjava.io.BufferedInputStream file_";
  protected final String TEXT_145 = " = new java.io.BufferedInputStream(file_is_";
  protected final String TEXT_146 = ");" + NL + "    \tjava.io.BufferedInputStream fileRef_";
  protected final String TEXT_147 = " = new java.io.BufferedInputStream(file_ref_is_";
  protected final String TEXT_148 = ");" + NL + "    \tint content_";
  protected final String TEXT_149 = " = -1,contentRef_";
  protected final String TEXT_150 = " = -1;" + NL + "    \twhile((content_";
  protected final String TEXT_151 = " = file_";
  protected final String TEXT_152 = ".read()) != -1 && (contentRef_";
  protected final String TEXT_153 = " = fileRef_";
  protected final String TEXT_154 = ".read()) != -1)" + NL + "    \t{" + NL + "    \t\tif(content_";
  protected final String TEXT_155 = " != contentRef_";
  protected final String TEXT_156 = ")" + NL + "    \t\t{" + NL + "    \t\t\tresult_";
  protected final String TEXT_157 = " = false;" + NL + "    \t\t\tbreak;" + NL + "    \t\t}" + NL + "    \t}" + NL + "    \tfile_";
  protected final String TEXT_158 = ".close();" + NL + "    \tfileRef_";
  protected final String TEXT_159 = ".close();\t\t\t" + NL + "\t\t";
  protected final String TEXT_160 = NL + "\t}" + NL + "" + NL + "\tString message";
  protected final String TEXT_161 = " = \"\";" + NL + "\tif (result_";
  protected final String TEXT_162 = ") {" + NL + "\t\tmessage";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";" + NL + "\t\t" + NL + "\t} else {" + NL + "\t\tmessage";
  protected final String TEXT_165 = " = ";
  protected final String TEXT_166 = ";" + NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_167 = "_DIFFERENCE\",result_";
  protected final String TEXT_168 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_169 = NL + "    System.out.println(message";
  protected final String TEXT_170 = ");" + NL + "\t";
  protected final String TEXT_171 = NL + "\tlog.info(\"";
  protected final String TEXT_172 = " - Compare result : \" + message";
  protected final String TEXT_173 = " + \".\");" + NL + "\t";
  protected final String TEXT_174 = NL + "\t";
  protected final String TEXT_175 = ".file = ";
  protected final String TEXT_176 = ";" + NL + "\t";
  protected final String TEXT_177 = ".file_ref = ";
  protected final String TEXT_178 = ";\t" + NL + "\t";
  protected final String TEXT_179 = ".moment = java.util.Calendar.getInstance().getTime();" + NL + "\t";
  protected final String TEXT_180 = ".job = jobName;" + NL + "\t";
  protected final String TEXT_181 = ".component = currentComponent;" + NL + "\t";
  protected final String TEXT_182 = ".differ = (result_";
  protected final String TEXT_183 = ")?0:1;" + NL + "\t";
  protected final String TEXT_184 = ".message = message";
  protected final String TEXT_185 = ";" + NL + "\t";
  protected final String TEXT_186 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_187 = " - Compare date : \" + routines.system.FormatterUtils.format_Date(";
  protected final String TEXT_188 = ".moment,\"dd-MM-yyyy HH:mm:ss\") + \".\");" + NL + "\t\t\t";
