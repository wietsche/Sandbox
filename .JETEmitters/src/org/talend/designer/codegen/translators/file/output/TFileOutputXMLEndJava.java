...
public class TFileOutputXMLEndJava
{
  ...
  protected final String TEXT_30 = "out_";
  protected final String TEXT_31 = ".write(\"</\"+";
  protected final String TEXT_32 = "+\">\");" + NL + "" + NL + "out_";
  protected final String TEXT_33 = ".newLine();" + NL;
  protected final String TEXT_34 = "\tout_";
  protected final String TEXT_35 = ".write(footers_";
  protected final String TEXT_36 = "[";
  protected final String TEXT_37 = "]);" + NL + "" + NL + "\tout_";
  protected final String TEXT_38 = ".newLine();" + NL + "\t";
  protected final String TEXT_39 = "out_";
  protected final String TEXT_40 = ".close();" + NL;
  protected final String TEXT_41 = NL + "\tif(currentRowCount_";
  protected final String TEXT_42 = " == 0){\t\t" + NL + "\t\tfile_";
  protected final String TEXT_43 = ".delete();" + NL + "\t}";
  protected final String TEXT_44 = "globalMap.put(\"";
  protected final String TEXT_45 = "_NB_LINE\",nb_line_";
  protected final String TEXT_46 = ");";
  protected final String TEXT_47 = NL + "\twriter_";
  protected final String TEXT_48 = ".close();";
  protected final String TEXT_49 = NL + "\t";
  protected final String TEXT_50 = NL + "\tif(nb_line_";
  protected final String TEXT_51 = " == 0){" + NL + "\t\tfile_";
  protected final String TEXT_52 = ".delete();" + NL + "\t}\t\t";
