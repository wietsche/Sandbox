...
public class TFileInputFullRowEndJava
{
  ...
  protected final String TEXT_31 = NL + NL + "            }" + NL + "           \t}finally{" + NL + "           \t\tif(fid_";
  protected final String TEXT_32 = "!=null){" + NL + "            \t\tfid_";
  protected final String TEXT_33 = ".close();" + NL + "            \t}" + NL + "            }" + NL + "            globalMap.put(\"";
  protected final String TEXT_34 = "_NB_LINE\", fid_";
  protected final String TEXT_35 = ".getRowNumber());";
