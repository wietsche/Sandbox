...
public class THDFSInputEndJava
{
  ...
  protected final String TEXT_31 = NL + "\t\t\t\t} // while";
  protected final String TEXT_32 = NL + "\t\t\t\treader_";
  protected final String TEXT_33 = ".close();";
  protected final String TEXT_34 = "\t\t\t\t" + NL + "\t\t\t\tif(fid_";
  protected final String TEXT_35 = " !=null ) {" + NL + "\t\t\t\t\tfid_";
  protected final String TEXT_36 = ".close();" + NL + "\t\t\t\t}";
  protected final String TEXT_37 = NL + "\t\t\t}// for";
