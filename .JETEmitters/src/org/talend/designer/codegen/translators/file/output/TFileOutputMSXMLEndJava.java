...
public class TFileOutputMSXMLEndJava {
  ...
  protected final String TEXT_175 = NL + "\t\t" + NL + "\t\tif(orderHelper_";
  protected final String TEXT_176 = ".need_recalculate(\"";
  protected final String TEXT_177 = "\")) {" + NL + "\t\t\tjava.util.List<org.dom4j.Element> allElements_";
  protected final String TEXT_178 = "_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ".elements();" + NL + "\t\t\tint order_";
  protected final String TEXT_181 = " = allElements_";
  protected final String TEXT_182 = "_";
  protected final String TEXT_183 = ".size();" + NL + "\t\t\t" + NL + "    \t\tjava.util.List<org.dom4j.Element> elements_";
  protected final String TEXT_184 = "_";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = ".elements(qname_";
  protected final String TEXT_187 = "_";
  protected final String TEXT_188 = ");" + NL + "    \t\tint app_size_";
  protected final String TEXT_189 = " = elements_";
  protected final String TEXT_190 = "_";
  protected final String TEXT_191 = ".size();" + NL + "    \t\t" + NL + "    \t\tif(app_size_";
  protected final String TEXT_192 = " > 0){" + NL + "    \t\t\torder_";
  ...
  protected final String TEXT_224 = " = index_sibling_";
  protected final String TEXT_225 = "_";
  protected final String TEXT_226 = "_";
  protected final String TEXT_227 = ";" + NL + "    \t\t\t} else {";
  protected final String TEXT_228 = NL + "\t\t\t\t}";
  protected final String TEXT_229 = NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tif(order_";
  protected final String TEXT_230 = " == allElements_";
  protected final String TEXT_231 = "_";
  protected final String TEXT_232 = ".size()) {" + NL + "\t\t\t\torderHelper_";
  protected final String TEXT_233 = ".fillTailAppendMap(\"";
  protected final String TEXT_234 = "\",true);" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\torderHelper_";
  protected final String TEXT_235 = ".setOrder(\"";
  protected final String TEXT_236 = "\",order_";
  protected final String TEXT_237 = ");" + NL + "\t\t\torderHelper_";
  protected final String TEXT_238 = ".fillRecalculateOrderMap(\"";
  protected final String TEXT_239 = "\",false);" + NL + "\t\t} else {" + NL + "\t\t\tint order_";
  protected final String TEXT_240 = " = orderHelper_";
  protected final String TEXT_241 = ".order(\"";
  protected final String TEXT_242 = "\");" + NL + "\t\t\torderHelper_";
  protected final String TEXT_243 = ".setOrder(\"";
  protected final String TEXT_244 = "\",++order_";
  protected final String TEXT_245 = ");" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tif(orderHelper_";
  protected final String TEXT_246 = ".tailAppend(\"";
  protected final String TEXT_247 = "\")) {" + NL + "\t\t\t";
  protected final String TEXT_248 = ".add(";
  protected final String TEXT_249 = ");" + NL + "\t\t} else {" + NL + "\t\t\t";
  protected final String TEXT_250 = ".elements().add(orderHelper_";
  protected final String TEXT_251 = ".order(\"";
  protected final String TEXT_252 = "\"),";
  protected final String TEXT_253 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_254 = NL + "\t\tif (";
  protected final String TEXT_255 = ".getNamespaceForPrefix(\"";
  ...
  protected final String TEXT_262 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_263 = " .parseAndAdd(";
  protected final String TEXT_264 = ",";
  protected final String TEXT_265 = ");" + NL + "\t\t}";
  protected final String TEXT_266 = NL + "\t\telse{" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_267 = " .parseAndAdd(";
  protected final String TEXT_268 = ",\"\");" + NL + "\t\t\t";
  protected final String TEXT_269 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_270 = NL + "\t\tif(";
  protected final String TEXT_271 = "!=null){" + NL + "\t\t\tnestXMLTool_";
  protected final String TEXT_272 = " .setText(";
  protected final String TEXT_273 = ",";
  protected final String TEXT_274 = ");" + NL + "\t\t}";
  protected final String TEXT_275 = NL + "\t\telse{" + NL + "\t\t\t";
  protected final String TEXT_276 = ".setText(\"\");" + NL + "\t\t\t";
  protected final String TEXT_277 = ".addAttribute(\"xsi:nil\",\"true\");" + NL + "\t\t}";
  protected final String TEXT_278 = NL + "\t\tnestXMLTool_";
  protected final String TEXT_279 = ".parseAndAdd(";
  protected final String TEXT_280 = ",\"";
  protected final String TEXT_281 = "\");" + NL;
  protected final String TEXT_282 = NL + "\t\tif(";
  protected final String TEXT_283 = "!=null){";
  protected final String TEXT_284 = NL + "\t\t\t";
  protected final String TEXT_285 = ".addAttribute(\"";
  protected final String TEXT_286 = "\",";
  protected final String TEXT_287 = ");";
  protected final String TEXT_288 = NL + "\t\t\t";
  protected final String TEXT_289 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_290 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_291 = "\",\"";
  protected final String TEXT_292 = "\")),";
  protected final String TEXT_293 = ");";
  protected final String TEXT_294 = NL + "\t\t}";
  protected final String TEXT_295 = NL + "\t\t\t";
  protected final String TEXT_296 = ".addAttribute(\"";
  protected final String TEXT_297 = "\", \"";
  protected final String TEXT_298 = "\");";
  protected final String TEXT_299 = NL + "\t\t\t";
  protected final String TEXT_300 = ".addAttribute(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_301 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_302 = "\",\"";
  protected final String TEXT_303 = "\")),\"";
  protected final String TEXT_304 = "\");";
  protected final String TEXT_305 = NL + "\t\tif(";
  protected final String TEXT_306 = "!=null){" + NL + "\t\t\t";
  protected final String TEXT_307 = ".addNamespace(\"";
  protected final String TEXT_308 = "\",TalendString.replaceSpecialCharForXML(";
  protected final String TEXT_309 = "));";
  protected final String TEXT_310 = NL + "        \t";
  protected final String TEXT_311 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_312 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(";
  ...
  protected final String TEXT_323 = "true";
  protected final String TEXT_324 = " && (";
  protected final String TEXT_325 = "(";
  protected final String TEXT_326 = "==null && ";
  protected final String TEXT_327 = " == null) || (true &&";
  protected final String TEXT_328 = NL + "\t";
  protected final String TEXT_329 = "!=null" + NL + " && ";
  protected final String TEXT_330 = ".getText()!=null" + NL + " &&";
  ...
  protected final String TEXT_337 = ".getText()!=null" + NL + " && ";
  protected final String TEXT_338 = ".getText().equals(\"";
  protected final String TEXT_339 = "\")" + NL + " )";
  protected final String TEXT_340 = " && (";
  protected final String TEXT_341 = "(";
  protected final String TEXT_342 = "==null && ";
  protected final String TEXT_343 = ".attribute(";
  protected final String TEXT_344 = ") == null) || (true && ";
  protected final String TEXT_345 = ".attribute(";
  protected final String TEXT_346 = ")!=null" + NL + "&& ";
  protected final String TEXT_347 = ".attribute(";
  protected final String TEXT_348 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_349 = ".attribute(";
  protected final String TEXT_350 = ").getText().equals(";
  ...
  protected final String TEXT_358 = ").getText()!=null" + NL + "&&";
  protected final String TEXT_359 = ".attribute(";
  protected final String TEXT_360 = ").getText().equals(\"";
  protected final String TEXT_361 = "\")" + NL + " )";
  protected final String TEXT_362 = NL;
  protected final String TEXT_363 = ".element(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_364 = "\",org.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_365 = "\",\"";
  protected final String TEXT_366 = "\")))";
  protected final String TEXT_367 = ".element(\"";
  protected final String TEXT_368 = "\")";
  protected final String TEXT_369 = NL + "TalendWrapTool_";
  protected final String TEXT_370 = " talendWrapTool_";
  protected final String TEXT_371 = " = new TalendWrapTool_";
  protected final String TEXT_372 = "();";
  protected final String TEXT_373 = NL + "class TalendWrapTool_";
  protected final String TEXT_374 = " {";
  protected final String TEXT_375 = NL + "}";
  protected final String TEXT_376 = NL + "nb_line_";
  protected final String TEXT_377 = "++;";
  protected final String TEXT_378 = NL + "public void create";
  protected final String TEXT_379 = "Doc(";
  protected final String TEXT_380 = "Struct ";
  protected final String TEXT_381 = ") throws java.lang.Exception {";
  protected final String TEXT_382 = NL + "talendWrapTool_";
  protected final String TEXT_383 = ".create";
  protected final String TEXT_384 = "Doc(";
  protected final String TEXT_385 = ");";
  protected final String TEXT_386 = NL + "java.util.List<java.util.List<String>> groupbyList_";
  protected final String TEXT_387 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "final java.util.Map<String,String> valueMap_";
  protected final String TEXT_388 = " = new java.util.HashMap<String,String>();" + NL + "boolean isXML10Char_";
  protected final String TEXT_389 = " = true;" + NL + "" + NL + "// sort group root element for judgement of group" + NL + "java.util.List<org.dom4j.Element> groupElementList_";
  protected final String TEXT_390 = " = new java.util.ArrayList<org.dom4j.Element>();" + NL + "org.dom4j.Element root4Group_";
  protected final String TEXT_391 = " = null;";
  protected final String TEXT_392 = NL + "org.dom4j.Element root_";
  protected final String TEXT_393 = "_";
  protected final String TEXT_394 = " = null;" + NL + "//used to judge branch root tags" + NL + "boolean needRoot_";
  protected final String TEXT_395 = "_";
  protected final String TEXT_396 = "  = true;" + NL + "//namespace support" + NL + "java.util.Map<String,String> uriToPrefixForDefaultNamespace_";
  protected final String TEXT_397 = "_";
  protected final String TEXT_398 = " = new java.util.HashMap<String,String>();" + NL + "java.util.Map<String,String> prefixToUriForNamespace_";
  protected final String TEXT_399 = "_";
  protected final String TEXT_400 = " = new java.util.HashMap<String,String>();";
  protected final String TEXT_401 = NL + "\tvoid putValue_";
  protected final String TEXT_402 = "_";
  protected final String TEXT_403 = "(final ";
  protected final String TEXT_404 = "Struct ";
  protected final String TEXT_405 = "){";
  protected final String TEXT_406 = NL + "\t\tvalueMap_";
  protected final String TEXT_407 = ".put(\"";
  protected final String TEXT_408 = "\", ";
  protected final String TEXT_409 = ");" + NL + "\t\tif(isXML10Char_";
  protected final String TEXT_410 = ") {" + NL + "\t\t\tisXML10Char_";
  protected final String TEXT_411 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_412 = ");" + NL + "\t\t}";
  protected final String TEXT_413 = NL + "\t}";
  protected final String TEXT_414 = NL + "\t}";
  protected final String TEXT_415 = NL + "\t" + NL + "\tvalueMap_";
  protected final String TEXT_416 = ".clear();" + NL + "\t";
  protected final String TEXT_417 = NL + "\t";
  protected final String TEXT_418 = NL + "\tputValue_";
  protected final String TEXT_419 = "_";
  protected final String TEXT_420 = "(";
  protected final String TEXT_421 = ");";
  protected final String TEXT_422 = NL + "\t\t\tvalueMap_";
  protected final String TEXT_423 = ".put(\"";
  protected final String TEXT_424 = "\", ";
  protected final String TEXT_425 = ");" + NL + "\t\t\tif(isXML10Char_";
  protected final String TEXT_426 = ") {" + NL + "\t\t\t\tisXML10Char_";
  protected final String TEXT_427 = " = org.talend.util.xml.XMLText.isValid(";
  protected final String TEXT_428 = ");" + NL + "\t\t\t}";
  protected final String TEXT_429 = NL + "\t";
  protected final String TEXT_430 = NL + "\t";
  protected final String TEXT_431 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_432 = "_";
  protected final String TEXT_433 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_434 = "_";
  protected final String TEXT_435 = " = false;";
  protected final String TEXT_436 = NL + "\t\troot_";
  protected final String TEXT_437 = "_";
  protected final String TEXT_438 = " = ";
  protected final String TEXT_439 = ";" + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_440 = NL + "\t}";
  protected final String TEXT_441 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_442 = "_";
  protected final String TEXT_443 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_444 = "_";
  protected final String TEXT_445 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_446 = "_";
  protected final String TEXT_447 = " = doc_";
  protected final String TEXT_448 = ".createXPath(\"";
  protected final String TEXT_449 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_450 = "_";
  protected final String TEXT_451 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_452 = "_";
  protected final String TEXT_453 = ");" + NL + "\t\troot_";
  protected final String TEXT_454 = "_";
  protected final String TEXT_455 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_456 = "_";
  protected final String TEXT_457 = ".selectSingleNode(doc_";
  protected final String TEXT_458 = ");" + NL + "\t\tif(!DocumentHelper.isMatchAtRoot(root_";
  protected final String TEXT_459 = "_";
  protected final String TEXT_460 = ",prefixToUriForNamespace_";
  protected final String TEXT_461 = "_";
  protected final String TEXT_462 = ")) {" + NL + "\t\t\tSystem.err.println(\"warn:::the pre input source content is empty!\");" + NL + "\t\t\t";
  protected final String TEXT_463 = NL + "\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\troot_";
  protected final String TEXT_465 = "_";
  protected final String TEXT_466 = " = (org.dom4j.Element)xpath_";
  protected final String TEXT_467 = "_";
  protected final String TEXT_468 = ".selectSingleNode(doc_";
  protected final String TEXT_469 = ");" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_470 = NL + "\t// build root xml tree " + NL + "\tif (needRoot_";
  protected final String TEXT_471 = "_";
  protected final String TEXT_472 = ") {" + NL + "\t\tneedRoot_";
  protected final String TEXT_473 = "_";
  protected final String TEXT_474 = " = false;" + NL + "\t\torg.dom4j.XPath xpath_";
  protected final String TEXT_475 = "_";
  protected final String TEXT_476 = " = doc_";
  protected final String TEXT_477 = ".createXPath(\"";
  protected final String TEXT_478 = "\");" + NL + "\t\txpath_";
  protected final String TEXT_479 = "_";
  protected final String TEXT_480 = ".setNamespaceURIs(prefixToUriForNamespace_";
  protected final String TEXT_481 = "_";
  protected final String TEXT_482 = ");" + NL + "\t\troot_";
  protected final String TEXT_483 = "_";
  protected final String TEXT_484 = " = " + NL + "\t\t\t(org.dom4j.Element)xpath_";
  protected final String TEXT_485 = "_";
  protected final String TEXT_486 = ".selectSingleNode(doc_";
  protected final String TEXT_487 = ");" + NL + "\t\t";
  protected final String TEXT_488 = NL + "\t\t";
  protected final String TEXT_489 = NL + "\t\troot_";
  protected final String TEXT_490 = "_";
  protected final String TEXT_491 = " = ";
  protected final String TEXT_492 = ";" + NL + "\t}else{" + NL + "\t\t";
  protected final String TEXT_493 = NL + "\t}";
  protected final String TEXT_494 = NL + "\t" + NL + "\t// build group xml tree ";
  protected final String TEXT_495 = "\t\t" + NL + "\t\tboolean bl_";
  protected final String TEXT_496 = "= false;//true:find the insert node;false:not";
  protected final String TEXT_497 = NL + "\t\tif(bl_";
  protected final String TEXT_498 = "==false){" + NL + "\t\t\tjava.util.List<org.dom4j.Element> listNodes= ";
  protected final String TEXT_499 = ".elements();" + NL + "\t\t\tif(listNodes!=null && listNodes.size()>0){" + NL + "\t\t\t\tint j=0;" + NL + "\t\t\t\tfor(j=0;j<listNodes.size();j++){" + NL + "\t\t\t\t\torg.dom4j.Element tempElem =listNodes.get(j);" + NL + "\t\t\t\t\tjava.util.Map<String,String> currentDeclaredNamespacesMapping = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_500 = NL + "\t\t\t\t\tif(DocumentHelper.compareNodes(\"";
  protected final String TEXT_501 = "\",tempElem,uriToPrefixForDefaultNamespace_";
  protected final String TEXT_502 = "_";
  protected final String TEXT_503 = ",currentDeclaredNamespacesMapping,";
  ...
  protected final String TEXT_508 = NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tif(j>=listNodes.size()){" + NL + "\t\t\t\t\tbl_";
  protected final String TEXT_509 = "=true;" + NL + "\t\t\t\t}" + NL + "\t\t\t}else{" + NL + "\t\t\t\tbl_";
  protected final String TEXT_510 = "=true;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif(bl_";
  protected final String TEXT_511 = "==true){";
  protected final String TEXT_512 = NL + "\t\t}";
  protected final String TEXT_513 = NL + "\t// build loop xml tree";
  protected final String TEXT_514 = NL;
  protected final String TEXT_515 = NL + "\tjava.io.FileOutputStream stream_";
  protected final String TEXT_516 = " = new java.io.FileOutputStream(fileName_";
  protected final String TEXT_517 = ");" + NL + " \t" + NL + "\torg.dom4j.io.XMLWriter output_";
  protected final String TEXT_518 = " = null;";
  protected final String TEXT_519 = NL + "\tif(talendWrapTool_";
  protected final String TEXT_520 = ".isXML10Char_";
  protected final String TEXT_521 = ") {";
  protected final String TEXT_522 = NL + "\tif(isXML10Char_";
  protected final String TEXT_523 = ") {";
  protected final String TEXT_524 = NL + "\t\toutput_";
  protected final String TEXT_525 = " = new org.dom4j.io.XMLWriter(stream_";
  protected final String TEXT_526 = ", format_";
  protected final String TEXT_527 = ");" + NL + "\t} else {" + NL + "\t\toutput_";
  protected final String TEXT_528 = " = new org.dom4j.io.XMLWriter(" + NL + "\t\t\t\t\t\t\tstream_";
  protected final String TEXT_529 = ", format_";
  protected final String TEXT_530 = ") {" + NL + "\t\t\t\t\t\t" + NL + "\t\t\tprivate org.dom4j.io.OutputFormat format = null;" + NL + "\t\t\t" + NL + "\t\t\t{" + NL + "\t\t\t\tformat = format_";
  protected final String TEXT_531 = ";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void writeDeclaration() throws IOException {" + NL + "\t\t        String encoding = format.getEncoding();" + NL + "" + NL + "\t\t        // Only print of declaration is not suppressed" + NL + "\t\t        if (!format.isSuppressDeclaration()) {" + NL + "\t\t            // Assume 1.0 version" + NL + "\t\t            if (encoding.equals(\"UTF8\")) {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"UTF-8\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            } else {" + NL + "\t\t                writer.write(\"<?xml version=\\\"1.1\\\"\");" + NL + "" + NL + "\t\t                if (!format.isOmitEncoding()) {" + NL + "\t\t                    writer.write(\" encoding=\\\"\" + encoding + \"\\\"\");" + NL + "\t\t                }" + NL + "" + NL + "\t\t                writer.write(\"?>\");" + NL + "\t\t            }" + NL + "" + NL + "\t\t            if (format.isNewLineAfterDeclaration()) {" + NL + "\t\t                println();" + NL + "\t\t            }" + NL + "\t\t        }" + NL + "\t\t    }" + NL + "\t\t};" + NL + "\t}" + NL + "\t" + NL + "    nestXMLTool_";
  protected final String TEXT_532 = ".replaceDefaultNameSpace(doc_";
  protected final String TEXT_533 = ".getRootElement());";
  protected final String TEXT_534 = NL + "    nestXMLTool_";
  protected final String TEXT_535 = ".removeEmptyElement(doc_";
  protected final String TEXT_536 = ".getRootElement());";
  protected final String TEXT_537 = NL + "\toutput_";
  protected final String TEXT_538 = ".setEscapeText(";
  protected final String TEXT_539 = ");" + NL + "    output_";
  protected final String TEXT_540 = ".write(doc_";
  protected final String TEXT_541 = ");" + NL + "    output_";
  protected final String TEXT_542 = ".close();" + NL + "    " + NL + "\tnameToElement_";
  protected final String TEXT_543 = ".clear();" + NL + "\t" + NL + "    globalMap.put(\"";
  protected final String TEXT_544 = "_NB_LINE\",nb_line_";
  protected final String TEXT_545 = ");" + NL;
  protected final String TEXT_546 = NL + "\tif(nb_line_";
  protected final String TEXT_547 = " == 0){" + NL + "\t\tcreateFile";
  protected final String TEXT_548 = ".delete();" + NL + "\t}";
