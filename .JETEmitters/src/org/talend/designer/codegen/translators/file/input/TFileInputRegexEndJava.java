...
public class TFileInputRegexEndJava
{
  ...
  protected final String TEXT_32 = NL + "\t\t\tif(!(source_";
  protected final String TEXT_33 = " instanceof java.io.InputStream)){" + NL + "            \tin";
  protected final String TEXT_34 = ".close();" + NL + "            }" + NL + "            in";
  protected final String TEXT_35 = " = null;" + NL + "            globalMap.put(\"";
