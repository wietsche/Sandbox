...
public class TFileInputXMLEndJava
{
  ...
  protected final String TEXT_32 = NL + "\ttry {" + NL + "\t\tlooper_";
  protected final String TEXT_33 = ".handleTaskResponse();" + NL + "\t} catch(java.lang.Exception e) {" + NL + "\t\tif(!(e.getCause() instanceof org.talend.xml.sax.exception.EnoughDataException))" + NL + "\t";
