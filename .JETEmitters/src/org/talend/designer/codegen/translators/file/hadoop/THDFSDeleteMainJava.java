...
public class THDFSDeleteMainJava
{
  ...
  protected final String TEXT_98 = ");" + NL + "\tif(fs_";
  protected final String TEXT_99 = ".exists(path_";
  protected final String TEXT_100 = ")){" + NL + "\t\tif(fs_";
  protected final String TEXT_101 = ".delete(path_";
  protected final String TEXT_102 = ", true)){" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_103 = "_CURRENT_STATUS\", \"Path deleted.\");" + NL + "\t\t\t" + NL + "\t    \t";
  protected final String TEXT_104 = NL + "            log.info(\"";
  protected final String TEXT_105 = " - directory or file : \" + path_";
  protected final String TEXT_106 = " + \" is deleted.\");";
  protected final String TEXT_107 = NL + "\t\t}else{" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_108 = "_CURRENT_STATUS\", \"No path deleted.\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_109 = NL + "            log.info(\"";
  protected final String TEXT_110 = " - fail to delete directory or file : \" + path_";
  protected final String TEXT_111 = " + \".\");";
  protected final String TEXT_112 = NL + "\t\t}" + NL + "\t}else{" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_113 = "_CURRENT_STATUS\", \"Path does not exist.\");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_114 = NL + "       \tlog.warn(\"";
  protected final String TEXT_115 = " - directory or file : \" + path_";
  protected final String TEXT_116 = " + \" does not exist.\");";
  protected final String TEXT_117 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_118 = "_DELETE_PATH\",";
