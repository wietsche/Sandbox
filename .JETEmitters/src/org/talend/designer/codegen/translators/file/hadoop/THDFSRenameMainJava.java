...
public class THDFSRenameMainJava
{
  ...
  protected final String TEXT_101 = ");" + NL + "" + NL + "                        if (fs_";
  protected final String TEXT_102 = ".exists(tempPath_";
  protected final String TEXT_103 = ")) {" + NL + "                            fs_";
  protected final String TEXT_104 = ".delete(tempPath_";
  protected final String TEXT_105 = ", true);" + NL + "                        }" + NL + "" + NL + "\t\t     \t\t\tif(success_";
  protected final String TEXT_106 = ") {" + NL + "\t\t     \t\t\t    ";
  protected final String TEXT_107 = NL + "                   \t\t\tlog.info(\"";
  protected final String TEXT_108 = " - \" + fromPath_";
  protected final String TEXT_109 = " + \" is renamed as \" + toPath_";
  protected final String TEXT_110 = " + \".\");" + NL + "                    \t\t";
  protected final String TEXT_111 = NL + "\t\t    \t\t\t\tglobalMap.put(\"";
  protected final String TEXT_112 = "_CURRENT_STATUS\", \"File rename OK.\");" + NL + "\t\t    \t\t\t\tnb_file_";
  protected final String TEXT_113 = "++;" + NL + "\t\t    \t\t\t} else {" + NL + "\t\t    \t\t\t\tglobalMap.put(\"";
  protected final String TEXT_114 = "_CURRENT_STATUS\", \"File rename fail.\");" + NL + "\t\t    \t\t\t\tSystem.err.println(\"Info : File rename fail\");" + NL + "            \t\t\t\t";
  protected final String TEXT_115 = NL + "                   \t\t\tlog.error(\"";
  protected final String TEXT_116 = " - fail to rename file from \" + fromPath_";
  protected final String TEXT_117 = " + \" to \" + toPath_";
  protected final String TEXT_118 = ");" + NL + "                    \t\t";
  protected final String TEXT_119 = NL + "\t\t    \t\t\t}" + NL + "\t\t    \t\t}" + NL + "\t\t    \t\t";
  protected final String TEXT_120 = NL + "\t    \t\t} catch(java.io.IOException e) {" + NL + "\t    \t\t\tglobalMap.put(\"";
  protected final String TEXT_121 = "_CURRENT_STATUS\", \"File rename fail.\");" + NL + "            \t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_123 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "    \t\t\t\t\t";
  protected final String TEXT_124 = NL + "           \t\t\tlog.error(\"";
  protected final String TEXT_125 = " - fail to rename file : \" + e.getMessage());" + NL + "            \t\t\t";
