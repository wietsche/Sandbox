...
public class THDFSOutputBeginJava
{
  ...
  protected final String TEXT_100 = "\t\t\t" + NL + "\t\torg.apache.hadoop.fs.FSDataOutputStream fsDataOutputStream_";
  protected final String TEXT_101 = " = null;" + NL + "\t\t";
  protected final String TEXT_102 = NL + "    \t\tif(!fs_";
  protected final String TEXT_103 = ".exists(path_";
  protected final String TEXT_104 = ")) {" + NL + "    \t\t\tfsDataOutputStream_";
  protected final String TEXT_105 = " = fs_";
  protected final String TEXT_106 = ".create(path_";
  protected final String TEXT_107 = ",false);" + NL + "    \t\t} else {" + NL + "\t\t\t\tfsDataOutputStream_";
  protected final String TEXT_108 = " = fs_";
  protected final String TEXT_109 = ".append(path_";
  ...
  protected final String TEXT_116 = NL + "\t\t\tjava.io.Writer out";
  protected final String TEXT_117 = " = null;" + NL + "\t\t\tout";
  protected final String TEXT_118 = "=new java.io.BufferedWriter(new java.io.OutputStreamWriter(fsDataOutputStream_";
  protected final String TEXT_119 = ",";
  protected final String TEXT_120 = "));" + NL + "\t";
  protected final String TEXT_121 = NL + "\t\t\t\torg.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_122 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\t\t\tcodec_";
  protected final String TEXT_123 = ".setConf(conf_";
  protected final String TEXT_124 = ");";
  protected final String TEXT_125 = NL + "\t\t\t\torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_126 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\t\torg.apache.hadoop.io.compress.CompressionOutputStream out";
  protected final String TEXT_129 = " = codec_";
  protected final String TEXT_130 = ".createOutputStream(fsDataOutputStream_";
  protected final String TEXT_131 = ");";
  protected final String TEXT_132 = NL + "\t\t\tboolean fileExistAndHasContent_";
  protected final String TEXT_133 = " = false;" + NL + "\t\t\tif(fs_";
  protected final String TEXT_134 = ".exists(path_";
  protected final String TEXT_135 = ")) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_136 = " = fs_";
  protected final String TEXT_137 = ".getFileStatus(path_";
  protected final String TEXT_138 = ");" + NL + "\t\t\t\tfileExistAndHasContent_";
  protected final String TEXT_139 = " = (!statu_";
  protected final String TEXT_140 = ".isDir()) && (statu_";
  protected final String TEXT_141 = ".getLen() != 0);" + NL + "\t\t\t}" + NL + "\t\t\tif(!fileExistAndHasContent_";
  protected final String TEXT_142 = ") {";
  protected final String TEXT_143 = NL + "\t\t\tStringBuilder header_";
  protected final String TEXT_144 = " = new StringBuilder();";
  protected final String TEXT_145 = NL + "\t\t\t\theader_";
  protected final String TEXT_146 = ".append(\"";
  protected final String TEXT_147 = "\");";
  protected final String TEXT_148 = NL + "                header_";
  protected final String TEXT_149 = ".append(";
  protected final String TEXT_150 = ");";
  protected final String TEXT_151 = NL + "\t\t\theader_";
  protected final String TEXT_152 = ".append(";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL + "\t\t\tout";
  protected final String TEXT_155 = ".write(header_";
  protected final String TEXT_156 = ".toString());";
  protected final String TEXT_157 = NL + "\t\t\tout";
  protected final String TEXT_158 = ".write(header_";
  protected final String TEXT_159 = ".toString().getBytes(";
  protected final String TEXT_160 = "));";
  protected final String TEXT_161 = NL + "\t\t\t}";
  protected final String TEXT_162 = NL + NL + "\t\t";
  protected final String TEXT_163 = NL;
  protected final String TEXT_164 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_165 = " = new org.apache.hadoop.io.SequenceFile.Writer(fs_";
  protected final String TEXT_166 = ", conf_";
  protected final String TEXT_167 = ", path_";
  protected final String TEXT_168 = ", ";
  protected final String TEXT_169 = ".class, ";
  protected final String TEXT_170 = ".class);" + NL + "\t";
  protected final String TEXT_171 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_172 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_173 = ", conf_";
  protected final String TEXT_174 = ", path_";
  protected final String TEXT_175 = ", ";
  protected final String TEXT_176 = ".class, ";
  protected final String TEXT_177 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.GzipCodec());";
  protected final String TEXT_178 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_179 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_180 = ", conf_";
  protected final String TEXT_181 = ", path_";
  protected final String TEXT_182 = ", ";
  protected final String TEXT_183 = ".class, ";
  protected final String TEXT_184 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.BZip2Codec());";
  protected final String TEXT_185 = NL + "\t\t\tList<";
  protected final String TEXT_186 = "Struct> ";
  protected final String TEXT_187 = "_list_";
  protected final String TEXT_188 = "= new java.util.ArrayList<";
