...
public class TFileInputMailBeginJava
{
  ...
  protected final String TEXT_219 = ".getFileName();" + NL + "\t                    " + NL + "\t                    if (attachfileName";
  protected final String TEXT_220 = ".indexOf(\"=?\") != -1){" + NL + "\t    \t\t\t\t\tint m_";
  protected final String TEXT_221 = " = 2, n_";
  protected final String TEXT_222 = ";" + NL + "\t    \t\t\t\t\tn_";
  protected final String TEXT_223 = " = attachfileName";
  protected final String TEXT_224 = ".indexOf(63, m_";
  protected final String TEXT_225 = "); // the first ? location " + NL + "\t    \t\t\t\t\tString sCharSet_";
  protected final String TEXT_226 = " = attachfileName";
  protected final String TEXT_227 = ".substring(attachfileName";
  protected final String TEXT_228 = ".indexOf(\"=?\") + 2, n_";
  protected final String TEXT_229 = "); // the character set value         " + NL + "\t    \t\t\t\t\tm_";
  protected final String TEXT_230 = " = n_";
  protected final String TEXT_231 = " + 1;                      " + NL + "\t    \t\t\t\t\tn_";
  protected final String TEXT_232 = " = attachfileName";
  protected final String TEXT_233 = ".indexOf(63, m_";
  protected final String TEXT_234 = "); // the second ? location                      " + NL + "\t    \t\t\t\t\tString flag_";
  protected final String TEXT_235 = " = attachfileName";
  protected final String TEXT_236 = ".substring(m_";
  protected final String TEXT_237 = ", n_";
  protected final String TEXT_238 = ");" + NL + "\t    \t\t\t\t\tm_";
  protected final String TEXT_239 = " = n_";
  protected final String TEXT_240 = " + 1;" + NL + "\t    \t\t\t\t\tn_";
  protected final String TEXT_241 = " = attachfileName";
  protected final String TEXT_242 = ".indexOf(\"?=\", m_";
  protected final String TEXT_243 = ");                      " + NL + "\t    \t\t\t\t\tString sNameCode_";
  protected final String TEXT_244 = " = attachfileName";
  protected final String TEXT_245 = ".substring(m_";
  protected final String TEXT_246 = ", n_";
  protected final String TEXT_247 = ");                  " + NL + "\t    \t\t\t\t\tjava.io.ByteArrayInputStream byteArrIS_";
  protected final String TEXT_248 = " = new java.io.ByteArrayInputStream(sNameCode_";
  protected final String TEXT_249 = ".getBytes());                      " + NL + "\t    \t\t\t\t\tObject obj_";
  protected final String TEXT_250 = " = null;" + NL + "\t                      " + NL + "\t    \t\t\t\t\tif (flag_";
  protected final String TEXT_251 = ".equalsIgnoreCase(\"B\")) {" + NL + "\t                        \tobj_";
  protected final String TEXT_252 = " = new com.sun.mail.util.BASE64DecoderStream(byteArrIS_";
  protected final String TEXT_253 = ");                    " + NL + "\t    \t\t\t\t\t} else if (flag_";
  protected final String TEXT_254 = ".equalsIgnoreCase(\"Q\")) {" + NL + "\t    \t\t\t\t\t\tobj_";
  protected final String TEXT_255 = " = new com.sun.mail.util.QDecoderStream(byteArrIS_";
  protected final String TEXT_256 = ");" + NL + "\t    \t\t\t\t\t}" + NL + "\t                      " + NL + "\t    \t\t\t\t\tif (obj_";
  protected final String TEXT_257 = " != null){" + NL + "\t                        \tint k_";
  protected final String TEXT_258 = " = byteArrIS_";
  protected final String TEXT_259 = ".available();" + NL + "\t                        \tbyte[] arrByte_";
  protected final String TEXT_260 = " = new byte[k_";
  protected final String TEXT_261 = "];" + NL + "\t                        \tk_";
  protected final String TEXT_262 = " = ((java.io.InputStream) (obj_";
  protected final String TEXT_263 = ")).read(arrByte_";
  protected final String TEXT_264 = ", 0, k_";
  protected final String TEXT_265 = ");" + NL + "\t                        \tattachfileName";
  protected final String TEXT_266 = " = new String(arrByte_";
  protected final String TEXT_267 = ", 0, k_";
  protected final String TEXT_268 = ", sCharSet_";
  protected final String TEXT_269 = ");" + NL + "\t                      \t}" + NL + "\t                    }" + NL + "\t                    " + NL + "\t\t\t\t\t\tif(!(";
  protected final String TEXT_270 = ").endsWith(\"/\")){" + NL + "\t           \t\t\t\tpath";
  protected final String TEXT_271 = " = ";
  protected final String TEXT_272 = " + \"/\";" + NL + "\t        \t\t\t}else{" + NL + "\t\t\t\t\t\t\tpath";
  protected final String TEXT_273 = " =";
  protected final String TEXT_274 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t                    path";
  protected final String TEXT_275 = " = path";
  protected final String TEXT_276 = " + attachfileName";
  protected final String TEXT_277 = ";" + NL + "\t                    ";
  protected final String TEXT_278 = NL + "\t\t                    \tlog.info(\"";
  protected final String TEXT_279 = " - Extracted attachment: '\"+attachfileName";
  protected final String TEXT_280 = "+\"'.\");" + NL + "\t                    ";
  protected final String TEXT_281 = NL + "\t                    java.io.File attachFile  = new java.io.File(path";
  protected final String TEXT_282 = ");" + NL + "\t                    out";
  protected final String TEXT_283 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(attachFile));" + NL + "\t                    in";
  protected final String TEXT_284 = " = new java.io.BufferedInputStream(mpart";
  protected final String TEXT_285 = ".getInputStream());" + NL + "\t                    int buffer";
  protected final String TEXT_286 = " = 0;" + NL + "\t                    while ((buffer";
  protected final String TEXT_287 = " = in";
  protected final String TEXT_288 = ".read()) != -1) {" + NL + "\t                           out";
  protected final String TEXT_289 = ".write(buffer";
  protected final String TEXT_290 = ");" + NL + "\t                           out";
  protected final String TEXT_291 = ".flush();" + NL + "\t\t\t\t\t\t}   " + NL + "\t                    out";
  protected final String TEXT_292 = ".close();" + NL + "\t                    in";
  protected final String TEXT_293 = ".close();    " + NL + "\t                }" + NL + "\t            }" + NL + "\t\t\t}" + NL + " \t         " + NL + " \t          " + NL + "\t\t\t// for output" + NL + "\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_295 = " < list_";
  protected final String TEXT_296 = ".size() && list_";
  protected final String TEXT_297 = ".get(";
  protected final String TEXT_298 = ")!=null){\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_300 = ".";
  protected final String TEXT_301 = " = (String)list_";
  protected final String TEXT_302 = ".get(";
  protected final String TEXT_303 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = " = ParserUtils.parseTo_Date(list_";
  protected final String TEXT_307 = ".get(";
  protected final String TEXT_308 = "), ";
  protected final String TEXT_309 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_311 = ".";
  protected final String TEXT_312 = " = list_";
  protected final String TEXT_313 = ".get(";
  protected final String TEXT_314 = ").getBytes();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_315 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_316 = ".";
  protected final String TEXT_317 = " = ParserUtils.parseTo_";
  protected final String TEXT_318 = "(list_";
  protected final String TEXT_319 = ".get(";
  protected final String TEXT_320 = "));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\t\t} else { " + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_322 = ".";
  protected final String TEXT_323 = " = ";
  protected final String TEXT_324 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t\t\t\thasData_";
  protected final String TEXT_326 = " = true;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t      \t\t\t\t\t\t\t";
  protected final String TEXT_328 = ".";
  protected final String TEXT_329 = " = ";
  protected final String TEXT_330 = ".";
  protected final String TEXT_331 = ";" + NL + "\t\t\t\t \t\t\t\t";
  protected final String TEXT_332 = NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_333 = NL + "\t\t\tcatch (java.lang.Exception e){" + NL + "\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_335 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_336 = NL + "\t\t\t\t//nothing to do, ignore the exception if don't die on error" + NL + "\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_337 = ": \" + e.getMessage());" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_338 = NL + "\t\tfinally{" + NL + "\t\t\tif(fileInput";
  protected final String TEXT_339 = "!=null)" + NL + "\t\t\t\t\tfileInput";
  protected final String TEXT_340 = ".close();" + NL + "\t\t} " + NL + "\t\t////////////////////////////" + NL + "\t\tif(hasData_";
  protected final String TEXT_341 = "){" + NL + "\t\t";
  protected final String TEXT_342 = NL + "        \t";
  protected final String TEXT_343 = "\t";
  protected final String TEXT_344 = NL + "\ttry{" + NL + "\t\torg.talend.msg.utils.MsgMailUtil msgMailUtil_";
  protected final String TEXT_345 = "=new org.talend.msg.utils.MsgMailUtil(";
  protected final String TEXT_346 = ",";
  protected final String TEXT_347 = ");" + NL + "\t\t";
  protected final String TEXT_348 = NL + "\t\t\tmsgMailUtil_";
  protected final String TEXT_349 = ".activeLog(log,\"";
  protected final String TEXT_350 = "\");" + NL + "\t\t";
  protected final String TEXT_351 = NL + "\t\tmsgMailUtil_";
  protected final String TEXT_352 = ".getAttachments();" + NL + "\t\t";
  protected final String TEXT_353 = NL + "\t\t\t\t\t\tObject value_";
  protected final String TEXT_354 = "_";
  protected final String TEXT_355 = "=msgMailUtil_";
  protected final String TEXT_356 = ".processMessage(\"";
  protected final String TEXT_357 = "\");" + NL + "\t\t\t\t\t\tif(value_";
  protected final String TEXT_358 = "_";
  protected final String TEXT_359 = "!=null){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = " = String.valueOf(value_";
  protected final String TEXT_363 = "_";
  protected final String TEXT_364 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = " = ParserUtils.parseTo_Date((java.util.Date)value_";
  protected final String TEXT_368 = "_";
  protected final String TEXT_369 = ", ";
  protected final String TEXT_370 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_371 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = " = value_";
  protected final String TEXT_374 = "_";
  protected final String TEXT_375 = ".getBytes();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_376 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = " = value_";
  protected final String TEXT_379 = "_";
  protected final String TEXT_380 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_382 = "_";
  protected final String TEXT_383 = " instanceof Object[]){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = ".";
  protected final String TEXT_385 = " = java.util.Arrays.asList((Object[])value_";
  protected final String TEXT_386 = "_";
  protected final String TEXT_387 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = " = java.util.Arrays.asList(value_";
  protected final String TEXT_390 = "_";
  protected final String TEXT_391 = ");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_392 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_393 = ".";
  protected final String TEXT_394 = " = ParserUtils.parseTo_";
  protected final String TEXT_395 = "(value_";
  protected final String TEXT_396 = "_";
  protected final String TEXT_397 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\t\t\t\thasData_";
  protected final String TEXT_400 = " = true;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t}catch (java.lang.Exception e_";
  protected final String TEXT_402 = "){" + NL + "\t\t";
  protected final String TEXT_403 = NL + "\t\t\tthrow e_";
  protected final String TEXT_404 = ";" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_406 = " - \" + e_";
  protected final String TEXT_407 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t//nothing to do, ignore the exception if don't die on error" + NL + "\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_409 = ": \" + e_";
  protected final String TEXT_410 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_411 = NL + "\t}" + NL + "\tif(hasData_";
