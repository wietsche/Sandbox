...
public class TFileInputARFFEndJava
{
  ...
  protected final String TEXT_32 = "++;" + NL + "\t\t\t}" + NL + "\t\t}finally{" + NL + "\t\t\tif(bufferedReader_";
  protected final String TEXT_33 = "!=null){" + NL + "\t\t\t\tbufferedReader_";
  protected final String TEXT_34 = ".close();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tglobalMap.put(\"";
