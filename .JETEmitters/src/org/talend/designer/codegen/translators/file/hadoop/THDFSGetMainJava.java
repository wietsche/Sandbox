...
public class THDFSGetMainJava
{
  ...
  protected final String TEXT_38 = "+\") exists!\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_39 = NL + "       \t\tlog.error(\"";
  protected final String TEXT_40 = " - No match file(\"+key_";
  protected final String TEXT_41 = "+\") exists.\");" + NL + "        \t";
  protected final String TEXT_42 = NL + "\t\t}else{" + NL + "\t\t\tString localFilePath_";
  protected final String TEXT_43 = " = \"\";" + NL + "\t    \tfor(org.apache.hadoop.fs.Path path_";
  protected final String TEXT_44 = ":filePathList_";
  protected final String TEXT_45 = "){" + NL + "\t\t\t\tif(path_";
  protected final String TEXT_46 = ".getName().matches(finalMask_";
  protected final String TEXT_47 = ")){" + NL + "\t\t\t\t\tif(\"\".equals(map_";
  protected final String TEXT_48 = ".get(key_";
  protected final String TEXT_49 = "))){" + NL + "\t\t\t\t\t\tlocalFilePath_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = "+\"/\"+path_";
  protected final String TEXT_52 = ".getName();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tlocalFilePath_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = "+\"/\"+map_";
  protected final String TEXT_55 = ".get(key_";
  protected final String TEXT_56 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tFileUtil_";
  protected final String TEXT_57 = " fileutil_";
  protected final String TEXT_58 = " = new FileUtil_";
  protected final String TEXT_59 = "();" + NL + "\t\t\t\t\t\tboolean success_";
  protected final String TEXT_60 = " = fileutil_";
  protected final String TEXT_61 = ".copyToLocal(fs_";
  protected final String TEXT_62 = ", path_";
  protected final String TEXT_63 = ", new java.io.File(localFilePath_";
  protected final String TEXT_64 = ")," + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_65 = ", ";
  protected final String TEXT_66 = ", ";
  protected final String TEXT_67 = ");" + NL + "\t\t\t\t\t\tif(success_";
  protected final String TEXT_68 = ") {" + NL + "\t\t\t\t\t\t\tmsg_";
  protected final String TEXT_69 = ".add(\"file: \" + path_";
  protected final String TEXT_70 = ".toString() + \", size: \"" + NL + "\t\t                    \t+ fileutil_";
  protected final String TEXT_71 = ".getSize() + \" bytes download successfully\");" + NL + "\t\t                    nb_success_";
  protected final String TEXT_72 = "++;" + NL + "\t\t                }" + NL + "\t\t\t\t\t}catch(java.io.IOException e){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_73 = NL + "            \t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_76 = " - \" +e.getMessage());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnb_file_";
