...
public class TFileArchiveMainJava
{
  ...
  protected final String TEXT_109 = NL + "  " + NL + "  " + NL + "   zip_";
  protected final String TEXT_110 = ".doZip();" + NL + "   \t  " + NL + "   globalMap.put(\"";
  protected final String TEXT_111 = "_ARCHIVE_FILEPATH\",zipFile_";
  protected final String TEXT_112 = ");" + NL + "   globalMap.put(\"";
  protected final String TEXT_113 = "_ARCHIVE_FILENAME\",(";
  protected final String TEXT_114 = ").contains(\"\\\\\")?" + NL + "    (";
  protected final String TEXT_115 = ").substring(((";
  protected final String TEXT_116 = ").lastIndexOf(\"\\\\\")+2)): (";
  protected final String TEXT_117 = ").substring(((";
  protected final String TEXT_118 = ").lastIndexOf(\"/\"))+1));" + NL;
