...
public class TPivotToColumnsDelimitedEndJava
{
  ...
  protected final String TEXT_19 = ");" + NL + "\t\t" + NL + "\t\t    for(int i = 0;i<group_Keys";
  protected final String TEXT_20 = ".size();i++){" + NL + "\t\t        " + NL + "\t\t        for(int j = 0; j < group_Keys";
  protected final String TEXT_21 = ".get(i).size(); j++) {" + NL + "\t\t\t\t\tout";
  protected final String TEXT_22 = ".write(group_Keys";
  protected final String TEXT_23 = ".get(i).get(j));" + NL + "\t\t\t\t\tout";
  protected final String TEXT_24 = ".write(";
  protected final String TEXT_25 = ");" + NL + "\t\t\t\t}" + NL + "\t\t        " + NL + "\t\t        java.util.List<String> aggOut";
  protected final String TEXT_26 = " = aggregation";
  protected final String TEXT_27 = ".get(group_Keys";
  protected final String TEXT_28 = ".get(i));" + NL + "\t\t" + NL + "\t\t        int gap";
  ...
  protected final String TEXT_65 = ".get(i);" + NL + "        " + NL + "\t\t\t\t";
  ...
  protected final String TEXT_81 = ".flush();" + NL + "\t\t" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_82 = NL + "\t\t";
  protected final String TEXT_83 = NL + "\t\t\tif(CsvWriter";
  protected final String TEXT_84 = "!=null){" + NL + "\t\t\t\tCsvWriter";
  protected final String TEXT_85 = ".close();" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_86 = NL + "\t\t\tif(out";
  protected final String TEXT_87 = "!=null){" + NL + "\t\t\t \tout";
  protected final String TEXT_88 = ".flush();" + NL + "\t\t\t \tout";
  protected final String TEXT_89 = ".close();" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_90 = NL + "\t\t\tif(nb_line_";
  protected final String TEXT_91 = " == 0 && (new java.io.File(fileName_";
  protected final String TEXT_92 = ").exists())){" + NL + "\t\t\t\tnew java.io.File(fileName_";
  protected final String TEXT_93 = ").delete();" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_95 = "\", true);" + NL + "\t";
  protected final String TEXT_96 = NL + NL + "globalMap.put(\"";
  protected final String TEXT_97 = "_NB_LINE\", nb_line_";
  protected final String TEXT_98 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_99 = "_NB_LINE_OUT\", nb_line_out_";
