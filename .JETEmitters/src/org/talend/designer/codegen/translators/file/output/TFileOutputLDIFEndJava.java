...
public class TFileOutputLDIFEndJava
{
  ...
  protected final String TEXT_31 = NL + "\tpw_";
  protected final String TEXT_32 = ".flush();" + NL + "\tpw_";
  protected final String TEXT_33 = ".close();" + NL + "\tglobalMap.put(\"";
  ...
  protected final String TEXT_38 = " == 0){" + NL + "\t\tfile_";
