...
public class TFileExistMainJava
{
  ...
  protected final String TEXT_34 = ".exists()) {" + NL + "    globalMap.put(\"";
  protected final String TEXT_35 = "_EXISTS\",false);";
  protected final String TEXT_36 = NL + "    log.info(\"";
  protected final String TEXT_37 = " - Directory or file : \" + file_";
  protected final String TEXT_38 = ".getAbsolutePath() + \" doesn't exist.\");";
  protected final String TEXT_39 = NL + "}else{" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_40 = "_EXISTS\",true);";
  protected final String TEXT_41 = NL + "    log.info(\"";
  protected final String TEXT_42 = " - Directory or file : \" + file_";
  protected final String TEXT_43 = ".getAbsolutePath() + \" exists.\");";
  protected final String TEXT_44 = NL + "}" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_45 = "_FILENAME\",";
