...
public class THDFSPutBeginJava
{
  ...
  protected final String TEXT_98 = " = 0;" + NL + "\t" + NL + "\tfs_";
  protected final String TEXT_99 = ".mkdirs(new org.apache.hadoop.fs.Path(";
  protected final String TEXT_100 = "));" + NL + "\tjava.util.List<String> msg_";
  protected final String TEXT_101 = " = new java.util.ArrayList<String>();" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_102 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_103 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_104 = "_";
  protected final String TEXT_105 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_106 = "_";
  protected final String TEXT_107 = ".put(";
  protected final String TEXT_108 = ",";
  protected final String TEXT_109 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_110 = ".add(map_";
  protected final String TEXT_111 = "_";
  protected final String TEXT_112 = ");       " + NL + "\t";
  protected final String TEXT_113 = "\t" + NL + "" + NL + "\tString localdir_";
  protected final String TEXT_114 = "  = ";
  protected final String TEXT_115 = ";\t" + NL + "\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_116 = " : list_";
