...
public class THDFSPutMainJava
{
  ...
  protected final String TEXT_46 = " = \"\";" + NL + "\t    \t\tString hdfsFilePath_";
  ...
  protected final String TEXT_57 = "].getAbsolutePath();" + NL + "\t\t\t\t\t\thdfsFilePath_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = "+\"/\"+map_";
  protected final String TEXT_60 = ".get(key_";
  protected final String TEXT_61 = "); " + NL + "\t\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\t\tfs_";
  protected final String TEXT_62 = ".copyFromLocalFile(false, ";
  protected final String TEXT_63 = ", new org.apache.hadoop.fs.Path(localFilePath_";
  protected final String TEXT_64 = "), new org.apache.hadoop.fs.Path(hdfsFilePath_";
  protected final String TEXT_65 = "));" + NL + "\t\t    \t\t\t\t// add info to list will return" + NL + "\t\t    \t\t\t\tmsg_";
  protected final String TEXT_66 = ".add(\"file: \" + listings_";
  protected final String TEXT_67 = "[m_";
  protected final String TEXT_68 = "].getAbsolutePath() + \", size: \"" + NL + "\t\t                    \t+ listings_";
  protected final String TEXT_69 = "[m_";
  protected final String TEXT_70 = "].length() + \" bytes upload successfully\");" + NL + "\t\t                   " + NL + "\t\t    \t\t\t\tnb_success_";
  protected final String TEXT_71 = "++;" + NL + "\t\t    \t\t\t}catch(java.io.IOException e) {" + NL + "\t\t                \t";
  protected final String TEXT_72 = NL + "            \t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_74 = NL + "       \t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_75 = " - \" + e.getMessage());" + NL + "        \t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t                }" + NL + "\t\t\t\t\t\tnb_file_";
  protected final String TEXT_77 = "++;" + NL + "\t      \t\t\t}" + NL + "\t    \t\t}\t" + NL + "\t    \t}" + NL + "\t    }";
