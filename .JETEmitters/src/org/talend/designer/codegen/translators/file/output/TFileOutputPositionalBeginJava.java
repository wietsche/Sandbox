...
public class TFileOutputPositionalBeginJava
{
  ...
  protected final String TEXT_541 = ");" + NL + "\t\tboolean isFileGenerated_";
  protected final String TEXT_542 = " = true;";
  protected final String TEXT_543 = NL + "\t\tif(createFile";
  protected final String TEXT_544 = ".exists()){" + NL + "\t\t\tisFileGenerated_";
  protected final String TEXT_545 = " = false;" + NL + "\t\t}";
  protected final String TEXT_546 = NL + "        //create directory only if not exists" + NL + "        java.io.File parentFile_";
  protected final String TEXT_547 = " = createFile";
  protected final String TEXT_548 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_549 = " != null && !parentFile_";
  protected final String TEXT_550 = ".exists()) {" + NL + "            parentFile_";
  protected final String TEXT_551 = ".mkdirs();" + NL + "        }";
  protected final String TEXT_552 = NL + "        String fullName_";
  protected final String TEXT_553 = " = null;" + NL + "        String extension_";
  protected final String TEXT_554 = " = null;" + NL + "        String directory_";
  protected final String TEXT_555 = " = null;" + NL + "        if((fileNewName_";
  protected final String TEXT_556 = ".indexOf(\"/\") != -1)) {" + NL + "            if(fileNewName_";
  protected final String TEXT_557 = ".lastIndexOf(\".\") < fileNewName_";
  protected final String TEXT_558 = ".lastIndexOf(\"/\")) {" + NL + "                fullName_";
  protected final String TEXT_559 = " = fileNewName_";
  protected final String TEXT_560 = ";" + NL + "                extension_";
  protected final String TEXT_561 = " = \"\";" + NL + "            } else {" + NL + "                fullName_";
  protected final String TEXT_562 = " = fileNewName_";
  protected final String TEXT_563 = ".substring(0, fileNewName_";
  protected final String TEXT_564 = ".lastIndexOf(\".\"));" + NL + "                extension_";
  protected final String TEXT_565 = " = fileNewName_";
  protected final String TEXT_566 = ".substring(fileNewName_";
  protected final String TEXT_567 = ".lastIndexOf(\".\"));" + NL + "            }           " + NL + "            directory_";
  protected final String TEXT_568 = " = fileNewName_";
  protected final String TEXT_569 = ".substring(0, fileNewName_";
  protected final String TEXT_570 = ".lastIndexOf(\"/\"));            " + NL + "        } else {" + NL + "            if(fileNewName_";
  protected final String TEXT_571 = ".lastIndexOf(\".\") != -1) {" + NL + "                fullName_";
  protected final String TEXT_572 = " = fileNewName_";
  protected final String TEXT_573 = ".substring(0, fileNewName_";
  protected final String TEXT_574 = ".lastIndexOf(\".\"));" + NL + "                extension_";
  protected final String TEXT_575 = " = fileNewName_";
  protected final String TEXT_576 = ".substring(fileNewName_";
  protected final String TEXT_577 = ".lastIndexOf(\".\"));" + NL + "            } else {" + NL + "                fullName_";
  protected final String TEXT_578 = " = fileNewName_";
  protected final String TEXT_579 = ";" + NL + "                extension_";
  protected final String TEXT_580 = " = \"\";" + NL + "            }" + NL + "            directory_";
  protected final String TEXT_581 = " = \"\";" + NL + "        }" + NL + "\t\tString zipName_";
  protected final String TEXT_582 = " = fullName_";
  protected final String TEXT_583 = " + \".zip\";" + NL + "\t    java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_584 = "=new java.util.zip.ZipOutputStream(" + NL + "\t    \t\t\tnew java.io.BufferedOutputStream(new java.io.FileOutputStream(zipName_";
  protected final String TEXT_585 = ")));" + NL + "\t    zipOut_";
  protected final String TEXT_586 = ".putNextEntry(new java.util.zip.ZipEntry(createFile";
  protected final String TEXT_587 = ".getName()));" + NL + "\t\tfinal ";
  protected final String TEXT_588 = " out";
  protected final String TEXT_589 = " = new ";
  protected final String TEXT_590 = "(new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_591 = ",";
  protected final String TEXT_592 = "));";
  protected final String TEXT_593 = NL + "\t\tfinal ";
  protected final String TEXT_594 = " out";
  protected final String TEXT_595 = " = new ";
  protected final String TEXT_596 = "(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(fileNewName_";
  protected final String TEXT_597 = ", ";
  protected final String TEXT_598 = "),";
  protected final String TEXT_599 = "));";
  protected final String TEXT_600 = NL + "\t    java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_601 = "=new java.util.zip.ZipOutputStream(" + NL + "\t    \t\t\tnew java.io.BufferedOutputStream(";
  protected final String TEXT_602 = "));" + NL + "\t    zipOut_";
  protected final String TEXT_603 = ".putNextEntry(new java.util.zip.ZipEntry(\"TalendOutputPositional\"));" + NL + "\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_604 = " = new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_605 = ",";
  protected final String TEXT_606 = ");" + NL + "\t\tfinal ";
  protected final String TEXT_607 = " out";
  protected final String TEXT_608 = " = new ";
  protected final String TEXT_609 = "(outWriter_";
  protected final String TEXT_610 = ");";
  protected final String TEXT_611 = NL + "\t\tjava.io.OutputStreamWriter outWriter_";
  protected final String TEXT_612 = " = new java.io.OutputStreamWriter(";
  protected final String TEXT_613 = ",";
  protected final String TEXT_614 = ");" + NL + "\t\tfinal ";
  protected final String TEXT_615 = " out";
  protected final String TEXT_616 = " = new ";
  protected final String TEXT_617 = "(outWriter_";
  protected final String TEXT_618 = ");  ";
  protected final String TEXT_619 = NL + "\t\tif(createFile";
  protected final String TEXT_620 = ".length()==0){";
  protected final String TEXT_621 = NL + "    \t\t" + NL + "    \t\tString tempStringB";
  protected final String TEXT_622 = "=null;" + NL + "    \t\tint tempLengthB";
  protected final String TEXT_623 = "=0;";
  protected final String TEXT_624 = NL + "            positionUtil_";
  protected final String TEXT_625 = ".writeHeader_";
  protected final String TEXT_626 = "(tempStringB";
  protected final String TEXT_627 = ",tempLengthB";
  protected final String TEXT_628 = ",out";
  protected final String TEXT_629 = ",byteArray_";
  protected final String TEXT_630 = ",arrays_";
  protected final String TEXT_631 = ");";
  protected final String TEXT_632 = NL + "    \t\tout";
  protected final String TEXT_633 = ".write(";
