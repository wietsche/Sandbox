...
public class TFileOutputPropertiesEndJava
{
  ...
  protected final String TEXT_31 = NL + "\tjava.io.OutputStream fos_";
  protected final String TEXT_32 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_33 = ");" + NL + "\tproperties_";
  protected final String TEXT_34 = ".store(fos_";
  protected final String TEXT_35 = ", \"\");" + NL + "\tfos_";
  protected final String TEXT_36 = ".close();";
  protected final String TEXT_37 = NL + "\tini_";
  protected final String TEXT_38 = ".store();";
  protected final String TEXT_39 = NL + "int nb_line_";
  protected final String TEXT_40 = " = tos_count_";
