...
public class TMDMReadConfEndJava
{
  ...
  protected final String TEXT_43 = NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t   ";
  protected final String TEXT_44 = NL + "\t\t\t\t\t\tservice_";
  protected final String TEXT_45 = ".logout(new org.talend.mdm.webservice.WSLogout());\t\t\t\t\t   " + NL + "\t\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_47 = "\t\t\t\t\t\t      " + NL + "\t\t\t\t\t\t      throw e;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\t\t\t      System.err.println(e.getMessage());" + NL + "\t\t\t\t\t\t";
