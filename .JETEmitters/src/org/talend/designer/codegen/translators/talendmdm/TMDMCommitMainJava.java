...
public class TMDMCommitMainJava
{
  ...
  protected final String TEXT_42 = NL + "    org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_43 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"";
  protected final String TEXT_44 = "\");" + NL + "    " + NL + "    " + NL + "    if(service_";
  ...
  protected final String TEXT_49 = NL + "    \t\tmdmTransaction_";
  protected final String TEXT_50 = ".commit();";
  protected final String TEXT_51 = NL + "    \t}";
  protected final String TEXT_52 = NL + "        service_";
  protected final String TEXT_53 = ".logout(new org.talend.mdm.webservice.WSLogout());        ";
