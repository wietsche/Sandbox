...
public class TMDMBulkLoadMainJava
{
  ...
  protected final String TEXT_43 = " == 0) {" + NL + "\tif(inputStreamMerger_";
  protected final String TEXT_44 = " != null) {" + NL + "\t   ";
  protected final String TEXT_45 = NL + "\t   inputStreamMerger_";
  protected final String TEXT_46 = ".close();" + NL + "\t}" + NL + "\t" + NL + "\tinputStreamMerger_";
  protected final String TEXT_47 = " = bulkloadClient_";
  protected final String TEXT_48 = ".load();" + NL + "        resourceMap.put(\"mdmBulkStream";
  protected final String TEXT_49 = "\", inputStreamMerger_";
  protected final String TEXT_50 = ");" + NL + "}" + NL + "" + NL + "if(";
  protected final String TEXT_51 = ".";
  protected final String TEXT_52 = "!=null){";
  protected final String TEXT_53 = NL + "\tinputStreamMerger_";
  protected final String TEXT_54 = ".push(new java.io.ByteArrayInputStream(";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = ".toString().getBytes(\"UTF-8\")));" + NL + "}else{" + NL + "\tinputStreamMerger_";
  protected final String TEXT_57 = ".push(null);" + NL + "}" + NL + "\tcount_";
