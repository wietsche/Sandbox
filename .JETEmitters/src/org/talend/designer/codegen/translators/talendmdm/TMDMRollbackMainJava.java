...
public class TMDMRollbackMainJava
{
  ...
  protected final String TEXT_42 = NL + "\t" + NL + "    org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_43 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"";
  protected final String TEXT_44 = "\");" + NL + "" + NL + "    if(service_";
  protected final String TEXT_45 = " != null)" + NL + "    {" + NL + "    \tcom.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_46 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(\"";
  protected final String TEXT_47 = "\");" + NL + "    \tif(mdmTransaction_";
  protected final String TEXT_48 = "!=null) {" + NL + "    \t" + NL + "    \t   ";
  protected final String TEXT_49 = NL + "    \t   " + NL + "    \t\tmdmTransaction_";
  protected final String TEXT_50 = ".rollback();" + NL + "    \t\t" + NL + "    \t   ";
  protected final String TEXT_51 = NL + "    \t}";
  protected final String TEXT_52 = NL + "        " + NL + "        service_";
  protected final String TEXT_53 = ".logout(new org.talend.mdm.webservice.WSLogout());" + NL + "        ";
