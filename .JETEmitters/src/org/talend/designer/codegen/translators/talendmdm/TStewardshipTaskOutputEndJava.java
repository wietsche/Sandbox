...
public class TStewardshipTaskOutputEndJava
{
  ...
  protected final String TEXT_42 = NL + "\t\t\t\t\tif(targetRecordExisted_";
  protected final String TEXT_43 = "){" + NL + "\t\t\t\t\t\trecord_";
  protected final String TEXT_44 = " = task_";
  protected final String TEXT_45 = ".addTargetRecord();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_46 = NL + "\t    \t\t\t\t\t\trecord_";
  protected final String TEXT_47 = ".addSrcColumn(recordColumn_";
  protected final String TEXT_48 = "_";
  protected final String TEXT_49 = ",recordColumn_";
  protected final String TEXT_50 = "_Value_";
  protected final String TEXT_51 = ",recordColumn_";
  protected final String TEXT_52 = "_Type_";
  protected final String TEXT_53 = ",recordColumn_";
  protected final String TEXT_54 = "_Key_";
  protected final String TEXT_55 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tif(tasks_";
  protected final String TEXT_57 = ".getTaskCount()>=1){" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_58 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tString content = tasks_";
  protected final String TEXT_59 = ".getTasksAndClear();" + NL + "\t\t\t\t\t\t//System.out.println(content);" + NL + "\t\t\t\t\t\tboolean loadResult_";
  protected final String TEXT_60 = " = taskLoadClient_";
  protected final String TEXT_61 = ".doLoad(content);" + NL + "\t\t\t\t\t\tif(!loadResult_";
  protected final String TEXT_62 = "){" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_63 = NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tSystem.err.println(\"An error occured while uploading tasks.\");" + NL + "\t\t\t\t\t\t} else{" + NL + "\t\t\t\t\t\t    ";
