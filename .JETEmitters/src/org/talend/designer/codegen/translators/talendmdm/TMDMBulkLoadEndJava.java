...
public class TMDMBulkLoadEndJava
{
  ...
  protected final String TEXT_41 = NL + "if (inputStreamMerger_";
  protected final String TEXT_42 = "!=null) {" + NL + "inputStreamMerger_";
  protected final String TEXT_43 = ".close();" + NL + "} " + NL + "bulkloadClient_";
  protected final String TEXT_44 = ".waitForEndOfQueue();" + NL + "bulkloadClient_";
  protected final String TEXT_45 = " = null;";
  protected final String TEXT_46 = NL + "if(inputStreamMerger_";
  protected final String TEXT_47 = "!=null && inputStreamMerger_";
  protected final String TEXT_48 = ".getLastReportedFailure()!=null){" + NL;
  protected final String TEXT_49 = NL + "    " + NL + "    throw new Exception(inputStreamMerger_";
  protected final String TEXT_50 = ".getLastReportedFailure());" + NL + "}";
