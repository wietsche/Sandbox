...
public class TStewardshipTaskDeleteMainJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t\t" + NL + "\t\t\t    int delTaskId =  deleted_task_";
  protected final String TEXT_42 = "+1;" + NL + "\t\t\t    ";
  protected final String TEXT_43 = NL + "\t\t\t    " + NL + "\t\t\t";
  protected final String TEXT_44 = "\t\t        " + NL + "\t\t        " + NL + "\t\t\t\tTDSCWS_";
  protected final String TEXT_45 = ".deleteTask(";
  protected final String TEXT_46 = ");\t\t\t\t\t\t      " + NL + "\t\t        " + NL + "\t\t\t\tdeleted_task_";
  protected final String TEXT_47 = "++;" + NL + "\t\t\t";
  protected final String TEXT_48 = "\t\t\t\t\t\t    " + NL + "\t\t\t\t\t\t    " + NL + "\t\t\t\t\t\t\tTDSCWS_";
  protected final String TEXT_49 = ".deleteTask(";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = ");\t\t\t\t\t\t\t\t\t\t\t\t\t    " + NL + "\t\t\t\t\t\t    " + NL + "\t\t\t\t\t\t\tdeleted_task_";
