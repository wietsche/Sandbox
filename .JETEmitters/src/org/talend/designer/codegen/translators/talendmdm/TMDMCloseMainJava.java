...
public class TMDMCloseMainJava
{
  ...
  protected final String TEXT_43 = NL + "\torg.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_44 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(\"";
  protected final String TEXT_45 = "\");" + NL + "\tif(service_";
  protected final String TEXT_46 = " != null)" + NL + "\t{" + NL + "\t\tservice_";
  protected final String TEXT_47 = ".logout(new org.talend.mdm.webservice.WSLogout());        " + NL + "\t}";
