...
public class TMDMSPMainJava
{
  ...
  protected final String TEXT_42 = NL + NL + "List<String> params = new java.util.ArrayList<String>();";
  protected final String TEXT_43 = NL + NL + "params.add(";
  protected final String TEXT_44 = ".";
  protected final String TEXT_45 = ");";
  protected final String TEXT_46 = NL + "org.talend.mdm.webservice.WSExecuteStoredProcedure wsExeProc_";
  protected final String TEXT_47 = " = new org.talend.mdm.webservice.WSExecuteStoredProcedure(params,dataCluster_";
  protected final String TEXT_48 = ",wsStoredProcPK_";
  protected final String TEXT_49 = ");" + NL;
  protected final String TEXT_50 = "        " + NL + "\t\tList<String> xmlFields = service_";
  protected final String TEXT_51 = ".executeStoredProcedure(wsExeProc_";
  protected final String TEXT_52 = ").getStrings();" + NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\t" + NL + "\t\t\tfor(String xmlField_";
  protected final String TEXT_54 = " : xmlFields){" + NL + "\t\t\t\t";
  protected final String TEXT_55 = ".xmlField = xmlField_";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = "                " + NL + "\t\t\t\tservice_";
  protected final String TEXT_58 = ".executeStoredProcedure(wsExeProc_";
  protected final String TEXT_59 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_60 = "        " + NL + "\t\tservice_";
  protected final String TEXT_61 = ".executeStoredProcedure(wsExeProc_";
