...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_53 = ".getRequestContext();" + NL + "    context_";
  ...
  protected final String TEXT_73 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_74 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "" + NL + "List<String> pkIds = new java.util.ArrayList<String>();";
  protected final String TEXT_75 = NL + "pkIds.add(";
  protected final String TEXT_76 = ");";
  protected final String TEXT_77 = NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_78 = " = new org.talend.mdm.webservice.WSItemPK(";
  protected final String TEXT_79 = ",pkIds,dataCluster_";
  protected final String TEXT_80 = ");" + NL + "" + NL + "wsRouteItem_";
  protected final String TEXT_81 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_82 = ");" + NL + "" + NL + "//" + NL + "service_";
  protected final String TEXT_83 = ".routeItemV2(wsRouteItem_";
