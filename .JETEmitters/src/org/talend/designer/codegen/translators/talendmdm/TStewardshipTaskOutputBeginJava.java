...
public class TStewardshipTaskOutputBeginJava
{
  ...
  protected final String TEXT_42 = NL + "\t\t\t\t\tString taskFlag_";
  protected final String TEXT_43 = "=\"\";" + NL + "\t\t\t\t\tint nb_line_";
  protected final String TEXT_44 = " = 0;\t" + NL + "\t\t\t\t\torg.talend.stewardship.TaskGenerator tasks_";
  protected final String TEXT_45 = " = new org.talend.stewardship.TaskGenerator();" + NL + "\t\t\t\t\torg.talend.stewardship.Task task_";
  protected final String TEXT_46 = " = null;" + NL + "" + NL + "            \t\tString url_";
  ...
  protected final String TEXT_57 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\torg.talend.datastewardship.server.task.creation.TaskLoadClient taskLoadClient_";
  protected final String TEXT_58 = " = new org.talend.datastewardship.server.task.creation.TaskLoadClient(url_";
  protected final String TEXT_59 = ",";
  protected final String TEXT_60 = ",decryptedPassword_";
  protected final String TEXT_61 = ");" + NL + "\t\t\t\t\ttaskLoadClient_";
  protected final String TEXT_62 = ".validate();\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\torg.talend.stewardship.Record record_";
  protected final String TEXT_63 = " = null;" + NL + "\t\t\t\t\tboolean targetRecordExisted_";
  protected final String TEXT_64 = " = false;" + NL + "\t\t\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t\t    \tString recordColumn_";
  protected final String TEXT_66 = "_";
  protected final String TEXT_67 = " = null;" + NL + "\t\t\t\t\t    \tString recordColumn_";
  protected final String TEXT_68 = "_Value_";
  protected final String TEXT_69 = " = null;" + NL + "\t\t\t\t\t    \tString recordColumn_";
  protected final String TEXT_70 = "_Type_";
  protected final String TEXT_71 = " = null;" + NL + "\t\t\t\t\t    \tString recordColumn_";
  protected final String TEXT_72 = "_Key_";
