...
public class TMDMBulkLoadBeginJava
{
  ...
  protected final String TEXT_50 = NL + NL + "org.talend.mdm.bulkload.client.BulkloadClient bulkloadClient_";
  protected final String TEXT_51 = " = new org.talend.mdm.bulkload.client.BulkloadClient(";
  ...
  protected final String TEXT_59 = NL + "com.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_60 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(\"";
  protected final String TEXT_61 = "\");" + NL + "if(mdmTransaction_";
  protected final String TEXT_62 = "!=null) {" + NL + "\tbulkloadClient_";
  protected final String TEXT_63 = ".setTransactionId(mdmTransaction_";
  protected final String TEXT_64 = ".getId());" + NL + "}";
  protected final String TEXT_65 = NL + "bulkloadClient_";
  protected final String TEXT_66 = ".startThreadCount();" + NL + "bulkloadClient_";
  protected final String TEXT_67 = ".setOptions(new org.talend.mdm.bulkload.client.BulkloadOptions(";
  protected final String TEXT_68 = ", ";
  protected final String TEXT_69 = ", ";
  protected final String TEXT_70 = ", ";
  protected final String TEXT_71 = "));" + NL + "int count_";
  protected final String TEXT_72 = " = 0;" + NL + "org.talend.mdm.bulkload.client.InputStreamMerger inputStreamMerger_";
