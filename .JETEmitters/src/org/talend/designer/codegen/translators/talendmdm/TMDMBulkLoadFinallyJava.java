...
public class TMDMBulkLoadFinallyJava
{
  protected static String nl;
  public static synchronized TMDMBulkLoadFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMDMBulkLoadFinallyJava result = new TMDMBulkLoadFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_41 = NL + "Object o";
  protected final String TEXT_42 = " = resourceMap.get(\"mdmBulkStream";
  protected final String TEXT_43 = "\");" + NL + "if(o";
  protected final String TEXT_44 = " != null){";
  protected final String TEXT_45 = NL + "    " + NL + "\torg.talend.mdm.bulkload.client.InputStreamMerger stream = (org.talend.mdm.bulkload.client.InputStreamMerger)o";
  protected final String TEXT_46 = ";" + NL + "\tstream.clean();" + NL + "}";
