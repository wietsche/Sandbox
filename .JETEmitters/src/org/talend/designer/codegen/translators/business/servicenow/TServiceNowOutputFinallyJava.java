...
public class TServiceNowOutputFinallyJava
{
  protected static String nl;
  public static synchronized TServiceNowOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TServiceNowOutputFinallyJava result = new TServiceNowOutputFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "if(resourceMap.get(\"finish_";
  protected final String TEXT_44 = "\") == null) {" + NL + "\tif(resourceMap.get(\"";
  protected final String TEXT_45 = "_httpclient\") != null) {" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\t((org.apache.http.impl.client.CloseableHttpClient)resourceMap.get(\"";
  protected final String TEXT_46 = "_httpclient\")).close();" + NL + "\t\t}" + NL + "\t\tcatch(org.apache.http.conn.HttpHostConnectException httpEx_";
  protected final String TEXT_47 = ")" + NL + "\t\t{" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_48 = " = \"Failed to close the connection in ";
  protected final String TEXT_49 = " :\" + httpEx_";
  protected final String TEXT_50 = ".getMessage();" + NL + "\t\t\t";
  protected final String TEXT_51 = "log.warn(\"errorMessage_";
