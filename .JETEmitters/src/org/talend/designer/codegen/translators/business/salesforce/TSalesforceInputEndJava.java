...
public class TSalesforceInputEndJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t\t                // (for salesforce wizard preview)" + NL + "\t\t\t                if(limit_";
  protected final String TEXT_42 = " > 0 && nb_line_";
  protected final String TEXT_43 = " >= limit_";
  protected final String TEXT_44 = "){ " + NL + "\t\t\t                \tbContinue_";
  protected final String TEXT_45 = " = false;" + NL + "\t\t\t                \tbreak;" + NL + "\t\t\t                }" + NL + "\t\t\t            " + NL + "\t\t\t            }" + NL + "\t\t\t            // handle the loop + 1 problem by checking the most recent queryResult" + NL + "\t\t\t            if (qr_";
  protected final String TEXT_46 = ".getDone()) {" + NL + "\t\t\t                bContinue_";
  protected final String TEXT_47 = " = false;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                qr_";
  protected final String TEXT_48 = " = sfMgr_";
  protected final String TEXT_49 = ".queryMore(qr_";
  protected final String TEXT_50 = ".getQueryLocator(),new Integer(";
  protected final String TEXT_51 = "));" + NL + "\t\t\t            \ttopqr_";
  protected final String TEXT_52 = " = new org.talend.salesforce.TopQueryResult();" + NL + "\t\t\t\t\t\t\ttopqr_";
  protected final String TEXT_53 = ".processTopQueryResult(qr_";
  protected final String TEXT_54 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t        }" + NL + "\t\t\t\t";
  protected final String TEXT_55 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\tsfMgr_";
  protected final String TEXT_57 = ".logout();" + NL + "\t\t";
