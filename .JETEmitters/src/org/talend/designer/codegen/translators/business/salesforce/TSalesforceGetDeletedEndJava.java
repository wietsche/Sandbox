...
public class TSalesforceGetDeletedEndJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t\t\t\t}\t" + NL + "\t\t\t\t\t// handle the loop + 1 problem by checking the most recent queryResult" + NL + "\t\t            if (qr_";
  protected final String TEXT_42 = ".getDone()) {" + NL + "\t\t                bContinue_";
  protected final String TEXT_43 = " = false;" + NL + "\t\t            } else {" + NL + "\t\t                qr_";
  protected final String TEXT_44 = " = sfMgr_";
  protected final String TEXT_45 = ".queryMore(qr_";
  protected final String TEXT_46 = ".getQueryLocator(), batchSize_";
  protected final String TEXT_47 = ");" + NL + "\t\t            }" + NL + "\t\t\t\t}" + NL + "\t\t\t\tsoql_";
  protected final String TEXT_48 = " = new StringBuilder();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_49 = NL + "\t\tsfMgr_";
  protected final String TEXT_50 = ".logout();\t";
