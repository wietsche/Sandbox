...
public class TSalesforceBulkExecEndJava
{
  protected static String nl;
  public static synchronized TSalesforceBulkExecEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSalesforceBulkExecEndJava result = new TSalesforceBulkExecEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_41 = " " + NL + " \t" + NL + " \t}" + NL + " }" + NL + " \tsforceBulk_";
  protected final String TEXT_42 = ".closeFileRead();" + NL + " \tglobalMap.put(\"";
