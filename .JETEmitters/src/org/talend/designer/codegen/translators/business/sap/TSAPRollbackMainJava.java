...
public class TSAPRollbackMainJava
{
  ...
  protected final String TEXT_9 = ".getFunctionTemplate(\"BAPI_TRANSACTION_ROLLBACK\");" + NL + "\t" + NL + "\t    com.sap.mw.jco.JCO.Function function_";
  ...
  protected final String TEXT_32 = ".getFunctionTemplate(\"BAPI_TRANSACTION_ROLLBACK\");" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoFunction function_";
  ...
  protected final String TEXT_57 = ".rollback();" + NL + "\t    \t} catch (org.talend.sap.exception.SAPException e_";
