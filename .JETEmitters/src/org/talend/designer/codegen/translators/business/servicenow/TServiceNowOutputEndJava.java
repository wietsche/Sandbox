...
public class TServiceNowOutputEndJava
{
  protected static String nl;
  public static synchronized TServiceNowOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TServiceNowOutputEndJava result = new TServiceNowOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = "_NB_LINE_REJECTED\", nb_line_rejected_";
  protected final String TEXT_49 = ");" + NL;
  protected final String TEXT_50 = NL + "\tif (nb_line_inserted_";
  protected final String TEXT_51 = " == 0 && nb_line_update_";
  protected final String TEXT_52 = " == 0 && nb_line_rejected_";
  protected final String TEXT_53 = " != 0) {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_54 = " - All '\" + \"";
  protected final String TEXT_55 = "\".toUpperCase() + \"' requests have been rejected.\");" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_56 = "log.info(\"";
  protected final String TEXT_57 = " - Inserted records count: \" + nb_line_inserted_";
  protected final String TEXT_58 = " + \".'\");";
  protected final String TEXT_59 = "log.info(\"";
  protected final String TEXT_60 = " - Updated records count: \" + nb_line_update_";
  protected final String TEXT_61 = " + \".'\");";
  protected final String TEXT_62 = NL + "\t}" + NL + "\t";
  protected final String TEXT_63 = NL;
  protected final String TEXT_64 = NL;
  protected final String TEXT_65 = "_httpclient.close();" + NL + "resourceMap.put(\"finish_";
