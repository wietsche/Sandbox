...
public class TBonitaInstantiateProcessMainJava
{
  ...
  protected final String TEXT_7 = "\",routines.system.FormatterUtils.format_Date(";
  protected final String TEXT_8 = ".";
  protected final String TEXT_9 = ", ";
  protected final String TEXT_10 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_11 = NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\tvars_";
  protected final String TEXT_12 = ".put(\"";
  protected final String TEXT_13 = "\",java.net.URLEncoder.encode(java.net.URLEncoder.encode(String.valueOf(";
  protected final String TEXT_14 = ".";
  protected final String TEXT_15 = "), utf8Charset),utf8Charset));" + NL + "\t\t\t\t\t\t\t\t\t";
