...
public class TSalesforceOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TSalesforceOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSalesforceOutputBulkEndJava result = new TSalesforceOutputBulkEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_41 = NL + "\tif(csvWriter_";
  protected final String TEXT_42 = "!=null) {" + NL + "\t\tcsvWriter_";
  protected final String TEXT_43 = ".close();" + NL + "\t}" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_44 = "\", true); " + NL + "\tglobalMap.put(\"";
