...
public class TLogRowEndJava
{
  ...
  protected final String TEXT_42 = NL + NL + "                    " + NL + "                    java.io.PrintStream consoleOut_";
  protected final String TEXT_43 = " = null;" + NL + "                    if (globalMap.get(\"tLogRow_CONSOLE\")!=null)" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_44 = " = (java.io.PrintStream) globalMap.get(\"tLogRow_CONSOLE\");" + NL + "                    }" + NL + "                    else" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_45 = " = new java.io.PrintStream(new java.io.BufferedOutputStream(System.out));" + NL + "                    \tglobalMap.put(\"tLogRow_CONSOLE\",consoleOut_";
  protected final String TEXT_46 = ");" + NL + "                    }" + NL + "                    " + NL + "                    consoleOut_";
  protected final String TEXT_47 = ".println(util_";
  protected final String TEXT_48 = ".format().toString());" + NL + "                    consoleOut_";
  protected final String TEXT_49 = ".flush();";
