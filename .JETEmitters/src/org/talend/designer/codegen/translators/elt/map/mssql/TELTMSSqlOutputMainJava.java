...
public class TELTMSSqlOutputMainJava
{
  ...
  protected final String TEXT_93 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_126 = NL + NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_127 = " =null;" + NL + "\t";
  protected final String TEXT_128 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_129 = "+\"(";
  protected final String TEXT_130 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_133 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_134 = "+\" SET ";
  protected final String TEXT_135 = " \"";
  protected final String TEXT_136 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_137 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_138 = " = conn_";
  protected final String TEXT_139 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_140 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_141 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_142 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_143 = NL + "\t";
  protected final String TEXT_144 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_145 = " = conn_";
  protected final String TEXT_146 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_153 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_154 = " = pstmt_";
  protected final String TEXT_155 = ".executeUpdate();";
  protected final String TEXT_156 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_157 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_158 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_159 = " " + NL + "nb_line_updated_";
  protected final String TEXT_160 = " = pstmt_";
  protected final String TEXT_161 = ".executeUpdate();";
  protected final String TEXT_162 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_163 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_164 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_165 = " " + NL + "\t\tnb_line_deleted_";
  ...
  protected final String TEXT_177 = " = nb_line_updated_";
  protected final String TEXT_178 = " + nb_line_inserted_";
  protected final String TEXT_179 = " + nb_line_deleted_";
  protected final String TEXT_180 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_181 = "_NB_LINE\",nb_line_";
  protected final String TEXT_182 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_183 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_187 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_188 = ");" + NL;
  protected final String TEXT_189 = NL + "\tlog.info(\"";
  protected final String TEXT_190 = " - Has ";
  protected final String TEXT_191 = " records count: \" + nb_line_";
