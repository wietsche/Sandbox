...
public class TELTSybaseOutputMainJava
{
  ...
  protected final String TEXT_93 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_101 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_121 = ";" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_122 = " = null;";
  protected final String TEXT_123 = NL;
  protected final String TEXT_124 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_125 = " =null;" + NL;
  protected final String TEXT_126 = "\t" + NL + "\t\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_127 = "+\" (";
  protected final String TEXT_128 = ") (\"+select_query+\")\";" + NL + "\t\tpstmt_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".prepareStatement(insertQuery);";
  protected final String TEXT_131 = NL + "\t\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_132 = "+\" SET ";
  protected final String TEXT_133 = " \"";
  protected final String TEXT_134 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_135 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_138 = NL + "\t\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_139 = "+\" WHERE EXISTS (\"+ select_query.replaceAll(selectQueryColumnsName, \"*\")+\") \" ";
  protected final String TEXT_140 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_141 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".prepareStatement(deleteQuery);";
  protected final String TEXT_144 = NL + "\tint nb_line_";
  protected final String TEXT_145 = " = 0;" + NL + "\tint nb_line_updated_";
  protected final String TEXT_146 = " = 0;" + NL + "\tint nb_line_inserted_";
  protected final String TEXT_147 = " = 0;" + NL + "\tint nb_line_deleted_";
  protected final String TEXT_148 = " = 0;";
  protected final String TEXT_149 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_150 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_151 = " += nb_line_inserted_";
  ...
  protected final String TEXT_158 = " += nb_line_updated_";
  protected final String TEXT_159 = " = pstmt_";
  protected final String TEXT_160 = ".executeUpdate();";
  protected final String TEXT_161 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_162 = " + \" rows updated. \\n\");";
  protected final String TEXT_163 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  ...
  protected final String TEXT_170 = NL + "\tpstmt_";
