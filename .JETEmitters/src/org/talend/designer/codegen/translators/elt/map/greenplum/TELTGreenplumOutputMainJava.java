...
public class TELTGreenplumOutputMainJava
{
  ...
  protected final String TEXT_124 = " \" +select_query.substring(select_query.indexOf(\"FROM\"));";
  protected final String TEXT_125 = NL + "\t\tif(select_query.indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery+= ";
  protected final String TEXT_126 = ";";
  protected final String TEXT_127 = NL + "\tpstmt_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_130 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_131 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_132 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_133 = NL + "\t";
  protected final String TEXT_134 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_142 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_143 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_144 = " = pstmt_";
  protected final String TEXT_145 = ".executeUpdate();";
  protected final String TEXT_146 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_147 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_148 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_149 = " " + NL + "nb_line_updated_";
  protected final String TEXT_150 = " = pstmt_";
  protected final String TEXT_151 = ".executeUpdate();";
  protected final String TEXT_152 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_153 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_154 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_155 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_156 = " = pstmt_";
  protected final String TEXT_157 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_159 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_160 = NL + "pstmt_";
  protected final String TEXT_161 = ".close();" + NL;
  protected final String TEXT_162 = NL + "    if(conn_";
  protected final String TEXT_163 = " != null && !conn_";
  protected final String TEXT_164 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_165 = NL + "    }";
  protected final String TEXT_166 = NL + "nb_line_";
  protected final String TEXT_167 = " = nb_line_updated_";
  protected final String TEXT_168 = " + nb_line_inserted_";
  protected final String TEXT_169 = " + nb_line_deleted_";
  ...
  protected final String TEXT_173 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_174 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_175 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_176 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_177 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_178 = ");" + NL;
  protected final String TEXT_179 = NL + "\tlog.info(\"";
  protected final String TEXT_180 = " - Has ";
  protected final String TEXT_181 = " records count: \" + nb_line_";
