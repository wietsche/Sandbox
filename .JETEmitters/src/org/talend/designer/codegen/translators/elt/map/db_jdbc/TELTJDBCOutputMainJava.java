...
public class TELTJDBCOutputMainJava
{
  ...
  protected final String TEXT_101 = "String decryptedPassword_";
  ...
  protected final String TEXT_106 = NL + "\tdecryptedPassword_";
  ...
  protected final String TEXT_116 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_117 = "+\"(";
  protected final String TEXT_118 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_121 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  ...
  protected final String TEXT_128 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_129 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_130 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_131 = NL + "\t";
  protected final String TEXT_132 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_135 = NL + "int nb_line_";
  protected final String TEXT_136 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_137 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_138 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_139 = " = 0;" + NL + "\t";
  protected final String TEXT_140 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_141 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_142 = " = pstmt_";
  protected final String TEXT_143 = ".executeUpdate();";
  protected final String TEXT_144 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_145 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_146 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_147 = " " + NL + "nb_line_updated_";
  protected final String TEXT_148 = " = pstmt_";
  protected final String TEXT_149 = ".executeUpdate();";
  protected final String TEXT_150 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_151 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_152 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_153 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_154 = " = pstmt_";
  protected final String TEXT_155 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_156 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_157 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_158 = NL + NL + "pstmt_";
  protected final String TEXT_159 = ".close();" + NL;
  protected final String TEXT_160 = NL + "    if(conn_";
  protected final String TEXT_161 = " != null && !conn_";
  protected final String TEXT_162 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_163 = NL + "    }";
  protected final String TEXT_164 = NL + "nb_line_";
  protected final String TEXT_165 = " = nb_line_updated_";
  protected final String TEXT_166 = " + nb_line_inserted_";
  protected final String TEXT_167 = " + nb_line_deleted_";
  protected final String TEXT_168 = ";" + NL + "globalMap.put(\"";
  protected final String TEXT_169 = "_NB_LINE\",nb_line_";
  protected final String TEXT_170 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_171 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_172 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_173 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_174 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_175 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_176 = ");" + NL;
  protected final String TEXT_177 = NL + "\tlog.info(\"";
  protected final String TEXT_178 = " - Has ";
  protected final String TEXT_179 = " records count: \" + nb_line_";
