...
public class TWriteXMLFieldOutBeginJava
{
  ...
  protected final String TEXT_71 = " = null;" + NL + "// sort group root element for judgement of group" + NL + "java.util.List<org.dom4j.Element> groupElementList_";
  protected final String TEXT_72 = " = new java.util.ArrayList<org.dom4j.Element>();" + NL + "org.dom4j.Element root4Group_";
  protected final String TEXT_73 = " = null;" + NL + "org.dom4j.Document doc_";
  protected final String TEXT_74 = "  = org.dom4j.DocumentHelper.createDocument();";
  protected final String TEXT_75 = NL + "org.dom4j.io.OutputFormat format_";
  protected final String TEXT_76 = " = org.dom4j.io.OutputFormat.createCompactFormat();" + NL + "format_";
  protected final String TEXT_77 = ".setNewLineAfterDeclaration(false);";
  protected final String TEXT_78 = NL + "org.dom4j.io.OutputFormat format_";
  protected final String TEXT_79 = " = org.dom4j.io.OutputFormat.createPrettyPrint();";
  protected final String TEXT_80 = NL + "format_";
  protected final String TEXT_81 = ".setTrimText(false);" + NL + "format_";
  protected final String TEXT_82 = ".setEncoding(";
  protected final String TEXT_83 = ");";
  protected final String TEXT_84 = "format_";
  protected final String TEXT_85 = ".setExpandEmptyElements(true);";
  protected final String TEXT_86 = NL + "int[] orders_";
  protected final String TEXT_87 = " = new int[";
  protected final String TEXT_88 = "];";
  protected final String TEXT_89 = NL + "java.util.List<String> endTabStrs_";
  protected final String TEXT_90 = " = new java.util.ArrayList<String>();" + NL + "java.util.List<String> startTabStrs_";
  protected final String TEXT_91 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_92 = NL + "endTabStrs_";
  protected final String TEXT_93 = ".add(\"";
  protected final String TEXT_94 = "</";
  protected final String TEXT_95 = ">\");" + NL + "startTabStrs_";
  protected final String TEXT_96 = ".add(\"";
  protected final String TEXT_97 = "<";
  protected final String TEXT_98 = ">\");";
  protected final String TEXT_99 = NL + "int preUnNullMaxIndex_";
  protected final String TEXT_100 = " = -1;" + NL + "int preNewTabIndex_";
  protected final String TEXT_101 = " = -1;" + NL + "String[] startTabs_";
  protected final String TEXT_102 = " = new String[endTabStrs_";
  protected final String TEXT_103 = ".size()];" + NL + "String[] endTabs_";
  protected final String TEXT_104 = " = new String[endTabStrs_";
  protected final String TEXT_105 = ".size()];" + NL + "java.io.StringWriter strWriter_";
  protected final String TEXT_106 = " = new java.io.StringWriter();" + NL + "java.io.BufferedWriter out_";
  protected final String TEXT_107 = " = new java.io.BufferedWriter(strWriter_";
  protected final String TEXT_108 = ");";
  protected final String TEXT_109 = NL + "out_";
  protected final String TEXT_110 = ".write(\"<?xml version=\\\"1.0\\\" encoding=\\\"\"+";
  protected final String TEXT_111 = "+\"\\\"?>\");" + NL + "out_";
