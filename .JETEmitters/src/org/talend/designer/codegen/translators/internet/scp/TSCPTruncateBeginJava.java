...
public class TSCPTruncateBeginJava
{
  ...
  protected final String TEXT_57 = " + \"' with the username '\" + username_";
  ...
  protected final String TEXT_126 = NL + NL + "        ch.ethz.ssh2.SCPClient scp_";
  protected final String TEXT_127 = " = new  ch.ethz.ssh2.SCPClient(conn_";
  protected final String TEXT_128 = ");" + NL + "        " + NL + "        String[] destFileNames_";
  protected final String TEXT_129 = " = new String[]{";
  protected final String TEXT_130 = NL + "            \t";
  protected final String TEXT_131 = ",";
  protected final String TEXT_132 = NL + "       };" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_134 = " - Truncating file from the server.\");" + NL + "\t\t";
  protected final String TEXT_135 = NL + "       for(String destFile_";
  protected final String TEXT_136 = " : destFileNames_";
