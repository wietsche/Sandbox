...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_69 = NL + "\t((javax.jms.TopicConnection)connection_";
  protected final String TEXT_70 = ").setClientID(";
  protected final String TEXT_71 = ");" + NL + "\t";
  protected final String TEXT_72 = NL + "\t" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_73 = " = connection_";
  protected final String TEXT_74 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_75 = " = session_";
  protected final String TEXT_76 = ".create";
  protected final String TEXT_77 = "(";
  protected final String TEXT_78 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_79 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_80 = " = ((javax.jms.TopicSession) session_";
  protected final String TEXT_81 = ").createDurableSubscriber((javax.jms.Topic)dest_";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = ",";
  protected final String TEXT_84 = ",false);" + NL + "\t";
  protected final String TEXT_85 = NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_86 = "\t= session_";
  protected final String TEXT_87 = ".createConsumer(dest_";
  protected final String TEXT_88 = ", ";
  protected final String TEXT_89 = ");" + NL + "\t";
  protected final String TEXT_90 = NL + "\t" + NL + "\tconnection_";
  protected final String TEXT_91 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "\t";
  protected final String TEXT_92 = NL + "\t";
  protected final String TEXT_93 = NL + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_94 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_95 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  protected final String TEXT_96 = " = consumer_";
  protected final String TEXT_97 = ".receive(";
  protected final String TEXT_98 = "*1000)) != null) {" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t\t";
  protected final String TEXT_100 = ".message=message_";
  protected final String TEXT_101 = ";\t";
  protected final String TEXT_102 = NL + "\t\t";
  protected final String TEXT_103 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_104 = ").getObject().toString());";
  protected final String TEXT_105 = NL + "\t\t";
  protected final String TEXT_106 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_107 = ").getText();";
