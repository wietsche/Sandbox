...
public class TKafkaInputEndJava
{
  ...
  protected final String TEXT_1 = "    // Stop reading if the maximum number of input messages has been reached." + NL + "    if (tos_count_";
  protected final String TEXT_2 = " >= ";
  protected final String TEXT_3 = ") {" + NL + "        break;" + NL + "    }";
  protected final String TEXT_4 = NL + "    } catch (kafka.consumer.ConsumerTimeoutException e) {";
  protected final String TEXT_5 = NL + "                // Immediately stop processing messagesDeadline if the max duration deadline has passed." + NL + "                if (System.currentTimeMillis() > maxMsgWaitDeadline_";
  protected final String TEXT_6 = ")" + NL + "                    break;";
