...
public class TFTPGetBeginJava
{
  ...
  protected final String TEXT_346 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_347 = NL + "\t\t    \t\tftp_";
  protected final String TEXT_348 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  ...
  protected final String TEXT_362 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_363 = ");";
  protected final String TEXT_364 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_365 = " = ";
  protected final String TEXT_366 = "; ";
  protected final String TEXT_367 = NL + "            \t" + NL + "\t\t\t\tftp_";
  protected final String TEXT_368 = ".login(";
  protected final String TEXT_369 = ", decryptedPassword_";
  protected final String TEXT_370 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_371 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_372 = " - Connect to '\" + ";
  protected final String TEXT_373 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_374 = NL + "\t\t\t\tftp_";
  protected final String TEXT_375 = " = (it.sauronsoftware.ftp4j.FTPClient)globalMap.get(\"";
  protected final String TEXT_376 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\trootDir_";
  protected final String TEXT_378 = " = ftp_";
  protected final String TEXT_379 = ".currentDirectory();" + NL + "\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t";
  protected final String TEXT_381 = NL + "\t\t\t\t\tif(ftp_";
  protected final String TEXT_382 = "!=null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_383 = " - Use an existing connection.Connection username: \" + ftp_";
  protected final String TEXT_384 = ".getUsername() + \", Connection hostname: \" + ftp_";
  protected final String TEXT_385 = ".getHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_386 = ".getPort() + \".\"); " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_387 = NL + "\t\t\tgetter_";
  protected final String TEXT_388 = " = new FTPSGetter_";
  protected final String TEXT_389 = "();" + NL + "\t\t\tgetter_";
  protected final String TEXT_390 = ".ftpClient = ftp_";
  protected final String TEXT_391 = ";" + NL + "\t\t\tremotedir_";
  protected final String TEXT_392 = " = ";
  protected final String TEXT_393 = ";" + NL + "\t\t\tftp_";
  protected final String TEXT_394 = ".changeDirectory(remotedir_";
  protected final String TEXT_395 = ");" + NL + "\t\t} catch (java.lang.IllegalStateException e) {" + NL + "\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_397 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_398 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (java.io.IOException e) {" + NL + "\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_400 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_401 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "\t\t\t";
  protected final String TEXT_402 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_403 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_404 = NL + "\t\t    e.printStackTrace();" + NL + "\t\t} catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_406 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_407 = NL + "\t\t    e.printStackTrace();" + NL + "  \t\t}";
  protected final String TEXT_408 = NL + "java.util.List<String> maskList_";
  protected final String TEXT_409 = " = new java.util.ArrayList<String>();" + NL;
  protected final String TEXT_410 = "    " + NL + "  maskList_";
  protected final String TEXT_411 = ".add(";
  protected final String TEXT_412 = ");       ";
  protected final String TEXT_413 = "  " + NL + "    ftp_";
  protected final String TEXT_414 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.BINARY);";
  protected final String TEXT_415 = "  " + NL + "    ftp_";
  protected final String TEXT_416 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.ASCII);";
  protected final String TEXT_417 = NL + "String localdir_";
  protected final String TEXT_418 = "  = ";
  protected final String TEXT_419 = ";  " + NL + "//create folder if local direcotry (assigned by property) not exists" + NL + "java.io.File dirHandle_";
  protected final String TEXT_420 = " = new java.io.File(localdir_";
  protected final String TEXT_421 = ");" + NL + "" + NL + "if (!dirHandle_";
  protected final String TEXT_422 = ".exists()) {" + NL + "  dirHandle_";
  protected final String TEXT_423 = ".mkdirs();" + NL + "}" + NL + "String root_";
  protected final String TEXT_424 = " = getter_";
  protected final String TEXT_425 = ".pwd();" + NL;
  protected final String TEXT_426 = NL + "\tlog.info(\"";
  protected final String TEXT_427 = " - Downloading files from the server.\");";
  protected final String TEXT_428 = NL + "for (String maskStr_";
  protected final String TEXT_429 = " : maskList_";
