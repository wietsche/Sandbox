...
public class TJMSOutputMainJava
{
  ...
  protected final String TEXT_41 = NL + "producer_";
  protected final String TEXT_42 = ".send((javax.jms.Message)";
  protected final String TEXT_43 = ".message);" + NL + "nbline_";
  protected final String TEXT_44 = "++;";
  protected final String TEXT_45 = NL + "javax.jms.ObjectMessage message_";
  protected final String TEXT_46 = " = session_";
  protected final String TEXT_47 = ".createObjectMessage();" + NL + "message_";
  protected final String TEXT_48 = ".setObject(";
  protected final String TEXT_49 = ".messageContent);";
  protected final String TEXT_50 = NL + "javax.jms.TextMessage message_";
  protected final String TEXT_51 = " = session_";
  protected final String TEXT_52 = ".createTextMessage();" + NL + "message_";
  protected final String TEXT_53 = ".setText(";
  protected final String TEXT_54 = ".messageContent);";
  protected final String TEXT_55 = NL + "producer_";
  protected final String TEXT_56 = ".send(message_";
  protected final String TEXT_57 = ");" + NL + "" + NL + "nbline_";
