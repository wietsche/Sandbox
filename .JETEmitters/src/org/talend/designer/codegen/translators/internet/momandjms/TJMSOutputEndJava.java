...
public class TJMSOutputEndJava
{
  ...
  protected final String TEXT_42 = ".close();" + NL + "session_";
  protected final String TEXT_43 = ".close();" + NL + "connection_";
  protected final String TEXT_44 = ".close();" + NL + "globalMap.put(\"";
  protected final String TEXT_45 = "_NB_LINE\", nbline_";
