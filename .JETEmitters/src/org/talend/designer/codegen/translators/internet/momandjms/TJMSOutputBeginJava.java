...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_41 = NL + "\tjava.util.Hashtable props_";
  ...
  protected final String TEXT_69 = ".start();" + NL + "" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_70 = " = connection_";
  protected final String TEXT_71 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_72 = " = session_";
  protected final String TEXT_73 = ".create";
  protected final String TEXT_74 = "(";
  protected final String TEXT_75 = ");" + NL + "" + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_76 = " = session_";
  protected final String TEXT_77 = ".createProducer(dest_";
  protected final String TEXT_78 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_79 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_80 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_81 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
