...
public class TFTPFilePropertiesBeginJava
{
  ...
  protected final String TEXT_186 = NL + "\t\t\t\tlog4jSb_";
  protected final String TEXT_187 = ".append();" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - md5 message is : '\"+ ";
  protected final String TEXT_189 = ".md5 + \"'.\"); " + NL + "\t\t  ";
  protected final String TEXT_190 = NL + "\t      is_";
  protected final String TEXT_191 = ".close();" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t}  ";
  protected final String TEXT_193 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_194 = " =null;" + NL + "" + NL + "\t";
  protected final String TEXT_195 = NL + "\t\tftp_";
  protected final String TEXT_196 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_197 = "\");" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_199 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_200 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_201 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_202 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_203 = NL + "\t";
  protected final String TEXT_204 = NL + "\t    ftp_";
  protected final String TEXT_205 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_206 = ".setRemoteHost(";
  protected final String TEXT_207 = ");" + NL + "\t    ftp_";
  protected final String TEXT_208 = ".setRemotePort(";
  protected final String TEXT_209 = ");" + NL + "" + NL + "\t\t";
  protected final String TEXT_210 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_211 = " - \" + ";
  protected final String TEXT_212 = ");" + NL + "\t\t";
  protected final String TEXT_213 = NL + "\t\t";
  protected final String TEXT_214 = NL + "\t    \tftp_";
  protected final String TEXT_215 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t";
  protected final String TEXT_216 = NL + "\t    \tftp_";
  protected final String TEXT_217 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_218 = NL + "\t\tftp_";
  protected final String TEXT_219 = ".setControlEncoding(";
  protected final String TEXT_220 = ");" + NL + "\t\t";
  protected final String TEXT_221 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_222 = " - Attempt to connect to '\" + ";
  protected final String TEXT_223 = " + \"' with username '\" +";
  protected final String TEXT_224 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t    ftp_";
  protected final String TEXT_226 = ".connect();" + NL + "\t    " + NL + "\t\t";
  ...
  protected final String TEXT_234 = NL + "    \t\t" + NL + "\t    ftp_";
  protected final String TEXT_235 = ".login(";
  protected final String TEXT_236 = ", decryptedPassword_";
  protected final String TEXT_237 = ");" + NL + "\t\t";
  protected final String TEXT_238 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_239 = " - Connect to '\" + ";
  protected final String TEXT_240 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_241 = "  " + NL + "\t";
  protected final String TEXT_242 = NL + "\t";
  protected final String TEXT_243 = NL + "\t\tftp_";
  protected final String TEXT_244 = ".setType(com.enterprisedt.net.ftp.FTPTransferType.BINARY);" + NL + "\t";
  protected final String TEXT_245 = NL + "\tString remoteDir_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "\t";
  protected final String TEXT_248 = " = new ";
  protected final String TEXT_249 = "Struct();" + NL + "  \tString remoteFile_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = " + \"/\" + ";
  protected final String TEXT_252 = ";" + NL + "" + NL + "\tif (ftp_";
  protected final String TEXT_253 = ".exists(remoteFile_";
  protected final String TEXT_254 = ")) {" + NL + "\t    ";
  protected final String TEXT_255 = ".abs_path = (remoteFile_";
  protected final String TEXT_256 = ").replaceAll(\"//\", \"/\");" + NL + "\t    ";
  protected final String TEXT_257 = ".dirname = ";
  protected final String TEXT_258 = ";" + NL + "\t    ";
  protected final String TEXT_259 = ".basename = ";
  protected final String TEXT_260 = ";" + NL + "\t    ";
  protected final String TEXT_261 = ".size = ftp_";
  protected final String TEXT_262 = ".size(remoteFile_";
  protected final String TEXT_263 = ");" + NL + "\t    ";
  protected final String TEXT_264 = ".mtime = ftp_";
  protected final String TEXT_265 = ".modtime(remoteFile_";
  protected final String TEXT_266 = ").getTime();" + NL + "\t    ";
  protected final String TEXT_267 = ".mtime_string =ftp_";
  protected final String TEXT_268 = ".modtime(remoteFile_";
  protected final String TEXT_269 = ").toString();" + NL + "\t\t";
  protected final String TEXT_270 = NL + "\t\t\tlog4jSb_";
  protected final String TEXT_271 = ".append(\"";
  protected final String TEXT_272 = " - File properties for remoteDir is : '\" + ";
  protected final String TEXT_273 = " + \"',file name is : '\" + ";
  protected final String TEXT_274 = " +\"',file size is : '\" + ";
  protected final String TEXT_275 = ".size + \"',file last modify time is : '\" + ";
  protected final String TEXT_276 = ".mtime_string + \"'\");" + NL + "\t\t";
  protected final String TEXT_277 = NL + NL + "\t    ";
  protected final String TEXT_278 = NL + "\t      // Calculation of the Message Digest MD5" + NL + "\t      java.security.MessageDigest dgs_";
  protected final String TEXT_279 = " = java.security.MessageDigest.getInstance(\"MD5\");" + NL + "\t      dgs_";
  protected final String TEXT_280 = ".update(ftp_";
  protected final String TEXT_281 = ".get(remoteFile_";
  protected final String TEXT_282 = "));" + NL + "\t      ";
  protected final String TEXT_283 = ".md5 =String.format(\"%032x\", new java.math.BigInteger(1, dgs_";
  protected final String TEXT_284 = ".digest()));" + NL + "\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\t\tlog4jSb_";
  protected final String TEXT_286 = ".append(\",md5 message is : '\"+ ";
  protected final String TEXT_287 = ".md5 + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_288 = NL + "\t    ";
  protected final String TEXT_289 = NL + "\t\t";
  protected final String TEXT_290 = NL + "\t\t\tlog.debug(log4jSb_";
