...
public class TPOPBeginJava
{
  ...
  protected final String TEXT_129 = ".open(javax.mail.Folder.READ_ONLY);" + NL + "\t}" + NL + "\tjavax.mail.Message[] msgs_";
  protected final String TEXT_130 = " = folder_";
  protected final String TEXT_131 = ".getMessages();" + NL + "" + NL + "\t";
  protected final String TEXT_132 = NL + "\t\tlog.info(\"";
  protected final String TEXT_133 = " - Retrieving mails from server.\");" + NL + "\t";
  protected final String TEXT_134 = NL + "\tfor (int counter_";
  protected final String TEXT_135 = " = 0; counter_";
  protected final String TEXT_136 = " < msgs_";
  protected final String TEXT_137 = ".length; counter_";
  protected final String TEXT_138 = "++) {" + NL + "\t\t";
  protected final String TEXT_139 = NL + "\t\t\tif(nb_email_";
  protected final String TEXT_140 = " >= ";
  protected final String TEXT_141 = ") break; " + NL + "\t\t";
  protected final String TEXT_142 = NL + "\t\tjavax.mail.Message message_";
  protected final String TEXT_143 = " = msgs_";
  protected final String TEXT_144 = "[counter_";
  protected final String TEXT_145 = "];" + NL + "  " + NL + "\t\ttry {" + NL + "\t\t\tboolean isMatch_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "  ";
  protected final String TEXT_148 = NL + "\t\t\t        java.util.regex.Pattern pattern_";
  protected final String TEXT_149 = "_";
  protected final String TEXT_150 = " = java.util.regex.Pattern.compile(";
  protected final String TEXT_151 = ");" + NL + "\t\t\t        java.util.regex.Matcher matcher_";
  protected final String TEXT_152 = "_";
  protected final String TEXT_153 = " = pattern_";
  protected final String TEXT_154 = "_";
  protected final String TEXT_155 = ".matcher(message_";
  protected final String TEXT_156 = ".getSubject()==null?\"\":message_";
  protected final String TEXT_157 = ".getSubject());" + NL + "\t\t\t        isMatch_";
  protected final String TEXT_158 = " = isMatch_";
  protected final String TEXT_159 = " ";
  protected final String TEXT_160 = " matcher_";
  protected final String TEXT_161 = "_";
  protected final String TEXT_162 = ".find();";
  protected final String TEXT_163 = NL + "\t\t\t        java.util.regex.Pattern pattern_";
  protected final String TEXT_164 = "_";
  protected final String TEXT_165 = " = java.util.regex.Pattern.compile(";
  protected final String TEXT_166 = ");" + NL + "\t\t\t        java.util.regex.Matcher matcher_";
  protected final String TEXT_167 = "_";
  protected final String TEXT_168 = " = pattern_";
  protected final String TEXT_169 = "_";
  protected final String TEXT_170 = ".matcher(message_";
  protected final String TEXT_171 = ".getFrom()[0]==null?\"\":message_";
  protected final String TEXT_172 = ".getFrom()[0].toString());" + NL + "\t\t\t        isMatch_";
  protected final String TEXT_173 = " = isMatch_";
  protected final String TEXT_174 = " ";
  protected final String TEXT_175 = " matcher_";
  protected final String TEXT_176 = "_";
  protected final String TEXT_177 = ".find();";
  protected final String TEXT_178 = NL + "\t\t\t        java.util.regex.Pattern pattern_";
  protected final String TEXT_179 = "_";
  protected final String TEXT_180 = " = java.util.regex.Pattern.compile(";
  protected final String TEXT_181 = ");" + NL + "\t\t\t        java.util.regex.Matcher matcher_";
  protected final String TEXT_182 = "_";
  protected final String TEXT_183 = " = null;" + NL + "\t\t\t\t\tjavax.mail.Address[] addr_";
  protected final String TEXT_184 = "_";
  protected final String TEXT_185 = " = message_";
  protected final String TEXT_186 = ".getAllRecipients();" + NL + "\t\t\t\t\tboolean matcherFind_";
  protected final String TEXT_187 = "_";
  protected final String TEXT_188 = " = false;" + NL + "\t\t\t\t\tfor(int matcher_";
  protected final String TEXT_189 = " = 0;matcher_";
  protected final String TEXT_190 = " < addr_";
  protected final String TEXT_191 = "_";
  protected final String TEXT_192 = ".length;matcher_";
  protected final String TEXT_193 = "++){" + NL + "\t\t\t\t\t\tmatcher_";
  protected final String TEXT_194 = "_";
  protected final String TEXT_195 = " = pattern_";
  protected final String TEXT_196 = "_";
  protected final String TEXT_197 = ".matcher(addr_";
  protected final String TEXT_198 = "_";
  protected final String TEXT_199 = "[matcher_";
  protected final String TEXT_200 = "]==null?\"\":addr_";
  protected final String TEXT_201 = "_";
  protected final String TEXT_202 = "[matcher_";
  protected final String TEXT_203 = "].toString());" + NL + "\t\t\t\t\t\tmatcherFind_";
  protected final String TEXT_204 = "_";
  protected final String TEXT_205 = " = matcher_";
  protected final String TEXT_206 = "_";
  protected final String TEXT_207 = ".find()||matcherFind_";
  protected final String TEXT_208 = "_";
  protected final String TEXT_209 = ";" + NL + "\t\t\t\t\t\tif(matcherFind_";
  protected final String TEXT_210 = "_";
  protected final String TEXT_211 = "){" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t        isMatch_";
  protected final String TEXT_212 = " = isMatch_";
  protected final String TEXT_213 = " ";
  protected final String TEXT_214 = " matcherFind_";
  ...
  protected final String TEXT_219 = " = null;" + NL + "  " + NL + "\t\t\t        try {" + NL + "\t\t\t          date_";
  protected final String TEXT_220 = "_";
  protected final String TEXT_221 = " = ParserUtils.parseTo_Date(";
  protected final String TEXT_222 = ", \"dd-MM-yyyy HH:mm:ss\");" + NL + "\t\t\t        } catch (java.lang.Exception e){" + NL + "\t\t\t          date_";
  protected final String TEXT_223 = "_";
  protected final String TEXT_224 = " = ParserUtils.parseTo_Date(";
  protected final String TEXT_225 = ", \"dd-MM-yyyy\");" + NL + "\t\t\t        }" + NL + "\t\t\t  " + NL + "\t\t\t        if (date_";
  protected final String TEXT_226 = "_";
  protected final String TEXT_227 = " != null) {" + NL + "\t\t\t          isMatch_";
  protected final String TEXT_228 = " = isMatch_";
  protected final String TEXT_229 = " ";
  protected final String TEXT_230 = " (message_";
  protected final String TEXT_231 = ".getSentDate()!=null && message_";
  protected final String TEXT_232 = ".getSentDate().";
  protected final String TEXT_233 = "before";
  protected final String TEXT_234 = "after";
  protected final String TEXT_235 = "(date_";
  protected final String TEXT_236 = "_";
  protected final String TEXT_237 = "));" + NL + "\t\t\t        }";
  protected final String TEXT_238 = NL + "\t\t\t\tif (isMatch_";
  protected final String TEXT_239 = ") {";
  protected final String TEXT_240 = " " + NL + "     \t\t\tmessage_";
  protected final String TEXT_241 = ".setFlag(javax.mail.Flags.Flag.DELETED, true);" + NL + "    \t\t";
  protected final String TEXT_242 = NL + "\t\t\t    String filename_";
  protected final String TEXT_243 = " = ";
  protected final String TEXT_244 = ";" + NL + "\t\t\t    java.io.File file_";
  protected final String TEXT_245 = " = new java.io.File(";
  protected final String TEXT_246 = ", filename_";
  protected final String TEXT_247 = ");" + NL + "\t\t\t    java.io.OutputStream os_";
  protected final String TEXT_248 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_249 = ");" + NL + "\t\t\t    ";
  protected final String TEXT_250 = " " + NL + "\t\t\t    message_";
  protected final String TEXT_251 = ".writeTo(os_";
  protected final String TEXT_252 = ");" + NL + "\t\t\t    os_";
  protected final String TEXT_253 = ".close();" + NL + "\t\t\t    nb_email_";
  protected final String TEXT_254 = "++;" + NL + "\t\t\t    globalMap.put(\"";
  protected final String TEXT_255 = "_CURRENT_FILE\", filename_";
  protected final String TEXT_256 = ");" + NL + "\t\t\t    globalMap.put(\"";
  protected final String TEXT_257 = "_CURRENT_FILEPATH\", file_";
  protected final String TEXT_258 = ".getAbsolutePath());";
