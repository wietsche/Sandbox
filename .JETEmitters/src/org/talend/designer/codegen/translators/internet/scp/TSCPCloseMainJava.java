...
public class TSCPCloseMainJava
{
  ...
  protected final String TEXT_33 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_34 = " != null){" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_36 = " - Closing the connection '";
  protected final String TEXT_37 = "' to the server.\");" + NL + "\t\t";
  ...
  protected final String TEXT_42 = "' to the server closed.\");" + NL + "\t\t";
