...
public class TSCPFileListBeginJava
{
  ...
  protected final String TEXT_40 = NL + "\t    String hostname_";
  ...
  protected final String TEXT_124 = "     " + NL + "\t\t//initial the command" + NL + "\t\tStringBuilder command_";
  protected final String TEXT_125 = " = new StringBuilder();";
  protected final String TEXT_126 = NL + "         \t\tif(command_";
  protected final String TEXT_127 = ".length() > 0){" + NL + "\t\t\t\t\tcommand_";
  protected final String TEXT_128 = ".append(";
  protected final String TEXT_129 = ");" + NL + "\t\t\t\t} " + NL + "            \tcommand_";
  protected final String TEXT_130 = ".append(";
  protected final String TEXT_131 = ");";
  protected final String TEXT_132 = NL + "\t\t/* Create a session */" + NL + "\t\tch.ethz.ssh2.Session sess_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".openSession();" + NL + "\t\t//execute the command" + NL + "\t\tsess_";
  protected final String TEXT_135 = ".execCommand((command_";
  protected final String TEXT_136 = ").toString());" + NL + "\t\tint nb_line_";
  protected final String TEXT_137 = " = 0;" + NL + "\t\t//get the return info" + NL + "\t\tjava.io.InputStream stdout_";
  protected final String TEXT_138 = " = sess_";
  protected final String TEXT_139 = ".getStdout();" + NL + "\t\tjava.io.BufferedReader brout_";
  protected final String TEXT_140 = "= new java.io.BufferedReader(new java.io.InputStreamReader(stdout_";
  protected final String TEXT_141 = "));" + NL + "        String line_out_";
  protected final String TEXT_142 = " = \"\";" + NL + "        StringBuilder stringStdout_";
  protected final String TEXT_143 = " =new StringBuilder();" + NL + "\t\twhile((line_out_";
  protected final String TEXT_144 = " = brout_";
  protected final String TEXT_145 = ".readLine()) != null) {";
