...
public class TJMSInputEndJava
{
  ...
  protected final String TEXT_41 = NL + "\tnbline_";
  protected final String TEXT_42 = "++;" + NL + "\tmessage_";
  protected final String TEXT_43 = ".acknowledge();" + NL + "\tif(";
  protected final String TEXT_44 = " > 0 && nbline_";
  protected final String TEXT_45 = " >= ";
  protected final String TEXT_46 = "){" + NL + "\t\tbreak;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "consumer_";
  protected final String TEXT_47 = ".close();" + NL + "session_";
  protected final String TEXT_48 = ".close();" + NL + "connection_";
  protected final String TEXT_49 = ".close();";
  protected final String TEXT_50 = NL + "globalMap.put(\"";
  protected final String TEXT_51 = "_NB_LINE\", nbline_";
