...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_105 = NL + NL + "\t\tsession_";
  ...
  protected final String TEXT_148 = ".getHome());" + NL + "\t  \t}";
  ...
  protected final String TEXT_155 = ");" + NL + "\t    list";
  protected final String TEXT_156 = ".add(map";
  protected final String TEXT_157 = ");       ";
  protected final String TEXT_158 = NL;
  protected final String TEXT_159 = NL + "    \tlog.info(\"";
  protected final String TEXT_160 = " - Renaming file from server.\");";
  protected final String TEXT_161 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_162 = " : list";
  protected final String TEXT_163 = ") {" + NL;
  protected final String TEXT_164 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_165 = " =null;" + NL + "" + NL + "\t";
  protected final String TEXT_166 = NL + "    \tftp_";
  protected final String TEXT_167 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_168 = "\");" + NL + "\t\t";
  protected final String TEXT_169 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_170 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_171 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_172 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_173 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_174 = NL + "\t  \t";
  protected final String TEXT_175 = NL + "\t  \t\tString rootDir_";
  protected final String TEXT_176 = " = ftp_";
  protected final String TEXT_177 = ".pwd();" + NL + "\t  \t";
  protected final String TEXT_178 = NL + "\t";
  protected final String TEXT_179 = "    " + NL + "\t    ftp_";
  protected final String TEXT_180 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_181 = ".setRemoteHost(";
  protected final String TEXT_182 = ");" + NL + "\t    ftp_";
  protected final String TEXT_183 = ".setRemotePort(";
  ...
  protected final String TEXT_190 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\tftp_";
  protected final String TEXT_192 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\tftp_";
  protected final String TEXT_194 = ".setControlEncoding(";
  protected final String TEXT_195 = ");" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_197 = " - Attempt to connect to '\" + ";
  protected final String TEXT_198 = " + \"' with username '\" +";
  protected final String TEXT_199 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\tftp_";
  protected final String TEXT_201 = ".connect();  " + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_209 = NL + "\t\t\t" + NL + "\t\tftp_";
  ...
  protected final String TEXT_214 = " - Connect to '\" + ";
  protected final String TEXT_215 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_216 = "   " + NL + "\t";
  protected final String TEXT_217 = NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_218 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  protected final String TEXT_219 = "    " + NL + "\t\tjava.util.Map<String,String> map";
  protected final String TEXT_220 = " = new java.util.HashMap<String,String>();  " + NL + "\t\tmap";
  protected final String TEXT_221 = ".put(";
  protected final String TEXT_222 = ",";
  protected final String TEXT_223 = ");" + NL + "\t\tlist";
  protected final String TEXT_224 = ".add(map";
  protected final String TEXT_225 = ");       " + NL + "\t";
  protected final String TEXT_226 = "  " + NL + "\tString remotedir";
  protected final String TEXT_227 = " = ";
  protected final String TEXT_228 = ";" + NL + "\tftp_";
  protected final String TEXT_229 = ".chdir(remotedir";
  protected final String TEXT_230 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_231 = NL + "\t\tlog.info(\"";
  protected final String TEXT_232 = " - Renaming file from server.\");" + NL + "\t";
