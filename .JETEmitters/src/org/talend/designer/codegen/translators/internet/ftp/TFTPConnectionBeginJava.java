...
public class TFTPConnectionBeginJava
{
  ...
  protected final String TEXT_188 = ".setSSLSocketFactory(sslSocketFactory);";
  protected final String TEXT_189 = NL + "\t\t\tftp_";
  protected final String TEXT_190 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_191 = NL + "\t\t\tftp_";
  protected final String TEXT_192 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_193 = NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_195 = " -FTPS security Mode is ";
  ...
  protected final String TEXT_201 = ".connect(";
  protected final String TEXT_202 = ",";
  protected final String TEXT_203 = ");" + NL + "  \t\t";
  protected final String TEXT_204 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_205 = " - Connect to '\" + ";
  protected final String TEXT_206 = " + \"' has succeeded.\");" + NL + "\t\t";
  ...
  protected final String TEXT_215 = NL + "\t   \t" + NL + "    \tftp_";
  protected final String TEXT_216 = ".login(";
  protected final String TEXT_217 = ", decryptedPassword_";
  protected final String TEXT_218 = ");" + NL + "  \t} catch (java.lang.IllegalStateException e) {" + NL + "\t\t";
  protected final String TEXT_219 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_220 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_221 = NL + "    \te.printStackTrace();" + NL + "\t} catch (java.io.IOException e) {" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_223 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_224 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_226 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "\t\t";
  protected final String TEXT_228 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_229 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_230 = NL + "\t\te.printStackTrace();" + NL + "\t}" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_231 = "\", ftp_";
