...
public class TFTPDeleteBeginJava
{
  ...
  protected final String TEXT_167 = NL + "\t\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_168 = " =null;" + NL + "" + NL + "\t\t";
  protected final String TEXT_169 = NL + "    \t\tftp_";
  protected final String TEXT_170 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_171 = "\");" + NL + "\t\t\t";
  protected final String TEXT_172 = NL + "\t\t\t\tif(ftp_";
  protected final String TEXT_173 = "!=null) {" + NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_174 = " - Uses an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_175 = ".getRemoteHost() + \",Connection port: \" + ftp_";
  protected final String TEXT_176 = ".getRemotePort() + \".\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_177 = NL + "\t\t  \t";
  protected final String TEXT_178 = NL + "\t\t  \t\tString rootDir_";
  protected final String TEXT_179 = " = ftp_";
  protected final String TEXT_180 = ".pwd();" + NL + "\t\t  \t";
  protected final String TEXT_181 = NL + "  \t\t";
  protected final String TEXT_182 = "    " + NL + "\t\t    ftp_";
  protected final String TEXT_183 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t\t    ftp_";
  protected final String TEXT_184 = ".setRemoteHost(";
  protected final String TEXT_185 = ");" + NL + "\t\t    ftp_";
  protected final String TEXT_186 = ".setRemotePort(";
  protected final String TEXT_187 = ");" + NL + "\t\t    ";
  protected final String TEXT_188 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_189 = " - \" + ";
  protected final String TEXT_190 = ");" + NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t\t    ";
  protected final String TEXT_192 = NL + "\t\t      ftp_";
  protected final String TEXT_193 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t    ";
  protected final String TEXT_194 = NL + "\t\t      ftp_";
  protected final String TEXT_195 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t\t    ";
  protected final String TEXT_196 = NL + "\t\t    ftp_";
  protected final String TEXT_197 = ".setControlEncoding(";
  protected final String TEXT_198 = ");" + NL + "\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_200 = " - Attempt to connect to '\" + ";
  protected final String TEXT_201 = " + \"' with username: '\" +";
  protected final String TEXT_202 = "+ \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_203 = NL + "\t\t    ftp_";
  protected final String TEXT_204 = ".connect();  " + NL + "\t\t    " + NL + "\t\t    ";
  ...
  protected final String TEXT_212 = NL + "\t\t    " + NL + "\t\t    ftp_";
  protected final String TEXT_213 = ".login(";
  protected final String TEXT_214 = ", decryptedPassword_";
  protected final String TEXT_215 = ");" + NL + "\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_217 = " - Connect to '\" + ";
  protected final String TEXT_218 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_219 = "  " + NL + "  \t\t";
  protected final String TEXT_220 = "  " + NL + "  \t\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_221 = " = new java.util.ArrayList<java.util.Map<String,String>>();  " + NL + "" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\tjava.util.Map<String,String> map";
  protected final String TEXT_223 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tmap";
  protected final String TEXT_224 = ".put(";
  protected final String TEXT_225 = ",\"\");" + NL + "\t\t\t\tlist";
  protected final String TEXT_226 = ".add(map";
  protected final String TEXT_227 = ");       " + NL + "  \t\t";
  protected final String TEXT_228 = "  " + NL + "\t\t\tString remotedir";
  protected final String TEXT_229 = " = ";
  protected final String TEXT_230 = ";" + NL + "\t\t\tftp_";
  protected final String TEXT_231 = ".chdir(remotedir";
  protected final String TEXT_232 = ");" + NL + "\t\t\tString root";
  protected final String TEXT_233 = " = ftp_";
  protected final String TEXT_234 = ".pwd();" + NL + "" + NL + "\t\t";
  protected final String TEXT_235 = NL + "\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_237 = " - Deleting file from server.\");" + NL + "\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_239 = " - Deleting directory from server.\");" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "\t\t";
  protected final String TEXT_241 = NL + "\t\t\tfor (java.util.Map<String, String> map";
  protected final String TEXT_242 = " : list";
