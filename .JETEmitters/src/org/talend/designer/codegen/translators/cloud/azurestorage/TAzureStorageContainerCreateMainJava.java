...
public class TAzureStorageContainerCreateMainJava
{
  protected static String nl;
  public static synchronized TAzureStorageContainerCreateMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAzureStorageContainerCreateMainJava result = new TAzureStorageContainerCreateMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_27 = ".createIfNotExist();";
  protected final String TEXT_28 = NL + "\t\tif(result_";
  protected final String TEXT_29 = ") {" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_30 = " - The container doesn't exist and is created successfully.\");" + NL + "\t\t} else {" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_31 = " - The container already exists or is not created successfully.\");" + NL + "\t\t}";
  protected final String TEXT_32 = NL + "\tcom.microsoft.windowsazure.services.blob.client.BlobContainerPermissions blobContainerPerms_";
  protected final String TEXT_33 = " = new com.microsoft.windowsazure.services.blob.client.BlobContainerPermissions();" + NL + "\tblobContainerPerms_";
  protected final String TEXT_34 = ".setPublicAccess(com.microsoft.windowsazure.services.blob.client.BlobContainerPublicAccessType.CONTAINER);" + NL + "\tblobContainer_";
  protected final String TEXT_35 = ".uploadPermissions(blobContainerPerms_";
  protected final String TEXT_36 = ");";
  protected final String TEXT_37 = NL + "\t}catch(com.microsoft.windowsazure.services.core.storage.StorageException e_";
  ...
  protected final String TEXT_43 = ".getMessage());";
  ...
  protected final String TEXT_47 = ".getErrorCode()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_48 = ".getErrorCode());" + NL + "\t\t}" + NL + "\t\tif(e_";
  protected final String TEXT_49 = ".getMessage()!=null){" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_50 = ".getExtendedErrorInformation());" + NL + "\t\t}";
  ...
  public String generate(Object argument)
  {
	...
	String containerAcl = ElementParameterParser.getValue(node,"__CONTAINER_ACL__");
	...
	if("CONTAINER_ACL_PUBLIC".equals(containerAcl)){
