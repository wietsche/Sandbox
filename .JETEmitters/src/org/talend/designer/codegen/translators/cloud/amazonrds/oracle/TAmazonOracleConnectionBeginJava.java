...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_189 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_190 = ")) {";
  protected final String TEXT_191 = NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t";
  protected final String TEXT_193 = NL + NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_200 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_201 = "\",conn_";
  protected final String TEXT_202 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
