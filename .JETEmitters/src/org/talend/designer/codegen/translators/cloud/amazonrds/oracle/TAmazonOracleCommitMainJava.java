...
public class TAmazonOracleCommitMainJava
{
  protected static String nl;
  public static synchronized TAmazonOracleCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleCommitMainJava result = new TAmazonOracleCommitMainJava();
    nl = null;
    return result;
  }
