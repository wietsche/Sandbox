...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_59 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_60 = ");" + NL + "\t\t";
  protected final String TEXT_61 = NL + "\t\tconn_";
  protected final String TEXT_62 = ".deleteBucket(";
  protected final String TEXT_63 = ");" + NL + "\t\t";
  protected final String TEXT_64 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_65 = " - Delete the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_67 = "){" + NL + "\t\t";
  protected final String TEXT_68 = NL + "\t\t\tthrow(e_";
  ...
  protected final String TEXT_73 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_74 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_76 = " !=null){" + NL + "\t\t\tconn_";
