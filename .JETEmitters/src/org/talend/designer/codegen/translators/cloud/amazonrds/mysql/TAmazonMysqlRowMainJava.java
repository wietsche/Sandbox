...
public class TAmazonMysqlRowMainJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlRowMainJava result = new TAmazonMysqlRowMainJava();
    nl = null;
    return result;
  }
