...
public class TAmazonMysqlCloseMainJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlCloseMainJava result = new TAmazonMysqlCloseMainJava();
    nl = null;
    return result;
  }
