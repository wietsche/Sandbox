...
public class TBoxPutBeginJava
{
  ...
  protected final String TEXT_89 = "_client.getOAuthDataController().setAutoRefreshOAuth(true);" + NL + "\t\t\t}   " + NL + "    \t";
  protected final String TEXT_90 = "_client.authenticate(new com.box.boxjavalibv2.dao.BoxOAuthToken(";
  protected final String TEXT_91 = "_map));" + NL + "\t\t}";
  protected final String TEXT_92 = NL + "\tcom.box.boxjavalibv2.BoxClient ";
  protected final String TEXT_93 = "_client = (com.box.boxjavalibv2.BoxClient)globalMap.get(";
  protected final String TEXT_94 = ");";
  protected final String TEXT_95 = "\t" + NL + "\tcom.box.boxjavalibv2.dao.BoxFile ";
  protected final String TEXT_96 = "_boxFile = null;" + NL + "\tcom.box.boxjavalibv2.dao.BoxFolder ";
  protected final String TEXT_97 = "_boxFolder = null;";
  protected final String TEXT_98 = NL + "\tjava.io.ByteArrayOutputStream ";
  protected final String TEXT_99 = "_uploader_output = new java.io.ByteArrayOutputStream();" + NL + "\tjava.io.ByteArrayInputStream ";
  protected final String TEXT_100 = "_uploader_input = null;" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_101 = "_OUTPUTSTREAM\", ";
  protected final String TEXT_102 = "_uploader_output);" + NL + "\ttry" + NL + "\t{";
