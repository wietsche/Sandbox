...
public class TAmazonOracleCloseMainJava
{
  protected static String nl;
  public static synchronized TAmazonOracleCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleCloseMainJava result = new TAmazonOracleCloseMainJava();
    nl = null;
    return result;
  }
