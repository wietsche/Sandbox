...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_57 = NL + "\tint nb_bucket_";
  protected final String TEXT_58 = " = 0;" + NL + "\t";
  protected final String TEXT_59 = NL + "\t\tlog.info(\"";
  protected final String TEXT_60 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_61 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_62 = " = conn_";
  protected final String TEXT_63 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_64 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_65 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_66 = " : buckets_";
  protected final String TEXT_67 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_68 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_69 = " = bucket_";
  protected final String TEXT_70 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_71 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_72 = ");" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_74 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_75 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_76 = " - Name of current bucket : \" + currentBucketName_";
