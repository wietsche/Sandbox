...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_57 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_60 = "!=null && key_";
  protected final String TEXT_61 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_62 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_63 = " - Deleting an object with key:\" + ";
  protected final String TEXT_64 = ");" + NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\tconn_";
  protected final String TEXT_66 = ".deleteObject(";
  protected final String TEXT_67 = ", key_";
  protected final String TEXT_68 = ");" + NL + "\t\t\t";
  protected final String TEXT_69 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_70 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_71 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_72 = "){" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_74 = ");" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_76 = " - \" + e_";
  protected final String TEXT_77 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_79 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_80 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_81 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_82 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
