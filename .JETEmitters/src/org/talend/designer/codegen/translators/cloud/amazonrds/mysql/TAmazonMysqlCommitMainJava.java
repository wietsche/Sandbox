...
public class TAmazonMysqlCommitMainJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlCommitMainJava result = new TAmazonMysqlCommitMainJava();
    nl = null;
    return result;
  }
