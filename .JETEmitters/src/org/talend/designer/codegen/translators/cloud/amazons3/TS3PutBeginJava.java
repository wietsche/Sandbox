...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_59 = " - Uploading an object with key:\" + ";
  protected final String TEXT_60 = ");" + NL + "\t\t";
  protected final String TEXT_61 = NL + "\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_62 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_63 = ", ";
  protected final String TEXT_64 = ", new java.io.File(";
  protected final String TEXT_65 = "));" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_67 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_68 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tputRequest_";
  protected final String TEXT_69 = ".setMetadata(objectMetadata_";
  protected final String TEXT_70 = ");" + NL + "\t\t";
  protected final String TEXT_71 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_72 = ".putObject(putRequest_";
  protected final String TEXT_73 = ");" + NL + "\t\t";
  protected final String TEXT_74 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_75 = " - Upload the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_76 = NL + "\t}catch(java.lang.Exception e_";
  protected final String TEXT_77 = "){" + NL + "\t\t";
  protected final String TEXT_78 = NL + "\t\t\tthrow(e_";
  ...
  protected final String TEXT_83 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_84 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_86 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_87 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
