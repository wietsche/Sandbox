...
public class TAmazonOracleRowEndJava
{
  protected static String nl;
  public static synchronized TAmazonOracleRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleRowEndJava result = new TAmazonOracleRowEndJava();
    nl = null;
    return result;
  }
