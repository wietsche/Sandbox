...
public class TAmazonMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_33 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_34 = NL + "\t\tString proprtties_";
  protected final String TEXT_35 = " = ";
  protected final String TEXT_36 = ";" + NL + "\t\tif (proprtties_";
  protected final String TEXT_37 = " == null || proprtties_";
  protected final String TEXT_38 = ".trim().length() == 0) {" + NL + "\t\t\tproprtties_";
  protected final String TEXT_39 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (proprtties_";
  protected final String TEXT_40 = " != null && !proprtties_";
  protected final String TEXT_41 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproprtties_";
  protected final String TEXT_42 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString url_";
  protected final String TEXT_43 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_44 = " + \":\" + ";
  protected final String TEXT_45 = " + \"/\" + ";
  protected final String TEXT_46 = " + \"?\" + proprtties_";
  protected final String TEXT_47 = ";";
  protected final String TEXT_48 = NL + NL + "\t";
  protected final String TEXT_49 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_62 = NL + "\t\tString dbPwd_";
  protected final String TEXT_63 = " = decryptedPassword_";
  protected final String TEXT_64 = ";" + NL + "\t";
  protected final String TEXT_65 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_66 = " = null;" + NL + "\t";
  protected final String TEXT_67 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_68 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_70 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_71 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_73 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_74 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_79 = " - Written records count: \" + nb_line_";
  protected final String TEXT_80 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_82 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_84 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_85 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_87 = " - Writing the record \" + nb_line_";
  protected final String TEXT_88 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_90 = " - Processing the record \" + nb_line_";
  protected final String TEXT_91 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_93 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_94 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_96 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_97 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_99 = " - Uses an existing connection ";
  protected final String TEXT_100 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_102 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_103 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_104 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_108 = ", dbUser_";
  protected final String TEXT_109 = ", dbPwd_";
  protected final String TEXT_110 = ");" + NL + "\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\tconn_";
  protected final String TEXT_112 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\tconn_";
  protected final String TEXT_114 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\tconn_";
  protected final String TEXT_116 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\tconn_";
  protected final String TEXT_118 = ".setAutoCommit(";
  protected final String TEXT_119 = ");" + NL + "\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\tlog.";
  protected final String TEXT_121 = "(\"";
  protected final String TEXT_122 = " - \" + ";
  protected final String TEXT_123 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t    \t\tlog.";
  protected final String TEXT_125 = "(\"";
  protected final String TEXT_126 = "\");" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_128 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_130 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_131 = ": pstmt_";
  protected final String TEXT_132 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_133 = " += (countEach_";
  protected final String TEXT_134 = " < 0 ? 0 : ";
  protected final String TEXT_135 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t";
  protected final String TEXT_137 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
