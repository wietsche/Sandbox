...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_59 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_60 = ");" + NL + "\t\t";
  protected final String TEXT_61 = NL + "\t\tconn_";
  protected final String TEXT_62 = ".createBucket(";
  protected final String TEXT_63 = ");" + NL + "\t\t";
  protected final String TEXT_64 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_65 = " - Create the bucket successfully.\");" + NL + "\t\t";
