...
public class TAmazonMysqlRollbackMainJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlRollbackMainJava result = new TAmazonMysqlRollbackMainJava();
    nl = null;
    return result;
  }
