...
public class TAzureStorageGetBeginJava
{
  protected static String nl;
  public static synchronized TAzureStorageGetBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAzureStorageGetBeginJava result = new TAzureStorageGetBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_37 = NL + "\t\t\t\t\tnew java.io.File(";
  protected final String TEXT_38 = " + \"/\" + blob_";
  protected final String TEXT_39 = ".getName()).getParentFile().mkdirs();";
  protected final String TEXT_40 = NL + "\t\t\t\tblob_";
  protected final String TEXT_41 = ".download(new java.io.FileOutputStream(";
  protected final String TEXT_42 = " + \"/\" + blob_";
  protected final String TEXT_43 = ".getName()));";
  protected final String TEXT_44 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_45 = " - Download the blob : \" + blob_";
  protected final String TEXT_46 = ".getName() + \" successfully.\");";
  ...
  protected final String TEXT_51 = "_LOCAL_FOLDER\", ";
  protected final String TEXT_52 = ");" + NL + "\t} catch (java.lang.Exception e_";
  protected final String TEXT_53 = ") {";
  protected final String TEXT_54 = NL + "\t\t\tthrow e_";
