...
public class TAmazonOracleRowBeginJava
{
  ...
  protected final String TEXT_122 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_123 = " + \":\" + ";
  protected final String TEXT_124 = " + \":\" + ";
  protected final String TEXT_125 = ";" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_128 = " + \")(port=\" + ";
  protected final String TEXT_129 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_130 = " + \")))\";" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\tString url_";
  protected final String TEXT_132 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_149 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_150 = " = null;" + NL + "\tString query_";
  protected final String TEXT_151 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_155 = ".prepareStatement(";
  protected final String TEXT_156 = ");\t" + NL + "\t";
  protected final String TEXT_157 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();" + NL + "\t";
  protected final String TEXT_160 = NL;
  protected final String TEXT_161 = NL + "\t\tint nb_line_inserted_";
  protected final String TEXT_162 = " = 0;";
  protected final String TEXT_163 = NL + "\t\tint nb_line_update_";
  protected final String TEXT_164 = " = 0;";
  protected final String TEXT_165 = NL + "\t\tint nb_line_deleted_";
