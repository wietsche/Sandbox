...
public class TBoxDeleteBeginJava
{
  protected static String nl;
  public static synchronized TBoxDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TBoxDeleteBeginJava result = new TBoxDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_58 = "_clientSecret.isEmpty()) {" + NL + "\t\tthrow new Exception(\"Client Id and secret can not be empty\");" + NL + "\t}" + NL + "\tif(globalMap.get(\"delete_";
  ...
  protected final String TEXT_92 = "_map));" + NL + "\t\t\tglobalMap.put(\"delete_";
  protected final String TEXT_93 = "\", ";
  protected final String TEXT_94 = "_client);" + NL + "\t\t}" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_95 = "_client = (com.box.boxjavalibv2.BoxClient)globalMap.get(\"delete_";
