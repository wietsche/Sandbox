...
public class Subprocess_footerJava
{
  ...
  protected final String TEXT_23 = "\", \"\", Thread.currentThread().getId() + \"\", \"\", \"\", \"\", \"\", \"\");" + NL + "\t\t\t\t\t\t\t\t}\t    \t\t\t\t    \t\t\t" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_24 = NL + "\t\t\t\t\t\t\t\tif(execStat){    \t" + NL + "\t\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_25 = "\", 0, \"ok\");" + NL + "\t\t\t\t\t\t\t\t} " + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_33 = "\") == null){" + NL + "\t\t\t\t\t\tif(resourceMap.get(\"start_";
  protected final String TEXT_34 = "\") != null){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_36 = "[\" + Thread.currentThread().getName() + \"] - \" + e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"THREADS_HAVE_ERROR\", e);" + NL + "\t\t\t\t\t\t\treturn;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_38 = NL + "\t\t\t\tthrow te;" + NL + "\t\t\t}catch(java.lang.Error error){\t" + NL + "\t\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t\trunStat.stopThreadStat();" + NL + "\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\tif(resourceMap.get(\"finish_";
  protected final String TEXT_41 = "\") == null){" + NL + "\t\t\t\t\t\tif(resourceMap.get(\"start_";
  protected final String TEXT_42 = "\") != null){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_43 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_44 = "[\" + Thread.currentThread().getName() + \"] - \" + error.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"THREADS_HAVE_ERROR\",error);" + NL + "\t\t\t\t\t\t\treturn;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t\tthrow error;" + NL + "\t\t\t}finally{" + NL + "\t\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t\t\t\t//free memory for \"";
  protected final String TEXT_48 = "\"" + NL + "\t\t\t\t\t\t\tglobalMap.remove(\"";
  protected final String TEXT_49 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\t\t     \t\t\t//free memory for \"";
  protected final String TEXT_51 = "\"" + NL + "\t\t\t\t\t     \t\t\tglobalMap.remove(\"tHash_Lookup_";
  protected final String TEXT_52 = "\"); " + NL + "\t\t\t\t     \t\t\t";
  protected final String TEXT_53 = "      \t" + NL + "\t\t\t\t\t      \t\t\t//free memory for \"";
  protected final String TEXT_54 = "\"" + NL + "\t\t\t\t\t\t\t\t\tglobalMap.remove(\"tHash_";
  protected final String TEXT_55 = "\");" + NL + "\t\t\t\t      \t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t}catch(java.lang.Exception e){\t" + NL + "\t\t\t\t\t//ignore" + NL + "\t\t\t\t}catch(java.lang.Error error){" + NL + "\t\t\t\t\t//ignore" + NL + "\t\t\t\t}" + NL + "\t\t\t\tresourceMap = null;" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_58 = NL + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_59 = "_SUBPROCESS_STATE\", 1);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_60 = NL + "\t\t/**" + NL + "\t\t * End of Function: ";
  protected final String TEXT_61 = "Process " + NL + "\t\t\t */" + NL + " \t\t";
