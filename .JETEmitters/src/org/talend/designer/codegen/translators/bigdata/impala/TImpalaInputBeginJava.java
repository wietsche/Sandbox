...
public class TImpalaInputBeginJava
{
  protected static String nl;
  public static synchronized TImpalaInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TImpalaInputBeginJava result = new TImpalaInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_175 = " = \"jdbc:hive2://\"+";
  ...
  protected final String TEXT_193 = ";" + NL + "\t\t\tif(dbname_";
  protected final String TEXT_194 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_195 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_196 = ".trim())) {" + NL + "\t\t\t\tjava.sql.Statement goToDatabase_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_199 = ".execute(\"use \" + dbname_";
  protected final String TEXT_200 = ");" + NL + "\t\t\t\tgoToDatabase_";
  protected final String TEXT_201 = ".close();" + NL + "\t\t    }";
  protected final String TEXT_202 = NL + NL + "\t";
  protected final String TEXT_203 = NL + "\t\t    int nb_line_";
  protected final String TEXT_204 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_205 = " = null;";
  protected final String TEXT_206 = NL + "\t\t        conn_";
  protected final String TEXT_207 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_208 = "\");";
  protected final String TEXT_209 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_210 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_211 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_212 = " = dataSources_";
  protected final String TEXT_213 = ".get(";
  protected final String TEXT_214 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_215 = "\", conn_";
  protected final String TEXT_216 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_217 = NL + "\t\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\t";
  protected final String TEXT_219 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_220 = " =  conn_";
  protected final String TEXT_221 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_222 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_223 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_224 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_225 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_226 = NL + "                 conn_";
  protected final String TEXT_227 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_228 = NL + "               ";
  protected final String TEXT_229 = " + \"=\" + ";
  protected final String TEXT_230 = " + \";\" +";
  protected final String TEXT_231 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_232 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_239 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_240 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_241 = NL;
  protected final String TEXT_242 = NL + "                       globalMap.put(\"";
  protected final String TEXT_243 = "_QUERY\",dbquery_";
  protected final String TEXT_244 = ");";
  protected final String TEXT_245 = NL + "                       globalMap.put(\"";
  protected final String TEXT_246 = "_QUERY\",dbquery_";
  protected final String TEXT_247 = ");";
  protected final String TEXT_248 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_249 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_250 = " = stmt_";
  protected final String TEXT_251 = ".executeQuery(dbquery_";
  protected final String TEXT_252 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_253 = " = rs_";
  protected final String TEXT_254 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_255 = " = rsmd_";
  protected final String TEXT_256 = ".getColumnCount();" + NL;
  protected final String TEXT_257 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_258 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_259 = ".setDbmsId(\"";
  protected final String TEXT_260 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_261 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_262 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_263 = ".add(\"";
  protected final String TEXT_264 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_265 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_268 = "; i <= rsmd_";
  protected final String TEXT_269 = ".getColumnCount()-";
  protected final String TEXT_270 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_271 = ".contains(rsmd_";
  protected final String TEXT_272 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_273 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_274 = ".setName(rsmd_";
  protected final String TEXT_275 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_276 = ".setDbName(rsmd_";
  protected final String TEXT_277 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_278 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_279 = "\", rsmd_";
  protected final String TEXT_280 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_281 = ".getPrecision(i), rsmd_";
  protected final String TEXT_282 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setDbType(rsmd_";
  protected final String TEXT_284 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setDbTypeId(rsmd_";
  protected final String TEXT_286 = ".getColumnType(i));";
  protected final String TEXT_287 = NL + "                \tdcm_";
  protected final String TEXT_288 = ".setFormat(";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_291 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_292 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_293 = ".setLength(rsmd_";
  protected final String TEXT_294 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_295 = ".setLength(rsmd_";
  protected final String TEXT_296 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_297 = NL + "\t\t\tdcm_";
  protected final String TEXT_298 = ".setLength(rsmd_";
  protected final String TEXT_299 = ".getPrecision(i));";
  protected final String TEXT_300 = NL + "                \tdcm_";
  protected final String TEXT_301 = ".setPrecision(rsmd_";
  protected final String TEXT_302 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setNullable(rsmd_";
  protected final String TEXT_304 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_306 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_307 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_308 = ".metadatas.add(dcm_";
  protected final String TEXT_309 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_310 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_311 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_312 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_313 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_314 = NL + "\t\t    ";
  protected final String TEXT_315 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_316 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_317 = NL + "\t\t    while (rs_";
  protected final String TEXT_318 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_319 = "++;" + NL + "\t\t        ";
  protected final String TEXT_320 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_321 = " = ";
  protected final String TEXT_322 = " + dcg_";
  protected final String TEXT_323 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
