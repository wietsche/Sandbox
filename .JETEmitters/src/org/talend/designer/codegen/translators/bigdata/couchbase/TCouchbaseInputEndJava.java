...
public class TCouchbaseInputEndJava
{
  protected static String nl;
  public static synchronized TCouchbaseInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCouchbaseInputEndJava result = new TCouchbaseInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_33 = ".shutdown();" + NL + "\t";
