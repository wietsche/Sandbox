...
public class TImpalaLoadMainJava
{
  ...
  protected final String TEXT_156 = NL + "\t\tString path_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";";
  protected final String TEXT_159 = NL + "\t\tString tablename_";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";";
  protected final String TEXT_162 = NL + "\t\t\tString partition_";
  protected final String TEXT_163 = " = ";
  protected final String TEXT_164 = ";";
  protected final String TEXT_165 = NL + "\t\t\tString tablename_";
  protected final String TEXT_166 = " = ";
  protected final String TEXT_167 = ";";
  protected final String TEXT_168 = NL + "\t\t\t\tString partition_";
  protected final String TEXT_169 = " = ";
  protected final String TEXT_170 = ";";
  protected final String TEXT_171 = NL + "\t\t\tString path_";
  protected final String TEXT_172 = " = ";
  protected final String TEXT_173 = ";";
  protected final String TEXT_174 = NL + "\t\tString query_";
  protected final String TEXT_175 = " = ";
  protected final String TEXT_176 = ";";
  protected final String TEXT_177 = NL + NL + "\tString querySQL_";
  protected final String TEXT_178 = " = \"";
  protected final String TEXT_179 = "\";" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "" + NL + "\ttry {" + NL + "\t\tstmt_";
  protected final String TEXT_182 = ".execute(querySQL_";
  protected final String TEXT_183 = ");" + NL + "\t} catch(java.sql.SQLException e_";
  protected final String TEXT_184 = ") {" + NL + "\t    ";
  protected final String TEXT_185 = NL + "\t    \tthrow e_";
  protected final String TEXT_186 = ";" + NL + "\t    ";
  protected final String TEXT_187 = " " + NL + "\t    \tSystem.err.println(\"Exception in the component ";
  protected final String TEXT_188 = ":\" + e_";
  protected final String TEXT_189 = ".getMessage());" + NL + "\t    ";
  protected final String TEXT_190 = NL + "\t}" + NL + "\tstmt_";
  ...
  protected final String TEXT_195 = "_QUERY\", querySQL_";
