...
public class TCouchbaseOutEndJava
{
  protected static String nl;
  public static synchronized TCouchbaseOutEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCouchbaseOutEndJava result = new TCouchbaseOutEndJava();
    nl = null;
    return result;
  }
