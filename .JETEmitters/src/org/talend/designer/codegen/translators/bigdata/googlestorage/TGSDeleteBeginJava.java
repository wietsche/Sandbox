...
public class TGSDeleteBeginJava
{
  protected static String nl;
  public static synchronized TGSDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGSDeleteBeginJava result = new TGSDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_24 = ");" + NL + "\t\tservice_";
  ...
  protected final String TEXT_103 = ".deleteObject(currentBucketName_";
  protected final String TEXT_104 = ",objectSummary_";
  protected final String TEXT_105 = ".getKey());" + NL + "\t";
