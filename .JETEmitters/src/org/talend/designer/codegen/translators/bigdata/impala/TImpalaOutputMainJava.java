...
public class TImpalaOutputMainJava {
  protected static String nl;
  public static synchronized TImpalaOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TImpalaOutputMainJava result = new TImpalaOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = NL + "        if(needInitialization_";
  protected final String TEXT_47 = ") {";
  protected final String TEXT_48 = NL + "                needInitialization_";
  protected final String TEXT_49 = " = false;";
  protected final String TEXT_50 = NL + "            sbValue_";
  protected final String TEXT_51 = " = new java.lang.StringBuilder(insertPrefix_";
  protected final String TEXT_52 = ");" + NL + "        }" + NL + "        sbValue_";
  protected final String TEXT_53 = ".append(\"(\");";
  protected final String TEXT_54 = NL + "                    if(true) {" + NL + "                        throw new java.lang.Exception(\"The component tImpalaOutput does not the support the type ";
  protected final String TEXT_55 = ".\");" + NL + "                    }";
  protected final String TEXT_56 = NL + "                    if(";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = "==null) {" + NL + "                        sbValue_";
  protected final String TEXT_59 = ".append(\"";
  protected final String TEXT_60 = "null\");" + NL + "                    } else {";
  protected final String TEXT_61 = NL + "                    sbValue_";
  protected final String TEXT_62 = ".append(\"";
  protected final String TEXT_63 = "'\" + ";
  protected final String TEXT_64 = ".";
  protected final String TEXT_65 = ".replaceAll(\"\\'\", \"\\\\\\\\'\") + \"'\");";
  protected final String TEXT_66 = NL + "\t\t\t\t\tsbValue_";
  protected final String TEXT_67 = ".append(\"";
  protected final String TEXT_68 = "'\" + ";
  protected final String TEXT_69 = ".";
  protected final String TEXT_70 = " + \"'\");";
  protected final String TEXT_71 = NL + "                    sbValue_";
  protected final String TEXT_72 = ".append(\"";
  protected final String TEXT_73 = "'\" + FormatterUtils.format_Date(";
  protected final String TEXT_74 = ".";
  protected final String TEXT_75 = ", \"yyyy-MM-dd\") + \"'\");";
  protected final String TEXT_76 = NL + "                    sbValue_";
  protected final String TEXT_77 = ".append(\"";
  protected final String TEXT_78 = "\" + ";
  protected final String TEXT_79 = ".";
  protected final String TEXT_80 = ");";
  protected final String TEXT_81 = NL + "                    }";
  protected final String TEXT_82 = NL + "        sbValue_";
  protected final String TEXT_83 = ".append(\")\");" + NL + "        rowCount";
  protected final String TEXT_84 = "++;" + NL + "\t\ttry {" + NL + "\t\t\tnb_line_";
  protected final String TEXT_85 = "++;";
  protected final String TEXT_86 = NL + "                if(rowCount";
  protected final String TEXT_87 = " == ";
  protected final String TEXT_88 = ") {";
  protected final String TEXT_89 = NL + "\t\t\tstmt_";
  protected final String TEXT_90 = ".executeUpdate(sbValue_";
  protected final String TEXT_91 = ".toString());" + NL + "\t\t\tinsertPrefix_";
  protected final String TEXT_92 = " = insertPrefix_";
  protected final String TEXT_93 = ".replace(\"INSERT OVERWRITE\", \"INSERT INTO\");" + NL + "\t\t\t";
  protected final String TEXT_94 = NL + "                    rowCount";
  protected final String TEXT_95 = " = 0;" + NL + "                    needInitialization_";
  protected final String TEXT_96 = " = true;" + NL + "                } else {" + NL + "                    sbValue_";
  protected final String TEXT_97 = ".append(\",\");                    " + NL + "                }";
  protected final String TEXT_98 = NL + "\t\t} catch(java.lang.Exception e) {";
  protected final String TEXT_99 = NL + "\t\t\t\tthrow e;";
  protected final String TEXT_100 = NL + "\t\t\t\tSystem.err.print(\"Exception in the component ";
  protected final String TEXT_101 = ":\" + e.getMessage());";
