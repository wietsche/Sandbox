...
public class TImpalaOutputBeginJava {
  protected static String nl;
  public static synchronized TImpalaOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TImpalaOutputBeginJava result = new TImpalaOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_155 = NL + "\tString tableName_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";" + NL + "\tint nb_line_";
  protected final String TEXT_158 = " = 0;";
  protected final String TEXT_159 = NL + "    String insertPrefix_";
  protected final String TEXT_160 = " = \"INSERT ";
  protected final String TEXT_161 = " \" + tableName_";
  protected final String TEXT_162 = " + \" (";
  protected final String TEXT_163 = ") VALUES \";\t\t" + NL + "\tjava.lang.StringBuilder sbValue_";
  protected final String TEXT_164 = " = null;" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "    int rowCount";
  protected final String TEXT_167 = " = 0;" + NL + "    boolean needInitialization_";
