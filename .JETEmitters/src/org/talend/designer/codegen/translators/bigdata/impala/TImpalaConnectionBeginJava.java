...
public class TImpalaConnectionBeginJava
{
  protected static String nl;
  public static synchronized TImpalaConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TImpalaConnectionBeginJava result = new TImpalaConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_30 = " = \"jdbc:hive2://\"+";
  ...
  protected final String TEXT_55 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_57 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_58 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_60 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_61 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_66 = " - Written records count: \" + nb_line_";
  protected final String TEXT_67 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_68 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_69 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_71 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_72 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_74 = " - Writing the record \" + nb_line_";
  protected final String TEXT_75 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_77 = " - Processing the record \" + nb_line_";
  protected final String TEXT_78 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_80 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_81 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_83 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_84 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_86 = " - Uses an existing connection ";
  protected final String TEXT_87 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_89 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_90 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  ...
  protected final String TEXT_99 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\tconn_";
  protected final String TEXT_101 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\tconn_";
  protected final String TEXT_103 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\t\tconn_";
  protected final String TEXT_105 = ".setAutoCommit(";
  protected final String TEXT_106 = ");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\tlog.";
  protected final String TEXT_108 = "(\"";
  protected final String TEXT_109 = " - \" + ";
  protected final String TEXT_110 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_111 = NL + "\t    \t\tlog.";
  protected final String TEXT_112 = "(\"";
  protected final String TEXT_113 = "\");" + NL + "\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_115 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_117 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_118 = ": pstmt_";
  protected final String TEXT_119 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_120 = " += (countEach_";
  protected final String TEXT_121 = " < 0 ? 0 : ";
  protected final String TEXT_122 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_123 = NL + "\t";
  protected final String TEXT_124 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_135 = NL + "\t" + NL + "\tglobalMap.put(\"db_";
