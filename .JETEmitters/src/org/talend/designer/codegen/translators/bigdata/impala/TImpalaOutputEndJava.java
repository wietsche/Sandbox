...
public class TImpalaOutputEndJava {
  protected static String nl;
  public static synchronized TImpalaOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TImpalaOutputEndJava result = new TImpalaOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_44 = NL + "        if(rowCount";
  protected final String TEXT_45 = " != 0) {" + NL + "            try {" + NL + "                stmt_";
  protected final String TEXT_46 = ".executeUpdate(sbValue_";
  protected final String TEXT_47 = ".toString().substring(0, sbValue_";
  protected final String TEXT_48 = ".toString().length()-1));";
  protected final String TEXT_49 = NL + "            } catch(java.lang.Exception e) {";
  protected final String TEXT_50 = NL + "                    throw e;";
  protected final String TEXT_51 = NL + "                    System.err.print(\"Exception in the component ";
  protected final String TEXT_52 = ":\" + e.getMessage());";
