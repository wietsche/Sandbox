...
public class TBigQueryOutputBulkEndJava
{
  ...
  protected final String TEXT_31 = NL + "\tif(csvWriter_";
  protected final String TEXT_32 = "!=null) {" + NL + "\t\tcsvWriter_";
  protected final String TEXT_33 = ".close();" + NL + "\t}" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_34 = "\", true); " + NL + "\tglobalMap.put(\"";
