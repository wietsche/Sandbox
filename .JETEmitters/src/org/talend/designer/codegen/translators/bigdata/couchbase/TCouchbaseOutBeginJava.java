...
public class TCouchbaseOutBeginJava
{
  protected static String nl;
  public static synchronized TCouchbaseOutBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCouchbaseOutBeginJava result = new TCouchbaseOutBeginJava();
    nl = null;
    return result;
  }
