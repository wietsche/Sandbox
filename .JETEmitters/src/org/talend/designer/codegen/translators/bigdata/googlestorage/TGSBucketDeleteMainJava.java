...
public class TGSBucketDeleteMainJava
{
  ...
  protected final String TEXT_23 = ");" + NL + "\t\tservice_";
  protected final String TEXT_24 = ".getAccountOwner();" + NL + "\t";
  protected final String TEXT_25 = NL + "\t\tservice_";
  protected final String TEXT_26 = ".deleteBucket(";
  protected final String TEXT_27 = ");" + NL + "" + NL + "\t}catch(org.jets3t.service.ServiceException e_";
  protected final String TEXT_28 = ") {" + NL + "\t\t";
  protected final String TEXT_29 = NL + "\t\t\tthrow(e_";
  protected final String TEXT_30 = ");" + NL + "\t\t";
  protected final String TEXT_31 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_32 = " - Exception in component ";
  protected final String TEXT_33 = ":\" + e_";
  protected final String TEXT_34 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_36 = ":\");" + NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_37 = ".getMessage());" + NL + "\t\t\tif(e_";
  protected final String TEXT_38 = ".getErrorCode()!=null){" + NL + "\t\t\t\t";
  protected final String TEXT_39 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_40 = " - \" + e_";
  protected final String TEXT_41 = ".getErrorCode());" + NL + "\t\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_43 = ".getErrorCode());" + NL + "\t\t\t}" + NL + "\t\t\tif(e_";
  protected final String TEXT_44 = ".getErrorMessage()!=null){" + NL + "\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_46 = " - \" + e_";
  protected final String TEXT_47 = ".getErrorMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t\tSystem.err.println(e_";
  protected final String TEXT_49 = ".getErrorMessage());" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t}finally{" + NL + "\t\tif(service_";
  protected final String TEXT_51 = " !=null){" + NL + "\t\t\tservice_";
  protected final String TEXT_52 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
