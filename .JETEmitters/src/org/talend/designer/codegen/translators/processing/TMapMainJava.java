...
public class TMapMainJava {
  ...
  protected final String TEXT_99 = NL + NL + "\t\t\t\t\t" + NL + "\t\t\t\t" + NL + "\t\t\t\t" + NL + "\t\t\t\t\trsc_";
  protected final String TEXT_100 = "_";
  protected final String TEXT_101 = " = (SortableRow_";
  protected final String TEXT_102 = "_";
  protected final String TEXT_103 = ") fsi_";
  protected final String TEXT_104 = "_";
  protected final String TEXT_105 = ".next();" + NL + "               \t\trsc_";
  protected final String TEXT_106 = "_";
  protected final String TEXT_107 = ".copyDataTo(";
  protected final String TEXT_108 = " ";
  protected final String TEXT_109 = ");" + NL + "               \t\t" + NL + "               \t\t";
  protected final String TEXT_110 = " = rsc_";
  protected final String TEXT_111 = "_";
  protected final String TEXT_112 = ".is__rejectedInnerJoin;" + NL + "               \t\t" + NL + "\t\t\t";
  protected final String TEXT_113 = NL + "\t\t\t\t";
  protected final String TEXT_114 = " = false;" + NL + "\t\t\t";
  protected final String TEXT_115 = NL + "                            " + NL + " \t\t\t\t\t    boolean forceLoop";
  protected final String TEXT_116 = " = false;" + NL + "       \t\t  \t    \t" + NL + "       \t\t  \t    \t";
  protected final String TEXT_117 = NL + " \t\t\t\t\t\t\t";
  protected final String TEXT_118 = " ";
  protected final String TEXT_119 = "ObjectFromLookup = null;" + NL + "                          " + NL + "\t\t           \t\t  \tif(!";
  protected final String TEXT_120 = " && ";
  protected final String TEXT_121 = ") { // G_TM_M_020" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\t\t\t\thasCasePrimitiveKeyWithNull_";
  protected final String TEXT_123 = " = false;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_124 = NL + " \t                        \t\t   ";
  protected final String TEXT_125 = NL + "                        \t\t\t    ";
  protected final String TEXT_126 = NL + "\t                        \t\t    \tObject exprKeyValue_";
  protected final String TEXT_127 = "__";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ";" + NL + "\t                        \t\t    \tif(exprKeyValue_";
  protected final String TEXT_130 = "__";
  protected final String TEXT_131 = " == null) {" + NL + "\t                        \t\t    \t\thasCasePrimitiveKeyWithNull_";
  protected final String TEXT_132 = " = true;" + NL + "\t                        \t\t    \t} else {" + NL + "\t                        \t\t    \t\t";
  protected final String TEXT_133 = "HashKey.";
  protected final String TEXT_134 = " = (";
  protected final String TEXT_135 = ")(";
  protected final String TEXT_136 = ") rsc_";
  protected final String TEXT_137 = "_";
  protected final String TEXT_138 = ".exprKey_";
  protected final String TEXT_139 = "__";
  protected final String TEXT_140 = ";" + NL + "                        \t\t    \t\t}" + NL + "                        \t\t    \t\t";
  protected final String TEXT_141 = NL + "                        \t\t    \t\t";
  protected final String TEXT_142 = "HashKey.";
  protected final String TEXT_143 = " = rsc_";
  protected final String TEXT_144 = "_";
  protected final String TEXT_145 = ".exprKey_";
  protected final String TEXT_146 = "__";
  protected final String TEXT_147 = ";" + NL + "                        \t\t    \t\t";
  protected final String TEXT_148 = NL + "\t                        \t\t    \tObject exprKeyValue_";
  protected final String TEXT_149 = "__";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t                        \t\t    \tif(exprKeyValue_";
  protected final String TEXT_152 = "__";
  protected final String TEXT_153 = " == null) {" + NL + "\t                        \t\t    \t\thasCasePrimitiveKeyWithNull_";
  protected final String TEXT_154 = " = true;" + NL + "\t                        \t\t    \t} else {" + NL + "                        \t\t    \t\t\t";
  protected final String TEXT_155 = "HashKey.";
  protected final String TEXT_156 = " = (";
  protected final String TEXT_157 = ")(";
  protected final String TEXT_158 = ") exprKeyValue_";
  ...
  protected final String TEXT_169 = "HashKey.hashCodeDirty = true;" + NL + "                        \t\t";
  protected final String TEXT_170 = NL + "\t  \t\t\t\t\t" + NL + "\t  \t\t\t\t\t\t\t";
  protected final String TEXT_171 = NL + "\t" + NL + "\t\t  \t\t\t\t\t\t\tif(!hasCasePrimitiveKeyWithNull_";
  protected final String TEXT_172 = ") { // G_TM_M_091" + NL + "\t\t  \t\t\t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\t  \t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t";
  protected final String TEXT_174 = NL + NL + "\t\t\t  \t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_175 = ".lookup( ";
  protected final String TEXT_176 = "HashKey );" + NL + "\t\t\t  \t\t\t\t\t\t\tif(tHash_Lookup_Cache_";
  protected final String TEXT_177 = ".hasNext()) { // G_TM_M_835" + NL + "\t\t\t  \t\t\t\t\t\t\t" + NL + "\t\t  \t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_178 = " = tHash_Lookup_Cache_";
  protected final String TEXT_179 = ";" + NL + "\t\t\t  \t\t\t\t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t\t\t} // G_TM_M_834" + NL + "\t\t\t\t\t\t\t\t\t\telse { // G_TM_M_835" + NL + "" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\t\t\t\t\t\tglobalMap.put(";
  protected final String TEXT_181 = ", ";
  protected final String TEXT_182 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_184 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_186 = " = " + NL + "\t\t\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_187 = "LookupManager<";
  protected final String TEXT_188 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_189 = "LookupManager<";
  protected final String TEXT_190 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t globalMap.get( \"tHash_Lookup_";
  protected final String TEXT_191 = "\" ));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_193 = " = " + NL + "\t\t\t\t\t\t\t\t\t\t(org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_194 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_195 = "Struct>) " + NL + "\t\t\t\t\t\t\t\t\t\t\tglobalMap.get( \"tHash_Lookup_";
  protected final String TEXT_196 = "\" ));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_198 = ".initGet();" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_199 = ".lookup( ";
  protected final String TEXT_200 = "HashKey );" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_201 = NL + NL + "\t\t\t\t\t\t\t\t\t\t} // G_TM_M_835" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_203 = NL + "\t  \t\t\t\t\t" + NL + "\t\t  \t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_204 = ".lookup( ";
  protected final String TEXT_205 = "HashKey );" + NL + "" + NL + "\t  \t\t\t\t\t\t\t";
  protected final String TEXT_206 = NL + NL + "\t  \t\t\t\t\t\t\t";
  protected final String TEXT_207 = NL + NL + "\t\t\t  \t\t\t\t\t\t} // G_TM_M_091" + NL + "\t\t\t  \t\t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t";
  protected final String TEXT_208 = NL + NL + " \t\t\t\t\t\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\t\t\t\t\t  " + NL + "\t\t\t\t\t\t\t\t  if(";
  protected final String TEXT_210 = "!tHash_Lookup_";
  protected final String TEXT_211 = ".hasNext()) { // G_TM_M_090" + NL + "" + NL + "  \t\t\t\t\t\t\t\t";
  protected final String TEXT_212 = NL + "\t\t  \t\t\t\t" + NL + "\t  \t\t\t\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t  \t\t\t\t\t\t\t";
  protected final String TEXT_214 = " = true;" + NL + "\t  \t\t\t\t\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t" + NL + "\t\t  \t\t\t\t\t\t\t\tforceLoop";
  protected final String TEXT_217 = " = true;" + NL + "\t  \t\t\t\t\t" + NL + "  \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_218 = NL + "  \t\t\t\t\t\t\t\t\t  \t\t" + NL + " \t\t\t\t\t\t\t\t";
  protected final String TEXT_219 = NL + "\t\t\t\t\t\t\t\t  " + NL + "\t\t\t\t\t\t\t\t  } // G_TM_M_090" + NL + "" + NL + "  \t\t\t\t\t\t\t\t";
  protected final String TEXT_220 = NL + NL + NL + NL + "\t\t\t\t\t\t\t} // G_TM_M_020" + NL + "\t\t\t           \t\t  \t  " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_221 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\telse { // G 20 - G 21" + NL + "   \t\t\t\t\t\t\t\t\tforceLoop";
  protected final String TEXT_222 = " = true;" + NL + "\t\t\t           \t\t  \t} // G 21" + NL + "                    \t\t  \t" + NL + "                    \t\t";
  protected final String TEXT_223 = NL + "\t\t\t\t           \t\tif(tHash_Lookup_";
  protected final String TEXT_224 = " != null && tHash_Lookup_";
  protected final String TEXT_225 = ".getCount(";
  protected final String TEXT_226 = "HashKey) > 1) { // G 071" + NL + "\t\t\t  \t\t\t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t\t";
  protected final String TEXT_227 = NL + "\t\t\t\t\t\t\t\t\t \t\t" + NL + "\t\t\t\t\t\t\t\t\t//System.out.println(";
  protected final String TEXT_228 = ");" + NL + "\t\t\t\t\t\t\t\t} // G 071" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_229 = NL + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_230 = "Struct ";
  protected final String TEXT_231 = " = null;" + NL + "                    \t\t  \t " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_232 = NL + NL + "\t\t\t\t\t\t\t\twhile ((tHash_Lookup_";
  protected final String TEXT_233 = " != null && tHash_Lookup_";
  protected final String TEXT_234 = ".hasNext()) || forceLoop";
  protected final String TEXT_235 = ") { // G_TM_M_043" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\t\t\t // CALL close loop of lookup '";
  protected final String TEXT_237 = "'" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_238 = NL + "                    \t\t  \t " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_239 = "   " + NL + "                    \t\t  \t " + NL + "\t       \t\t  \t    \t";
  protected final String TEXT_240 = "Struct fromLookup_";
  protected final String TEXT_241 = " = null;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_242 = " = ";
  protected final String TEXT_243 = "Default;" + NL + "\t\t\t\t\t\t\t\t\t\t " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_244 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\tif(!forceLoop";
  protected final String TEXT_245 = ") { // G 46" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\t\t\t " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\tif (tHash_Lookup_";
  protected final String TEXT_248 = " !=null && tHash_Lookup_";
  protected final String TEXT_249 = ".hasNext()) { // G 099" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_251 = " = tHash_Lookup_";
  protected final String TEXT_252 = ".next();" + NL + "" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_253 = NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t} // G 099" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + NL + "\t\t\t\t\t\t\tif(fromLookup_";
  ...
  protected final String TEXT_258 = NL + NL + "\t\t\t\t\t\t\t\tif(tHash_Lookup_Cache_";
  protected final String TEXT_259 = " != tHash_Lookup_";
  protected final String TEXT_260 = ") {" + NL + "\t\t\t\t\t\t\t\t\ttHash_Lookup_Cache_";
  protected final String TEXT_261 = ".put(";
  protected final String TEXT_262 = ");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t  \t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_264 = NL + "                    \t\t  \t  \t\t" + NL + "\t\t\t\t\t\t\t\tif( !";
  protected final String TEXT_265 = " && " + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_266 = NL + "\t\t\t\t\t\t\t\t\t!(" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_268 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\t\t\t\t\t\t)" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t\t\t\t) { // G 016" + NL + "                    \t\t  \t  \t\t  " + NL + "\t\t\t\t\t\t\t\t\tfromLookup_";
  protected final String TEXT_271 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_272 = " = ";
  protected final String TEXT_273 = "Default;" + NL + "                    \t\t  \t  \t\t  \t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_275 = " = true;" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_276 = NL + "\t\t\t\t\t\t\t\t} // G 016" + NL + "     \t               \t\t  \t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_277 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif(fromLookup_";
  protected final String TEXT_278 = " == null && !";
  protected final String TEXT_279 = ") { // G 017" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\tcontinue;" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t} // G 017" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_280 = NL + "     \t               \t\t  \t  \t  " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_281 = "\t" + NL + "\t                    \t\t  \t" + NL + "\t\t                    ";
  protected final String TEXT_282 = NL + "\t                    \t" + NL + "\t                    \t\t} // G 46" + NL + "\t                    \t\t  \t" + NL + "\t\t\t\t\t\t\t\tforceLoop";
  protected final String TEXT_283 = " = false;" + NL + "\t\t\t\t\t\t\t\t\t \t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_284 = NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_285 = " exprKey_";
  protected final String TEXT_286 = "__";
  protected final String TEXT_287 = " = ";
  protected final String TEXT_288 = ";" + NL + "\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t            \t\t\t\t\tif(!";
  protected final String TEXT_290 = ") { // G_TM_M_255" + NL + "\t\t            \t\t\t\t";
  protected final String TEXT_291 = NL + " \t           \t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_292 = NL + "        \t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_293 = NL + "                        \t\t    \t\t\t\tObject exprKeyValue_";
  protected final String TEXT_294 = "__";
  protected final String TEXT_295 = " = ";
  protected final String TEXT_296 = ";" + NL + "                        \t\t    \t\t\t\tif(exprKeyValue_";
  protected final String TEXT_297 = "__";
  protected final String TEXT_298 = " == null) {" + NL + "            \t            \t\t    \t\t\t\thasCasePrimitiveKeyWithNull_";
  protected final String TEXT_299 = " = true;" + NL + "\t\t\t                        \t\t    \t} else {" + NL + "\t\t\t\t\t\t\t            \t\t\t\texprKey_";
  protected final String TEXT_300 = "__";
  protected final String TEXT_301 = " =  (";
  protected final String TEXT_302 = ")(";
  protected final String TEXT_303 = ") exprKeyValue_";
  protected final String TEXT_304 = "__";
  protected final String TEXT_305 = ";" + NL + "                       \t\t    \t\t\t\t\t}" + NL + "                       \t\t    \t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t            \t\t\t\t\texprKey_";
  protected final String TEXT_307 = "__";
  protected final String TEXT_308 = " = ";
  protected final String TEXT_309 = ";" + NL + "            \t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "                \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_311 = NL + "            \t\t\t\t    \t\t\t\t";
  protected final String TEXT_312 = NL + "                    \t\t\t\t\t} // G_TM_M_255" + NL + "                    \t\t\t\t";
  protected final String TEXT_313 = NL + NL + "\t\t\t\t\t\t\t\tSortableRow_";
  protected final String TEXT_314 = "_";
  protected final String TEXT_315 = " rsc_";
  protected final String TEXT_316 = "_";
  protected final String TEXT_317 = " = new SortableRow_";
  protected final String TEXT_318 = "_";
  protected final String TEXT_319 = "();" + NL + "" + NL + "\t\t\t\t\t\t\t\trsc_";
  protected final String TEXT_320 = "_";
  protected final String TEXT_321 = ".fillFrom(";
  protected final String TEXT_322 = " ";
  protected final String TEXT_323 = " exprKey_";
  protected final String TEXT_324 = "__";
  protected final String TEXT_325 = ");" + NL + "" + NL + "\t\t\t\t\t\t\t\trsc_";
  protected final String TEXT_326 = "_";
  protected final String TEXT_327 = ".is__rejectedInnerJoin = ";
  protected final String TEXT_328 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_329 = " = false;" + NL + "" + NL + "\t\t\t\t\t\t\t\t// Sort and store in KeyFile(s) and DataFile(s)" + NL + "\t\t\t\t\t\t\t\tfsi_";
  protected final String TEXT_330 = "_";
  protected final String TEXT_331 = ".put(rsc_";
  protected final String TEXT_332 = "_";
  protected final String TEXT_333 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\t\tif(forceLoop";
  protected final String TEXT_335 = ") {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t            \t\t\t}  // G_TM_M_043 loop (MultipleResult) ";
  protected final String TEXT_336 = NL + "\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t        \t    \t\t\t}  // G_TM_M_043 loop (closeAllRowsBlock) ";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_339 = NL + "\t    \t        \t} // G_TM_M_250 loop \"";
  protected final String TEXT_340 = "\"" + NL + "" + NL + "\t            \t\t";
  protected final String TEXT_341 = NL + "\t            \t" + NL + "\t           \t";
  protected final String TEXT_342 = NL + "\t            \t" + NL + "\t            \t" + NL + "\t            ";
  protected final String TEXT_343 = "\t\t\t\t" + NL + "\t\t\t\t\tfsi_";
  protected final String TEXT_344 = "_";
  protected final String TEXT_345 = ".endGet();" + NL + "\t\t\t\t";
  protected final String TEXT_346 = " " + NL + "\t            \t" + NL + "\t            \tfsi_";
  protected final String TEXT_347 = "_";
  protected final String TEXT_348 = ".endPut();" + NL + "\t            \t" + NL + "\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\ttry {" + NL + "\t\t";
  protected final String TEXT_350 = "// ###############################";
  protected final String TEXT_351 = NL + "        { // start of Var scope" + NL + "        " + NL + "\t        // ###############################" + NL + "        \t// # Vars tables" + NL + "        ";
  protected final String TEXT_352 = "// ###############################";
  protected final String TEXT_353 = NL + "        // ###############################" + NL + "        // # Output tables";
  protected final String TEXT_354 = NL;
  protected final String TEXT_355 = NL;
  protected final String TEXT_356 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t//if anohter java.lang.Exception when processing an java.lang.Exception" + NL + "    \t\t";
  protected final String TEXT_357 = NL + "    \t\t\tlog.error(\"";
  protected final String TEXT_358 = " - \" + e.getMessage());" + NL + "    \t\t";
  protected final String TEXT_359 = NL + "\t\t\ttry{//EE";
  protected final String TEXT_360 = NL;
  protected final String TEXT_361 = "                " + NL + "                ";
  protected final String TEXT_362 = "            " + NL + "               ";
  protected final String TEXT_363 = NL + "                ";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = "_tmp;";
  protected final String TEXT_366 = NL + "                ";
  protected final String TEXT_367 = ".errorMessage = e.getMessage();";
  protected final String TEXT_368 = NL + "                ";
  protected final String TEXT_369 = ".errorStackTrace = ResumeUtil.getExceptionStackTrace(e);" + NL + "              " + NL + "                ";
  protected final String TEXT_370 = "\t\t\t" + NL + "\t\t\t" + NL + "    ";
  protected final String TEXT_371 = "\t" + NL + "                \t\t";
  protected final String TEXT_372 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_373 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_374 = " = null;";
  protected final String TEXT_375 = NL + "         } catch (java.lang.Exception ee) {//EE" + NL + "        \t\t";
  protected final String TEXT_376 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_377 = " - \" + ee.getMessage());" + NL + "        \t\t";
  protected final String TEXT_378 = NL + "\t\t\t\tee.printStackTrace();";
  protected final String TEXT_379 = "\t" + NL + "                \t\t";
  protected final String TEXT_380 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_381 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_382 = " = null;";
  protected final String TEXT_383 = NL + "\t\t}//EE  \t\t\t" + NL + "\t}//end catch";
  protected final String TEXT_384 = NL + NL + NL + NL + NL + NL + NL;
