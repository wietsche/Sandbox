...
public class TIterateToFlowOutBeginJava
{
  ...
  protected final String TEXT_41 = NL + "OnSubjobOkStruct";
  protected final String TEXT_42 = " struct_";
  protected final String TEXT_43 = " = new OnSubjobOkStruct";
  protected final String TEXT_44 = "();";
  protected final String TEXT_45 = NL + "struct_";
  protected final String TEXT_46 = ".";
  protected final String TEXT_47 = "  = ";
  protected final String TEXT_48 = ";";
  protected final String TEXT_49 = NL + "\tlog.trace(\"struct_";
  protected final String TEXT_50 = " - \" + struct_";
  protected final String TEXT_51 = ".toLogString());";
  protected final String TEXT_52 = NL;
  protected final String TEXT_53 = NL + "\t";
  protected final String TEXT_54 = NL + "\t\tsynchronized (";
  protected final String TEXT_55 = ".this.globalMap) {" + NL + "\t";
  protected final String TEXT_56 = NL + "\t\tsynchronized (";
  protected final String TEXT_57 = ".this.obj) {" + NL + "\t";
  protected final String TEXT_58 = NL + "\t\t    if(";
  protected final String TEXT_59 = ".this.globalMap.containsKey(\"";
  protected final String TEXT_60 = "\")){" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_61 = "> list_";
  protected final String TEXT_62 = " = (java.util.List<OnSubjobOkStruct";
  protected final String TEXT_63 = ">)";
  protected final String TEXT_64 = ".this.globalMap.get(\"";
  protected final String TEXT_65 = "\"); " + NL + "\t\t    \tlist_";
  protected final String TEXT_66 = ".add(struct_";
  protected final String TEXT_67 = ");" + NL + "\t\t    }else{" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_68 = "> list_";
  protected final String TEXT_69 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<OnSubjobOkStruct";
  protected final String TEXT_70 = ">());" + NL + "\t\t    \tlist_";
  protected final String TEXT_71 = ".add(struct_";
  protected final String TEXT_72 = ");" + NL + "\t\t    \t";
  protected final String TEXT_73 = ".this.globalMap.put(\"";
  protected final String TEXT_74 = "\",list_";
  protected final String TEXT_75 = ");" + NL + "\t\t    }" + NL + "\t\t}";
  protected final String TEXT_76 = NL + "    if(globalMap.get(\"";
  protected final String TEXT_77 = "\") != null){" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_78 = "> list_";
  protected final String TEXT_79 = " = (java.util.List<OnSubjobOkStruct";
  protected final String TEXT_80 = ">)globalMap.get(\"";
  protected final String TEXT_81 = "\"); " + NL + "    \tlist_";
  protected final String TEXT_82 = ".add(struct_";
  protected final String TEXT_83 = ");" + NL + "    }else{" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_84 = "> list_";
  protected final String TEXT_85 = " = new java.util.ArrayList<OnSubjobOkStruct";
  protected final String TEXT_86 = ">();" + NL + "    \tlist_";
  protected final String TEXT_87 = ".add(struct_";
