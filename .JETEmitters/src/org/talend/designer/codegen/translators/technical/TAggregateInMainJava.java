...
public class TAggregateInMainJava
{
  ...
  protected final String TEXT_43 = " = aggregated_row_";
  protected final String TEXT_44 = ".";
  protected final String TEXT_45 = ";" + NL + "            \t\t\t\t    ";
  protected final String TEXT_46 = NL + "            \t\t\t\t    String s_";
  protected final String TEXT_47 = "_";
  protected final String TEXT_48 = "_";
  protected final String TEXT_49 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = ");" + NL + "            \t\t\t\t    ";
  protected final String TEXT_52 = ".";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = "s_";
  ...
  protected final String TEXT_61 = "(\"null\").equals(s_";
  protected final String TEXT_62 = "_";
  protected final String TEXT_63 = "_";
  protected final String TEXT_64 = ") ? null : ParserUtils.parseTo_Date(s_";
  ...
  protected final String TEXT_75 = NL + "                                if(aggregated_row_";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = "_count > 0){" + NL + "                                \t";
  protected final String TEXT_78 = NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_79 = ".";
  protected final String TEXT_80 = " = aggregated_row_";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = "_sum.divide(new BigDecimal(String.valueOf(aggregated_row_";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = "_count)), ";
  protected final String TEXT_85 = ", BigDecimal.ROUND_HALF_UP)" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t    \t\t\t\t\t\t\t\t\t.";
  protected final String TEXT_87 = "Value()" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_88 = NL + "\t    \t\t\t\t\t\t\t\t;" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_89 = NL + "\t    \t\t\t\t\t\t\t\tdouble ";
  protected final String TEXT_90 = "_";
  protected final String TEXT_91 = "_temp = (double) aggregated_row_";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = "_sum / (double) aggregated_row_";
  protected final String TEXT_94 = ".";
  protected final String TEXT_95 = "_count;" + NL + "\t    \t\t\t\t\t\t\t\t" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = " = String.valueOf(";
  protected final String TEXT_99 = "_";
  protected final String TEXT_100 = "_temp);" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = " = (";
  protected final String TEXT_103 = ") ";
  protected final String TEXT_104 = "_";
  protected final String TEXT_105 = "_temp;" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_106 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_107 = NL + "                                } else {" + NL + "                                \t\tString count = \"0\";" + NL + "   \t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_108 = NL + "    \t\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = " = count;" + NL + "    \t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_118 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_119 = ".count);" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = "_clmCount);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_126 = ".count);" + NL + "\t    \t\t\t\t\t\t\t\t  ";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = "_clmCount);" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = " = (";
  protected final String TEXT_133 = ") aggregated_row_";
  protected final String TEXT_134 = ".count;" + NL + "\t                                \t";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = " = (";
  protected final String TEXT_137 = ") aggregated_row_";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = "_clmCount;" + NL + "\t                                \t";
  protected final String TEXT_140 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_143 = ".distinctValues_";
  protected final String TEXT_144 = ".size());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = " = String.valueOf(aggregated_row_";
  ...
  protected final String TEXT_152 = ".distinctValues_";
  protected final String TEXT_153 = ".size();" + NL + "\t                                \t";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_156 = ".";
  protected final String TEXT_157 = "_";
  protected final String TEXT_158 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "    \t\t\t\t\t\t\t\tif(aggregated_row_";
  protected final String TEXT_160 = ".";
  protected final String TEXT_161 = "_";
  protected final String TEXT_162 = " != null) {" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = aggregated_row_";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = "_";
  protected final String TEXT_167 = ".";
  protected final String TEXT_168 = "Value();" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "    \t\t\t\t\t\t\t\t}else{" + NL + "    \t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_177 = " = aggregated_row_";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = "_";
  protected final String TEXT_180 = ";" + NL + "                                \t";
  protected final String TEXT_181 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = " = aggregated_row_";
  protected final String TEXT_184 = ".";
  protected final String TEXT_185 = "_";
  protected final String TEXT_186 = ".toString();" + NL + "\t    \t\t\t\t\t\t";
  protected final String TEXT_187 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_188 = ".";
  protected final String TEXT_189 = " = aggregated_row_";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = "_";
  protected final String TEXT_192 = ";" + NL + "    \t\t\t\t\t\t\t";
  protected final String TEXT_193 = "double result_";
  protected final String TEXT_194 = "_";
  protected final String TEXT_195 = "_";
  protected final String TEXT_196 = " = utilClass_";
  protected final String TEXT_197 = ".sd(aggregated_row_";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = "_";
  protected final String TEXT_200 = ".toArray(new Double[0]));" + NL + "\t\t    \t\t\t\t\t\t\tif(((Double)result_";
  protected final String TEXT_201 = "_";
  protected final String TEXT_202 = "_";
  protected final String TEXT_203 = ").equals((Double)Double.NaN)) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = null;" + NL + "\t\t    \t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_206 = ".";
  protected final String TEXT_207 = " = new BigDecimal(result_";
  protected final String TEXT_208 = "_";
  protected final String TEXT_209 = "_";
  protected final String TEXT_210 = ");" + NL + "\t\t    \t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = (";
  protected final String TEXT_213 = ") utilClass_";
  protected final String TEXT_214 = ".sd(aggregated_row_";
  protected final String TEXT_215 = ".";
  protected final String TEXT_216 = "_";
  protected final String TEXT_217 = ".toArray(new Double[0]));" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_218 = ".";
  protected final String TEXT_219 = " = String.valueOf(utilClass_";
  protected final String TEXT_220 = ".sd(aggregated_row_";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = "_";
  protected final String TEXT_223 = ".toArray(new Double[0])));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_224 = NL + "                                ";
  protected final String TEXT_225 = ".";
  protected final String TEXT_226 = " = aggregated_row_";
