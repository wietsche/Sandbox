...
public class TMapOutBeginJava {


  protected static String nl;
  public static synchronized TMapOutBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapOutBeginJava result = new TMapOutBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_324 = "        " + NL + "        " + NL + "" + NL + "" + NL + "" + NL + "        " + NL + NL + NL;
