...
public class TAggregateInBeginJava
{
  ...
  protected final String TEXT_41 = NL + "java.util.Collection<AggOperationStruct_";
  protected final String TEXT_42 = "> values_";
  protected final String TEXT_43 = " = hash_";
  protected final String TEXT_44 = ".values();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_45 = "_NB_LINE\", values_";
  protected final String TEXT_46 = ".size());" + NL;
  protected final String TEXT_47 = NL + "for(AggOperationStruct_";
  protected final String TEXT_48 = " aggregated_row_";
  protected final String TEXT_49 = " : values_";
  protected final String TEXT_50 = ") { // G_AggR_600" + NL + NL;
