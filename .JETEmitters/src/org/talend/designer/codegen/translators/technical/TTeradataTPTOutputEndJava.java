...
public class TTeradataTPTOutputEndJava
{
  protected static String nl;
  public static synchronized TTeradataTPTOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataTPTOutputEndJava result = new TTeradataTPTOutputEndJava();
    nl = null;
    return result;
  }
