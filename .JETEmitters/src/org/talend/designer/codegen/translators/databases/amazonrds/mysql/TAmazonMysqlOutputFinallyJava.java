...
public class TAmazonMysqlOutputFinallyJava
{
  protected static String nl;
  public static synchronized TAmazonMysqlOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonMysqlOutputFinallyJava result = new TAmazonMysqlOutputFinallyJava();
    nl = null;
    return result;
  }
