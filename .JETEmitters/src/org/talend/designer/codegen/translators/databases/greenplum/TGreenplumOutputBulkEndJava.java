...
public class TGreenplumOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TGreenplumOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumOutputBulkEndJava result = new TGreenplumOutputBulkEndJava();
    nl = null;
    return result;
  }
