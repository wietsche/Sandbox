...
public class TFirebirdOutputFinallyJava
{
  protected static String nl;
  public static synchronized TFirebirdOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdOutputFinallyJava result = new TFirebirdOutputFinallyJava();
    nl = null;
    return result;
  }
