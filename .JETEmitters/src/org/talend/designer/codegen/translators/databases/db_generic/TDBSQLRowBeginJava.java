...
public class TDBSQLRowBeginJava
{
  ...
  protected final String TEXT_122 = NL + "\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_134 = NL + NL + "\t\t\tString dbPwd_";
  protected final String TEXT_135 = " = decryptedPassword_";
  protected final String TEXT_136 = ";" + NL + "" + NL + "\t\t\tString driverClass_";
  protected final String TEXT_137 = " = \"";
  protected final String TEXT_138 = "\";" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_139 = " = ";
  protected final String TEXT_140 = ";" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_142 = " == null || dbProperties_";
  protected final String TEXT_143 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_147 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_148 = " = dbProperties_";
  protected final String TEXT_149 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  ...
  protected final String TEXT_154 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_155 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_156 = ".getBytes()));" + NL + "\t\t\t\tconn_";
  protected final String TEXT_157 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_158 = ", atnParamsPrope_";
  protected final String TEXT_159 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_161 = " = null;" + NL + "\tString query_";
  protected final String TEXT_162 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_163 = " = false;";
  protected final String TEXT_164 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".prepareStatement(";
  protected final String TEXT_167 = ");\t" + NL + "\t";
  protected final String TEXT_168 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();" + NL + "\t";
