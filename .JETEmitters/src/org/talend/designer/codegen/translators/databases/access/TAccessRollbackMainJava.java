...
public class TAccessRollbackMainJava
{
  protected static String nl;
  public static synchronized TAccessRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessRollbackMainJava result = new TAccessRollbackMainJava();
    nl = null;
    return result;
  }
