...
public class TMSSqlTableListEndJava
{
  protected static String nl;
  public static synchronized TMSSqlTableListEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlTableListEndJava result = new TMSSqlTableListEndJava();
    nl = null;
    return result;
  }
