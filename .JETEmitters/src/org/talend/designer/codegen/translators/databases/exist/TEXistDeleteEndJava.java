...
public class TEXistDeleteEndJava
{
  protected static String nl;
  public static synchronized TEXistDeleteEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXistDeleteEndJava result = new TEXistDeleteEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_44 = NL + "col_";
  protected final String TEXT_45 = ".close();";
  protected final String TEXT_46 = NL + "globalMap.put(\"";
  protected final String TEXT_47 = "_NB_FILE\",nb_file_";
