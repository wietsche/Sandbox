...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_139 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_150 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_151 = "\",conn_";
  protected final String TEXT_152 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
