...
public class TSAPHanaRowMainJava
{
  protected static String nl;
  public static synchronized TSAPHanaRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaRowMainJava result = new TSAPHanaRowMainJava();
    nl = null;
    return result;
  }
