...
public class TOracleOutputBulkBeginJava
{
  ...
  protected final String TEXT_50 = " = \"\";" + NL + "\t\t}" + NL + "\t\t//create directory only if not exists" + NL + "\t\tif(directory_";
  ...
  protected final String TEXT_65 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_WITH_LOB_";
  protected final String TEXT_68 = " = \"|\";";
  protected final String TEXT_69 = "\t\t\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_LEFT_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_RIGHT_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = "\t\t" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_75 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(fileName_";
