...
public class TParAccelRollbackMainJava
{
  protected static String nl;
  public static synchronized TParAccelRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelRollbackMainJava result = new TParAccelRollbackMainJava();
    nl = null;
    return result;
  }
