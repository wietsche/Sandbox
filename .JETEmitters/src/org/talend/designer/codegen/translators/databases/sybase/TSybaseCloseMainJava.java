...
public class TSybaseCloseMainJava
{
  protected static String nl;
  public static synchronized TSybaseCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseCloseMainJava result = new TSybaseCloseMainJava();
    nl = null;
    return result;
  }
