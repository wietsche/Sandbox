...
public class TPostgresPlusRowEndJava
{
  protected static String nl;
  public static synchronized TPostgresPlusRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusRowEndJava result = new TPostgresPlusRowEndJava();
    nl = null;
    return result;
  }
