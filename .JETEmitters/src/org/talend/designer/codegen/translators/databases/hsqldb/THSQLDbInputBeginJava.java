...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_177 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_178 = " + \":\" + ";
  protected final String TEXT_179 = " + \"/\" + ";
  protected final String TEXT_180 = ";";
  protected final String TEXT_181 = NL + "\t\t            url_";
  protected final String TEXT_182 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_183 = " + \":\" + ";
  protected final String TEXT_184 = " + \"/\" + ";
  protected final String TEXT_185 = ";";
  protected final String TEXT_186 = NL + "\t\t            url_";
  protected final String TEXT_187 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_188 = " + \":\" + ";
  protected final String TEXT_189 = " + \"/\" + ";
  protected final String TEXT_190 = ";";
  protected final String TEXT_191 = NL + "\t\t            url_";
  protected final String TEXT_192 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_193 = " + \":\" + ";
  protected final String TEXT_194 = " + \"/\" + ";
  protected final String TEXT_195 = ";";
  protected final String TEXT_196 = NL + "\t\t        url_";
  protected final String TEXT_197 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_198 = " + \"/\" + ";
  protected final String TEXT_199 = ";";
  protected final String TEXT_200 = NL + "\t\t\t\turl_";
  protected final String TEXT_201 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_202 = " ;";
  protected final String TEXT_203 = NL + "\t\t\t\turl_";
  protected final String TEXT_204 = " += \";\" + ";
  protected final String TEXT_205 = ";";
  protected final String TEXT_206 = NL + "    " + NL + "\t";
  protected final String TEXT_207 = NL + "\t\t    int nb_line_";
  protected final String TEXT_208 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_209 = " = null;";
  protected final String TEXT_210 = NL + "\t\t        conn_";
  protected final String TEXT_211 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_212 = "\");";
  protected final String TEXT_213 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_214 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_215 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_216 = " = dataSources_";
  protected final String TEXT_217 = ".get(";
  protected final String TEXT_218 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_219 = "\", conn_";
  protected final String TEXT_220 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_221 = NL + "\t\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\t";
  protected final String TEXT_223 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_224 = " =  conn_";
  protected final String TEXT_225 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_226 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_227 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_228 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_229 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_230 = NL + "                 conn_";
  protected final String TEXT_231 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_232 = NL + "               ";
  protected final String TEXT_233 = " + \"=\" + ";
  protected final String TEXT_234 = " + \";\" +";
  protected final String TEXT_235 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_236 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + "\t\t    ";
  protected final String TEXT_239 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_240 = " = ";
  protected final String TEXT_241 = ";" + NL + "\t\t\t";
  protected final String TEXT_242 = NL + "                log.info(\"";
  protected final String TEXT_243 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_244 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_245 = NL;
  protected final String TEXT_246 = NL + "                       globalMap.put(\"";
  protected final String TEXT_247 = "_QUERY\",dbquery_";
  protected final String TEXT_248 = ");";
  protected final String TEXT_249 = NL + "                       globalMap.put(\"";
  protected final String TEXT_250 = "_QUERY\",dbquery_";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_253 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_276 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_288 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setDbTypeId(rsmd_";
  protected final String TEXT_290 = ".getColumnType(i));";
  ...
  protected final String TEXT_351 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_352 = ".getObject(";
  protected final String TEXT_353 = "column_index_";
  protected final String TEXT_354 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_355 = NL + "                                    ";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_366 = ".setEPSG(";
  ...
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_374 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = "; i_";
  protected final String TEXT_377 = "  <= rsmd_";
  protected final String TEXT_378 = ".getColumnCount(); i_";
  protected final String TEXT_379 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_380 = ".getColumnTypeName(i_";
  protected final String TEXT_381 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_382 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_383 = ".getClob(i_";
  protected final String TEXT_384 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_385 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_386 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_387 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_388 = ".add(tNTextImpl_";
  protected final String TEXT_389 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_390 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_391 = ".";
  protected final String TEXT_392 = ", rs_";
  protected final String TEXT_393 = ", fixedColumnCount_";
  protected final String TEXT_394 = ",list_";
  protected final String TEXT_395 = ",";
  protected final String TEXT_396 = ");";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = ", rs_";
  protected final String TEXT_400 = ", fixedColumnCount_";
  protected final String TEXT_401 = ",";
  protected final String TEXT_402 = ");";
  protected final String TEXT_403 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_404 = ".";
  protected final String TEXT_405 = ", rs_";
  protected final String TEXT_406 = ", fixedColumnCount_";
  protected final String TEXT_407 = ",";
  protected final String TEXT_408 = ");";
  protected final String TEXT_409 = NL + "                                  Object geom = rs_";
  protected final String TEXT_410 = ".getObject(";
  protected final String TEXT_411 = "column_index_";
  protected final String TEXT_412 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_420 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_421 = " - Retrieving the record \" + nb_line_";
