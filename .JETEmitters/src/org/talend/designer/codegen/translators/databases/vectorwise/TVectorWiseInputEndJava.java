...
public class TVectorWiseInputEndJava
{
  protected static String nl;
  public static synchronized TVectorWiseInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseInputEndJava result = new TVectorWiseInputEndJava();
    nl = null;
    return result;
  }
