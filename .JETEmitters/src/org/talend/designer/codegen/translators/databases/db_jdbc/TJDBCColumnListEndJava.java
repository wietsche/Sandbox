...
public class TJDBCColumnListEndJava
{
  ...
  protected final String TEXT_70 = NL + "}" + NL + "}catch(Exception e_";
  ...
  protected final String TEXT_76 = NL + "}finally{" + NL + "    try{" + NL + "        if(stmt2_";
  protected final String TEXT_77 = "!=null){" + NL + "            stmt2_";
  protected final String TEXT_78 = ".close();" + NL + "        }" + NL + "    }catch(Exception e2_";
  protected final String TEXT_79 = "){";
  protected final String TEXT_80 = NL + "            throw(e2_";
  protected final String TEXT_81 = ");";
  protected final String TEXT_82 = NL + "            System.err.println(e2_";
  protected final String TEXT_83 = ".getMessage());";
  protected final String TEXT_84 = NL + "    }" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_85 = "_NB_COLUMN\", nb_column_";
