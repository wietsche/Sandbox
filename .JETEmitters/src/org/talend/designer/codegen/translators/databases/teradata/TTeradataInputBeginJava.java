...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_173 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_174 = " = ";
  protected final String TEXT_175 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_176 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_177 = " == null || dbProperties_";
  protected final String TEXT_178 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_179 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_180 = " + \"/DATABASE=\" + ";
  protected final String TEXT_181 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_182 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_183 = " + \"/DATABASE=\" + ";
  protected final String TEXT_184 = " + \",\" + ";
  protected final String TEXT_185 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_186 = NL + "                stmt_";
  protected final String TEXT_187 = ".setFetchSize(200000);";
  ...
  protected final String TEXT_263 = ".getColumnName(i));" + NL + "                \tdcm_";
