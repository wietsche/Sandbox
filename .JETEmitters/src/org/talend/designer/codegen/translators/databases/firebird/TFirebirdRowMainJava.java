...
public class TFirebirdRowMainJava
{
  protected static String nl;
  public static synchronized TFirebirdRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdRowMainJava result = new TFirebirdRowMainJava();
    nl = null;
    return result;
  }
