...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_177 = NL + "\t\t\t\tstmt_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY," + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjava.sql.ResultSet.CONCUR_READ_ONLY);" + NL + "\t\t\t\t((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_180 = ").enableStreamingResults();";
  protected final String TEXT_181 = NL + "                stmt_";
  protected final String TEXT_182 = ".setFetchSize(";
  protected final String TEXT_183 = ");";
  protected final String TEXT_184 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_185 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_186 = ") {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_187 = " = dataSources_";
  protected final String TEXT_188 = ".get(";
  protected final String TEXT_189 = ").getConnection();" + NL + "\t\t\t\t} else {";
  ...
  protected final String TEXT_194 = NL + "\t\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_204 = NL + NL + "\t\t\t\t\tString dbPwd_";
  protected final String TEXT_205 = " = decryptedPassword_";
  protected final String TEXT_206 = ";" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t}";
  protected final String TEXT_208 = NL + "            java.util.Date date_";
  protected final String TEXT_209 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  protected final String TEXT_210 = " = rs_";
  protected final String TEXT_211 = ".getTimestamp(";
  protected final String TEXT_212 = "column_index_";
  protected final String TEXT_213 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_214 = " = rs_";
  protected final String TEXT_215 = ".getDate(";
  protected final String TEXT_216 = "column_index_";
  protected final String TEXT_217 = ");" + NL + "            }";
  protected final String TEXT_218 = NL + "            ";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = " = date_";
  protected final String TEXT_221 = ";";
  protected final String TEXT_222 = NL + "    " + NL + "\t";
  protected final String TEXT_223 = NL + "\t\t    int nb_line_";
  protected final String TEXT_224 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_225 = " = null;";
  protected final String TEXT_226 = NL + "\t\t        conn_";
  protected final String TEXT_227 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_228 = "\");";
  protected final String TEXT_229 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_230 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_231 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_232 = " = dataSources_";
  protected final String TEXT_233 = ".get(";
  protected final String TEXT_234 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_235 = "\", conn_";
  protected final String TEXT_236 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_237 = NL + "\t\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\t";
  protected final String TEXT_239 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_240 = " =  conn_";
  protected final String TEXT_241 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_242 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_243 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_244 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_245 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_246 = NL + "                 conn_";
  protected final String TEXT_247 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_248 = NL + "               ";
  protected final String TEXT_249 = " + \"=\" + ";
  protected final String TEXT_250 = " + \";\" +";
  protected final String TEXT_251 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_252 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_253 = ");";
  protected final String TEXT_254 = NL + "\t\t    ";
  protected final String TEXT_255 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_256 = " = ";
  protected final String TEXT_257 = ";" + NL + "\t\t\t";
  protected final String TEXT_258 = NL + "                log.info(\"";
  protected final String TEXT_259 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_260 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_261 = NL;
  protected final String TEXT_262 = NL + "                       globalMap.put(\"";
  protected final String TEXT_263 = "_QUERY\",dbquery_";
  protected final String TEXT_264 = ");";
  protected final String TEXT_265 = NL + "                       globalMap.put(\"";
  protected final String TEXT_266 = "_QUERY\",dbquery_";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_269 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_270 = " = stmt_";
  protected final String TEXT_271 = ".executeQuery(dbquery_";
  protected final String TEXT_272 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_273 = " = rs_";
  protected final String TEXT_274 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_275 = " = rsmd_";
  protected final String TEXT_276 = ".getColumnCount();" + NL;
  protected final String TEXT_277 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_278 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_279 = ".setDbmsId(\"";
  protected final String TEXT_280 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_281 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_282 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_283 = ".add(\"";
  protected final String TEXT_284 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_285 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_286 = " = ";
  protected final String TEXT_287 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_288 = "; i <= rsmd_";
  protected final String TEXT_289 = ".getColumnCount()-";
  protected final String TEXT_290 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_291 = ".contains(rsmd_";
  protected final String TEXT_292 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_293 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setName(rsmd_";
  protected final String TEXT_295 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_296 = ".setDbName(rsmd_";
  protected final String TEXT_297 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_298 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_299 = "\", rsmd_";
  protected final String TEXT_300 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_301 = ".getPrecision(i), rsmd_";
  protected final String TEXT_302 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setDbType(rsmd_";
  protected final String TEXT_304 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_305 = ".setDbTypeId(rsmd_";
  protected final String TEXT_306 = ".getColumnType(i));";
  ...
  protected final String TEXT_336 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_337 = NL + "\t\t    while (rs_";
  protected final String TEXT_338 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_339 = "++;" + NL + "\t\t        ";
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_341 = " = ";
  protected final String TEXT_342 = " + dcg_";
  protected final String TEXT_343 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_345 = " = ";
  protected final String TEXT_346 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_360 = " = (List)rs_";
  ...
  protected final String TEXT_367 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_368 = ".getObject(";
  protected final String TEXT_369 = "column_index_";
  protected final String TEXT_370 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_371 = NL + "                                    ";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_382 = ".setEPSG(";
  ...
  protected final String TEXT_389 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_390 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_391 = " = ";
  protected final String TEXT_392 = "; i_";
  protected final String TEXT_393 = "  <= rsmd_";
  protected final String TEXT_394 = ".getColumnCount(); i_";
  protected final String TEXT_395 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_396 = ".getColumnTypeName(i_";
  protected final String TEXT_397 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_398 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_399 = ".getClob(i_";
  protected final String TEXT_400 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_401 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_402 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_403 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_404 = ".add(tNTextImpl_";
  protected final String TEXT_405 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_406 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = ", rs_";
  protected final String TEXT_409 = ", fixedColumnCount_";
  protected final String TEXT_410 = ",list_";
  protected final String TEXT_411 = ",";
  protected final String TEXT_412 = ");";
  protected final String TEXT_413 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_414 = ".";
  protected final String TEXT_415 = ", rs_";
  protected final String TEXT_416 = ", fixedColumnCount_";
  protected final String TEXT_417 = ",";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_420 = ".";
  protected final String TEXT_421 = ", rs_";
  protected final String TEXT_422 = ", fixedColumnCount_";
  protected final String TEXT_423 = ",";
  protected final String TEXT_424 = ");";
  protected final String TEXT_425 = NL + "                                  Object geom = rs_";
  ...
  protected final String TEXT_430 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = " = null;" + NL + "                                  }";
  protected final String TEXT_433 = NL + "\t\t                          ";
  protected final String TEXT_434 = NL + "\t\t                    }";
  protected final String TEXT_435 = NL + "\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_437 = " - Retrieving the record \" + nb_line_";
