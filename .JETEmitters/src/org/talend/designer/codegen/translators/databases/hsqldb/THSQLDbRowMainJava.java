...
public class THSQLDbRowMainJava
{
  protected static String nl;
  public static synchronized THSQLDbRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THSQLDbRowMainJava result = new THSQLDbRowMainJava();
    nl = null;
    return result;
  }
