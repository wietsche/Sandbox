...
public class TSAPHanaOutputBeginJava {
  protected static String nl;
  public static synchronized TSAPHanaOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaOutputBeginJava result = new TSAPHanaOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For update, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_49 = NL + "\t\tint deleteKeyCount_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";" + NL + "\t\tif(deleteKeyCount_";
  protected final String TEXT_52 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For delete, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_58 = " = 0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_59 = " = 0;" + NL + "int deletedCount_";
  protected final String TEXT_60 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_61 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_62 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_63 = " = 0;" + NL + "boolean whetherReject_";
  protected final String TEXT_64 = " = false;" + NL + "String tableName_";
  protected final String TEXT_65 = " = null;";
  protected final String TEXT_66 = NL + "\tString dbschema_";
  protected final String TEXT_67 = " = (String)globalMap.get(\"";
  protected final String TEXT_68 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_69 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_70 = "\");" + NL + "\t";
  protected final String TEXT_71 = NL + "\tjava.lang.Class.forName(\"com.sap.db.jdbc.Driver\");" + NL + "\t";
  ...
  protected final String TEXT_82 = NL + NL + "\tString dbPwd_";
  protected final String TEXT_83 = " = decryptedPassword_";
  protected final String TEXT_84 = ";" + NL + "" + NL + "\tString dbschema_";
  protected final String TEXT_85 = "= ";
  protected final String TEXT_86 = ";\t" + NL + "\tString dbProperties_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "\tString url_";
  protected final String TEXT_89 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_90 = " + \":\" + ";
  protected final String TEXT_91 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_92 = " != null && dbProperties_";
  protected final String TEXT_93 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_94 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_95 = " + \":\" + ";
  protected final String TEXT_96 = " + \"/?\" + dbProperties_";
  ...
  protected final String TEXT_112 = NL + "   int batchSize_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_115 = "=0;";
  protected final String TEXT_116 = NL + "tableName_";
  protected final String TEXT_117 = " = ";
  protected final String TEXT_118 = ";" + NL + "if(dbschema_";
  ...
  protected final String TEXT_122 = " + \".\" + tableName_";
  protected final String TEXT_123 = ";    " + NL + "}";
  protected final String TEXT_124 = NL + "int count_";
  ...
  protected final String TEXT_131 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_142 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_150 = ".toUpperCase()";
  ...
  protected final String TEXT_157 = ".close();";
  protected final String TEXT_158 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_179 = NL + "                    String keyCheckTable_";
  protected final String TEXT_180 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_187 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_190 = " + \"]\";";
  protected final String TEXT_191 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_192 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_193 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_308 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_311 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_312 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_313 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_314 = " =  tableForSearch_";
  protected final String TEXT_315 = ".substring(1,tableForSearch_";
  protected final String TEXT_316 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_317 = " =  tableForSearch_";
  protected final String TEXT_318 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_322 = ".getTables(null, conn_";
  protected final String TEXT_323 = ".getSchema(), tableForSearch_";
  protected final String TEXT_324 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_325 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_326 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_327 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_328 = ".close();";
  protected final String TEXT_329 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_333 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_334 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_335 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_336 = " = rsTable_";
  protected final String TEXT_337 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_338 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_364 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_365 = " = conn_";
  protected final String TEXT_366 = ".createStatement();";
  protected final String TEXT_367 = NL + "                                                      stmtDrop_";
  protected final String TEXT_368 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_375 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_395 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_396 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_404 = ".executeUpdate(\"";
  protected final String TEXT_405 = "\");";
  protected final String TEXT_406 = NL + "            stmtClear_";
  protected final String TEXT_407 = ".close();";
  protected final String TEXT_408 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_409 = " = conn_";
  protected final String TEXT_410 = ".createStatement();";
  protected final String TEXT_411 = NL + "                              stmtTruncCount_";
  protected final String TEXT_412 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_413 = "));";
  protected final String TEXT_414 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_415 = " = stmtTruncCount_";
  protected final String TEXT_416 = ".executeQuery(\"";
  protected final String TEXT_417 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_418 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_419 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_423 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_424 = " = conn_";
  protected final String TEXT_425 = ".createStatement();";
  protected final String TEXT_426 = NL + "                              stmtTrunc_";
  protected final String TEXT_427 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_428 = "));";
  protected final String TEXT_429 = NL + "                conn_";
  protected final String TEXT_430 = ".commit();";
  protected final String TEXT_431 = NL + "            stmtTrunc_";
  protected final String TEXT_432 = ".executeUpdate(\"";
  protected final String TEXT_433 = "\");";
  protected final String TEXT_434 = NL + "                if(!conn_";
  protected final String TEXT_435 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_436 = ".commit();" + NL + "                }";
  protected final String TEXT_437 = NL + "            deletedCount_";
  protected final String TEXT_438 = " += rsTruncCountNumber_";
  protected final String TEXT_439 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_440 = ".close();";
  protected final String TEXT_441 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_442 = " = conn_";
  protected final String TEXT_443 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_444 = " = stmtTruncCount_";
  protected final String TEXT_445 = ".executeQuery(\"";
  protected final String TEXT_446 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_474 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_488 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_493 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_508 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".prepareStatement(insert_";
  protected final String TEXT_511 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_512 = NL + "\t\tString delete_";
  protected final String TEXT_513 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_514 = " + \" WHERE ";
  protected final String TEXT_515 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_516 = " = conn_";
  protected final String TEXT_517 = ".prepareStatement(delete_";
  protected final String TEXT_518 = ");" + NL + "\t\t";
  protected final String TEXT_519 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_520 = " = null;" + NL + "\t   \t";
  protected final String TEXT_521 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_543 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_551 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_552 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_553 = " =null;" + NL + "\t";
  protected final String TEXT_554 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_555 = " = null;" + NL + "\t\t";
  protected final String TEXT_556 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_560 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_561 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_562 = " = null;";
  protected final String TEXT_563 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_564 = " = null;";
  protected final String TEXT_565 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_566 = " = null;";
  protected final String TEXT_567 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_568 = " = null;";
  protected final String TEXT_569 = NL + "\t\t \tString[] insertSQLSplits_";
