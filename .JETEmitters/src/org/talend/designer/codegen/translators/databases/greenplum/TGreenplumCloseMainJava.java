...
public class TGreenplumCloseMainJava
{
  protected static String nl;
  public static synchronized TGreenplumCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumCloseMainJava result = new TGreenplumCloseMainJava();
    nl = null;
    return result;
  }
