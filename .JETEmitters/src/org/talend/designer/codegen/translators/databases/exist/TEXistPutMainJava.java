...
public class TEXistPutMainJava
{
  ...
  protected final String TEXT_63 = "+1);" + NL + "\t\t}" + NL + "\t\tif (dir_";
  ...
  protected final String TEXT_72 = ";" + NL + "\t\tjava.io.File[] listings_";
  protected final String TEXT_73 = " = null;" + NL + "    \tjava.io.File file_";
  protected final String TEXT_74 = " = new java.io.File(tempdir_";
  protected final String TEXT_75 = ");" + NL + "    \tif(file_";
  protected final String TEXT_76 = ".isDirectory()){" + NL + "            listings_";
  protected final String TEXT_77 = " = file_";
  protected final String TEXT_78 = ".listFiles(new java.io.FileFilter(){" + NL + "                public boolean accept(java.io.File pathname) {" + NL + "                    boolean result = false;" + NL + "                    if (pathname != null && pathname.isFile()) {                      " + NL + "                            result = java.util.regex.Pattern.compile(finalMask_";
  protected final String TEXT_79 = ").matcher(pathname.getName()).find(); " + NL + "                    \t}" + NL + "                    return result;" + NL + "                }" + NL + "            });" + NL + "    \t} " + NL + "    \tif(listings_";
  protected final String TEXT_80 = " != null && listings_";
  protected final String TEXT_81 = ".length > 0){" + NL + "    \t\tfor(int m_";
  protected final String TEXT_82 = " = 0; m_";
  protected final String TEXT_83 = " < listings_";
  protected final String TEXT_84 = ".length; m_";
  protected final String TEXT_85 = "++){" + NL + "    \t\t\tString fileName_";
  protected final String TEXT_86 = " = listings_";
  protected final String TEXT_87 = "[m_";
  protected final String TEXT_88 = "].getName();" + NL + "     \t\t\tif(fileName_";
  protected final String TEXT_89 = ".matches(mask_";
  protected final String TEXT_90 = ")){" + NL + "     \t\t\t\tjava.io.File localFile_";
  protected final String TEXT_91 = " = new java.io.File(listings_";
  protected final String TEXT_92 = "[m_";
  protected final String TEXT_93 = "].getAbsolutePath());" + NL + "     \t\t\t\ttry{" + NL + "     \t\t\t\t\t";
  protected final String TEXT_94 = NL + "     \t\t\t\t\torg.xmldb.api.modules.XMLResource document_";
  protected final String TEXT_95 = " = (org.xmldb.api.modules.XMLResource) col_";
  protected final String TEXT_96 = ".createResource(localFile_";
  protected final String TEXT_97 = ".getName(), \"XMLResource\");" + NL + "\t\t\t\t        document_";
  protected final String TEXT_98 = ".setContent(localFile_";
  protected final String TEXT_99 = ");" + NL + "\t\t\t\t        col_";
  protected final String TEXT_100 = ".storeResource(document_";
  protected final String TEXT_101 = ");" + NL + "\t\t\t\t        ";
  protected final String TEXT_102 = NL + "     \t\t\t\t}catch(org.xmldb.api.base.XMLDBException e_";
  protected final String TEXT_103 = "){" + NL + "     \t\t\t\t\torg.exist.xmldb.RemoteBinaryResource document_";
  protected final String TEXT_104 = " = (org.exist.xmldb.RemoteBinaryResource) col_";
  protected final String TEXT_105 = ".createResource(localFile_";
  protected final String TEXT_106 = ".getName(), \"BinaryResource\");" + NL + "\t\t\t\t        document_";
  protected final String TEXT_107 = ".setContent(localFile_";
  protected final String TEXT_108 = ");" + NL + "\t\t\t\t        col_";
  protected final String TEXT_109 = ".storeResource(document_";
  protected final String TEXT_110 = ");" + NL + "     \t\t\t\t}" + NL + "\t\t\t\t\tnb_file_";
  protected final String TEXT_111 = "++;" + NL + "      \t\t\t}" + NL + "    \t\t}" + NL + "    \t}else{" + NL + "    \t\tSystem.err.println(\"No match file exist!\");" + NL + "    \t\t";
