...
public class TTeradataTPTExecMainJava
{
  ...
  protected final String TEXT_289 = ".write(\"  \t\tVARCHAR ARRAY WorkTable, ";
  ...
  protected final String TEXT_293 = ".write(\"  \t\tVARCHAR ARRAY TargetTable, ";
  protected final String TEXT_294 = "\");" + NL + "\t\t\t\tfw_";
  protected final String TEXT_295 = ".write(\"  \t\tVARCHAR ARRAY ErrorTable1, ";
  protected final String TEXT_296 = "\");" + NL + "\t\t\t\tfw_";
  protected final String TEXT_297 = ".write(\"  \t\tVARCHAR ARRAY ErrorTable2 ";
  ...
  protected final String TEXT_624 = NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t   fw_";
  protected final String TEXT_625 = ".write(\"            ,";
  protected final String TEXT_626 = " = '\"+";
  protected final String TEXT_627 = "+\".\"+";
  protected final String TEXT_628 = "+\"'";
  protected final String TEXT_629 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_630 = NL + NL + "                fw_";
  ...
  protected final String TEXT_644 = ".write(\"        ATTRIBUTES";
  protected final String TEXT_645 = "\");" + NL + "                fw_";
  protected final String TEXT_646 = ".write(\"        (";
  protected final String TEXT_647 = "\");" + NL + "                fw_";
  protected final String TEXT_648 = ".write(\"            FileName = '\" + ";
  protected final String TEXT_649 = " + \"', ";
  protected final String TEXT_650 = "\");" + NL + "                fw_";
  protected final String TEXT_651 = ".write(\"            Format = 'DELIMITED', ";
  protected final String TEXT_652 = "\");" + NL + "                fw_";
  protected final String TEXT_653 = ".write(\"            OpenMode = 'Read', ";
  protected final String TEXT_654 = "\");" + NL + "                fw_";
  protected final String TEXT_655 = ".write(\"            DirectoryPath = '', ";
  protected final String TEXT_656 = "\");" + NL + "                fw_";
  protected final String TEXT_657 = ".write(\"            IndicatorMode = 'N', ";
  protected final String TEXT_658 = "\");" + NL + "                fw_";
  protected final String TEXT_659 = ".write(\"            TextDelimiter = '\" + ";
  protected final String TEXT_660 = " + \"'";
  protected final String TEXT_661 = "\");" + NL + "                fw_";
  protected final String TEXT_662 = ".write(\"        )";
  protected final String TEXT_663 = "\");" + NL + "                fw_";
  protected final String TEXT_664 = ".write(\"    );";
  protected final String TEXT_665 = "\");" + NL + "                fw_";
  protected final String TEXT_666 = ".write(\"  );";
  protected final String TEXT_667 = "\");" + NL + "" + NL + "                //write script to file" + NL + "                fw_";
  protected final String TEXT_668 = ".close();" + NL + "" + NL + "                //run tbuild (TPT) command";
  protected final String TEXT_669 = NL + "                            String[] sb_";
  protected final String TEXT_670 = "= {\"cmd\",\"/c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_671 = "+";
  protected final String TEXT_672 = "+\".script\\\" -e \"+";
  ...
  protected final String TEXT_678 = "+\".scr\\\" -e \"+";
  protected final String TEXT_679 = "+\" > \\\"\"+";
  protected final String TEXT_680 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_681 = NL + "                        String[] sb_";
  protected final String TEXT_682 = "= {\"cmd\",\"/c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_683 = "+";
  protected final String TEXT_684 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_685 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_686 = NL + "                        String[] sb_";
  protected final String TEXT_687 = "= {\"sh\",\"-c\",\"tbuild -f \\\"\"+";
  protected final String TEXT_688 = "+";
  protected final String TEXT_689 = "+\".scr\\\" > \\\"\"+";
  protected final String TEXT_690 = "+\"\\\" 2>&1\"};";
  protected final String TEXT_691 = NL + "                \tString cmdStr_";
  protected final String TEXT_692 = " = java.util.Arrays.toString(sb_";
  protected final String TEXT_693 = ");" + NL + "                    log.info(\"";
  protected final String TEXT_694 = " - Executing command: '\" + cmdStr_";
  protected final String TEXT_695 = " + \"'.\");";
  protected final String TEXT_696 = NL + "                final Process process_";
  protected final String TEXT_697 = " = Runtime.getRuntime().exec(sb_";
  protected final String TEXT_698 = ");" + NL + "                Thread normal_";
  protected final String TEXT_699 = " = new Thread() {" + NL + "                    public void run() {" + NL + "                        try {" + NL + "                            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_700 = ".getInputStream()));" + NL + "                            String line = \"\";" + NL + "                            try {" + NL + "                                while((line = reader.readLine()) != null) {" + NL + "                                   System.out.println(line);" + NL + "                                }" + NL + "                            } finally {" + NL + "                                 reader.close();" + NL + "                            }" + NL + "                        }catch(java.io.IOException ioe) {";
  protected final String TEXT_701 = NL + "                            ioe.printStackTrace();" + NL + "                        }" + NL + "                    }" + NL + "                };" + NL + "                normal_";
  protected final String TEXT_702 = ".start();" + NL + "" + NL + "                Thread error_";
  protected final String TEXT_703 = " = new Thread() {" + NL + "                    public void run() {" + NL + "                        try {" + NL + "                            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_704 = ".getErrorStream()));" + NL + "                            String line = \"\";" + NL + "                            try {" + NL + "                                while((line = reader.readLine()) != null) {" + NL + "                                    System.err.println(line);" + NL + "                                }" + NL + "                            } finally {" + NL + "                                reader.close();" + NL + "                            }" + NL + "                        } catch(java.io.IOException ioe) {";
  protected final String TEXT_705 = NL + "                           ioe.printStackTrace();" + NL + "                        }" + NL + "                    }" + NL + "                };" + NL + "                error_";
  protected final String TEXT_706 = ".start();" + NL + "" + NL + "                process_";
  protected final String TEXT_707 = ".waitFor();" + NL + "" + NL + "                normal_";
  protected final String TEXT_708 = ".interrupt();" + NL + "" + NL + "                error_";
  protected final String TEXT_709 = ".interrupt();" + NL + "" + NL + "                globalMap.put(\"";
  protected final String TEXT_710 = "_EXIT_VALUE\", process_";
  protected final String TEXT_711 = ".exitValue());" + NL;
  protected final String TEXT_712 = NL + "                    if(process_";
  protected final String TEXT_713 = ".exitValue()>=";
  protected final String TEXT_714 = ") {" + NL + "                        throw new RuntimeException(\"TPT returned exit code \"+process_";
  protected final String TEXT_715 = ".exitValue());" + NL + "                    }";
  protected final String TEXT_716 = NL + "                    log.info(\"";
  protected final String TEXT_717 = " - Excute command:'\" + cmdStr_";
  protected final String TEXT_718 = " + \"' has finished.\");";
