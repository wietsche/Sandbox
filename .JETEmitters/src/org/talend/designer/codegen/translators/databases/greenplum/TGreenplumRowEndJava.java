...
public class TGreenplumRowEndJava
{
  protected static String nl;
  public static synchronized TGreenplumRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumRowEndJava result = new TGreenplumRowEndJava();
    nl = null;
    return result;
  }
