...
public class TMemSQLCloseMainJava
{
  protected static String nl;
  public static synchronized TMemSQLCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLCloseMainJava result = new TMemSQLCloseMainJava();
    nl = null;
    return result;
  }
