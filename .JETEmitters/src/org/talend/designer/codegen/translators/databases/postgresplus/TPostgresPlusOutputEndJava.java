...
public class TPostgresPlusOutputEndJava
{
  protected static String nl;
  public static synchronized TPostgresPlusOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusOutputEndJava result = new TPostgresPlusOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_62 = ".executeBatch();";
  ...
  protected final String TEXT_68 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  ...
  protected final String TEXT_74 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  ...
  protected final String TEXT_96 = " != null) {" + NL + "                            pstmt_";
  ...
  protected final String TEXT_101 = ".isClosed()) {";
  protected final String TEXT_102 = NL + "                if (commitCounter_";
  protected final String TEXT_103 = " > 0) {";
  protected final String TEXT_104 = NL + "                    conn_";
  protected final String TEXT_105 = ".commit();";
  protected final String TEXT_106 = NL + "                }";
  protected final String TEXT_107 = NL + "                conn_";
  protected final String TEXT_108 = " .close();";
  protected final String TEXT_109 = NL + "                resourceMap.put(\"finish_";
  protected final String TEXT_110 = "\", true);" + NL + "            }";
  protected final String TEXT_111 = NL;
  protected final String TEXT_112 = NL + "\tnb_line_deleted_";
  protected final String TEXT_113 = "=nb_line_deleted_";
  protected final String TEXT_114 = "+ deletedCount_";
  protected final String TEXT_115 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_116 = "=nb_line_update_";
  protected final String TEXT_117 = " + updatedCount_";
  protected final String TEXT_118 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_119 = "=nb_line_inserted_";
  protected final String TEXT_120 = " + insertedCount_";
  protected final String TEXT_121 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_122 = "=nb_line_rejected_";
  protected final String TEXT_123 = " + rejectedCount_";
  protected final String TEXT_124 = ";" + NL + "\t";
  protected final String TEXT_125 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_126 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_127 = "_NB_LINE\",nb_line_";
  protected final String TEXT_128 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_129 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_130 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_131 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_132 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_133 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_134 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_135 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_136 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_137 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_138 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_139 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_140 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_141 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_142 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_143 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_144 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_147 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_148 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_149 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_150 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_153 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_154 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_165 = "_NB_LINE_REJECTED\", nb_line_rejected_";
