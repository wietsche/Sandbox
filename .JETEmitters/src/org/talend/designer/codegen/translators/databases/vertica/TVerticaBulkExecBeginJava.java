...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_438 = ".charAt(0);" + NL + "\t\tString sql_";
  protected final String TEXT_439 = " = \"COPY \" + tableName_";
  protected final String TEXT_440 = " " + NL + "\t\t";
  protected final String TEXT_441 = NL + "\t\t\t+ \"";
  protected final String TEXT_442 = "\"" + NL + "\t\t";
  protected final String TEXT_443 = "\t\t" + NL + "\t\t+ \" FROM STDIN DELIMITER '\" +OUT_DELIM_";
  protected final String TEXT_444 = " + \"'\" " + NL + "\t    ";
  protected final String TEXT_445 = " + \" NULL '\"  + ";
  protected final String TEXT_446 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_447 = NL + "\t\t";
  protected final String TEXT_448 = " + \" DIRECT\"";
  protected final String TEXT_449 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_450 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_451 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_452 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_454 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_455 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_456 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_457 = " - Bulk SQL:\"+sql_";
  ...
  protected final String TEXT_463 = NL + "    \tfis_";
  protected final String TEXT_464 = " = new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_465 = "));";
  protected final String TEXT_466 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_467 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_468 = ",sql_";
  protected final String TEXT_469 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_470 = ".start();" + NL + "\t\tvcs_";
  protected final String TEXT_471 = ".addStream(fis_";
  protected final String TEXT_472 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_473 = ".execute();" + NL + "\t\tvcs_";
  protected final String TEXT_474 = ".finish();" + NL + "\t\t";
  protected final String TEXT_475 = NL + "            log.info(\"";
  protected final String TEXT_476 = " - Bulk insert data into ";
  protected final String TEXT_477 = "\" + tableName_";
  protected final String TEXT_478 = " + \"";
  protected final String TEXT_479 = " has finished.\");";
  protected final String TEXT_480 = NL + "\t\tlong copyNumber_";
  protected final String TEXT_481 = " = vcs_";
  protected final String TEXT_482 = ".getRowCount();" + NL + "\t\t" + NL + "\t\t//get rejected and accepted row number" + NL + "\t\tjava.sql.Statement stmt_accept_reject_";
  protected final String TEXT_483 = " = conn_";
  protected final String TEXT_484 = ".createStatement();" + NL + "\t\t" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_485 = " = stmt_accept_reject_";
  protected final String TEXT_486 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "\t    int accetpedRowNumber_";
  protected final String TEXT_487 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_488 = ".next()) {" + NL + "\t    \taccetpedRowNumber_";
  protected final String TEXT_489 = " = rs_";
  protected final String TEXT_490 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    rs_";
  protected final String TEXT_491 = " = stmt_accept_reject_";
  protected final String TEXT_492 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "\t    int rejectedRowNumber_";
  protected final String TEXT_493 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_494 = ".next()) {" + NL + "\t    \trejectedRowNumber_";
  protected final String TEXT_495 = " = rs_";
  protected final String TEXT_496 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tstmt_accept_reject_";
  protected final String TEXT_497 = ".close();" + NL + "\t\t" + NL + "\t\tif(";
  protected final String TEXT_498 = " && copyNumber_";
  protected final String TEXT_499 = " <= 0){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_500 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_501 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_502 = " - Number of records inserted into table ";
  protected final String TEXT_503 = "\" + tableName_";
  protected final String TEXT_504 = " + \"";
  protected final String TEXT_505 = " by ";
  protected final String TEXT_506 = ": \" + (copyNumber_";
  protected final String TEXT_507 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_508 = NL + "\t\t\tSystem.out.println(\"Number of records inserted into table ";
  protected final String TEXT_509 = "\" + tableName_";
  protected final String TEXT_510 = " + \"";
  protected final String TEXT_511 = " by ";
  protected final String TEXT_512 = ": \" + (copyNumber_";
  protected final String TEXT_513 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_514 = "_ACCEPTED_ROW_NUMBER\",accetpedRowNumber_";
  protected final String TEXT_515 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_516 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  protected final String TEXT_517 = ");";
  protected final String TEXT_518 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_521 = " = stmt_";
  protected final String TEXT_522 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_523 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_524 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_525 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_526 = " = rs_";
  protected final String TEXT_527 = ".getInt(1);" + NL + "\t\t}" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_528 = ").startCopyIn(sql_";
  protected final String TEXT_529 = ", fis_";
  protected final String TEXT_530 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_531 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_532 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_533 = ").finishCopyIn();" + NL + "\t    ";
  protected final String TEXT_534 = NL + "            log.info(\"";
  protected final String TEXT_535 = " - Bulk insert data into ";
  protected final String TEXT_536 = "\" + tableName_";
  protected final String TEXT_537 = " + \"";
  protected final String TEXT_538 = " has finished.\");";
  protected final String TEXT_539 = NL + "\t\trs_";
  protected final String TEXT_540 = " = stmt_";
  protected final String TEXT_541 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_542 = ");" + NL + "\t    int nbLineAfterLoad_";
  protected final String TEXT_543 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_544 = ".next()) {" + NL + "\t    \tnbLineAfterLoad_";
  protected final String TEXT_545 = " = rs_";
  protected final String TEXT_546 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\tstmt_";
  protected final String TEXT_547 = ".close();" + NL + "\t\tif(";
  protected final String TEXT_548 = " && nbLineBeforeLoad_";
  protected final String TEXT_549 = " >= nbLineAfterLoad_";
  protected final String TEXT_550 = "){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted in component ";
  protected final String TEXT_551 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_552 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_553 = " - Number of records inserted to table ";
  protected final String TEXT_554 = "\" + tableName_";
  protected final String TEXT_555 = " + \"";
  protected final String TEXT_556 = " by ";
  protected final String TEXT_557 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_558 = " - nbLineBeforeLoad_";
  protected final String TEXT_559 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_560 = NL + "\t\t\tSystem.out.println(\"Number of records inserted to table ";
  protected final String TEXT_561 = "\" + tableName_";
  protected final String TEXT_562 = " + \"";
  protected final String TEXT_563 = " by ";
  protected final String TEXT_564 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_565 = " - nbLineBeforeLoad_";
  protected final String TEXT_566 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_567 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_568 = " - nbLineBeforeLoad_";
  protected final String TEXT_569 = ");";
  protected final String TEXT_570 = NL + "        String tmpTableName_";
  protected final String TEXT_571 = " = \"tmp_";
  protected final String TEXT_572 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_573 = " == null || dbschema_";
  protected final String TEXT_574 = ".trim().length() == 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_575 = " = ";
  protected final String TEXT_576 = ";" + NL + "\t\t} else {" + NL + "\t    \ttableName_";
  protected final String TEXT_577 = " = dbschema_";
  protected final String TEXT_578 = " + \".\" + ";
  protected final String TEXT_579 = ";" + NL + "\t    \ttmpTableName_";
  protected final String TEXT_580 = "=dbschema_";
  protected final String TEXT_581 = " + \".\" + tmpTableName_";
  protected final String TEXT_582 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_583 = " = conn_";
  protected final String TEXT_584 = ".createStatement();" + NL + "\t";
  protected final String TEXT_585 = NL + "\t\tlog.info(\"";
  protected final String TEXT_586 = " - Updating ";
  protected final String TEXT_587 = "\" + tableName_";
  protected final String TEXT_588 = " + \"";
  protected final String TEXT_589 = " from ";
  protected final String TEXT_590 = "\"+tmpTableName_";
  protected final String TEXT_591 = "+\"";
  protected final String TEXT_592 = ".\");" + NL + "\t";
  protected final String TEXT_593 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_594 = ".executeUpdate(\"";
  protected final String TEXT_595 = "\");" + NL + "\t";
  protected final String TEXT_596 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_597 = ".close();" + NL + "        tableName_";
  protected final String TEXT_598 = " = tmpTableName_";
  protected final String TEXT_599 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_600 = " = conn_";
  protected final String TEXT_601 = ".createStatement();" + NL + "\t";
  protected final String TEXT_602 = NL + "\t\tlog.info(\"";
  protected final String TEXT_603 = " - Droping temp table ";
  protected final String TEXT_604 = "\" + tableName_";
  protected final String TEXT_605 = " + \"";
  protected final String TEXT_606 = ".\");" + NL + "\t";
  protected final String TEXT_607 = NL + "        stmtTmpDrop_";
  protected final String TEXT_608 = ".execute(\"";
  protected final String TEXT_609 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_610 = ".close();        " + NL + "\t";
  protected final String TEXT_611 = NL + "\t\tlog.info(\"";
  protected final String TEXT_612 = " - Drop temp table ";
  protected final String TEXT_613 = "\" + tableName_";
  protected final String TEXT_614 = "+ \"";
  protected final String TEXT_615 = " has succeeded.\");" + NL + "\t";
  protected final String TEXT_616 = NL + "}finally{" + NL + "\tif(fis_";
  protected final String TEXT_617 = "!=null)" + NL + "\t\tfis_";
  protected final String TEXT_618 = ".close();";
  protected final String TEXT_619 = NL + "}" + NL + NL + NL + NL + NL + NL + NL;
