...
public class TSQLiteCommitMainJava
{
  protected static String nl;
  public static synchronized TSQLiteCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteCommitMainJava result = new TSQLiteCommitMainJava();
    nl = null;
    return result;
  }
