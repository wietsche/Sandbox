...
public class TParAccelInputEndJava
{
  protected static String nl;
  public static synchronized TParAccelInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelInputEndJava result = new TParAccelInputEndJava();
    nl = null;
    return result;
  }
