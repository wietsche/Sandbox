...
public class TRedshiftInputBeginJava
{
  ...
  protected final String TEXT_178 = ",true));" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\torg.postgresql.Driver.setLogLevel(";
  protected final String TEXT_179 = ");" + NL + "" + NL + "\t\t\tString url_";
  protected final String TEXT_180 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_181 = " + \":\" + ";
  protected final String TEXT_182 = " + \"/\" + ";
  protected final String TEXT_183 = " +\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_184 = "+\"&protocolVersion=3\";";
  protected final String TEXT_185 = NL + "                stmt_";
  protected final String TEXT_186 = ".setFetchSize(";
