...
public class TOracleSPBeginJava
{
  ...
  protected final String TEXT_53 = NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_54 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_55 = ".put(\"user\",";
  protected final String TEXT_56 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_57 = ".put(\"password\",decryptedPassword_";
  protected final String TEXT_58 = ");" + NL + "    if(";
  protected final String TEXT_59 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_60 = ") && !\"\".equals(";
  protected final String TEXT_61 = ")){" + NL + "         atnParamsPrope_";
  protected final String TEXT_62 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_63 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "     }" + NL + "\tconnection_";
  protected final String TEXT_64 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_65 = ", atnParamsPrope_";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_68 = NL + "\tjava.sql.Statement stmtNLS_";
  protected final String TEXT_69 = " = connection_";
  protected final String TEXT_70 = ".createStatement();";
  protected final String TEXT_71 = NL + "\t\tstmtNLS_";
  protected final String TEXT_72 = ".execute(\"ALTER SESSION SET NLS_LANGUAGE=\" +\"";
  protected final String TEXT_73 = "\" );";
  protected final String TEXT_74 = NL + "\t\tstmtNLS_";
  protected final String TEXT_75 = ".execute(\"ALTER SESSION SET NLS_TERRITORY=\" +\"";
  protected final String TEXT_76 = "\" );";
  protected final String TEXT_77 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_78 = " = connection_";
  protected final String TEXT_79 = ".prepareCall(\"{";
  protected final String TEXT_80 = "call \" + ";
  protected final String TEXT_81 = " + \"(";
  protected final String TEXT_82 = "?";
  protected final String TEXT_83 = ",?";
  protected final String TEXT_84 = ")}\");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_85 = ";" + NL + "String tmpString_";
