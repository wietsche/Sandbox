...
public class TSQLiteRollbackMainJava
{
  protected static String nl;
  public static synchronized TSQLiteRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteRollbackMainJava result = new TSQLiteRollbackMainJava();
    nl = null;
    return result;
  }
