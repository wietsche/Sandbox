...
public class TParAccelOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TParAccelOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelOutputBulkEndJava result = new TParAccelOutputBulkEndJava();
    nl = null;
    return result;
  }
