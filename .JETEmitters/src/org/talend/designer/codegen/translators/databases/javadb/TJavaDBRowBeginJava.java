...
public class TJavaDBRowBeginJava
{
  ...
  protected final String TEXT_121 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_122 = ");" + NL + "\t\t\t";
  protected final String TEXT_123 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_124 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_125 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_126 = "),Integer.parseInt(";
  protected final String TEXT_127 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_128 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_129 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_130 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_131 = " && timeOut_";
  protected final String TEXT_132 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_133 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_134 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_135 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_136 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_137 = NL + "\t\t\t\tString url_";
  protected final String TEXT_138 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_139 = ";" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_141 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_142 = " + \":\" + ";
  protected final String TEXT_143 = " + \"/\" + ";
  protected final String TEXT_144 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_146 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_147 = " + \":\" + ";
  protected final String TEXT_148 = " + \"/\" + ";
  protected final String TEXT_149 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_151 = " = null;" + NL + "\tString query_";
  ...
  protected final String TEXT_156 = ".prepareStatement(";
