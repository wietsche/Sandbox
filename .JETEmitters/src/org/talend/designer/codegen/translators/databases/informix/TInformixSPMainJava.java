...
public class TInformixSPMainJava
{
  ...
  protected final String TEXT_61 = ".setTimestamp(";
  protected final String TEXT_62 = ", new java.sql.Timestamp(";
  ...
  protected final String TEXT_87 = NL + "\t\t\t\t\t\t\t\tjava.sql.ResultSet tmpResult_";
  protected final String TEXT_88 = " = statement_";
  protected final String TEXT_89 = ".getResultSet();" + NL + "\t\t\t\t\t\t\t\tif (tmpResult_";
  protected final String TEXT_90 = ".next()) {";
  protected final String TEXT_91 = NL + "\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_92 = " = tmpResult_";
  ...
  protected final String TEXT_101 = " = tmpResult_";
  protected final String TEXT_102 = ".getTimestamp(";
  ...
  protected final String TEXT_110 = " = tmpResult_";
  protected final String TEXT_111 = ".get";
  protected final String TEXT_112 = "(";
  protected final String TEXT_113 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_115 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_116 = " = statement_";
  protected final String TEXT_117 = ".getString(";
  protected final String TEXT_118 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_119 = " != null && tmpString_";
  protected final String TEXT_120 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_121 = ".";
  protected final String TEXT_122 = " = tmpString_";
  protected final String TEXT_123 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_124 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_125 = " = statement_";
  protected final String TEXT_126 = ".getTimestamp(";
  protected final String TEXT_127 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_128 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_131 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_138 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_139 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_140 = ".";
  protected final String TEXT_141 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_152 = NL + "\t\t// No code generated: define a schema for ";
