...
public class TNeo4jOutputRelationshipBeginJava
{
  ...
  protected final String TEXT_121 = NL + "                org.neo4j.graphdb.GraphDatabaseService databaseService_";
  protected final String TEXT_122 = " = new org.neo4j.rest.graphdb.RestGraphDatabase(";
  protected final String TEXT_123 = ", ";
  protected final String TEXT_124 = ", decryptedPassword_";
  protected final String TEXT_125 = ");";
  protected final String TEXT_126 = NL + "                org.neo4j.graphdb.GraphDatabaseService databaseService_";
  protected final String TEXT_127 = " = new org.neo4j.rest.graphdb.RestGraphDatabase(";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "            org.neo4j.graphdb.GraphDatabaseService databaseService_";
  protected final String TEXT_130 = " = new org.neo4j.graphdb.factory.GraphDatabaseFactory().newEmbeddedDatabase(";
  protected final String TEXT_131 = ");" + NL + "\t    \t";
  protected final String TEXT_132 = NL + "\tint nb_line_";
  protected final String TEXT_133 = " = 0;" + NL + "\tlong counter_";
  protected final String TEXT_134 = " = 0;";
  protected final String TEXT_135 = NL + "\tresourceMap.put(\"databaseService_";
  protected final String TEXT_136 = "\", databaseService_";
  protected final String TEXT_137 = ");";
  protected final String TEXT_138 = NL + "    \tjava.util.Map<String, String> importProperties_";
  protected final String TEXT_139 = " = new java.util.HashMap<String, String>();" + NL + "\t\timportProperties_";
  protected final String TEXT_140 = ".put(\"neostore.nodestore.db.mapped_memory\", \"0M\");" + NL + "\t\timportProperties_";
  protected final String TEXT_141 = ".put(\"neostore.relationshipstore.db.mapped_memory\", ";
  protected final String TEXT_142 = ");" + NL + "\t\timportProperties_";
  protected final String TEXT_143 = ".put(\"neostore.propertystore.db.mapped_memory\", ";
  protected final String TEXT_144 = ");" + NL + "\t\timportProperties_";
  protected final String TEXT_145 = ".put(\"neostore.propertystore.db.strings.mapped_memory\", ";
  protected final String TEXT_146 = ");" + NL + "\t\timportProperties_";
  protected final String TEXT_147 = ".put(\"neostore.propertystore.db.arrays.mapped_memory\", ";
  protected final String TEXT_148 = ");" + NL + "\t\tString storeDir_";
  protected final String TEXT_149 = " = \"\";" + NL + "\t    ";
  protected final String TEXT_150 = NL + NL + "    \torg.neo4j.unsafe.batchinsert.BatchInserterIndex startIndexInserter_";
  protected final String TEXT_151 = " = indexProvider_";
  protected final String TEXT_152 = ".nodeIndex(";
  protected final String TEXT_153 = ", org.neo4j.helpers.collection.MapUtil.stringMap(\"type\", \"exact\"));" + NL + "    \torg.neo4j.unsafe.batchinsert.BatchInserterIndex endIndexInserter_";
  protected final String TEXT_154 = " = indexProvider_";
  protected final String TEXT_155 = ".nodeIndex(";
  protected final String TEXT_156 = ", org.neo4j.helpers.collection.MapUtil.stringMap(\"type\", \"exact\"));" + NL + "    \t";
  protected final String TEXT_157 = NL + "        org.neo4j.graphdb.index.Index<org.neo4j.graphdb.Node> startIndexNode_";
  protected final String TEXT_158 = " = null;" + NL + "        org.neo4j.graphdb.index.Index<org.neo4j.graphdb.Node> endIndexNode_";
  protected final String TEXT_159 = " = null;";
  protected final String TEXT_160 = NL + "    \tstartIndexNode_";
  protected final String TEXT_161 = " = databaseService_";
  protected final String TEXT_162 = ".index().forNodes(";
  protected final String TEXT_163 = ");" + NL + "    \tendIndexNode_";
  protected final String TEXT_164 = " = databaseService_";
  protected final String TEXT_165 = ".index().forNodes(";
  protected final String TEXT_166 = ");" + NL + "    \t";
  protected final String TEXT_167 = NL + NL + "\torg.neo4j.graphdb.RelationshipType relationshipType_";
  protected final String TEXT_168 = " = org.neo4j.graphdb.DynamicRelationshipType.withName(";
