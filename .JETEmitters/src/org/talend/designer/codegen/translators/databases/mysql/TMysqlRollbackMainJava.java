...
public class TMysqlRollbackMainJava
{
  protected static String nl;
  public static synchronized TMysqlRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlRollbackMainJava result = new TMysqlRollbackMainJava();
    nl = null;
    return result;
  }
