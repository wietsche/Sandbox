...
public class TJDBCConnectionBeginJava
{
  ...
  protected final String TEXT_143 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_156 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_157 = "\", url_";
  protected final String TEXT_158 = ");" + NL + "\t//globalMap.put(\"user_";
  protected final String TEXT_159 = "\", dbUser_";
  protected final String TEXT_160 = ");" + NL + "\t//globalMap.put(\"pass_";
