...
public class TAmazonOracleOutputFinallyJava
{
  protected static String nl;
  public static synchronized TAmazonOracleOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleOutputFinallyJava result = new TAmazonOracleOutputFinallyJava();
    nl = null;
    return result;
  }
