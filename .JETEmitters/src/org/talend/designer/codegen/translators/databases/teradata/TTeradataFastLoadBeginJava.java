...
public class TTeradataFastLoadBeginJava
{
  ...
  protected final String TEXT_97 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_98 = " =null;";
  protected final String TEXT_99 = NL + NL + "\t String tableName_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";" + NL + "\t String dbname_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ";" + NL + "\tif(dbname_";
  protected final String TEXT_104 = " == null || dbname_";
  protected final String TEXT_105 = ".trim().length() == 0) {" + NL + "    \ttableName_";
  protected final String TEXT_106 = " = ";
  protected final String TEXT_107 = ";" + NL + "\t} else {" + NL + "    \ttableName_";
  protected final String TEXT_108 = " = dbname_";
  protected final String TEXT_109 = " + \".\" + ";
  protected final String TEXT_110 = ";" + NL + "\t}" + NL + "" + NL + "\t\tpstmt_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = ".prepareStatement(\"INSERT INTO \"+tableName_";
  ...
  protected final String TEXT_117 = NL + "\tint commitEvery_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";" + NL + "\tconn_";
  protected final String TEXT_120 = ".setAutoCommit(false);";
