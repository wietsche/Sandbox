...
public class TIngresRollbackMainJava
{
  protected static String nl;
  public static synchronized TIngresRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresRollbackMainJava result = new TIngresRollbackMainJava();
    nl = null;
    return result;
  }
