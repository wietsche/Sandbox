...
public class TAmazonOracleInputEndJava
{
  protected static String nl;
  public static synchronized TAmazonOracleInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAmazonOracleInputEndJava result = new TAmazonOracleInputEndJava();
    nl = null;
    return result;
  }
