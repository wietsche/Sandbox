...
public class TPostgresqlOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TPostgresqlOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlOutputBulkEndJava result = new TPostgresqlOutputBulkEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_31 = "\", true); " + NL + "\tglobalMap.put(\"";
