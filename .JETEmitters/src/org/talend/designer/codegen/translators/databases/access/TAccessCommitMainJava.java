...
public class TAccessCommitMainJava
{
  protected static String nl;
  public static synchronized TAccessCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessCommitMainJava result = new TAccessCommitMainJava();
    nl = null;
    return result;
  }
