...
public class TPostgresqlRollbackMainJava
{
  protected static String nl;
  public static synchronized TPostgresqlRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlRollbackMainJava result = new TPostgresqlRollbackMainJava();
    nl = null;
    return result;
  }
