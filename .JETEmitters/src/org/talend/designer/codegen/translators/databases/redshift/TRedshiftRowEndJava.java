...
public class TRedshiftRowEndJava
{
  protected static String nl;
  public static synchronized TRedshiftRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftRowEndJava result = new TRedshiftRowEndJava();
    nl = null;
    return result;
  }
