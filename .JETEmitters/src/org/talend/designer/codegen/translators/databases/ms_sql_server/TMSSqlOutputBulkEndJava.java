...
public class TMSSqlOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TMSSqlOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlOutputBulkEndJava result = new TMSSqlOutputBulkEndJava();
    nl = null;
    return result;
  }
