...
public class TMemSQLOutputFinallyJava
{
  protected static String nl;
  public static synchronized TMemSQLOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLOutputFinallyJava result = new TMemSQLOutputFinallyJava();
    nl = null;
    return result;
  }
