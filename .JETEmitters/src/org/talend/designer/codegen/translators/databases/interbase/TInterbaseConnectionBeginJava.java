...
public class TInterbaseConnectionBeginJava
{
  protected static String nl;
  public static synchronized TInterbaseConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseConnectionBeginJava result = new TInterbaseConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_4 = " = \"";
  protected final String TEXT_5 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_6 = ");";
  protected final String TEXT_7 = NL + "\t\t\tSharedDBConnectionLog4j.initLogger(log,\"";
  protected final String TEXT_8 = "\");";
  protected final String TEXT_9 = NL + "\t\t\tString sharedConnectionName_";
  protected final String TEXT_10 = " = ";
  protected final String TEXT_11 = ";" + NL + "\t\t\tconn_";
  protected final String TEXT_12 = " = ";
  protected final String TEXT_13 = ".getDBConnection(\"";
  protected final String TEXT_14 = "\",url_";
  protected final String TEXT_15 = ",dbUser_";
  protected final String TEXT_16 = " , dbPwd_";
  protected final String TEXT_17 = " , sharedConnectionName_";
  ...
  protected final String TEXT_28 = ".setAutoCommit(";
  protected final String TEXT_29 = ");";
  protected final String TEXT_30 = NL + "\t\tString url_";
  protected final String TEXT_31 = " = \"jdbc:interbase://\"+";
  ...
  protected final String TEXT_123 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_134 = NL + "\t" + NL + " \t" + NL + " \tglobalMap.put(\"conn_\" + \"";
