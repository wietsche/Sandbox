...
public class TInformixOutputEndJava
{
  ...
  protected final String TEXT_55 = NL + "\t\t\ttry {" + NL + "\t\t\t\t// when PreparedStatement execute \"executeBatch\" if have no any data to update that will throw \"java.sql.SQLException: Method can be called only once.\"" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_56 = " != null && batchSizeCounter_";
  protected final String TEXT_57 = " > 0) {" + NL + "\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_75 = NL + "    \t    \t}" + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_76 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_77 = NL + "            \tSystem.err.println(e.getMessage());" + NL + "            \t";
  protected final String TEXT_78 = NL + "        \t}";
  protected final String TEXT_79 = NL + "        if(pstmt_";
  protected final String TEXT_80 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_81 = ".close();" + NL + "" + NL + "        }" + NL;
  protected final String TEXT_82 = NL + "\t\t";
  protected final String TEXT_83 = NL + "        conn_";
  protected final String TEXT_84 = ".commit();" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t";
  protected final String TEXT_86 = NL + "\tconn_";
  protected final String TEXT_87 = " .close();" + NL + "\t";
  protected final String TEXT_88 = NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_89 = "\", true);" + NL + "\t";
  protected final String TEXT_90 = NL;
  protected final String TEXT_91 = NL + "\tnb_line_deleted_";
  protected final String TEXT_92 = "=nb_line_deleted_";
  protected final String TEXT_93 = "+ deletedCount_";
  protected final String TEXT_94 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_95 = "=nb_line_update_";
  protected final String TEXT_96 = " + updatedCount_";
  protected final String TEXT_97 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_98 = "=nb_line_inserted_";
  protected final String TEXT_99 = " + insertedCount_";
  protected final String TEXT_100 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_101 = "=nb_line_rejected_";
  protected final String TEXT_102 = " + rejectedCount_";
  protected final String TEXT_103 = ";" + NL + "\t";
  protected final String TEXT_104 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_105 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_106 = "_NB_LINE\",nb_line_";
  protected final String TEXT_107 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_108 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_109 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_110 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_111 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_112 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_113 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_114 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_115 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_116 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_117 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_120 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_121 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_122 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_123 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_126 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_127 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_128 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_130 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_131 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_132 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_133 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_134 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_135 = NL + "        globalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE\",nb_line_";
  protected final String TEXT_137 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_UPDATED\",nb_line_update_";
  ...
  protected final String TEXT_144 = "_NB_LINE_REJECTED\", nb_line_rejected_";
