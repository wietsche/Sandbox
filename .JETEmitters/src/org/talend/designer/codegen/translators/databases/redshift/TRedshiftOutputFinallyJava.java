...
public class TRedshiftOutputFinallyJava
{
  protected static String nl;
  public static synchronized TRedshiftOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftOutputFinallyJava result = new TRedshiftOutputFinallyJava();
    nl = null;
    return result;
  }
