...
public class TOracleCloseMainJava
{
  protected static String nl;
  public static synchronized TOracleCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleCloseMainJava result = new TOracleCloseMainJava();
    nl = null;
    return result;
  }
