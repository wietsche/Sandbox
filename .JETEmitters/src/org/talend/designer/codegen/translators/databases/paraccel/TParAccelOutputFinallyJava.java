...
public class TParAccelOutputFinallyJava
{
  protected static String nl;
  public static synchronized TParAccelOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelOutputFinallyJava result = new TParAccelOutputFinallyJava();
    nl = null;
    return result;
  }
