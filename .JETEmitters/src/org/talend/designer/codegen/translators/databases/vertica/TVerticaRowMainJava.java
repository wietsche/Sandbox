...
public class TVerticaRowMainJava
{
  protected static String nl;
  public static synchronized TVerticaRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaRowMainJava result = new TVerticaRowMainJava();
    nl = null;
    return result;
  }
