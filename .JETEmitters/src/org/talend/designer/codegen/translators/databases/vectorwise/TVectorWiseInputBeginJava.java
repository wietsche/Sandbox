...
public class TVectorWiseInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:ingres://\" + ";
  protected final String TEXT_176 = " + \":\" + ";
  protected final String TEXT_177 = " + \"/\" + ";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "    " + NL + "\t";
  protected final String TEXT_180 = NL + "\t\t    int nb_line_";
  protected final String TEXT_181 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_182 = " = null;";
  protected final String TEXT_183 = NL + "\t\t        conn_";
  protected final String TEXT_184 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_185 = "\");";
  protected final String TEXT_186 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_187 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_188 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_189 = " = dataSources_";
  protected final String TEXT_190 = ".get(";
  protected final String TEXT_191 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_192 = "\", conn_";
  protected final String TEXT_193 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_194 = NL + "\t\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\t";
  protected final String TEXT_196 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_197 = " =  conn_";
  protected final String TEXT_198 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_199 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_200 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_201 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_202 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_203 = NL + "                 conn_";
  protected final String TEXT_204 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_205 = NL + "               ";
  protected final String TEXT_206 = " + \"=\" + ";
  protected final String TEXT_207 = " + \";\" +";
  protected final String TEXT_208 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_209 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = NL + "\t\t    ";
  protected final String TEXT_212 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_213 = " = ";
  protected final String TEXT_214 = ";" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "                log.info(\"";
  protected final String TEXT_216 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_217 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_218 = NL;
  protected final String TEXT_219 = NL + "                       globalMap.put(\"";
  protected final String TEXT_220 = "_QUERY\",dbquery_";
  ...
  protected final String TEXT_226 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_227 = " = stmt_";
  protected final String TEXT_228 = ".executeQuery(dbquery_";
  protected final String TEXT_229 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_230 = " = rs_";
  protected final String TEXT_231 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_232 = " = rsmd_";
  protected final String TEXT_233 = ".getColumnCount();" + NL;
  protected final String TEXT_234 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_235 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_236 = ".setDbmsId(\"";
  protected final String TEXT_237 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_238 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_239 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_240 = ".add(\"";
  protected final String TEXT_241 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_242 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_243 = " = ";
  protected final String TEXT_244 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_245 = "; i <= rsmd_";
  protected final String TEXT_246 = ".getColumnCount()-";
  protected final String TEXT_247 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_248 = ".contains(rsmd_";
  protected final String TEXT_249 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_250 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_251 = ".setName(rsmd_";
  protected final String TEXT_252 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_253 = ".setDbName(rsmd_";
  protected final String TEXT_254 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_255 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_256 = "\", rsmd_";
  protected final String TEXT_257 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_258 = ".getPrecision(i), rsmd_";
  protected final String TEXT_259 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_260 = ".setDbType(rsmd_";
  protected final String TEXT_261 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_262 = ".setDbTypeId(rsmd_";
  protected final String TEXT_263 = ".getColumnType(i));";
  protected final String TEXT_264 = NL + "                \tdcm_";
  protected final String TEXT_265 = ".setFormat(";
  protected final String TEXT_266 = ");";
  protected final String TEXT_267 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_268 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_269 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_270 = ".setLength(rsmd_";
  protected final String TEXT_271 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_272 = ".setLength(rsmd_";
  protected final String TEXT_273 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_274 = NL + "\t\t\tdcm_";
  protected final String TEXT_275 = ".setLength(rsmd_";
  protected final String TEXT_276 = ".getPrecision(i));";
  protected final String TEXT_277 = NL + "                \tdcm_";
  protected final String TEXT_278 = ".setPrecision(rsmd_";
  protected final String TEXT_279 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_280 = ".setNullable(rsmd_";
  protected final String TEXT_281 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_284 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_285 = ".metadatas.add(dcm_";
  protected final String TEXT_286 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_287 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_288 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_289 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_290 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_291 = NL + "\t\t    ";
  protected final String TEXT_292 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_293 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_294 = NL + "\t\t    while (rs_";
  protected final String TEXT_295 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_296 = "++;" + NL + "\t\t        ";
  protected final String TEXT_297 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_298 = " = ";
  protected final String TEXT_299 = " + dcg_";
  protected final String TEXT_300 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_306 = " < ";
  protected final String TEXT_307 = "column_index_";
  protected final String TEXT_308 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_309 = ".";
  protected final String TEXT_310 = " = ";
  protected final String TEXT_311 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_312 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_313 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_314 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_315 = NL + "\t\t                            ";
  protected final String TEXT_316 = ".";
  protected final String TEXT_317 = " = (List)rs_";
  protected final String TEXT_318 = ".getObject(";
  protected final String TEXT_319 = "column_index_";
  protected final String TEXT_320 = ");";
  protected final String TEXT_321 = NL + "\t                         \t\t";
  protected final String TEXT_322 = NL + "\t                         \t\t";
  protected final String TEXT_323 = NL + "\t                         \t\t";
  protected final String TEXT_324 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_325 = ".getObject(";
  protected final String TEXT_326 = "column_index_";
  protected final String TEXT_327 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_328 = NL + "                                    ";
  protected final String TEXT_329 = ".";
  protected final String TEXT_330 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_339 = ".setEPSG(";
  protected final String TEXT_340 = ");" + NL + "                                        }";
  protected final String TEXT_341 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_342 = NL + "                                  ";
  protected final String TEXT_343 = ".";
  protected final String TEXT_344 = "=dcg_";
  protected final String TEXT_345 = ";";
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_347 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = "; i_";
  protected final String TEXT_350 = "  <= rsmd_";
  protected final String TEXT_351 = ".getColumnCount(); i_";
  protected final String TEXT_352 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_353 = ".getColumnTypeName(i_";
  protected final String TEXT_354 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_355 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_356 = ".getClob(i_";
  protected final String TEXT_357 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_358 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_359 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_360 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_361 = ".add(tNTextImpl_";
  protected final String TEXT_362 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_363 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = ", rs_";
  protected final String TEXT_366 = ", fixedColumnCount_";
  protected final String TEXT_367 = ",list_";
  ...
  protected final String TEXT_376 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = ", rs_";
  protected final String TEXT_379 = ", fixedColumnCount_";
  protected final String TEXT_380 = ",";
  protected final String TEXT_381 = ");";
  protected final String TEXT_382 = NL + "                                  Object geom = rs_";
  protected final String TEXT_383 = ".getObject(";
  protected final String TEXT_384 = "column_index_";
  protected final String TEXT_385 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_386 = ".";
  protected final String TEXT_387 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_394 = " - Retrieving the record \" + nb_line_";
