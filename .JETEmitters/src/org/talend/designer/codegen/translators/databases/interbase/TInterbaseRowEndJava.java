...
public class TInterbaseRowEndJava
{
  protected static String nl;
  public static synchronized TInterbaseRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseRowEndJava result = new TInterbaseRowEndJava();
    nl = null;
    return result;
  }
