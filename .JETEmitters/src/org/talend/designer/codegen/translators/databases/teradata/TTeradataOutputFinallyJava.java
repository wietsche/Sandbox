...
public class TTeradataOutputFinallyJava
{
  protected static String nl;
  public static synchronized TTeradataOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputFinallyJava result = new TTeradataOutputFinallyJava();
    nl = null;
    return result;
  }
