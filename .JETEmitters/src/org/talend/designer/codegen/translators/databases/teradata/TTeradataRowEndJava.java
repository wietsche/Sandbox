...
public class TTeradataRowEndJava
{
  ...
  protected final String TEXT_112 = NL + "        stmt_";
  protected final String TEXT_113 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_114 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_115 = NL;
  protected final String TEXT_116 = NL + "\tpstmt_";
  protected final String TEXT_117 = ".close();";
  protected final String TEXT_118 = NL + "\tstmt_";
  ...
  protected final String TEXT_123 = NL + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_124 = "=0;" + NL + "" + NL + "\t\t}";
  protected final String TEXT_125 = NL + "\t";
  protected final String TEXT_126 = NL;
  protected final String TEXT_127 = NL + "    conn_";
  protected final String TEXT_128 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_129 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_130 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_131 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_132 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
  protected final String TEXT_133 = NL + "     }catch(Exception e){";
