...
public class TVerticaOutputFinallyJava
{
  protected static String nl;
  public static synchronized TVerticaOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaOutputFinallyJava result = new TVerticaOutputFinallyJava();
    nl = null;
    return result;
  }
