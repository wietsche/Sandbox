...
public class TRedshiftCommitMainJava
{
  protected static String nl;
  public static synchronized TRedshiftCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftCommitMainJava result = new TRedshiftCommitMainJava();
    nl = null;
    return result;
  }
