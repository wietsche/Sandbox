...
public class TTeradataInputEndJava
{
  ...
  protected final String TEXT_112 = NL + NL + "\t}" + NL + "}finally{" + NL + "\tstmt_";
  ...
  protected final String TEXT_119 = ".setAutoCommit(true);" + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_120 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_121 = NL + "                   try{" + NL + "                        conn_";
  protected final String TEXT_122 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_123 = ");" + NL + "                   }catch(Exception e){" + NL + "                         System.err.println(e.getMessage());" + NL + "                   }";
