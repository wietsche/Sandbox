...
public class TSybaseCommitMainJava
{
  protected static String nl;
  public static synchronized TSybaseCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseCommitMainJava result = new TSybaseCommitMainJava();
    nl = null;
    return result;
  }
