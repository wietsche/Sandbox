...
public class TParAccelCloseMainJava
{
  protected static String nl;
  public static synchronized TParAccelCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelCloseMainJava result = new TParAccelCloseMainJava();
    nl = null;
    return result;
  }
