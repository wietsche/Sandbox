...
public class TPostgresqlOutputEndJava
{
  ...
  protected final String TEXT_43 = NL + "\t\tjava.sql.Statement stmtCreateGeoColumns_";
  protected final String TEXT_44 = " = conn_";
  protected final String TEXT_45 = ".createStatement();" + NL + "" + NL + "\t\t// Delete geometry columns entry if already exists." + NL + "\t\tString deleteGeometryColumns_";
  protected final String TEXT_46 = " = \"DELETE FROM geometry_columns WHERE f_table_name='\" +" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_47 = " + \"' AND f_table_schema='\" + ";
  protected final String TEXT_48 = " +\"'\";" + NL + "\t\tstmtCreateGeoColumns_";
  protected final String TEXT_49 = ".execute(deleteGeometryColumns_";
  protected final String TEXT_50 = ");" + NL + "" + NL + "\t\t// Create new entry in geometry columns table" + NL + "        String insertGeometryColumns_";
  protected final String TEXT_51 = " = \"INSERT INTO geometry_columns VALUES ('', '\"+ ";
  protected final String TEXT_52 = " +\"', '\"+" + NL + "        \t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_53 = " +\"','\"+ geometryColumnName_";
  protected final String TEXT_54 = " +" + NL + "        \t\t\t\t\t\t\t\t\t\t\"', \"+dimension_";
  protected final String TEXT_55 = "+\", \"+ SRID_";
  protected final String TEXT_56 = " +\", 'GEOMETRY')\";" + NL + "        stmtCreateGeoColumns_";
  protected final String TEXT_57 = ".execute(insertGeometryColumns_";
  protected final String TEXT_58 = ");" + NL + "" + NL + "        stmtCreateGeoColumns_";
  protected final String TEXT_59 = ".close();" + NL + "\t\t";
  protected final String TEXT_60 = NL + "    \tjava.sql.Statement stmtCreateIndex_";
  protected final String TEXT_61 = " = conn_";
  protected final String TEXT_62 = ".createStatement();" + NL + "\t\t// Drop spatial index if exists" + NL + "\t\tString dropIndex_";
  protected final String TEXT_63 = " = \"DROP INDEX IF EXISTS \\\"\"+ tableName_";
  protected final String TEXT_64 = " +\"_geo_index\\\"\";" + NL + "\t\tstmtCreateIndex_";
  protected final String TEXT_65 = ".execute(dropIndex_";
  protected final String TEXT_66 = ");" + NL + "" + NL + "\t\t// Create spatial index using GIST on geometry columns" + NL + "\t\tString createIndex_";
  protected final String TEXT_67 = " = \"CREATE INDEX \\\"\"+ ";
  protected final String TEXT_68 = " +\"_geo_index\\\" ON \\\"\"+ tableName_";
  protected final String TEXT_69 = " +" + NL + "\t\t\t\t\t\t\t\t \"\\\" USING GIST (\\\"\" + geometryColumnName_";
  protected final String TEXT_70 = " +\"\\\")\";" + NL + "        stmtCreateIndex_";
  protected final String TEXT_71 = ".execute(createIndex_";
  protected final String TEXT_72 = ");" + NL + "       stmtCreateIndex_";
  protected final String TEXT_73 = ".close();" + NL + "\t\t";
  protected final String TEXT_74 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_75 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_76 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_77 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_78 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_79 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_80 = ".close();" + NL + "        }";
  protected final String TEXT_81 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_82 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_83 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_84 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_85 = ".close();" + NL + "        }";
  protected final String TEXT_86 = NL + "\t    try {" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_87 = " = 0;" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_88 = " != null && batchSizeCounter_";
  protected final String TEXT_89 = " > 0) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_91 = ": pstmt_";
  protected final String TEXT_92 = ".executeBatch()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_93 = " += (countEach_";
  protected final String TEXT_94 = " < 0 ? 0 : countEach_";
  protected final String TEXT_95 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t}" + NL + "\t\t    \t";
  protected final String TEXT_97 = NL + "\t\t    \t\tinsertedCount_";
  protected final String TEXT_98 = " += countSum_";
  protected final String TEXT_99 = ";" + NL + "\t\t    \t";
  protected final String TEXT_100 = NL + "\t\t    \t\tupdatedCount_";
  protected final String TEXT_101 = " += countSum_";
  protected final String TEXT_102 = ";" + NL + "\t\t    \t";
  protected final String TEXT_103 = NL + "\t\t    \t    deletedCount_";
  protected final String TEXT_104 = " += countSum_";
  protected final String TEXT_105 = ";" + NL + "\t\t    \t";
  protected final String TEXT_106 = NL + "\t    }catch (java.sql.BatchUpdateException e){" + NL + "\t    \t";
  protected final String TEXT_107 = NL + "\t    \t\tthrow(e);" + NL + "\t    \t";
  protected final String TEXT_108 = NL + "\t    \tint countSum_";
  protected final String TEXT_109 = " = 0;" + NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_110 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_111 = " += (countEach_";
  protected final String TEXT_112 = " < 0 ? 0 : countEach_";
  protected final String TEXT_113 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_114 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_115 = " += countSum_";
  protected final String TEXT_116 = ";" + NL + "\t    \t";
  protected final String TEXT_117 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_118 = " += countSum_";
  protected final String TEXT_119 = ";" + NL + "\t    \t";
  protected final String TEXT_120 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_121 = " += countSum_";
  protected final String TEXT_122 = ";" + NL + "\t    \t";
  protected final String TEXT_123 = NL + "\t    \tSystem.err.println(e.getMessage());" + NL + "\t    \t";
  protected final String TEXT_124 = NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_125 = NL + "        if(pstmt_";
  protected final String TEXT_126 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_127 = ".close();" + NL + "        }";
  protected final String TEXT_128 = NL;
  protected final String TEXT_129 = NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\tconn_";
  protected final String TEXT_131 = ".commit();" + NL + "\t\t\t";
