...
public class TSasInputEndJava
{
  protected static String nl;
  public static synchronized TSasInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSasInputEndJava result = new TSasInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = ".close();" + NL + "\tif(conn_";
  protected final String TEXT_72 = "!=null){" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t}" + NL + "}" + NL + "globalMap.put(\"";
