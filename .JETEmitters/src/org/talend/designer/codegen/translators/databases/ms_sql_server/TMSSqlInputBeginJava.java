...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_174 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_175 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_176 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_177 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_178 = ", talendToDBArray_";
  protected final String TEXT_179 = "); ";
  protected final String TEXT_180 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_181 = " = (String)globalMap.get(\"";
  protected final String TEXT_182 = "\");";
  protected final String TEXT_183 = NL + "\t\t    String port_";
  protected final String TEXT_184 = " = ";
  protected final String TEXT_185 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_186 = " = ";
  protected final String TEXT_187 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_188 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_189 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_190 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_191 = " += \":\" + ";
  protected final String TEXT_192 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_193 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_194 = " += \"//\" + ";
  protected final String TEXT_195 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_196 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_197 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ";";
  protected final String TEXT_200 = NL + "\t\t\t";
  protected final String TEXT_201 = ".";
  protected final String TEXT_202 = " = mssqlGTU_";
  protected final String TEXT_203 = ".getDate(rsmd_";
  protected final String TEXT_204 = ", rs_";
  protected final String TEXT_205 = ", ";
  protected final String TEXT_206 = "column_index_";
  protected final String TEXT_207 = ");" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_209 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_210 = ".getClob(";
  protected final String TEXT_211 = ");" + NL + "\t\t\t\tif(clob_";
  protected final String TEXT_212 = "!=null){" + NL + "\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_213 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_214 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_215 = " = tNTextImpl_";
  protected final String TEXT_216 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_217 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_218 = NL + "           \t\ttmpContent_";
  protected final String TEXT_219 = " = rs_";
  protected final String TEXT_220 = ".getString(";
  protected final String TEXT_221 = "column_index_";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "            if(tmpContent_";
  protected final String TEXT_224 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_225 = " .contains(rsmd_";
  protected final String TEXT_226 = ".getColumnTypeName(";
  protected final String TEXT_227 = "column_index_";
  protected final String TEXT_228 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_229 = ".";
  protected final String TEXT_230 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_231 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = " = tmpContent_";
  protected final String TEXT_234 = ";" + NL + "                }" + NL + "            } else {";
  protected final String TEXT_235 = NL + "                ";
  protected final String TEXT_236 = ".";
  protected final String TEXT_237 = " = null;" + NL + "            }";
  protected final String TEXT_238 = NL + "    " + NL + "\t";
  protected final String TEXT_239 = NL + "\t\t    int nb_line_";
  protected final String TEXT_240 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_241 = " = null;";
  protected final String TEXT_242 = NL + "\t\t        conn_";
  protected final String TEXT_243 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_244 = "\");";
  protected final String TEXT_245 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_246 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_247 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_248 = " = dataSources_";
  protected final String TEXT_249 = ".get(";
  protected final String TEXT_250 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_251 = "\", conn_";
  protected final String TEXT_252 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_253 = NL + "\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t";
  protected final String TEXT_255 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_256 = " =  conn_";
  protected final String TEXT_257 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_258 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_259 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_260 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_261 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_262 = NL + "                 conn_";
  protected final String TEXT_263 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_264 = NL + "               ";
  protected final String TEXT_265 = " + \"=\" + ";
  protected final String TEXT_266 = " + \";\" +";
  protected final String TEXT_267 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_268 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_269 = ");";
  protected final String TEXT_270 = NL + "\t\t    ";
  protected final String TEXT_271 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_272 = " = ";
  protected final String TEXT_273 = ";" + NL + "\t\t\t";
  protected final String TEXT_274 = NL + "                log.info(\"";
  protected final String TEXT_275 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_276 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_277 = NL;
  protected final String TEXT_278 = NL + "                       globalMap.put(\"";
  protected final String TEXT_279 = "_QUERY\",dbquery_";
  protected final String TEXT_280 = ");";
  protected final String TEXT_281 = NL + "                       globalMap.put(\"";
  protected final String TEXT_282 = "_QUERY\",dbquery_";
  protected final String TEXT_283 = ");";
  protected final String TEXT_284 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_285 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_286 = " = stmt_";
  protected final String TEXT_287 = ".executeQuery(dbquery_";
  protected final String TEXT_288 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_289 = " = rs_";
  protected final String TEXT_290 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_291 = " = rsmd_";
  protected final String TEXT_292 = ".getColumnCount();" + NL;
  protected final String TEXT_293 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_294 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_295 = ".setDbmsId(\"";
  protected final String TEXT_296 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_297 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_298 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_299 = ".add(\"";
  protected final String TEXT_300 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_301 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_304 = "; i <= rsmd_";
  protected final String TEXT_305 = ".getColumnCount()-";
  protected final String TEXT_306 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_307 = ".contains(rsmd_";
  protected final String TEXT_308 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_309 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setName(rsmd_";
  protected final String TEXT_311 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setDbName(rsmd_";
  protected final String TEXT_313 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_315 = "\", rsmd_";
  protected final String TEXT_316 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_317 = ".getPrecision(i), rsmd_";
  protected final String TEXT_318 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setDbType(rsmd_";
  protected final String TEXT_320 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setDbTypeId(rsmd_";
  protected final String TEXT_322 = ".getColumnType(i));";
  protected final String TEXT_323 = NL + "                \tdcm_";
  protected final String TEXT_324 = ".setFormat(";
  protected final String TEXT_325 = ");";
  protected final String TEXT_326 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_327 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_328 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_329 = ".setLength(rsmd_";
  protected final String TEXT_330 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_331 = ".setLength(rsmd_";
  protected final String TEXT_332 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_333 = NL + "\t\t\tdcm_";
  protected final String TEXT_334 = ".setLength(rsmd_";
  protected final String TEXT_335 = ".getPrecision(i));";
  protected final String TEXT_336 = NL + "                \tdcm_";
  protected final String TEXT_337 = ".setPrecision(rsmd_";
  protected final String TEXT_338 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_339 = ".setNullable(rsmd_";
  protected final String TEXT_340 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_341 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_342 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_343 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_344 = ".metadatas.add(dcm_";
  protected final String TEXT_345 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_346 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_347 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_348 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_349 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_350 = NL + "\t\t    ";
  protected final String TEXT_351 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_352 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_353 = NL + "\t\t    while (rs_";
  protected final String TEXT_354 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_355 = "++;" + NL + "\t\t        ";
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = " + dcg_";
  protected final String TEXT_359 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_361 = " = ";
  protected final String TEXT_362 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_365 = " < ";
  protected final String TEXT_366 = "column_index_";
  protected final String TEXT_367 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = " = ";
  protected final String TEXT_370 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_371 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_374 = NL + "\t\t                            ";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = " = (List)rs_";
  protected final String TEXT_377 = ".getObject(";
  protected final String TEXT_378 = "column_index_";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "\t                         \t\t";
  protected final String TEXT_381 = NL + "\t                         \t\t";
  protected final String TEXT_382 = NL + "\t                         \t\t";
  protected final String TEXT_383 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  ...
  protected final String TEXT_389 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_398 = ".setEPSG(";
  protected final String TEXT_399 = ");" + NL + "                                        }";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_401 = NL + "                                  ";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = "=dcg_";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_406 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_407 = " = ";
  protected final String TEXT_408 = "; i_";
  protected final String TEXT_409 = "  <= rsmd_";
  protected final String TEXT_410 = ".getColumnCount(); i_";
  protected final String TEXT_411 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_412 = ".getColumnTypeName(i_";
  protected final String TEXT_413 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_414 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_415 = ".getClob(i_";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_417 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_418 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_419 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_420 = ".add(tNTextImpl_";
  protected final String TEXT_421 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_422 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = ", rs_";
  protected final String TEXT_425 = ", fixedColumnCount_";
  protected final String TEXT_426 = ",list_";
  protected final String TEXT_427 = ",";
  protected final String TEXT_428 = ");";
  protected final String TEXT_429 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ", rs_";
  protected final String TEXT_432 = ", fixedColumnCount_";
  protected final String TEXT_433 = ",";
  protected final String TEXT_434 = ");";
  protected final String TEXT_435 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_436 = ".";
  protected final String TEXT_437 = ", rs_";
  protected final String TEXT_438 = ", fixedColumnCount_";
  protected final String TEXT_439 = ",";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL + "                                  Object geom = rs_";
  protected final String TEXT_442 = ".getObject(";
  protected final String TEXT_443 = "column_index_";
  protected final String TEXT_444 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  ...
  protected final String TEXT_453 = " - Retrieving the record \" + nb_line_";
  ...
  protected final String TEXT_460 = NL + NL + NL + NL;
