...
public class TOracleRollbackMainJava
{
  protected static String nl;
  public static synchronized TOracleRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleRollbackMainJava result = new TOracleRollbackMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_81 = ").getConnection();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_82 = NL + NL + "if(conn_";
  protected final String TEXT_83 = " != null && !conn_";
  protected final String TEXT_84 = ".isClosed()) {" + NL + "\t";
  protected final String TEXT_85 = NL + "\t\ttry{" + NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t}finally{" + NL + "\t    \t";
