...
public class THBaseCloseMainJava
{
  ...
  protected final String TEXT_31 = NL + "\torg.apache.hadoop.conf.Configuration conn_";
  protected final String TEXT_32 = " = (org.apache.hadoop.conf.Configuration)globalMap.get(\"";
  protected final String TEXT_33 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_34 = " != null )" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_35 = NL;
  protected final String TEXT_36 = NL + "        org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_37 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_38 = ");" + NL + "        if ((hConnection_";
  protected final String TEXT_39 = " != null) && (!hConnection_";
  protected final String TEXT_40 = ".isClosed())) {" + NL + "            hConnection_";
  protected final String TEXT_41 = ".close();" + NL + "        }";
  protected final String TEXT_42 = NL + "\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_43 = ",true);";
  protected final String TEXT_44 = NL + "\t\tglobalMap.remove(\"";
