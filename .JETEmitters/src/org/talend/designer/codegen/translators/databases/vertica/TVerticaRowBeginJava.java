...
public class TVerticaRowBeginJava
{
  ...
  protected final String TEXT_122 = " = \"jdbc:vertica://\"+";
  protected final String TEXT_123 = "+\":\"+";
  protected final String TEXT_124 = "+\"/\"+";
  protected final String TEXT_125 = ";" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:vertica://\"+";
  protected final String TEXT_128 = "+\":\"+";
  protected final String TEXT_129 = "+\"/\"+";
  protected final String TEXT_130 = " + \"?\" + ";
  protected final String TEXT_131 = ";" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_133 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_135 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tint nb_line_deleted_";
