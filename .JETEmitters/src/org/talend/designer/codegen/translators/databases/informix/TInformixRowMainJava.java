...
public class TInformixRowMainJava
{
  protected static String nl;
  public static synchronized TInformixRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixRowMainJava result = new TInformixRowMainJava();
    nl = null;
    return result;
  }
