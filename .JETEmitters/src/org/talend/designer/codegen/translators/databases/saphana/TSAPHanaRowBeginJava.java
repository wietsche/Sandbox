...
public class TSAPHanaRowBeginJava
{
  protected static String nl;
  public static synchronized TSAPHanaRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaRowBeginJava result = new TSAPHanaRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_121 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_124 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_125 = " + \":\" + ";
  protected final String TEXT_126 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_127 = " != null && dbProperties_";
  protected final String TEXT_128 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_129 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_130 = " + \":\" + ";
  protected final String TEXT_131 = " + \"/?\" + dbProperties_";
  protected final String TEXT_132 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_134 = " = null;" + NL + "\tString query_";
  protected final String TEXT_135 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_136 = " = false;";
  protected final String TEXT_137 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_138 = " = conn_";
  protected final String TEXT_139 = ".prepareStatement(";
