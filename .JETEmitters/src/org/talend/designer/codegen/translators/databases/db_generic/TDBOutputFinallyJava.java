...
public class TDBOutputFinallyJava
{
  protected static String nl;
  public static synchronized TDBOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDBOutputFinallyJava result = new TDBOutputFinallyJava();
    nl = null;
    return result;
  }
