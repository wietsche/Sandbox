...
public class TGreenplumRollbackMainJava
{
  protected static String nl;
  public static synchronized TGreenplumRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumRollbackMainJava result = new TGreenplumRollbackMainJava();
    nl = null;
    return result;
  }
