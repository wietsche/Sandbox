...
public class TSAPHanaOutputEndJava
{
  protected static String nl;
  public static synchronized TSAPHanaOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaOutputEndJava result = new TSAPHanaOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_58 = NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_59 = ": pstmt_";
  protected final String TEXT_60 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_61 = " += (countEach_";
  protected final String TEXT_62 = " < 0 ? 0 : countEach_";
  protected final String TEXT_63 = ");" + NL + "\t\t\t\t}  " + NL + "\t\t\t\t";
  protected final String TEXT_64 = "               \t" + NL + "\t\t\t}" + NL + "\t    \t";
  protected final String TEXT_65 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_66 = " += countSum_";
  protected final String TEXT_67 = "; " + NL + "\t    \t";
  protected final String TEXT_68 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_69 = " += countSum_";
  protected final String TEXT_70 = ";" + NL + "\t    \t";
  protected final String TEXT_71 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_72 = " += countSum_";
  protected final String TEXT_73 = ";" + NL + "\t    \t";
  protected final String TEXT_74 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_75 = "){" + NL + "    \t";
  protected final String TEXT_76 = NL + "    \t\tthrow(e_";
  protected final String TEXT_77 = ");" + NL + "    \t";
  protected final String TEXT_78 = NL + "    \tint countSum_";
  protected final String TEXT_79 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_80 = ": e_";
  protected final String TEXT_81 = ".getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_82 = " += (countEach_";
  protected final String TEXT_83 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_92 = " += countSum_";
  protected final String TEXT_93 = ";" + NL + "    \t";
  protected final String TEXT_94 = " " + NL + "    \tSystem.err.println(e_";
  protected final String TEXT_95 = ".getMessage());" + NL + "    \t";
  protected final String TEXT_96 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_97 = "   " + NL + "                " + NL + "        if(pstmt_";
  protected final String TEXT_98 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_99 = ".close();" + NL + "            " + NL + "        }        ";
