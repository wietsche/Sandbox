...
public class TRedshiftCloseMainJava
{
  protected static String nl;
  public static synchronized TRedshiftCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftCloseMainJava result = new TRedshiftCloseMainJava();
    nl = null;
    return result;
  }
