...
public class TJDBCOutputFinallyJava
{
  protected static String nl;
  public static synchronized TJDBCOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputFinallyJava result = new TJDBCOutputFinallyJava();
    nl = null;
    return result;
  }
