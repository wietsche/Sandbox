...
public class TEXAOutputFinallyJava
{
  protected static String nl;
  public static synchronized TEXAOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXAOutputFinallyJava result = new TEXAOutputFinallyJava();
    nl = null;
    return result;
  }
