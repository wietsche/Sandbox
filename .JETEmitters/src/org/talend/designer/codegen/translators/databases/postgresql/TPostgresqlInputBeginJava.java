...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_176 = " + \":\" + ";
  protected final String TEXT_177 = " + \"/\" + ";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "                stmt_";
  protected final String TEXT_180 = ".setFetchSize(";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL + "    " + NL + "\t";
  protected final String TEXT_183 = NL + "\t\t    int nb_line_";
  protected final String TEXT_184 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_185 = " = null;";
  protected final String TEXT_186 = NL + "\t\t        conn_";
  protected final String TEXT_187 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_188 = "\");";
  protected final String TEXT_189 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_190 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_191 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_192 = " = dataSources_";
  protected final String TEXT_193 = ".get(";
  protected final String TEXT_194 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_195 = "\", conn_";
  protected final String TEXT_196 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_197 = NL + "\t\t\t\t";
  protected final String TEXT_198 = NL + "\t\t\t\t";
  protected final String TEXT_199 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_200 = " =  conn_";
  protected final String TEXT_201 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_202 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_203 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_204 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_205 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_206 = NL + "                 conn_";
  protected final String TEXT_207 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_208 = NL + "               ";
  protected final String TEXT_209 = " + \"=\" + ";
  protected final String TEXT_210 = " + \";\" +";
  protected final String TEXT_211 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_212 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "\t\t    ";
  protected final String TEXT_215 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ";" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "                log.info(\"";
  protected final String TEXT_219 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_226 = "_QUERY\",dbquery_";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_229 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_230 = " = stmt_";
  protected final String TEXT_231 = ".executeQuery(dbquery_";
  protected final String TEXT_232 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_233 = " = rs_";
  protected final String TEXT_234 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_235 = " = rsmd_";
  protected final String TEXT_236 = ".getColumnCount();" + NL;
  protected final String TEXT_237 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_238 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_239 = ".setDbmsId(\"";
  protected final String TEXT_240 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_241 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_242 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_243 = ".add(\"";
  protected final String TEXT_244 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_245 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_246 = " = ";
  protected final String TEXT_247 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_248 = "; i <= rsmd_";
  protected final String TEXT_249 = ".getColumnCount()-";
  protected final String TEXT_250 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_251 = ".contains(rsmd_";
  protected final String TEXT_252 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_253 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_254 = ".setName(rsmd_";
  protected final String TEXT_255 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_256 = ".setDbName(rsmd_";
  protected final String TEXT_257 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_258 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_259 = "\", rsmd_";
  protected final String TEXT_260 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_261 = ".getPrecision(i), rsmd_";
  protected final String TEXT_262 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_263 = ".setDbType(rsmd_";
  protected final String TEXT_264 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_265 = ".setDbTypeId(rsmd_";
  protected final String TEXT_266 = ".getColumnType(i));";
  ...
  protected final String TEXT_327 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_328 = ".getObject(";
  protected final String TEXT_329 = "column_index_";
  protected final String TEXT_330 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_331 = NL + "                                    ";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_342 = ".setEPSG(";
  ...
  protected final String TEXT_349 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_350 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_351 = " = ";
  protected final String TEXT_352 = "; i_";
  protected final String TEXT_353 = "  <= rsmd_";
  protected final String TEXT_354 = ".getColumnCount(); i_";
  protected final String TEXT_355 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_356 = ".getColumnTypeName(i_";
  protected final String TEXT_357 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_358 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_359 = ".getClob(i_";
  protected final String TEXT_360 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_361 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_362 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_363 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_364 = ".add(tNTextImpl_";
  protected final String TEXT_365 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_366 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = ", rs_";
  protected final String TEXT_369 = ", fixedColumnCount_";
  protected final String TEXT_370 = ",list_";
  protected final String TEXT_371 = ",";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = ", rs_";
  protected final String TEXT_376 = ", fixedColumnCount_";
  protected final String TEXT_377 = ",";
  protected final String TEXT_378 = ");";
  protected final String TEXT_379 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_380 = ".";
  protected final String TEXT_381 = ", rs_";
  protected final String TEXT_382 = ", fixedColumnCount_";
  protected final String TEXT_383 = ",";
  protected final String TEXT_384 = ");";
  protected final String TEXT_385 = NL + "                                  Object geom = rs_";
  protected final String TEXT_386 = ".getObject(";
  protected final String TEXT_387 = "column_index_";
  protected final String TEXT_388 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_389 = ".";
  protected final String TEXT_390 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_397 = " - Retrieving the record \" + nb_line_";
