...
public class TSAPHanaRowEndJava
{
  protected static String nl;
  public static synchronized TSAPHanaRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaRowEndJava result = new TSAPHanaRowEndJava();
    nl = null;
    return result;
  }
