...
public class TMemSQLInputEndJava
{
  protected static String nl;
  public static synchronized TMemSQLInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLInputEndJava result = new TMemSQLInputEndJava();
    nl = null;
    return result;
  }
