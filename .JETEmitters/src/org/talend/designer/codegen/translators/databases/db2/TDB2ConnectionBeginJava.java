...
public class TDB2ConnectionBeginJava
{
  ...
  protected final String TEXT_132 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_140 = NL + "\tif (null != conn_";
  ...
  protected final String TEXT_147 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_148 = "\", ";
  protected final String TEXT_149 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_150 = "\", ";
  protected final String TEXT_151 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_152 = "\", dbUser_";
  protected final String TEXT_153 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_154 = "\", dbPwd_";
