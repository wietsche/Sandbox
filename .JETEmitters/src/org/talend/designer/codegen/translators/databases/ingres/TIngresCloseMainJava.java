...
public class TIngresCloseMainJava
{
  protected static String nl;
  public static synchronized TIngresCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresCloseMainJava result = new TIngresCloseMainJava();
    nl = null;
    return result;
  }
