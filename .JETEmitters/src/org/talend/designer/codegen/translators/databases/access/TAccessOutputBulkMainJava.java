...
public class TAccessOutputBulkMainJava
{
  ...
  protected final String TEXT_35 = ".write(OUT_FIELDS_ENCLOSURE_";
  protected final String TEXT_36 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_37 = NL + "    \t\t\t\t\tout";
  protected final String TEXT_38 = ".write(" + NL + "    \t\t\t\t";
  ...
  protected final String TEXT_53 = ".write(OUT_FIELDS_ENCLOSURE_";
  protected final String TEXT_54 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_55 = NL + "\t    \t\t\t\t} " + NL + "\t\t\t\t\t";
  protected final String TEXT_56 = "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\tout";
  protected final String TEXT_57 = ".write(OUT_DELIM_";
  protected final String TEXT_58 = ");";
  protected final String TEXT_59 = NL + "    \t\t\tout";
  protected final String TEXT_60 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_61 = ");" + NL + "    \t\t\tnb_line_";
  protected final String TEXT_62 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_64 = " - Writing the record \" + nb_line_";
