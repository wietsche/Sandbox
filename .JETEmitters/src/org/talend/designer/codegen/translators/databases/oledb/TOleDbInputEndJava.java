...
public class TOleDbInputEndJava
{
  ...
  protected final String TEXT_41 = NL + "oBool_";
  protected final String TEXT_42 = " = (Boolean)reader_";
  protected final String TEXT_43 = ".invokeGeneric(\"Read\");" + NL + "bool_";
  protected final String TEXT_44 = " = oBool_";
  protected final String TEXT_45 = " != null && oBool_";
  protected final String TEXT_46 = ".booleanValue();" + NL + "}" + NL + "//stmt_";
  protected final String TEXT_47 = ".close();" + NL + "//conn_";
  protected final String TEXT_48 = " .close();" + NL + "globalMap.put(\"";
