...
public class TSybaseOutputEndJava
{
  ...
  protected final String TEXT_98 = ".execute(\"SET IDENTITY_INSERT \"+ ";
  protected final String TEXT_99 = " +\" OFF\");" + NL + "        stmt_";
  ...
  protected final String TEXT_108 = NL + "        resourceMap.put(\"finish_";
