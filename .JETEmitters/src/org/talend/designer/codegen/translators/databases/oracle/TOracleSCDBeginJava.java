...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_113 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  ...
  protected final String TEXT_121 = NL + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_122 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_123 = " = null;";
  protected final String TEXT_124 = NL + "        String searching_";
  protected final String TEXT_125 = " = \"";
  protected final String TEXT_126 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_127 = " = connection_";
  protected final String TEXT_128 = ".prepareStatement(searching_";
  protected final String TEXT_129 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_130 = " = null;";
  protected final String TEXT_131 = NL + "        String search_";
  protected final String TEXT_132 = " = \"";
  protected final String TEXT_133 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_134 = " = connection_";
  protected final String TEXT_135 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_136 = " = statement_";
  protected final String TEXT_137 = ".executeQuery(search_";
  protected final String TEXT_138 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_139 = ", SCDStruct_";
  protected final String TEXT_140 = "> cache_";
  protected final String TEXT_141 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_142 = ", SCDStruct_";
  protected final String TEXT_143 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_144 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_145 = " sk_";
  protected final String TEXT_146 = " = new SCDSK_";
  protected final String TEXT_147 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_148 = " row_";
  protected final String TEXT_149 = " = new SCDStruct_";
  protected final String TEXT_150 = "();";
  protected final String TEXT_151 = NL + "                    tmpValue_";
  protected final String TEXT_152 = " = resultSet_";
  protected final String TEXT_153 = ".getString(";
  protected final String TEXT_154 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_155 = " != null && tmpValue_";
  protected final String TEXT_156 = ".length() > 0) {";
  protected final String TEXT_157 = NL + "                        ";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = " = tmpValue_";
  protected final String TEXT_160 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_161 = NL + "                            if(tmpValue_";
  protected final String TEXT_162 = " == null) {";
  protected final String TEXT_163 = NL + "                                ";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " = null;" + NL + "                            } else {";
  protected final String TEXT_166 = NL + "                                ";
  protected final String TEXT_167 = ".";
  protected final String TEXT_168 = " = '\\0';" + NL + "                            }";
  protected final String TEXT_169 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_170 = ")) {";
  protected final String TEXT_171 = NL + "                                ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_174 = "' in '";
  protected final String TEXT_175 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_176 = NL + "                    }";
  protected final String TEXT_177 = NL + "\t                    if(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_178 = ").getTIMESTAMPTZ(";
  protected final String TEXT_179 = ") != null){" + NL + "\t                    \t";
  protected final String TEXT_180 = ".";
  protected final String TEXT_181 = " = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) resultSet_";
  protected final String TEXT_182 = ").getTIMESTAMPTZ(";
  protected final String TEXT_183 = ").toBytes());" + NL + "\t                    }else{" + NL + "\t                    \t";
  protected final String TEXT_184 = ".";
  protected final String TEXT_185 = " = null;" + NL + "\t                    }" + NL + "\t                ";
  protected final String TEXT_186 = NL + "\t                    timestamp_";
  protected final String TEXT_187 = " = resultSet_";
  protected final String TEXT_188 = ".getTimestamp(";
  protected final String TEXT_189 = ");" + NL + "\t                    if(timestamp_";
  protected final String TEXT_190 = " != null) {" + NL + "\t                        ";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = new java.util.Date(timestamp_";
  protected final String TEXT_193 = ".getTime());" + NL + "\t                    } else {" + NL + "\t                        ";
  protected final String TEXT_194 = ".";
  protected final String TEXT_195 = " = null;" + NL + "\t                    }";
  protected final String TEXT_196 = NL + "                    if(resultSet_";
  protected final String TEXT_197 = ".getObject(";
  protected final String TEXT_198 = ") != null) {";
  protected final String TEXT_199 = NL + "                        ";
  protected final String TEXT_200 = ".";
  protected final String TEXT_201 = " = resultSet_";
  protected final String TEXT_202 = ".get";
  protected final String TEXT_203 = "(";
  protected final String TEXT_204 = ");" + NL + "                    }";
  protected final String TEXT_205 = NL + "            cache_";
  protected final String TEXT_206 = ".put(sk_";
  protected final String TEXT_207 = ", row_";
  protected final String TEXT_208 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_209 = ".close();" + NL + "        statement_";
  protected final String TEXT_210 = ".close();";
  protected final String TEXT_211 = NL + "            System.out.println(\"[";
  protected final String TEXT_212 = "] comparison cache loaded\");";
  protected final String TEXT_213 = NL + "        ";
  protected final String TEXT_214 = " nextSurrogateKey_";
  protected final String TEXT_215 = " = 1;";
  protected final String TEXT_216 = NL + "            if(cache_";
  protected final String TEXT_217 = ".size() > 0) {";
  protected final String TEXT_218 = NL + "        String tmpQuery_";
  protected final String TEXT_219 = " = \"SELECT MAX(";
  protected final String TEXT_220 = ") FROM \" + tableName_";
  protected final String TEXT_221 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_222 = " = connection_";
  protected final String TEXT_223 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_224 = " = tmpStmt_";
  protected final String TEXT_225 = ".executeQuery(tmpQuery_";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + "        if(tmpRS_";
  protected final String TEXT_228 = ".next() && tmpRS_";
  protected final String TEXT_229 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_230 = " = tmpRS_";
  protected final String TEXT_231 = ".get";
  protected final String TEXT_232 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_233 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_234 = ".close();";
  protected final String TEXT_235 = NL + "            }";
  protected final String TEXT_236 = NL + "    String insertionSQL_";
  protected final String TEXT_237 = " = \"";
  protected final String TEXT_238 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_239 = " = connection_";
  protected final String TEXT_240 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_241 = ");";
  protected final String TEXT_242 = NL + "            insertionStatement_";
  protected final String TEXT_243 = ".setTimestamp(";
  protected final String TEXT_244 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_245 = "\")));";
  protected final String TEXT_246 = NL + "            insertionStatement_";
  protected final String TEXT_247 = ".setNull(";
  protected final String TEXT_248 = ", java.sql.Types.DATE);";
  protected final String TEXT_249 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = ";" + NL + "            String datePattern_";
  protected final String TEXT_252 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_253 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_254 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_255 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_256 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_257 = ".setTimestamp(";
  protected final String TEXT_258 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_259 = ").parse(";
  protected final String TEXT_260 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_261 = ").getTime()));";
  protected final String TEXT_262 = NL + "        String updateSQLForType1_";
  protected final String TEXT_263 = " = \"";
  protected final String TEXT_264 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_265 = " = connection_";
  protected final String TEXT_266 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = NL + "        String updateSQLForType2_";
  protected final String TEXT_269 = " = \"";
  protected final String TEXT_270 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_271 = " = connection_";
  protected final String TEXT_272 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_273 = ");";
  protected final String TEXT_274 = NL + "            updateForType2_";
  protected final String TEXT_275 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_276 = "\")));";
  protected final String TEXT_277 = NL + "        String updateSQLForType3_";
  protected final String TEXT_278 = " = \"";
  protected final String TEXT_279 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_280 = " = connection_";
  protected final String TEXT_281 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_282 = ");";
  protected final String TEXT_283 = NL;
  protected final String TEXT_284 = NL + "        SCDSK_";
  protected final String TEXT_285 = " lookUpKey_";
  protected final String TEXT_286 = " = null;";
  protected final String TEXT_287 = NL + "    SCDStruct_";
  protected final String TEXT_288 = " lookUpValue_";
