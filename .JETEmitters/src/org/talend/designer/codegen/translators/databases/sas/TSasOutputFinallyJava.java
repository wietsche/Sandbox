...
public class TSasOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSasOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSasOutputFinallyJava result = new TSasOutputFinallyJava();
    nl = null;
    return result;
  }
