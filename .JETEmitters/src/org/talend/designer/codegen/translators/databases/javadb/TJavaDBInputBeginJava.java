...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_174 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_177 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_178 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_179 = "),Integer.parseInt(";
  protected final String TEXT_180 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_181 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_182 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_183 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_184 = " && timeOut_";
  protected final String TEXT_185 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_186 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_187 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_188 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_189 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_190 = NL + "\t\t\t\tString url_";
  protected final String TEXT_191 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_192 = ";";
  protected final String TEXT_193 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_194 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_195 = " + \":\" + ";
  protected final String TEXT_196 = " + \"/\" + ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_199 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_200 = " + \":\" + ";
  protected final String TEXT_201 = " + \"/\" + ";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "\t\t\t    String driverClass_";
  protected final String TEXT_204 = " = \"";
  protected final String TEXT_205 = "\";" + NL + "\t\t\t    java.lang.Class.forName(driverClass_";
  protected final String TEXT_206 = ").newInstance();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_237 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_238 = " =  conn_";
  protected final String TEXT_239 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_240 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_241 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_242 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_243 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_244 = NL + "                 conn_";
  protected final String TEXT_245 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_246 = NL + "               ";
  protected final String TEXT_247 = " + \"=\" + ";
  protected final String TEXT_248 = " + \";\" +";
  protected final String TEXT_249 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_250 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_251 = ");";
  protected final String TEXT_252 = NL + "\t\t    ";
  protected final String TEXT_253 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ";" + NL + "\t\t\t";
  protected final String TEXT_256 = NL + "                log.info(\"";
  protected final String TEXT_257 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_258 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_259 = NL;
  protected final String TEXT_260 = NL + "                       globalMap.put(\"";
  protected final String TEXT_261 = "_QUERY\",dbquery_";
  protected final String TEXT_262 = ");";
  protected final String TEXT_263 = NL + "                       globalMap.put(\"";
  protected final String TEXT_264 = "_QUERY\",dbquery_";
  protected final String TEXT_265 = ");";
  protected final String TEXT_266 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_267 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_268 = " = stmt_";
  protected final String TEXT_269 = ".executeQuery(dbquery_";
  protected final String TEXT_270 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_271 = " = rs_";
  protected final String TEXT_272 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_273 = " = rsmd_";
  protected final String TEXT_274 = ".getColumnCount();" + NL;
  protected final String TEXT_275 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_276 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_277 = ".setDbmsId(\"";
  protected final String TEXT_278 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_279 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_280 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_281 = ".add(\"";
  protected final String TEXT_282 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_283 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_284 = " = ";
  protected final String TEXT_285 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_286 = "; i <= rsmd_";
  protected final String TEXT_287 = ".getColumnCount()-";
  protected final String TEXT_288 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_289 = ".contains(rsmd_";
  protected final String TEXT_290 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_291 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setName(rsmd_";
  protected final String TEXT_293 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_294 = ".setDbName(rsmd_";
  protected final String TEXT_295 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_296 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_297 = "\", rsmd_";
  protected final String TEXT_298 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_299 = ".getPrecision(i), rsmd_";
  protected final String TEXT_300 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setDbType(rsmd_";
  protected final String TEXT_302 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setDbTypeId(rsmd_";
  protected final String TEXT_304 = ".getColumnType(i));";
  protected final String TEXT_305 = NL + "                \tdcm_";
  protected final String TEXT_306 = ".setFormat(";
  protected final String TEXT_307 = ");";
  protected final String TEXT_308 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_309 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_310 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_311 = ".setLength(rsmd_";
  protected final String TEXT_312 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_313 = ".setLength(rsmd_";
  protected final String TEXT_314 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_315 = NL + "\t\t\tdcm_";
  protected final String TEXT_316 = ".setLength(rsmd_";
  protected final String TEXT_317 = ".getPrecision(i));";
  protected final String TEXT_318 = NL + "                \tdcm_";
  protected final String TEXT_319 = ".setPrecision(rsmd_";
  protected final String TEXT_320 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_321 = ".setNullable(rsmd_";
  protected final String TEXT_322 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_323 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_324 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_325 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_326 = ".metadatas.add(dcm_";
  protected final String TEXT_327 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_328 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_329 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_330 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_331 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_332 = NL + "\t\t    ";
  protected final String TEXT_333 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_334 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_335 = NL + "\t\t    while (rs_";
  protected final String TEXT_336 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_337 = "++;" + NL + "\t\t        ";
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_339 = " = ";
  protected final String TEXT_340 = " + dcg_";
  protected final String TEXT_341 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_343 = " = ";
  protected final String TEXT_344 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_347 = " < ";
  protected final String TEXT_348 = "column_index_";
  protected final String TEXT_349 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_350 = ".";
  protected final String TEXT_351 = " = ";
  protected final String TEXT_352 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_353 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t                            ";
  protected final String TEXT_357 = ".";
  protected final String TEXT_358 = " = (List)rs_";
  ...
  protected final String TEXT_365 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_366 = ".getObject(";
  protected final String TEXT_367 = "column_index_";
  protected final String TEXT_368 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_369 = NL + "                                    ";
  protected final String TEXT_370 = ".";
  protected final String TEXT_371 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_380 = ".setEPSG(";
  protected final String TEXT_381 = ");" + NL + "                                        }";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "                                  ";
  protected final String TEXT_384 = ".";
  protected final String TEXT_385 = "=dcg_";
  protected final String TEXT_386 = ";";
  protected final String TEXT_387 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_388 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_389 = " = ";
  protected final String TEXT_390 = "; i_";
  protected final String TEXT_391 = "  <= rsmd_";
  protected final String TEXT_392 = ".getColumnCount(); i_";
  protected final String TEXT_393 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_394 = ".getColumnTypeName(i_";
  protected final String TEXT_395 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_396 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_397 = ".getClob(i_";
  protected final String TEXT_398 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_399 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_400 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_401 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_402 = ".add(tNTextImpl_";
  protected final String TEXT_403 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_404 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_405 = ".";
  protected final String TEXT_406 = ", rs_";
  protected final String TEXT_407 = ", fixedColumnCount_";
  protected final String TEXT_408 = ",list_";
  protected final String TEXT_409 = ",";
  protected final String TEXT_410 = ");";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = ", rs_";
  protected final String TEXT_414 = ", fixedColumnCount_";
  protected final String TEXT_415 = ",";
  protected final String TEXT_416 = ");";
  protected final String TEXT_417 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_418 = ".";
  protected final String TEXT_419 = ", rs_";
  protected final String TEXT_420 = ", fixedColumnCount_";
  protected final String TEXT_421 = ",";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL + "                                  Object geom = rs_";
  protected final String TEXT_424 = ".getObject(";
  protected final String TEXT_425 = "column_index_";
  protected final String TEXT_426 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  ...
  protected final String TEXT_434 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_435 = " - Retrieving the record \" + nb_line_";
