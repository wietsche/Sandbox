...
public class TVerticaRollbackMainJava
{
  protected static String nl;
  public static synchronized TVerticaRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaRollbackMainJava result = new TVerticaRollbackMainJava();
    nl = null;
    return result;
  }
