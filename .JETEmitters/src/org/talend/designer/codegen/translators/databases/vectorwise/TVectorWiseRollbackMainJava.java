...
public class TVectorWiseRollbackMainJava
{
  protected static String nl;
  public static synchronized TVectorWiseRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseRollbackMainJava result = new TVectorWiseRollbackMainJava();
    nl = null;
    return result;
  }
