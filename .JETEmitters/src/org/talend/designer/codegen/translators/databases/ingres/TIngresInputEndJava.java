...
public class TIngresInputEndJava
{
  protected static String nl;
  public static synchronized TIngresInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresInputEndJava result = new TIngresInputEndJava();
    nl = null;
    return result;
  }
