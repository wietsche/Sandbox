...
public class TPostgresPlusCommitMainJava
{
  protected static String nl;
  public static synchronized TPostgresPlusCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusCommitMainJava result = new TPostgresPlusCommitMainJava();
    nl = null;
    return result;
  }
