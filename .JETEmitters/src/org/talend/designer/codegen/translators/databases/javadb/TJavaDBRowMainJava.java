...
public class TJavaDBRowMainJava
{
  protected static String nl;
  public static synchronized TJavaDBRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaDBRowMainJava result = new TJavaDBRowMainJava();
    nl = null;
    return result;
  }
