...
public class TMysqlColumnListEndJava
{
  protected static String nl;
  public static synchronized TMysqlColumnListEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlColumnListEndJava result = new TMysqlColumnListEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "}" + NL + "stmt2_";
  protected final String TEXT_71 = ".close();" + NL + "globalMap.put(\"";
  protected final String TEXT_72 = "_NB_COLUMN\", nb_column_";
