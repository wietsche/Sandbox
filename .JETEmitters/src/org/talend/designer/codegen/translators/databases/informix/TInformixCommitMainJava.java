...
public class TInformixCommitMainJava
{
  protected static String nl;
  public static synchronized TInformixCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixCommitMainJava result = new TInformixCommitMainJava();
    nl = null;
    return result;
  }
