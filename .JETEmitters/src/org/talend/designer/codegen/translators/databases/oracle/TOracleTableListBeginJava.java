...
public class TOracleTableListBeginJava
{
  ...
  protected final String TEXT_74 = NL + "\tString statement_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";";
  protected final String TEXT_77 = NL + "\tString statement_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";";
  protected final String TEXT_80 = NL + NL + "String query_";
  protected final String TEXT_81 = " = \"\";" + NL + "" + NL + "if(statement_";
  protected final String TEXT_82 = " != null && statement_";
  protected final String TEXT_83 = ".length() > 0){";
  protected final String TEXT_84 = NL + "\tquery_";
  protected final String TEXT_85 = " = \"SELECT TABLE_NAME FROM ";
  protected final String TEXT_86 = " WHERE (\" + statement_";
  protected final String TEXT_87 = " + \") ORDER BY TABLE_NAME ASC\";";
  protected final String TEXT_88 = NL + "\tquery_";
  protected final String TEXT_89 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' AND (\" + statement_";
  protected final String TEXT_90 = " + \") ORDER BY tname ASC\";";
  protected final String TEXT_91 = NL + "\tquery_";
  protected final String TEXT_92 = " = statement_";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + NL + "}else{";
  protected final String TEXT_95 = NL + "\tquery_";
  protected final String TEXT_96 = " = \"SELECT TABLE_NAME FROM ";
  protected final String TEXT_97 = " ORDER BY TABLE_NAME ASC\";";
  protected final String TEXT_98 = NL + "\tquery_";
  protected final String TEXT_99 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' ORDER BY tname ASC\";";
  protected final String TEXT_100 = NL + "\tquery_";
  protected final String TEXT_101 = " = \"SELECT TABLE_NAME FROM USER_TABLES ORDER BY TABLE_NAME ASC\";";
  protected final String TEXT_102 = NL + "}";
  protected final String TEXT_103 = NL + "    log.info(\"";
  protected final String TEXT_104 = " - Query:'\"+query_";
  protected final String TEXT_105 = "+\"'.\");";
  protected final String TEXT_106 = NL + NL + "int nb_table_";
  protected final String TEXT_107 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_110 = " = stmt2_";
  protected final String TEXT_111 = ".executeQuery(query_";
  protected final String TEXT_112 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_113 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_114 = " = rs_";
  protected final String TEXT_115 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_116 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_117 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_118 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_119 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_120 = " - Name of table \"+nb_table_";
  protected final String TEXT_121 = "+\":\"+currentTableName_";
  protected final String TEXT_122 = "+\".\");" + NL + "\t";
  protected final String TEXT_123 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_124 = "_CURRENT_TABLE\", currentTableName_";
