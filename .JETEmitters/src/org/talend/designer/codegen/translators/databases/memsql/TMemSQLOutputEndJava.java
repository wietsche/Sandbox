...
public class TMemSQLOutputEndJava
{
  protected static String nl;
  public static synchronized TMemSQLOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLOutputEndJava result = new TMemSQLOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_56 = NL + "                    if(batchSizeCounter_";
  protected final String TEXT_57 = " > 0){" + NL + "                        long countSum_";
  protected final String TEXT_58 = " = 0;" + NL + "                        int[] resultStatus = {};" + NL + "                        try {" + NL + "                            if (pstmt_";
  protected final String TEXT_59 = " != null) {";
  protected final String TEXT_60 = NL + "                               resultStatus = pstmt_";
  protected final String TEXT_61 = ".executeBatch();";
  protected final String TEXT_62 = NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_63 = "){";
  protected final String TEXT_64 = NL + "                                throw(e_";
  protected final String TEXT_65 = ");";
  protected final String TEXT_66 = NL + "                            System.out.println(e_";
  protected final String TEXT_67 = ".getMessage());" + NL + "                            for(int countEach_";
  protected final String TEXT_68 = ": e_";
  protected final String TEXT_69 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  protected final String TEXT_70 = " += (countEach_";
  protected final String TEXT_71 = " < 0 ? 0 : countEach_";
  protected final String TEXT_72 = ");" + NL + "                                }";
  protected final String TEXT_73 = NL + "                        }" + NL + "" + NL + "                        if (pstmt_";
  protected final String TEXT_74 = " != null) {" + NL + "                        " + NL + "                            long tmp_batchUpdateCount_";
  protected final String TEXT_75 = " = 0;" + NL + "                            for(int i : resultStatus){" + NL + "                                  if(i==-3){//EXECUTE_FAILED";
  protected final String TEXT_76 = NL + "                                        System.err.println(\"Query failed to execute.\");" + NL + "                                  }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_77 = NL + "                                        System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                                  }else{" + NL + "                                       tmp_batchUpdateCount_";
  protected final String TEXT_78 = " += (i<0 ? 0 : i);" + NL + "                                  }" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_79 = " += countSum_";
  protected final String TEXT_80 = ";" + NL + "                            ";
  protected final String TEXT_81 = NL + "                                insertedCount_";
  protected final String TEXT_82 = NL + "                                updatedCount_";
  protected final String TEXT_83 = NL + "                                deletedCount_";
  protected final String TEXT_84 = NL + "                            += tmp_batchUpdateCount_";
  protected final String TEXT_85 = ";" + NL + "                        }" + NL + "                    }";
  protected final String TEXT_86 = NL + NL + "        if(pstmt_";
  ...
  protected final String TEXT_91 = " != null && !conn_";
  protected final String TEXT_92 = ".isClosed()) {";
  protected final String TEXT_93 = NL + "            conn_";
  protected final String TEXT_94 = " .close();";
  protected final String TEXT_95 = NL + "            resourceMap.put(\"finish_";
  protected final String TEXT_96 = "\", true);" + NL + "        }";
  protected final String TEXT_97 = NL;
  protected final String TEXT_98 = NL + "\tnb_line_deleted_";
  protected final String TEXT_99 = "=nb_line_deleted_";
  protected final String TEXT_100 = "+ deletedCount_";
  ...
  protected final String TEXT_104 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_105 = "=nb_line_inserted_";
  protected final String TEXT_106 = " + insertedCount_";
  protected final String TEXT_107 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_108 = "=nb_line_rejected_";
  protected final String TEXT_109 = " + rejectedCount_";
  protected final String TEXT_110 = ";" + NL + "\t";
  protected final String TEXT_111 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_113 = "_NB_LINE\",nb_line_";
  protected final String TEXT_114 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_115 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_116 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_117 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_119 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_120 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_121 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_122 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_123 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_124 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_125 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_126 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_127 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_130 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_131 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_132 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_133 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_134 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_135 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_136 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_137 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_138 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_139 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_140 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_145 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_146 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_147 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_148 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_149 = "_NB_LINE_DELETED\",nb_line_deleted_";
