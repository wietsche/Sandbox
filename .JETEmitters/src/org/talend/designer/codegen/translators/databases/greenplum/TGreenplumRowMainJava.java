...
public class TGreenplumRowMainJava
{
  protected static String nl;
  public static synchronized TGreenplumRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumRowMainJava result = new TGreenplumRowMainJava();
    nl = null;
    return result;
  }
