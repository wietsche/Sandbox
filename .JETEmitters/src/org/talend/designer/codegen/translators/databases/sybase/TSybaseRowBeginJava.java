...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_122 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_123 = " + \":\" + ";
  protected final String TEXT_124 = " + \"/\" + ";
  protected final String TEXT_125 = "; " + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tString url_";
  protected final String TEXT_127 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \"/\" + ";
  protected final String TEXT_130 = " + \"?\" + ";
  protected final String TEXT_131 = ";" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\tString tableName_";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = " ;" + NL + "\t\t\t\tString dbschema_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "\t\t\t\tif (dbschema_";
  ...
  protected final String TEXT_141 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_142 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_143 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_144 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_145 = " = null;" + NL + "\tString query_";
  protected final String TEXT_146 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_147 = " = false;";
  protected final String TEXT_148 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".prepareStatement(";
