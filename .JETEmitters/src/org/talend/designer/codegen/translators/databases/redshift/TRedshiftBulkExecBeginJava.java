...
public class TRedshiftBulkExecBeginJava {
  ...
  protected final String TEXT_441 = ".append(\"s3://\").append(";
  protected final String TEXT_442 = ").append(\"/\").append(";
  protected final String TEXT_443 = ")" + NL + "\t.append(\"' \")" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_444 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_445 = ")";
  protected final String TEXT_446 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_447 = ")";
  protected final String TEXT_448 = NL + "\t.append(\"' \")";
  protected final String TEXT_449 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_450 = ").append(\"' \")";
  protected final String TEXT_451 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_452 = ").append(\"' \")";
  protected final String TEXT_453 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_454 = ").append(\"' \")";
  protected final String TEXT_455 = NL + "\t;";
  protected final String TEXT_456 = NL + "\tif(textEnclosure_";
  protected final String TEXT_457 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_458 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_459 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_460 = NL + "\tcommand_";
  protected final String TEXT_461 = ".append(\"ENCODING \").append(";
  protected final String TEXT_462 = ").append(\" \")";
  protected final String TEXT_463 = NL + "\t\t\t.append(\"";
  protected final String TEXT_464 = " '\").append(";
  protected final String TEXT_465 = ").append(\"' \")";
  protected final String TEXT_466 = NL + "\t\t\t.append(\"";
  protected final String TEXT_467 = " \")";
  protected final String TEXT_468 = NL + "\t\t\t.append(\"";
  protected final String TEXT_469 = " \").append(";
  protected final String TEXT_470 = ").append(\" \")";
  protected final String TEXT_471 = NL + "\t\t\t.append(\"MAXERROR \").append(";
  protected final String TEXT_472 = ").append(\" \")";
  protected final String TEXT_473 = NL + "\t\t\t\t.append(\"ACCEPTINVCHARS \")";
  protected final String TEXT_474 = NL + "\t\t\t\t.append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_475 = ").append(\"' \")";
  protected final String TEXT_476 = NL + "\t\t\t\t.append(\"";
  protected final String TEXT_477 = " ON\")";
  protected final String TEXT_478 = NL + "\t\t\t\t.append(\"";
  protected final String TEXT_479 = " OFF\")";
  protected final String TEXT_480 = NL + "\t\t.append(\"ENCRYPTED \")";
  protected final String TEXT_481 = NL + "\t\t.append(\"";
  protected final String TEXT_482 = " \")";
  protected final String TEXT_483 = NL + "\t\t.append(\"DATEFORMAT '\").append(";
  protected final String TEXT_484 = ").append(\"' \")";
  protected final String TEXT_485 = NL + "\t\t.append(\"DATEFORMAT 'auto' \")";
  protected final String TEXT_486 = NL + "\t\t.append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_487 = ").append(\"' \")";
  protected final String TEXT_488 = NL + "\t\t.append(\"TIMEFORMAT 'auto' \")";
  protected final String TEXT_489 = NL + "\t\t.append(\"TIMEFORMAT 'epochsecs' \")";
  protected final String TEXT_490 = NL + "\t\t.append(\"TIMEFORMAT 'epochmillisecs' \")";
  protected final String TEXT_491 = NL + "\t;" + NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_492 = "=conn_";
  protected final String TEXT_493 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_494 = ".execute(command_";
  protected final String TEXT_495 = ".toString());";
  protected final String TEXT_496 = NL + "\t\tif(stmt_";
  protected final String TEXT_497 = ".getWarnings()!=null) {";
  protected final String TEXT_498 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_499 = " - \" + stmt_";
  protected final String TEXT_500 = ".getWarnings().getMessage());";
  protected final String TEXT_501 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_502 = ".getWarnings().getMessage());";
  protected final String TEXT_503 = NL + "\t\t}";
  protected final String TEXT_504 = NL + "\t";
  protected final String TEXT_505 = NL + "\t\tlog.info(\"";
  protected final String TEXT_506 = " - Finish loading data to table : \" + tableName2_";
