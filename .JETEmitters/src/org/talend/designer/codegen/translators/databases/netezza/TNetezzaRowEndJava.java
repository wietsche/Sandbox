...
public class TNetezzaRowEndJava
{
  protected static String nl;
  public static synchronized TNetezzaRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaRowEndJava result = new TNetezzaRowEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "        stmt_";
  protected final String TEXT_71 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_72 = " +\" OFF\");" + NL + "\t";
  ...
  protected final String TEXT_78 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_79 = ">commitCounter_";
  ...
  protected final String TEXT_84 = "_NB_EFFECTED\",nb_";
...
log4jCodeGenerateUtil.logInfo(node,"info",cid+" - Has effected \"+nb_"+cid + "+\" records.");
