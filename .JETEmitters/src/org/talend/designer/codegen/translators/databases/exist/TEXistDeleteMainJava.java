...
public class TEXistDeleteMainJava
{
  ...
  protected final String TEXT_47 = "){" + NL + "\t\tString filemask_";
  protected final String TEXT_48 = " = key_";
  protected final String TEXT_49 = "; " + NL + "\t\tString dir_";
  protected final String TEXT_50 = " = null;\t" + NL + "\t\tString mask_";
  protected final String TEXT_51 = " = filemask_";
  protected final String TEXT_52 = ".replaceAll(\"\\\\\\\\\", \"/\") ;\t" + NL + "\t\tint i_";
  protected final String TEXT_53 = " = mask_";
  protected final String TEXT_54 = ".lastIndexOf('/');" + NL + "  \t\tif (i_";
  protected final String TEXT_55 = "!=-1){" + NL + "\t\t\tdir_";
  protected final String TEXT_56 = " = mask_";
  protected final String TEXT_57 = ".substring(0, i_";
  protected final String TEXT_58 = "); " + NL + "\t\t\tmask_";
  protected final String TEXT_59 = " = mask_";
  protected final String TEXT_60 = ".substring(i_";
  protected final String TEXT_61 = "+1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tmask_";
  protected final String TEXT_62 = " = mask_";
  protected final String TEXT_63 = ".replaceAll(\"\\\\.\", \"\\\\\\\\.\").replaceAll(\"\\\\*\", \".*\");" + NL + "\t\tfinal String finalMask_";
  protected final String TEXT_64 = " = mask_";
  protected final String TEXT_65 = ";";
  protected final String TEXT_66 = NL + "\t\t\tfor(String resourceName_";
  protected final String TEXT_67 = " : col_";
  protected final String TEXT_68 = ".listResources()){" + NL + "\t\t\t\tif(resourceName_";
  protected final String TEXT_69 = ".matches(finalMask_";
  protected final String TEXT_70 = ")){" + NL + "\t\t\t        org.xmldb.api.base.Resource resource_";
  protected final String TEXT_71 = " = col_";
  protected final String TEXT_72 = ".getResource(resourceName_";
  protected final String TEXT_73 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_74 = NL + "\t\t\t        col_";
  protected final String TEXT_75 = ".removeResource(resource_";
  protected final String TEXT_76 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_77 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_78 = NL + "\t\t\tfor(String subCol_";
  protected final String TEXT_79 = " : col_";
  protected final String TEXT_80 = ".listChildCollections()){" + NL + "\t\t\t\tif(subCol_";
  protected final String TEXT_81 = ".matches(finalMask_";
  protected final String TEXT_82 = ")){" + NL + "\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\tmgtService_";
  protected final String TEXT_84 = ".removeCollection(subCol_";
  protected final String TEXT_85 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_87 = NL + "\t\t\tfor(String resourceName_";
  protected final String TEXT_88 = " : col_";
  protected final String TEXT_89 = ".listResources()){" + NL + "\t\t\t\tif(resourceName_";
  protected final String TEXT_90 = ".matches(finalMask_";
  protected final String TEXT_91 = ")){" + NL + "\t\t\t        org.xmldb.api.base.Resource resource_";
  protected final String TEXT_92 = " = col_";
  protected final String TEXT_93 = ".getResource(resourceName_";
  protected final String TEXT_94 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_95 = NL + "\t\t\t        col_";
  protected final String TEXT_96 = ".removeResource(resource_";
  protected final String TEXT_97 = ");" + NL + "\t\t\t        ";
  protected final String TEXT_98 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tfor(String subCol_";
  protected final String TEXT_99 = " : col_";
  protected final String TEXT_100 = ".listChildCollections()){" + NL + "\t\t\t\tif(subCol_";
  protected final String TEXT_101 = ".matches(finalMask_";
  protected final String TEXT_102 = ")){" + NL + "\t\t\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\tmgtService_";
  protected final String TEXT_104 = ".removeCollection(subCol_";
  protected final String TEXT_105 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_107 = NL + "\t\tnb_file_";
