...
public class TJDBCSPBeginJava
{
  ...
  protected final String TEXT_46 = " " + NL + "\t\tif (null == connection_";
  protected final String TEXT_47 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_48 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconnection_";
  protected final String TEXT_49 = " = dataSources_";
  protected final String TEXT_50 = ".get(";
  protected final String TEXT_51 = ").getConnection();" + NL + "\t\t}";
  protected final String TEXT_52 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_60 = NL + "\t\t\tjava.lang.Class.forName(";
  ...
  protected final String TEXT_74 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_75 = ", ";
  protected final String TEXT_76 = ", decryptedPassword_";
  protected final String TEXT_77 = ");" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t";
  protected final String TEXT_79 = NL + "\t\t}";
  protected final String TEXT_80 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_81 = " = connection_";
  protected final String TEXT_82 = ".prepareCall(\"{";
  protected final String TEXT_83 = "call \" + ";
  protected final String TEXT_84 = " + \"(";
  protected final String TEXT_85 = "?";
  protected final String TEXT_86 = ",?";
  protected final String TEXT_87 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_88 = ";" + NL + "String tmpString_";
