...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_123 = NL + "                if(log.is";
  protected final String TEXT_124 = "Enabled())";
  ...
  protected final String TEXT_134 = ".append(\"Parameters:\");";
  protected final String TEXT_135 = NL + "                    ";
  protected final String TEXT_136 = ".append(\"";
  protected final String TEXT_137 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_138 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_145 = NL + "            StringBuilder ";
  protected final String TEXT_146 = " = new StringBuilder();    ";
  ...
  protected final String TEXT_155 = ".append(\"<null>\");" + NL + "                    }else{";
  protected final String TEXT_156 = NL + "                        ";
  protected final String TEXT_157 = ".append(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = ");" + NL + "                    }   ";
  protected final String TEXT_160 = NL + "                ";
  protected final String TEXT_161 = ".append(\"|\");";
  protected final String TEXT_162 = NL;
  protected final String TEXT_163 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_166 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_167 = " == null || dbProperties_";
  protected final String TEXT_168 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_169 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_170 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_171 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_172 = " + \"/\" + ";
  protected final String TEXT_173 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_174 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_175 = " = null;" + NL + "\tString query_";
  protected final String TEXT_176 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_180 = ".prepareStatement(";
  protected final String TEXT_181 = ");\t" + NL + "\t";
  protected final String TEXT_182 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement();" + NL + "\t";
  protected final String TEXT_185 = NL;
  protected final String TEXT_186 = NL + "\t";
  protected final String TEXT_187 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_188 = " =  conn_";
  protected final String TEXT_189 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_190 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_191 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_192 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_193 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_194 = NL + "                 conn_";
  protected final String TEXT_195 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_196 = NL + "               ";
  protected final String TEXT_197 = " + \"=\" + ";
  protected final String TEXT_198 = " + \";\" +";
  protected final String TEXT_199 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_200 = ".setAutoCommit(currentAutoCommitMode";
