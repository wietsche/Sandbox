...
public class TMSSqlRollbackMainJava
{
  protected static String nl;
  public static synchronized TMSSqlRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlRollbackMainJava result = new TMSSqlRollbackMainJava();
    nl = null;
    return result;
  }
