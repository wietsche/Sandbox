...
public class TParAccelRowBeginJava
{
  protected static String nl;
  public static synchronized TParAccelRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelRowBeginJava result = new TParAccelRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_122 = " = \"jdbc:paraccel://\"+";
  protected final String TEXT_123 = "+\":\"+";
  protected final String TEXT_124 = "+\"/\"+";
  protected final String TEXT_125 = ";" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_127 = " = null;" + NL + "\tString query_";
  protected final String TEXT_128 = " = \"\";" + NL + "\tboolean whetherReject_";
