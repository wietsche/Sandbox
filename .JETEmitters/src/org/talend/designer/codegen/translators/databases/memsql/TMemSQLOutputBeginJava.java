...
public class TMemSQLOutputBeginJava {
  protected static String nl;
  public static synchronized TMemSQLOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLOutputBeginJava result = new TMemSQLOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "           int batchSize_";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ";" + NL + "           int batchSizeCounter_";
  protected final String TEXT_46 = "=0;";
  protected final String TEXT_47 = NL + "            java.util.Calendar calendar_";
  protected final String TEXT_48 = " = java.util.Calendar.getInstance();" + NL + "            calendar_";
  protected final String TEXT_49 = ".set(1, 0, 1, 0, 0, 0);" + NL + "            long year1_";
  protected final String TEXT_50 = " = calendar_";
  protected final String TEXT_51 = ".getTime().getTime();" + NL + "            calendar_";
  protected final String TEXT_52 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "            long year10000_";
  protected final String TEXT_53 = " = calendar_";
  protected final String TEXT_54 = ".getTime().getTime();" + NL + "            long date_";
  ...
  protected final String TEXT_60 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_64 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_65 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_68 = " = false;";
  protected final String TEXT_69 = NL;
  protected final String TEXT_70 = NL + "        int updateKeyCount_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_73 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_74 = NL + "        int deleteKeyCount_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_77 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_83 = " =\"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_100 = NL + NL + "    String dbPwd_";
  protected final String TEXT_101 = " = decryptedPassword_";
  protected final String TEXT_102 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  ...
  protected final String TEXT_109 = NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_110 = "\", conn_";
  protected final String TEXT_111 = ");";
  protected final String TEXT_112 = NL;
  protected final String TEXT_113 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".createStatement();";
  protected final String TEXT_116 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_139 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_140 = ".equalsIgnoreCase(";
  protected final String TEXT_141 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_142 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_158 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_168 = " = deletedCount_";
  protected final String TEXT_169 = " + stmtClear_";
  protected final String TEXT_170 = ".executeUpdate(\"";
  protected final String TEXT_171 = "\");";
  protected final String TEXT_172 = NL + "\t    String insert_";
  protected final String TEXT_173 = " = \"INSERT INTO \" + ";
  protected final String TEXT_174 = " + \" (";
  protected final String TEXT_175 = ") VALUES (";
  protected final String TEXT_176 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_190 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_191 = " + \" WHERE ";
  protected final String TEXT_192 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_193 = " = \"INSERT INTO \" + ";
  protected final String TEXT_194 = " + \" (";
  protected final String TEXT_195 = ") VALUES (";
  protected final String TEXT_196 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".prepareStatement(insert_";
  protected final String TEXT_199 = ");" + NL + "\t    String update_";
  protected final String TEXT_200 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_214 = ");" + NL + "\t    String insert_";
  protected final String TEXT_215 = " = \"INSERT INTO \" + ";
  protected final String TEXT_216 = " + \" (";
  protected final String TEXT_217 = ") VALUES (";
  protected final String TEXT_218 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".prepareStatement(insert_";
  protected final String TEXT_221 = ");" + NL + "\t    ";
  protected final String TEXT_222 = NL + "\t    String delete_";
  protected final String TEXT_223 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_227 = ".prepareStatement(delete_";
  protected final String TEXT_228 = ");" + NL + "\t    ";
  protected final String TEXT_229 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_230 = " = null;" + NL + "       \t";
  protected final String TEXT_231 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_232 = " = insert_";
  protected final String TEXT_233 = ".split(\"\\\\?\");";
  protected final String TEXT_234 = NL + "\t\t\tupdate_";
  protected final String TEXT_235 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_236 = " = update_";
  protected final String TEXT_237 = ".split(\"\\\\?\");";
  protected final String TEXT_238 = NL + "\t\t\tupdate_";
  protected final String TEXT_239 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_240 = " = update_";
  protected final String TEXT_241 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_242 = " = insert_";
  protected final String TEXT_243 = ".split(\"\\\\?\");";
  protected final String TEXT_244 = NL + "\t\t\tdelete_";
  protected final String TEXT_245 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_246 = " = delete_";
  protected final String TEXT_247 = ".split(\"\\\\?\");";
  protected final String TEXT_248 = NL + "\t\t\treplace_";
  protected final String TEXT_249 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_250 = " = replace_";
  protected final String TEXT_251 = ".split(\"\\\\?\");";
  protected final String TEXT_252 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_253 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_254 = " = insertIgnore_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_257 = " = insert_";
...
DBLogUtil dbLog = null;
	...
	String javaDbDriver   = "com.mysql.jdbc.Driver";
...
List<IMetadataColumn> columnList_x = null;
List<IMetadataTable> metadatas_x = node.getMetadataList();
if ((metadatas_x!=null)&&(metadatas_x.size()>0)) {
    IMetadataTable metadata = metadatas_x.get(0);
    if (metadata!=null) {
        columnList_x = metadata.getListColumns();
    }
}

if(columnList_x!=null){
    for(IMetadataColumn column:columnList_x){
        String dataType = column.getType();
        if("DATE".equals(dataType) || "DATETIME".equals(dataType) || "TIME".equals(dataType) || "TIMESTAMP".equals(dataType) || "YEAR".equals(dataType)){
