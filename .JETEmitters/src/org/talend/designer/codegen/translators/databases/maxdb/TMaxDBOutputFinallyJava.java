...
public class TMaxDBOutputFinallyJava
{
  protected static String nl;
  public static synchronized TMaxDBOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMaxDBOutputFinallyJava result = new TMaxDBOutputFinallyJava();
    nl = null;
    return result;
  }
