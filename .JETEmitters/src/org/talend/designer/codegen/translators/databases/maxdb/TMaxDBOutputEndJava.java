...
public class TMaxDBOutputEndJava
{
  ...
  protected final String TEXT_65 = NL + "    " + NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_66 = "\", true);" + NL + "" + NL + "\tint rejectedCount_";
  protected final String TEXT_67 = " = 0;" + NL + "\t";
  protected final String TEXT_68 = NL + "\tnb_line_deleted_";
