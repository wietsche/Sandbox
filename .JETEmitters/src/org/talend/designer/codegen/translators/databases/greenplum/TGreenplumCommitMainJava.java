...
public class TGreenplumCommitMainJava
{
  protected static String nl;
  public static synchronized TGreenplumCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGreenplumCommitMainJava result = new TGreenplumCommitMainJava();
    nl = null;
    return result;
  }
