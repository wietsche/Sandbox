...
public class TJDBCInputEndJava
{
  ...
  protected final String TEXT_71 = NL + "\t}" + NL + "}finally{" + NL + "\tif(rs_";
  protected final String TEXT_72 = " !=null){" + NL + "\t\trs_";
  protected final String TEXT_73 = ".close();" + NL + "\t}" + NL + "\tstmt_";
  protected final String TEXT_74 = ".close();" + NL;
  protected final String TEXT_75 = NL + "if(conn_";
  protected final String TEXT_76 = " != null && !conn_";
  protected final String TEXT_77 = ".isClosed()) {" + NL + "\t";
