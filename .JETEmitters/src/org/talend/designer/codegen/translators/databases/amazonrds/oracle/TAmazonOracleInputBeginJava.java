...
public class TAmazonOracleInputBeginJava
{
  ...
  protected final String TEXT_491 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_492 = ".getColumnTypeName(i_";
  protected final String TEXT_493 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_494 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_495 = ".getClob(i_";
  protected final String TEXT_496 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_497 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_498 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_499 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_500 = ".add(tNTextImpl_";
  protected final String TEXT_501 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_502 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = ", rs_";
  protected final String TEXT_505 = ", fixedColumnCount_";
  protected final String TEXT_506 = ",list_";
  protected final String TEXT_507 = ",";
  protected final String TEXT_508 = ");";
  protected final String TEXT_509 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_510 = ".";
  protected final String TEXT_511 = ", rs_";
  protected final String TEXT_512 = ", fixedColumnCount_";
  protected final String TEXT_513 = ",";
  protected final String TEXT_514 = ");";
  protected final String TEXT_515 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_516 = ".";
  protected final String TEXT_517 = ", rs_";
  protected final String TEXT_518 = ", fixedColumnCount_";
  protected final String TEXT_519 = ",";
  protected final String TEXT_520 = ");";
  protected final String TEXT_521 = NL + "                                  Object geom = rs_";
  protected final String TEXT_522 = ".getObject(";
  protected final String TEXT_523 = "column_index_";
  protected final String TEXT_524 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_525 = ".";
  protected final String TEXT_526 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_532 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_533 = " - Retrieving the record \" + nb_line_";
