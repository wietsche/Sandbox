...
public class TFirebirdConnectionBeginJava
{
  ...
  protected final String TEXT_30 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_37 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_53 = NL + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_90 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_91 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_92 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_100 = ".rollback();" + NL + "\t\t\t";
  ...
  protected final String TEXT_106 = ".setAutoCommit(";
  protected final String TEXT_107 = ");" + NL + "\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\tlog.";
  protected final String TEXT_109 = "(\"";
  protected final String TEXT_110 = " - \" + ";
  protected final String TEXT_111 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_112 = NL + "\t    \t\tlog.";
  protected final String TEXT_113 = "(\"";
  protected final String TEXT_114 = "\");" + NL + "\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_116 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_118 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_119 = ": pstmt_";
  protected final String TEXT_120 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_121 = " += (countEach_";
  protected final String TEXT_122 = " < 0 ? 0 : ";
  protected final String TEXT_123 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t";
  protected final String TEXT_125 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
