...
public class TTeradataCommitMainJava
{
  protected static String nl;
  public static synchronized TTeradataCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataCommitMainJava result = new TTeradataCommitMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_116 = ".isClosed())" + NL + "{";
  ...
  protected final String TEXT_126 = NL + "                    System.err.println(e.getMessage());" + NL + "             }" + NL;
