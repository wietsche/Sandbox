...
public class TMSSqlTableListBeginJava
{
  ...
  protected final String TEXT_78 = " = \"\";" + NL + "" + NL + "if(dbSchema_";
  protected final String TEXT_79 = " != null && dbSchema_";
  protected final String TEXT_80 = ".length() > 0){" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_81 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE' AND table_schema='\" + dbSchema_";
  protected final String TEXT_82 = " + \"'\";" + NL + "\t" + NL + "}else{" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_83 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE'\";" + NL + "\t" + NL + "}" + NL + "if(whereClause_";
  protected final String TEXT_84 = " != null && whereClause_";
  protected final String TEXT_85 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_86 = " = query_";
  protected final String TEXT_87 = " + \" AND (\" + whereClause_";
  protected final String TEXT_88 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_89 = " = query_";
  protected final String TEXT_90 = " + \" ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_91 = NL + "    log.info(\"";
  protected final String TEXT_92 = " - Query:'\"+query_";
  protected final String TEXT_93 = "+\"'.\");";
  protected final String TEXT_94 = NL + NL + "int nb_table_";
  protected final String TEXT_95 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_98 = " = stmt2_";
  protected final String TEXT_99 = ".executeQuery(query_";
  protected final String TEXT_100 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_101 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_102 = " = rs_";
  protected final String TEXT_103 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_104 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_105 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_106 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_107 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_108 = " - Name of table \"+nb_table_";
  protected final String TEXT_109 = "+\":\"+currentTableName_";
  protected final String TEXT_110 = "+\".\");" + NL + "\t";
  protected final String TEXT_111 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_112 = "_CURRENT_TABLE\", currentTableName_";
