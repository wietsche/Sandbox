...
public class TSAPHanaCloseMainJava
{
  protected static String nl;
  public static synchronized TSAPHanaCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaCloseMainJava result = new TSAPHanaCloseMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_43 = NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_48 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tif(dataSources_";
  protected final String TEXT_49 = "!=null) {" + NL + "\t\t\t\tif(dataSources_";
  protected final String TEXT_50 = ".get(";
  protected final String TEXT_51 = ")!=null) {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_52 = " = dataSources_";
  protected final String TEXT_53 = ".get(";
  protected final String TEXT_54 = ").getConnection();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_55 = NL + "\tif(conn_";
  protected final String TEXT_56 = " != null && !conn_";
  protected final String TEXT_57 = ".isClosed())" + NL + "\t{";
