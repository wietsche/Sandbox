...
public class TMSSqlRowBeginJava
{
  ...
  protected final String TEXT_121 = NL + "\t\t\tString port_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_126 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_127 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_128 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_129 = " += \":\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_131 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_132 = " += \"//\" + ";
  protected final String TEXT_133 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_134 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_135 = ";" + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_137 = " = (String)globalMap.get(\"";
  protected final String TEXT_138 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_140 = " = ";
  protected final String TEXT_141 = ";" + NL + "\t    \t\t";
  protected final String TEXT_142 = NL + "\t\t        String  tableName_";
  protected final String TEXT_143 = " = null;" + NL + "\t\t        if(dbschema_";
  protected final String TEXT_144 = " == null || dbschema_";
  protected final String TEXT_145 = ".trim().length() == 0) {" + NL + "\t\t            tableName_";
  protected final String TEXT_146 = " = \"[\" + ";
  protected final String TEXT_147 = " + \"]\";" + NL + "\t\t        } else {" + NL + "\t\t            tableName_";
  protected final String TEXT_148 = " = \"[\" + dbschema_";
  protected final String TEXT_149 = " + \"].[\" + ";
  protected final String TEXT_150 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_151 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_152 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_154 = " = null;" + NL + "\tString query_";
  protected final String TEXT_155 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_159 = ".prepareStatement(";
  protected final String TEXT_160 = ");\t" + NL + "\t";
  protected final String TEXT_161 = NL + "\t\tjava.sql.Statement stmt_";
