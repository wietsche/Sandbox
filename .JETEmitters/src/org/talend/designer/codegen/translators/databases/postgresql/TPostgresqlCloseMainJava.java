...
public class TPostgresqlCloseMainJava
{
  protected static String nl;
  public static synchronized TPostgresqlCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlCloseMainJava result = new TPostgresqlCloseMainJava();
    nl = null;
    return result;
  }
