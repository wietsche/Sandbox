...
public class TSQLiteCloseMainJava
{
  protected static String nl;
  public static synchronized TSQLiteCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteCloseMainJava result = new TSQLiteCloseMainJava();
    nl = null;
    return result;
  }
