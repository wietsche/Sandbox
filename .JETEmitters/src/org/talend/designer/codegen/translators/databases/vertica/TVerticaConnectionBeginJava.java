...
public class TVerticaConnectionBeginJava
{
  protected static String nl;
  public static synchronized TVerticaConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaConnectionBeginJava result = new TVerticaConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_29 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_141 = ");" + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_142 = "\", ";
  protected final String TEXT_143 = ");" + NL + "\tglobalMap.put(\"db_";
