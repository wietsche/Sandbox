...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:interbase://\" + ";
  protected final String TEXT_176 = " + \"/\" + ";
  protected final String TEXT_177 = ";";
  protected final String TEXT_178 = NL + "    " + NL + "\t";
  protected final String TEXT_179 = NL + "\t\t    int nb_line_";
  protected final String TEXT_180 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_181 = " = null;";
  protected final String TEXT_182 = NL + "\t\t        conn_";
  protected final String TEXT_183 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_184 = "\");";
  protected final String TEXT_185 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_186 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_187 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_188 = " = dataSources_";
  protected final String TEXT_189 = ".get(";
  protected final String TEXT_190 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_191 = "\", conn_";
  protected final String TEXT_192 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_193 = NL + "\t\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\t";
  protected final String TEXT_195 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_196 = " =  conn_";
  protected final String TEXT_197 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_198 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_199 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_200 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_201 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_202 = NL + "                 conn_";
  protected final String TEXT_203 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_204 = NL + "               ";
  protected final String TEXT_205 = " + \"=\" + ";
  protected final String TEXT_206 = " + \";\" +";
  protected final String TEXT_207 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_208 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "\t\t    ";
  protected final String TEXT_211 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = ";" + NL + "\t\t\t";
  protected final String TEXT_214 = NL + "                log.info(\"";
  protected final String TEXT_215 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_216 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_217 = NL;
  protected final String TEXT_218 = NL + "                       globalMap.put(\"";
  protected final String TEXT_219 = "_QUERY\",dbquery_";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "                       globalMap.put(\"";
  protected final String TEXT_222 = "_QUERY\",dbquery_";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_248 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_249 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_250 = ".setName(rsmd_";
  protected final String TEXT_251 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_260 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_261 = ".setDbTypeId(rsmd_";
  protected final String TEXT_262 = ".getColumnType(i));";
  ...
  protected final String TEXT_288 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_289 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_290 = NL + "\t\t    ";
  protected final String TEXT_291 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_292 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_293 = NL + "\t\t    while (rs_";
  protected final String TEXT_294 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_295 = "++;" + NL + "\t\t        ";
  protected final String TEXT_296 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_297 = " = ";
  protected final String TEXT_298 = " + dcg_";
  protected final String TEXT_299 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_306 = "column_index_";
  ...
  protected final String TEXT_323 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_324 = ".getObject(";
  protected final String TEXT_325 = "column_index_";
  protected final String TEXT_326 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_327 = NL + "                                    ";
  protected final String TEXT_328 = ".";
  protected final String TEXT_329 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_338 = ".setEPSG(";
  ...
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_346 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_347 = " = ";
  protected final String TEXT_348 = "; i_";
  protected final String TEXT_349 = "  <= rsmd_";
  protected final String TEXT_350 = ".getColumnCount(); i_";
  protected final String TEXT_351 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_352 = ".getColumnTypeName(i_";
  protected final String TEXT_353 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_354 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_355 = ".getClob(i_";
  protected final String TEXT_356 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_357 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_358 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_359 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_360 = ".add(tNTextImpl_";
  protected final String TEXT_361 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_362 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_363 = ".";
  protected final String TEXT_364 = ", rs_";
  protected final String TEXT_365 = ", fixedColumnCount_";
  protected final String TEXT_366 = ",list_";
  protected final String TEXT_367 = ",";
  protected final String TEXT_368 = ");";
  protected final String TEXT_369 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_381 = NL + "                                  Object geom = rs_";
  protected final String TEXT_382 = ".getObject(";
  protected final String TEXT_383 = "column_index_";
  protected final String TEXT_384 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_393 = " - Retrieving the record \" + nb_line_";
