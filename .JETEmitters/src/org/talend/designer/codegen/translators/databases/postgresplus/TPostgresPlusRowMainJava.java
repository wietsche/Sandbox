...
public class TPostgresPlusRowMainJava
{
  protected static String nl;
  public static synchronized TPostgresPlusRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusRowMainJava result = new TPostgresPlusRowMainJava();
    nl = null;
    return result;
  }
