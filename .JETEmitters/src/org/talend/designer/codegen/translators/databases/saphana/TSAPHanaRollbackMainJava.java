...
public class TSAPHanaRollbackMainJava
{
  protected static String nl;
  public static synchronized TSAPHanaRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaRollbackMainJava result = new TSAPHanaRollbackMainJava();
    nl = null;
    return result;
  }
