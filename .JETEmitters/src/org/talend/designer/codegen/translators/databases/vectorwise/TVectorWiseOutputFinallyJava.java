...
public class TVectorWiseOutputFinallyJava
{
  protected static String nl;
  public static synchronized TVectorWiseOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseOutputFinallyJava result = new TVectorWiseOutputFinallyJava();
    nl = null;
    return result;
  }
