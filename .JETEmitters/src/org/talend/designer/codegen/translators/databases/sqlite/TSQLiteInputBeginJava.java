...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_183 = " = java.sql.DriverManager.getConnection(url_";
  ...
  protected final String TEXT_190 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_191 = "\");";
  protected final String TEXT_192 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_193 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_194 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_195 = " = dataSources_";
  protected final String TEXT_196 = ".get(";
  protected final String TEXT_197 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_198 = "\", conn_";
  protected final String TEXT_199 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_200 = NL + "\t\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\t";
  protected final String TEXT_202 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_203 = " =  conn_";
  protected final String TEXT_204 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_205 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_206 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_207 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_208 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_209 = NL + "                 conn_";
  protected final String TEXT_210 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_211 = NL + "               ";
  protected final String TEXT_212 = " + \"=\" + ";
  protected final String TEXT_213 = " + \";\" +";
  protected final String TEXT_214 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_215 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_216 = ");";
  protected final String TEXT_217 = NL + "\t\t    ";
  protected final String TEXT_218 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_219 = " = ";
  protected final String TEXT_220 = ";" + NL + "\t\t\t";
  protected final String TEXT_221 = NL + "                log.info(\"";
  protected final String TEXT_222 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_231 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_232 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_233 = " = stmt_";
  protected final String TEXT_234 = ".executeQuery(dbquery_";
  protected final String TEXT_235 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_236 = " = rs_";
  protected final String TEXT_237 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_238 = " = rsmd_";
  protected final String TEXT_239 = ".getColumnCount();" + NL;
  protected final String TEXT_240 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_241 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_242 = ".setDbmsId(\"";
  protected final String TEXT_243 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_244 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_245 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_246 = ".add(\"";
  protected final String TEXT_247 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_248 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_249 = " = ";
  protected final String TEXT_250 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_251 = "; i <= rsmd_";
  protected final String TEXT_252 = ".getColumnCount()-";
  protected final String TEXT_253 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_254 = ".contains(rsmd_";
  protected final String TEXT_255 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_256 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_257 = ".setName(rsmd_";
  protected final String TEXT_258 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_259 = ".setDbName(rsmd_";
  protected final String TEXT_260 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_261 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_262 = "\", rsmd_";
  protected final String TEXT_263 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_264 = ".getPrecision(i), rsmd_";
  protected final String TEXT_265 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_266 = ".setDbType(rsmd_";
  protected final String TEXT_267 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_268 = ".setDbTypeId(rsmd_";
  protected final String TEXT_269 = ".getColumnType(i));";
  protected final String TEXT_270 = NL + "                \tdcm_";
  protected final String TEXT_271 = ".setFormat(";
  protected final String TEXT_272 = ");";
  protected final String TEXT_273 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_274 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_275 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_276 = ".setLength(rsmd_";
  protected final String TEXT_277 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_278 = ".setLength(rsmd_";
  protected final String TEXT_279 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_280 = NL + "\t\t\tdcm_";
  protected final String TEXT_281 = ".setLength(rsmd_";
  protected final String TEXT_282 = ".getPrecision(i));";
  protected final String TEXT_283 = NL + "                \tdcm_";
  protected final String TEXT_284 = ".setPrecision(rsmd_";
  protected final String TEXT_285 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_286 = ".setNullable(rsmd_";
  protected final String TEXT_287 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_288 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_289 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_291 = ".metadatas.add(dcm_";
  protected final String TEXT_292 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_293 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_294 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_295 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_296 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_297 = NL + "\t\t    ";
  protected final String TEXT_298 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_299 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_300 = NL + "\t\t    while (rs_";
  protected final String TEXT_301 = ".next()) {" + NL + "\t\t        nb_line_";
  ...
  protected final String TEXT_307 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
