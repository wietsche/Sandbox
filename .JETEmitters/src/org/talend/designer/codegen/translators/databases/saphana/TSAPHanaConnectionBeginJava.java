...
public class TSAPHanaConnectionBeginJava
{
  protected static String nl;
  public static synchronized TSAPHanaConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaConnectionBeginJava result = new TSAPHanaConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_30 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_31 = " + \":\" + ";
  protected final String TEXT_32 = " ;" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_33 = " = ";
  protected final String TEXT_34 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_35 = " != null && dbProperties_";
  protected final String TEXT_36 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_37 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_38 = " + \":\" + ";
  protected final String TEXT_39 = " + \"/?\" + dbProperties_";
  protected final String TEXT_40 = ";" + NL + "\t\t\t}";
  protected final String TEXT_41 = NL + "\t\t\tglobalMap.put(\"dbschema_\" + \"";
  ...
  protected final String TEXT_123 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_124 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_126 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_127 = ": pstmt_";
  protected final String TEXT_128 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_129 = " += (countEach_";
  protected final String TEXT_130 = " < 0 ? 0 : ";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_132 = NL + "\t";
  protected final String TEXT_133 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
