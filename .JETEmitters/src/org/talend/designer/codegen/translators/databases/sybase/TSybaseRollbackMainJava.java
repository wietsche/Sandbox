...
public class TSybaseRollbackMainJava
{
  protected static String nl;
  public static synchronized TSybaseRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseRollbackMainJava result = new TSybaseRollbackMainJava();
    nl = null;
    return result;
  }
