...
public class TSybaseRowMainJava
{
  protected static String nl;
  public static synchronized TSybaseRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseRowMainJava result = new TSybaseRowMainJava();
    nl = null;
    return result;
  }
