...
public class TVectorWiseOutputEndJava
{
  ...
  protected final String TEXT_61 = ".executeBatch()) {" + NL + "\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_62 = " == -2 || countEach_";
  protected final String TEXT_63 = " == -3) {" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_64 = " += countEach_";
  protected final String TEXT_65 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\t\t}" + NL + "\t    \t\tinsertedCount_";
  ...
  protected final String TEXT_75 = ");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_76 = " += countSum_";
  protected final String TEXT_77 = ";" + NL + "\t    \t\t";
  protected final String TEXT_78 = NL + "            \tSystem.err.println(e.getMessage());" + NL + "            \t";
  protected final String TEXT_79 = NL + "        \t}";
  protected final String TEXT_80 = NL + NL + "            if(pstmt_";
  protected final String TEXT_81 = " != null) {" + NL + "    \t\t\tpstmt_";
  protected final String TEXT_82 = ".close();" + NL + "            }" + NL + "        \t";
  protected final String TEXT_83 = NL;
  protected final String TEXT_84 = NL + "\t    if (commitCounter_";
  protected final String TEXT_85 = " > 0) {" + NL + "\t        ";
  protected final String TEXT_86 = NL + "\t        conn_";
  protected final String TEXT_87 = ".commit();" + NL + "\t        ";
  protected final String TEXT_88 = NL + "\t    }";
  protected final String TEXT_89 = NL + "\t\t";
  protected final String TEXT_90 = NL + "    \tconn_";
  protected final String TEXT_91 = " .close();" + NL + "    \t";
  protected final String TEXT_92 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_93 = "\", true);";
  protected final String TEXT_94 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_95 = " = 0;";
  protected final String TEXT_96 = NL + "\tnb_line_deleted_";
  protected final String TEXT_97 = "=nb_line_deleted_";
  protected final String TEXT_98 = "+ deletedCount_";
  protected final String TEXT_99 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_100 = "=nb_line_update_";
  protected final String TEXT_101 = " + updatedCount_";
  protected final String TEXT_102 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_103 = "=nb_line_inserted_";
  protected final String TEXT_104 = " + insertedCount_";
  protected final String TEXT_105 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_106 = "=nb_line_rejected_";
  protected final String TEXT_107 = " + rejectedCount_";
  protected final String TEXT_108 = ";" + NL + "\t";
  protected final String TEXT_109 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_110 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_111 = "_NB_LINE\",nb_line_";
  protected final String TEXT_112 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_113 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_114 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_115 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_116 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_117 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_118 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_119 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_121 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_122 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_125 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_126 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_127 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_128 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_131 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_132 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_133 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_134 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_137 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_138 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_139 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_140 = NL + "        globalMap.put(\"";
  protected final String TEXT_141 = "_NB_LINE\",nb_line_";
  protected final String TEXT_142 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_143 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_144 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_145 = "_NB_LINE_INSERTED\",nb_line_inserted_";
