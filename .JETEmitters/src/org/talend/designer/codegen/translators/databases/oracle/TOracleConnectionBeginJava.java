...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_194 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_205 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_206 = "\",conn_";
  protected final String TEXT_207 = ");";
  protected final String TEXT_208 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_209 = "\",conn_";
  protected final String TEXT_210 = ".getMetaData().getUserName());";
  protected final String TEXT_211 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_212 = "\", ";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_215 = "\",";
  protected final String TEXT_216 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
