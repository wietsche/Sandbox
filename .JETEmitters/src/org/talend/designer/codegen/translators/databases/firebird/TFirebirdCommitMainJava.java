...
public class TFirebirdCommitMainJava
{
  protected static String nl;
  public static synchronized TFirebirdCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdCommitMainJava result = new TFirebirdCommitMainJava();
    nl = null;
    return result;
  }
