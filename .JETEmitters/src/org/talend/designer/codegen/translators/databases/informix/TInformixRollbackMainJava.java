...
public class TInformixRollbackMainJava
{
  protected static String nl;
  public static synchronized TInformixRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixRollbackMainJava result = new TInformixRollbackMainJava();
    nl = null;
    return result;
  }
