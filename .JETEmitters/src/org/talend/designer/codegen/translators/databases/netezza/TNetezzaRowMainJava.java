...
public class TNetezzaRowMainJava
{
  protected static String nl;
  public static synchronized TNetezzaRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaRowMainJava result = new TNetezzaRowMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_85 = ".getTime()));";
  protected final String TEXT_86 = NL + "\t\t\tpstmt_";
  protected final String TEXT_87 = ".set";
  protected final String TEXT_88 = "(";
  protected final String TEXT_89 = ",";
  protected final String TEXT_90 = ");";
  protected final String TEXT_91 = NL + "\t\trs_";
  protected final String TEXT_92 = " = pstmt_";
  protected final String TEXT_93 = ".executeQuery();";
  protected final String TEXT_94 = NL + "\t\tpstmt_";
  protected final String TEXT_95 = ".execute();" + NL + "\t\t";
  protected final String TEXT_96 = NL + "\t\trs_";
  protected final String TEXT_97 = " = stmt_";
  protected final String TEXT_98 = ".executeQuery(query_";
  protected final String TEXT_99 = ");";
  protected final String TEXT_100 = NL + "\t\tstmt_";
  protected final String TEXT_101 = ".execute(query_";
  protected final String TEXT_102 = ");" + NL + "\t\t";
  protected final String TEXT_103 = NL + "\t\tnb_line_inserted_";
  protected final String TEXT_104 = " += pstmt_";
  protected final String TEXT_105 = ".getUpdateCount();";
  protected final String TEXT_106 = NL + "\t\tnb_line_update_";
  ...
  protected final String TEXT_118 = NL + "\t\tnb_line_deleted_";
  ...
  protected final String TEXT_123 = NL + "\t\t\tthrow(e);" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\t";
  protected final String TEXT_125 = " = new ";
  protected final String TEXT_126 = "Struct();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_133 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_134 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_135 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_137 = NL + "\t}" + NL + "\t";
  protected final String TEXT_138 = NL + "\tif(!whetherReject_";
  ...
  protected final String TEXT_153 = NL + "\t\tcommitCounter_";
  protected final String TEXT_154 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_155 = " <= commitCounter_";
  protected final String TEXT_156 = ") {" + NL + "\t\t\t";
  protected final String TEXT_157 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_158 = "=0;" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_159 = NL + "\tnb_";
  protected final String TEXT_160 = " += pstmt_";
  protected final String TEXT_161 = ".getUpdateCount();";
  protected final String TEXT_162 = NL + "\tnb_";
  protected final String TEXT_163 = " += stmt_";
  protected final String TEXT_164 = ".getUpdateCount();";
