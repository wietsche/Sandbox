...
public class TInterbaseCommitMainJava
{
  protected static String nl;
  public static synchronized TInterbaseCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseCommitMainJava result = new TInterbaseCommitMainJava();
    nl = null;
    return result;
  }
