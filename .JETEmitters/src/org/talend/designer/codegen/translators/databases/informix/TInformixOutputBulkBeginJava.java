...
public class TInformixOutputBulkBeginJava
{
  ...
  protected final String TEXT_42 = " = 0;" + NL + "\t\tchar rowSeparator_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";" + NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_47 = " = new java.io.File(";
  protected final String TEXT_48 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_49 = NL + "        java.io.File parentFile_";
  protected final String TEXT_50 = " = file_";
  protected final String TEXT_51 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_52 = " != null && !parentFile_";
  protected final String TEXT_53 = ".exists()){" + NL + "            String absolutePath_";
  protected final String TEXT_54 = " = parentFile_";
  protected final String TEXT_55 = ".getAbsolutePath();";
  protected final String TEXT_56 = NL + "            if(parentFile_";
  protected final String TEXT_57 = ".mkdirs()){";
  protected final String TEXT_58 = NL + "                System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_59 = "+\"' has been created successfully.\");" + NL + "            }else{";
  protected final String TEXT_60 = NL + "                System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_61 = "+\"'.\");" + NL + "            }" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_62 = NL + "\t\t\t\t" + NL + "\t\tcom.talend.csv.CSVWriter csvWriter_";
  protected final String TEXT_63 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_64 = ", ";
  protected final String TEXT_65 = "), ";
  protected final String TEXT_66 = ")));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_67 = "\", csvWriter_";
  protected final String TEXT_68 = "); " + NL + "        csvWriter_";
  protected final String TEXT_69 = ".setSeparator(fieldSeparator_";
  protected final String TEXT_70 = ");" + NL + "        " + NL + "        csvWriter_";
  protected final String TEXT_71 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_72 = ");" + NL + "        csvWriter_";
  protected final String TEXT_73 = ".setEscapeChar('\\\\');" + NL + "      \tcsvWriter_";
  protected final String TEXT_74 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.NO);  ";
