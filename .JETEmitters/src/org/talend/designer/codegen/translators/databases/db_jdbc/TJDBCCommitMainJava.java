...
public class TJDBCCommitMainJava
{
  protected static String nl;
  public static synchronized TJDBCCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCCommitMainJava result = new TJDBCCommitMainJava();
    nl = null;
    return result;
  }
