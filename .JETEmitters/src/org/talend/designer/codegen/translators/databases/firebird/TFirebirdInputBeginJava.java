...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_175 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_183 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_184 = " = null;";
  protected final String TEXT_185 = NL + "\t\t        conn_";
  protected final String TEXT_186 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_187 = "\");";
  protected final String TEXT_188 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_189 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_190 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_191 = " = dataSources_";
  protected final String TEXT_192 = ".get(";
  protected final String TEXT_193 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_194 = "\", conn_";
  protected final String TEXT_195 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_196 = NL + "\t\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\t";
  protected final String TEXT_198 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_199 = " =  conn_";
  protected final String TEXT_200 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_201 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_202 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_203 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_204 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_205 = NL + "                 conn_";
  protected final String TEXT_206 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_207 = NL + "               ";
  protected final String TEXT_208 = " + \"=\" + ";
  protected final String TEXT_209 = " + \";\" +";
  protected final String TEXT_210 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_211 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_212 = ");";
  protected final String TEXT_213 = NL + "\t\t    ";
  protected final String TEXT_214 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_215 = " = ";
  protected final String TEXT_216 = ";" + NL + "\t\t\t";
  protected final String TEXT_217 = NL + "                log.info(\"";
  protected final String TEXT_218 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_219 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_220 = NL;
  protected final String TEXT_221 = NL + "                       globalMap.put(\"";
  protected final String TEXT_222 = "_QUERY\",dbquery_";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "                       globalMap.put(\"";
  protected final String TEXT_225 = "_QUERY\",dbquery_";
  protected final String TEXT_226 = ");";
  protected final String TEXT_227 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_228 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_229 = " = stmt_";
  protected final String TEXT_230 = ".executeQuery(dbquery_";
  protected final String TEXT_231 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_232 = " = rs_";
  protected final String TEXT_233 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_234 = " = rsmd_";
  protected final String TEXT_235 = ".getColumnCount();" + NL;
  protected final String TEXT_236 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_237 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_238 = ".setDbmsId(\"";
  protected final String TEXT_239 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_240 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_241 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_242 = ".add(\"";
  protected final String TEXT_243 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_244 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_247 = "; i <= rsmd_";
  protected final String TEXT_248 = ".getColumnCount()-";
  protected final String TEXT_249 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_250 = ".contains(rsmd_";
  protected final String TEXT_251 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_252 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_253 = ".setName(rsmd_";
  protected final String TEXT_254 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_255 = ".setDbName(rsmd_";
  protected final String TEXT_256 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_257 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_258 = "\", rsmd_";
  protected final String TEXT_259 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_260 = ".getPrecision(i), rsmd_";
  protected final String TEXT_261 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_262 = ".setDbType(rsmd_";
  protected final String TEXT_263 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_264 = ".setDbTypeId(rsmd_";
  protected final String TEXT_265 = ".getColumnType(i));";
  protected final String TEXT_266 = NL + "                \tdcm_";
  protected final String TEXT_267 = ".setFormat(";
  protected final String TEXT_268 = ");";
  protected final String TEXT_269 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_270 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_271 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_272 = ".setLength(rsmd_";
  protected final String TEXT_273 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_274 = ".setLength(rsmd_";
  protected final String TEXT_275 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_276 = NL + "\t\t\tdcm_";
  protected final String TEXT_277 = ".setLength(rsmd_";
  protected final String TEXT_278 = ".getPrecision(i));";
  protected final String TEXT_279 = NL + "                \tdcm_";
  protected final String TEXT_280 = ".setPrecision(rsmd_";
  protected final String TEXT_281 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_282 = ".setNullable(rsmd_";
  protected final String TEXT_283 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_284 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_286 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_287 = ".metadatas.add(dcm_";
  protected final String TEXT_288 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_289 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_290 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_291 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_292 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_293 = NL + "\t\t    ";
  protected final String TEXT_294 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_295 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_296 = NL + "\t\t    while (rs_";
  protected final String TEXT_297 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_298 = "++;" + NL + "\t\t        ";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = " + dcg_";
  protected final String TEXT_302 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_304 = " = ";
  protected final String TEXT_305 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_319 = " = (List)rs_";
  ...
  protected final String TEXT_326 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_327 = ".getObject(";
  protected final String TEXT_328 = "column_index_";
  protected final String TEXT_329 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_330 = NL + "                                    ";
  protected final String TEXT_331 = ".";
  protected final String TEXT_332 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_341 = ".setEPSG(";
  protected final String TEXT_342 = ");" + NL + "                                        }";
  protected final String TEXT_343 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "                                  ";
  protected final String TEXT_345 = ".";
  protected final String TEXT_346 = "=dcg_";
  protected final String TEXT_347 = ";";
  protected final String TEXT_348 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_349 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_350 = " = ";
  protected final String TEXT_351 = "; i_";
  protected final String TEXT_352 = "  <= rsmd_";
  protected final String TEXT_353 = ".getColumnCount(); i_";
  protected final String TEXT_354 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_355 = ".getColumnTypeName(i_";
  protected final String TEXT_356 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_357 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_358 = ".getClob(i_";
  protected final String TEXT_359 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_360 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_361 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_362 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_363 = ".add(tNTextImpl_";
  protected final String TEXT_364 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_365 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = ", rs_";
  protected final String TEXT_368 = ", fixedColumnCount_";
  protected final String TEXT_369 = ",list_";
  protected final String TEXT_370 = ",";
  protected final String TEXT_371 = ");";
  protected final String TEXT_372 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", rs_";
  protected final String TEXT_375 = ", fixedColumnCount_";
  protected final String TEXT_376 = ",";
  protected final String TEXT_377 = ");";
  protected final String TEXT_378 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_379 = ".";
  protected final String TEXT_380 = ", rs_";
  protected final String TEXT_381 = ", fixedColumnCount_";
  protected final String TEXT_382 = ",";
  protected final String TEXT_383 = ");";
  protected final String TEXT_384 = NL + "                                  Object geom = rs_";
  protected final String TEXT_385 = ".getObject(";
  protected final String TEXT_386 = "column_index_";
  protected final String TEXT_387 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_390 = ".";
  protected final String TEXT_391 = " = null;" + NL + "                                  }";
  protected final String TEXT_392 = NL + "\t\t                          ";
  protected final String TEXT_393 = NL + "\t\t                    }";
  protected final String TEXT_394 = NL + "\t\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_396 = " - Retrieving the record \" + nb_line_";
