...
public class TNetezzaRowBeginJava
{
  ...
  protected final String TEXT_124 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_125 = " == null || dbProperties_";
  protected final String TEXT_126 = ".trim().length() == 0) {" + NL + "\t\t\t    url_";
  protected final String TEXT_127 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_128 = " + \":\" + ";
  protected final String TEXT_129 = " + \"/\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_131 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_132 = " + \":\" + ";
  protected final String TEXT_133 = " + \"/\" + ";
  protected final String TEXT_134 = " + \"?\" + ";
  protected final String TEXT_135 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\t\tint nb_";
  ...
  protected final String TEXT_141 = " = false;";
  protected final String TEXT_142 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".prepareStatement(";
  protected final String TEXT_145 = ");\t" + NL + "\t";
  protected final String TEXT_146 = NL + "\t\tjava.sql.Statement stmt_";
