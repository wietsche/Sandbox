...
public class TMysqlInputEndJava
{
  ...
  protected final String TEXT_70 = NL + "\t}" + NL + "}finally{" + NL + "\tif(rs_";
  protected final String TEXT_71 = " !=null){" + NL + "\t\trs_";
  protected final String TEXT_72 = ".close();" + NL + "\t}" + NL + "\tstmt_";
  protected final String TEXT_73 = ".close();";
  protected final String TEXT_74 = NL + "\t\tif(conn_";
  protected final String TEXT_75 = " != null && !conn_";
  protected final String TEXT_76 = ".isClosed()) {" + NL + "\t\t\t";
