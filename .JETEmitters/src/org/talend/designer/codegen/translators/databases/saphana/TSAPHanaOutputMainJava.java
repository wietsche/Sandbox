package org.talend.designer.codegen.translators.databases.saphana;
...
public class TSAPHanaOutputMainJava {
  protected static String nl;
  public static synchronized TSAPHanaOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaOutputMainJava result = new TSAPHanaOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_52 = ".createStatement();";
  protected final String TEXT_53 = NL + "                              stmtDrop_";
  protected final String TEXT_54 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_65 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_66 = "));";
  protected final String TEXT_67 = NL + "                    stmtCreate_";
  protected final String TEXT_68 = ".execute(((\"";
  protected final String TEXT_69 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_85 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_86 = "));";
  protected final String TEXT_87 = NL + "                    stmtCreate_";
  protected final String TEXT_88 = ".execute(((\"";
  protected final String TEXT_89 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = ", \"";
  protected final String TEXT_92 = "\")";
  protected final String TEXT_93 = ".toUpperCase()";
  ...
  protected final String TEXT_102 = NL + "                    String keyCheckTable_";
  protected final String TEXT_103 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_104 = "+\"][\"+";
  protected final String TEXT_105 = "+\"][\"+";
  protected final String TEXT_106 = "+\"][\"+";
  protected final String TEXT_107 = "+\"][\"+";
  protected final String TEXT_108 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_109 = " + \"]\";";
  protected final String TEXT_110 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_111 = " = conn_";
  protected final String TEXT_112 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_113 = " + \"]\";";
  protected final String TEXT_114 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_115 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_116 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_117 = ")== null){//}";
  protected final String TEXT_118 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_121 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_122 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_123 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_124 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_125 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_130 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_131 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_132 = " = tableNameForSearch_";
  protected final String TEXT_133 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_134 = " = tableNameForSearch_";
  protected final String TEXT_135 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_136 = " = dbMetaData_";
  protected final String TEXT_137 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_138 = ", tableNameForSearch_";
  protected final String TEXT_139 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_140 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_141 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_142 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_146 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_147 = " = dbMetaData_";
  protected final String TEXT_148 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_149 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_164 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_187 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_188 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_196 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_197 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_198 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_199 = " == null || dbschema_";
  protected final String TEXT_200 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_203 = " = stmtSchema_";
  protected final String TEXT_204 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_205 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_206 = " = rsSchema_";
  protected final String TEXT_207 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_208 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_209 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_223 = " ==null || dbschema_";
  protected final String TEXT_224 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_225 = ".equals";
  protected final String TEXT_226 = "IgnoreCase";
  protected final String TEXT_227 = "(schema_";
  protected final String TEXT_228 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_229 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_230 = ".close();";
  protected final String TEXT_231 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_232 = " = ";
  protected final String TEXT_233 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_234 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_235 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_236 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_237 = " =  tableForSearch_";
  protected final String TEXT_238 = ".substring(1,tableForSearch_";
  protected final String TEXT_239 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_240 = " =  tableForSearch_";
  protected final String TEXT_241 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_245 = ".getTables(null, conn_";
  protected final String TEXT_246 = ".getSchema(), tableForSearch_";
  protected final String TEXT_247 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_248 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_249 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_250 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_251 = ".close();";
  ...
  protected final String TEXT_257 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_258 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_259 = " = rsTable_";
  protected final String TEXT_260 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_265 = NL + "                                if(!whetherExist_";
  protected final String TEXT_266 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_270 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_287 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".createStatement();";
  protected final String TEXT_290 = NL + "                                                      stmtDrop_";
  protected final String TEXT_291 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_298 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_306 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_307 = ".";
  protected final String TEXT_308 = ", \"";
  protected final String TEXT_309 = "\")";
  protected final String TEXT_310 = ".toUpperCase()";
  ...
  protected final String TEXT_318 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_319 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_320 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_329 = NL + "            stmtClear_";
  ...
  protected final String TEXT_333 = ".createStatement();";
  protected final String TEXT_334 = NL + "                              stmtTruncCount_";
  protected final String TEXT_335 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_336 = "));";
  protected final String TEXT_337 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_338 = " = stmtTruncCount_";
  protected final String TEXT_339 = ".executeQuery(\"";
  protected final String TEXT_340 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_341 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_342 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_346 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_352 = NL + "                conn_";
  protected final String TEXT_353 = ".commit();";
  protected final String TEXT_354 = NL + "            stmtTrunc_";
  protected final String TEXT_355 = ".executeUpdate(\"";
  protected final String TEXT_356 = "\");";
  protected final String TEXT_357 = NL + "                if(!conn_";
  protected final String TEXT_358 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_359 = ".commit();" + NL + "                }";
  protected final String TEXT_360 = NL + "            deletedCount_";
  protected final String TEXT_361 = " += rsTruncCountNumber_";
  protected final String TEXT_362 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_363 = ".close();";
  protected final String TEXT_364 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_365 = " = conn_";
  protected final String TEXT_366 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_367 = " = stmtTruncCount_";
  protected final String TEXT_368 = ".executeQuery(\"";
  protected final String TEXT_369 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_370 = " = conn_";
  protected final String TEXT_371 = ".createStatement();";
  ...
  protected final String TEXT_377 = NL + "            while(rsTruncCount_";
  protected final String TEXT_378 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_379 = " += rsTruncCount_";
  protected final String TEXT_380 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_381 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_382 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_383 = ".close();";
  protected final String TEXT_384 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_385 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_386 = " + \" (";
  protected final String TEXT_387 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_388 = ".";
  protected final String TEXT_389 = ", \"";
  protected final String TEXT_390 = "\")+\") VALUES (";
  protected final String TEXT_391 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_399 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_400 = ".";
  protected final String TEXT_401 = ")+\")\";";
  protected final String TEXT_402 = NL + "\t\tpstmt_";
  protected final String TEXT_403 = " = conn_";
  protected final String TEXT_404 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_409 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_416 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_428 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_435 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_436 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_437 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_438 = ".";
  protected final String TEXT_439 = ", \"";
  protected final String TEXT_440 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = ")+\")\";";
  protected final String TEXT_443 = NL + "\t\t\t\tString update_";
  protected final String TEXT_444 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_445 = " + \" SET ";
  protected final String TEXT_446 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_453 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_454 = ".";
  protected final String TEXT_455 = ", \"";
  protected final String TEXT_456 = "\")+\" WHERE ";
  protected final String TEXT_457 = "\";";
  protected final String TEXT_458 = NL + "\t    pstmt_";
  protected final String TEXT_459 = " = conn_";
  protected final String TEXT_460 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_461 = " + \" WHERE ";
  protected final String TEXT_462 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = ".prepareStatement(insert_";
  protected final String TEXT_465 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_466 = " = conn_";
  protected final String TEXT_467 = ".prepareStatement(update_";
  protected final String TEXT_468 = ");" + NL + "\t    ";
  protected final String TEXT_469 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_470 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_484 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_490 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_491 = ".";
  protected final String TEXT_492 = ", \"";
  protected final String TEXT_493 = "\")+\" WHERE ";
  protected final String TEXT_494 = "\";";
  protected final String TEXT_495 = NL + "\t\t\t\tString update_";
  protected final String TEXT_496 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_497 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_498 = ".";
  protected final String TEXT_499 = ", \"";
  protected final String TEXT_500 = "\")+\" WHERE ";
  protected final String TEXT_501 = "\";";
  protected final String TEXT_502 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_503 = " = conn_";
  protected final String TEXT_504 = ".prepareStatement(update_";
  protected final String TEXT_505 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_517 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_518 = " = insert_";
  protected final String TEXT_519 = ".split(\"\\\\?\");";
  protected final String TEXT_520 = NL + "\t\t\tupdate_";
  protected final String TEXT_521 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_522 = " = update_";
  ...
  protected final String TEXT_527 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_528 = " = insert_";
  protected final String TEXT_529 = ".split(\"\\\\?\");";
  protected final String TEXT_530 = NL + "\t\t\tdelete_";
  protected final String TEXT_531 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_532 = " = delete_";
  protected final String TEXT_533 = ".split(\"\\\\?\");";
  protected final String TEXT_534 = NL + "\t\t\treplace_";
  protected final String TEXT_535 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_536 = " = replace_";
  protected final String TEXT_537 = ".split(\"\\\\?\");";
  protected final String TEXT_538 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_539 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_540 = " = insertIgnore_";
  protected final String TEXT_541 = ".split(\"\\\\?\");";
  protected final String TEXT_542 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_543 = " = insert_";
  protected final String TEXT_544 = ".split(\"\\\\?\");";
  protected final String TEXT_545 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_546 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_547 = " = buffersSize_";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_550 = " = buffersSize_";
  protected final String TEXT_551 = ";";
  protected final String TEXT_552 = NL + "        whetherReject_";
  protected final String TEXT_553 = " = false;";
  protected final String TEXT_554 = NL + "                    ";
  protected final String TEXT_555 = NL + "                        query_";
  protected final String TEXT_556 = " = ";
  protected final String TEXT_557 = ";";
  protected final String TEXT_558 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_559 = ",";
  protected final String TEXT_560 = ".";
  protected final String TEXT_561 = ", ";
  protected final String TEXT_562 = ",insertSQLSplits_";
  protected final String TEXT_563 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_564 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_565 = ".";
  protected final String TEXT_566 = ", pstmt_";
  protected final String TEXT_567 = ", ";
  protected final String TEXT_568 = ", \"";
  protected final String TEXT_569 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_570 = NL + "                globalMap.put(\"";
  protected final String TEXT_571 = "_QUERY\", query_";
  protected final String TEXT_572 = ".toString().trim());";
  protected final String TEXT_573 = NL + "    \t\t";
  protected final String TEXT_574 = NL + "    \t\tpstmt_";
  protected final String TEXT_575 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_576 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_577 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_578 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_579 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_580 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_581 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_582 = " = insertedCount_";
  protected final String TEXT_583 = " + pstmt_";
  protected final String TEXT_584 = ".executeUpdate();";
  protected final String TEXT_585 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_586 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_587 = " = true;";
  protected final String TEXT_588 = NL + "                    throw(e_";
  protected final String TEXT_589 = ");";
  protected final String TEXT_590 = NL + "                        ";
  protected final String TEXT_591 = " = new ";
  protected final String TEXT_592 = "Struct();";
  protected final String TEXT_593 = NL + "                            ";
  protected final String TEXT_594 = ".";
  protected final String TEXT_595 = " = ";
  protected final String TEXT_596 = ".";
  protected final String TEXT_597 = ";";
  protected final String TEXT_598 = NL + "                        rejectedCount_";
  protected final String TEXT_599 = " = rejectedCount_";
  protected final String TEXT_600 = " + 1;";
  protected final String TEXT_601 = NL + "                        ";
  protected final String TEXT_602 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_603 = ").getSQLState();";
  protected final String TEXT_604 = NL + "                        ";
  protected final String TEXT_605 = ".errorMessage = e_";
  protected final String TEXT_606 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_607 = ";";
  protected final String TEXT_608 = NL + "                        System.err.print(e_";
  protected final String TEXT_609 = ".getMessage());";
  ...
  protected final String TEXT_619 = ",updateSQLSplits_";
  protected final String TEXT_620 = ");";
  protected final String TEXT_621 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_622 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_623 = ".";
  protected final String TEXT_624 = ", pstmt_";
  ...
  protected final String TEXT_643 = NL + "\t\t\t\t   query_";
  protected final String TEXT_644 = " = ";
  protected final String TEXT_645 = ";" + NL + "\t\t\t    ";
  protected final String TEXT_646 = NL + "                globalMap.put(\"";
  protected final String TEXT_647 = "_QUERY\", query_";
  protected final String TEXT_648 = ".toString().trim());";
  protected final String TEXT_649 = NL + "    \t\t";
  protected final String TEXT_650 = NL + "    \t\tpstmt_";
  protected final String TEXT_651 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_652 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_653 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_654 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_655 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_656 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_657 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_658 = " = updatedCount_";
  protected final String TEXT_659 = " + pstmt_";
  protected final String TEXT_660 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_661 = "                " + NL + "            } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_678 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_679 = ").getSQLState();";
  protected final String TEXT_680 = NL + "                        ";
  protected final String TEXT_681 = ".errorMessage = e_";
  protected final String TEXT_682 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_683 = ";";
  protected final String TEXT_684 = NL + "                        System.err.print(e_";
  protected final String TEXT_685 = ".getMessage());";
  ...
  protected final String TEXT_690 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_691 = " = pstmt_";
  protected final String TEXT_692 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_693 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_694 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_695 = " = rs_";
  protected final String TEXT_696 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_706 = ",updateSQLSplits_";
  protected final String TEXT_707 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_708 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_709 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_710 = ".";
  protected final String TEXT_711 = ", pstmtUpdate_";
  ...
  protected final String TEXT_735 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_736 = " = updatedCount_";
  protected final String TEXT_737 = " + pstmtUpdate_";
  protected final String TEXT_738 = ".executeUpdate(); " + NL + "                    nb_line_";
  protected final String TEXT_739 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_740 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_741 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_742 = " = true;";
  protected final String TEXT_743 = NL + "                        throw(e_";
  ...
  protected final String TEXT_755 = NL + "                            rejectedCount_";
  protected final String TEXT_756 = " = rejectedCount_";
  protected final String TEXT_757 = " + 1;";
  protected final String TEXT_758 = NL + "                            ";
  protected final String TEXT_759 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_760 = ").getSQLState();";
  protected final String TEXT_761 = NL + "                            ";
  protected final String TEXT_762 = ".errorMessage = e_";
  protected final String TEXT_763 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_764 = ";";
  protected final String TEXT_765 = NL + "                            System.err.print(e_";
  protected final String TEXT_766 = ".getMessage());";
  protected final String TEXT_767 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_787 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_788 = " = insertedCount_";
  protected final String TEXT_789 = " + pstmtInsert_";
  protected final String TEXT_790 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_791 = "++;";
  protected final String TEXT_792 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_793 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_794 = " = true;";
  protected final String TEXT_795 = NL + "                        throw(e_";
  ...
  protected final String TEXT_807 = NL + "                            rejectedCount_";
  protected final String TEXT_808 = " = rejectedCount_";
  protected final String TEXT_809 = " + 1;";
  protected final String TEXT_810 = NL + "                            ";
  protected final String TEXT_811 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_812 = ").getSQLState();";
  ...
  protected final String TEXT_821 = "=0;" + NL + "    \t    ";
  ...
  protected final String TEXT_832 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_860 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_861 = "=pstmtUpdate_";
  protected final String TEXT_862 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_863 = " = updatedCount_";
  protected final String TEXT_864 = " + updateFlag_";
  protected final String TEXT_865 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_866 = " == 0) {" + NL + "            \t";
  protected final String TEXT_867 = NL + "\t\t\t\tquery_";
  protected final String TEXT_868 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_869 = NL + "                        ";
  protected final String TEXT_870 = NL + "                            query_";
  protected final String TEXT_871 = " = ";
  protected final String TEXT_872 = ";";
  protected final String TEXT_873 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_874 = ",";
  protected final String TEXT_875 = ".";
  protected final String TEXT_876 = ", ";
  protected final String TEXT_877 = ",insertSQLSplits_";
  protected final String TEXT_878 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_879 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_880 = ".";
  protected final String TEXT_881 = ", pstmtInsert_";
  ...
  protected final String TEXT_888 = NL + "                    insertedCount_";
  protected final String TEXT_889 = " = insertedCount_";
  protected final String TEXT_890 = " + pstmtInsert_";
  protected final String TEXT_891 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_892 = "++;";
  protected final String TEXT_893 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_894 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_895 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_896 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_897 = " = true;";
  ...
  protected final String TEXT_914 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_915 = ").getSQLState();";
  protected final String TEXT_916 = NL + "                            ";
  protected final String TEXT_917 = ".errorMessage = e_";
  protected final String TEXT_918 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_919 = ";";
  protected final String TEXT_920 = NL + "                            System.err.print(e_";
  protected final String TEXT_921 = ".getMessage());";
  ...
  protected final String TEXT_930 = NL + "                        query_";
  protected final String TEXT_931 = " = ";
  protected final String TEXT_932 = ";";
  protected final String TEXT_933 = NL + "                globalMap.put(\"";
  protected final String TEXT_934 = "_QUERY\", query_";
  protected final String TEXT_935 = ".toString().trim());";
  protected final String TEXT_936 = NL + "    \t\t";
  protected final String TEXT_937 = NL + "    \t\t\tpstmt_";
  protected final String TEXT_938 = ".addBatch();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_939 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_940 = NL + "\t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_941 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_942 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_943 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_944 = " = deletedCount_";
  protected final String TEXT_945 = " + pstmt_";
  protected final String TEXT_946 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_947 = "++;";
  protected final String TEXT_948 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_949 = ") {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_963 = NL + "                        rejectedCount_";
  protected final String TEXT_964 = " = rejectedCount_";
  protected final String TEXT_965 = " + 1;";
  protected final String TEXT_966 = NL + "                        ";
  protected final String TEXT_967 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_968 = ").getSQLState();";
  protected final String TEXT_969 = NL + "                        ";
  protected final String TEXT_970 = ".errorMessage = e_";
  protected final String TEXT_971 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_972 = ";";
  protected final String TEXT_973 = NL + "                        System.err.print(e_";
  protected final String TEXT_974 = ".getMessage());";
  protected final String TEXT_975 = NL + "            }";
  protected final String TEXT_976 = NL + "    \t";
  protected final String TEXT_977 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_988 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_989 = " <= batchSizeCounter_";
  protected final String TEXT_990 = ") {                ";
  protected final String TEXT_991 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_1010 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1011 = "){" + NL + "                \t";
  protected final String TEXT_1012 = NL + "                \t\tthrow(e_";
  protected final String TEXT_1013 = ");" + NL + "                \t";
  protected final String TEXT_1014 = NL + "                \tint countSum_";
  protected final String TEXT_1015 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1016 = ": e_";
  protected final String TEXT_1017 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1018 = " += (countEach_";
  protected final String TEXT_1019 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1020 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1021 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1022 = " += countSum_";
  protected final String TEXT_1023 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_1024 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1025 = " += countSum_";
  protected final String TEXT_1026 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1027 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1028 = " += countSum_";
  protected final String TEXT_1029 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1030 = " " + NL + "                \tSystem.err.println(e_";
  protected final String TEXT_1031 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1032 = NL + "                }";
  protected final String TEXT_1033 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1034 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1035 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1036 = " <= commitCounter_";
  protected final String TEXT_1037 = ") {" + NL + "                ";
  protected final String TEXT_1038 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1039 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1040 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1041 = ": pstmt_";
  protected final String TEXT_1042 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1043 = " += (countEach_";
  protected final String TEXT_1044 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1045 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1046 = NL + "            \t    \t";
  protected final String TEXT_1047 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1048 = " += countSum_";
  protected final String TEXT_1049 = ";" + NL + "            \t    \t";
  protected final String TEXT_1050 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1051 = " += countSum_";
  protected final String TEXT_1052 = ";" + NL + "            \t    \t";
  protected final String TEXT_1053 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1054 = " += countSum_";
  protected final String TEXT_1055 = ";" + NL + "            \t    \t";
  protected final String TEXT_1056 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1057 = "){" + NL + "                \t";
  protected final String TEXT_1058 = NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1059 = ");" + NL + "                \t";
  protected final String TEXT_1060 = NL + "                \t\tint countSum_";
  protected final String TEXT_1061 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1062 = ": e_";
  protected final String TEXT_1063 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1076 = NL + "                        System.err.println(e_";
  protected final String TEXT_1077 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1078 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1079 = NL + "                \t";
  protected final String TEXT_1080 = NL + "                \tconn_";
  protected final String TEXT_1081 = ".commit();                " + NL + "                \t";
  protected final String TEXT_1082 = "   " + NL + "                \tcommitCounter_";
  protected final String TEXT_1083 = "=0;" + NL + "                }\t";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(TEXT_939);
				...
				dbLog.data().addingToBatch(dbLog.var("nb_line"), dbLog.str(dataAction));if (useBatchSize && !("").equals(batchSize) && !("0").equals(batchSize)) {
