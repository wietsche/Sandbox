...
public class TEXistXUpdateBeginJava
{
  ...
  protected final String TEXT_70 = NL + "\torg.xmldb.api.modules.XUpdateQueryService service_";
  protected final String TEXT_71 = " = (org.xmldb.api.modules.XUpdateQueryService) col_";
  protected final String TEXT_72 = ".getService(\"XUpdateQueryService\", \"1.0\");" + NL + "\tjava.io.File file_";
  protected final String TEXT_73 = " = new java.io.File(";
  protected final String TEXT_74 = ");" + NL + "\tjava.io.BufferedReader br_";
  protected final String TEXT_75 = " = new java.io.BufferedReader(new java.io.FileReader(file_";
  protected final String TEXT_76 = "));" + NL + "\tchar[] characters_";
  protected final String TEXT_77 = " = new char[new Long(file_";
  protected final String TEXT_78 = ".length()).intValue()];" + NL + "\tbr_";
  protected final String TEXT_79 = ".read(characters_";
  protected final String TEXT_80 = ", 0, new Long(file_";
  protected final String TEXT_81 = ".length()).intValue());" + NL + "\tbr_";
  protected final String TEXT_82 = ".close();" + NL + "\tString xUpdateModifications_";
  protected final String TEXT_83 = " = new String(characters_";
  protected final String TEXT_84 = ");" + NL + "\t";
  protected final String TEXT_85 = NL + "\t";
  protected final String TEXT_86 = NL + "\tservice_";
  protected final String TEXT_87 = ".update(xUpdateModifications_";
