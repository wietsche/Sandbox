...
public class TDB2CommitMainJava
{
  protected static String nl;
  public static synchronized TDB2CommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2CommitMainJava result = new TDB2CommitMainJava();
    nl = null;
    return result;
  }
