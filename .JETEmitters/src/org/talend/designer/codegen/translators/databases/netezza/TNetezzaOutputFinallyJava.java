...
public class TNetezzaOutputFinallyJava
{
  protected static String nl;
  public static synchronized TNetezzaOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaOutputFinallyJava result = new TNetezzaOutputFinallyJava();
    nl = null;
    return result;
  }
