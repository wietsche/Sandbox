...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_30 = " = \"jdbc:ucanaccess://\" + ";
  ...
  protected final String TEXT_53 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_66 = NL + "\t\tString dbPwd_";
  protected final String TEXT_67 = " = decryptedPassword_";
  protected final String TEXT_68 = ";" + NL + "\t";
  protected final String TEXT_69 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_70 = " = null;" + NL + "\t";
  protected final String TEXT_71 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_72 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_74 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_75 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_77 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_78 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_80 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_81 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_83 = " - Written records count: \" + nb_line_";
  protected final String TEXT_84 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_86 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_88 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_89 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_91 = " - Writing the record \" + nb_line_";
  protected final String TEXT_92 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_94 = " - Processing the record \" + nb_line_";
  protected final String TEXT_95 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_97 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_98 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_100 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_101 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_103 = " - Uses an existing connection ";
  protected final String TEXT_104 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_106 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_107 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  ...
  protected final String TEXT_116 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\tconn_";
  protected final String TEXT_118 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\tconn_";
  protected final String TEXT_120 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\tconn_";
  protected final String TEXT_122 = ".setAutoCommit(";
  protected final String TEXT_123 = ");" + NL + "\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\tlog.";
  protected final String TEXT_125 = "(\"";
  protected final String TEXT_126 = " - \" + ";
  protected final String TEXT_127 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t    \t\tlog.";
  protected final String TEXT_129 = "(\"";
  protected final String TEXT_130 = "\");" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_132 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_134 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_135 = ": pstmt_";
  protected final String TEXT_136 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_137 = " += (countEach_";
  protected final String TEXT_138 = " < 0 ? 0 : ";
  protected final String TEXT_139 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t";
  protected final String TEXT_141 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_149 = NL + "\tif (null != conn_";
