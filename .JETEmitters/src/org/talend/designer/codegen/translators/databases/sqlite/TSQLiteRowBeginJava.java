...
public class TSQLiteRowBeginJava
{
  ...
  protected final String TEXT_122 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_123 = ";" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_125 = " = null;" + NL + "\tString query_";
  protected final String TEXT_126 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_130 = ".prepareStatement(";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(TEXT_123);
		...
		public void createConnection(INode node) {
			this.createConnection(node, false);
		}
	}
