...
public class TRedshiftRollbackMainJava
{
  protected static String nl;
  public static synchronized TRedshiftRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftRollbackMainJava result = new TRedshiftRollbackMainJava();
    nl = null;
    return result;
  }
