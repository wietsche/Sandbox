...
public class TAccessRowMainJava
{
  protected static String nl;
  public static synchronized TAccessRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessRowMainJava result = new TAccessRowMainJava();
    nl = null;
    return result;
  }
