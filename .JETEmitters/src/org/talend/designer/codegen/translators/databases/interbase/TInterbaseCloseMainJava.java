...
public class TInterbaseCloseMainJava
{
  protected static String nl;
  public static synchronized TInterbaseCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseCloseMainJava result = new TInterbaseCloseMainJava();
    nl = null;
    return result;
  }
