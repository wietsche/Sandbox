...
public class TMongoDBInputEndJava
{
  ...
  protected final String TEXT_30 = NL + "\t\t\t}finally{" + NL + "\t\t\t\tif(mongo_";
  protected final String TEXT_31 = " != null )" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_32 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_33 = " - Closing the connection \" + mongo_";
  protected final String TEXT_34 = ".getServerAddressList() + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\t\t\tmongo_";
  protected final String TEXT_36 = ".close();" + NL + "\t\t\t\t\t";
  protected final String TEXT_37 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_38 = " - The connection was closed successfully.\");" + NL + "\t\t\t\t\t";
