...
public class TFirebirdRowBeginJava
{
  protected static String nl;
  public static synchronized TFirebirdRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdRowBeginJava result = new TFirebirdRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_123 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_130 = " = null;" + NL + "\tString query_";
  protected final String TEXT_131 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_135 = ".prepareStatement(";
  protected final String TEXT_136 = ");\t" + NL + "\t";
  protected final String TEXT_137 = NL + "\t\tjava.sql.Statement stmt_";
