...
public class TVectorWiseCommitMainJava
{
  protected static String nl;
  public static synchronized TVectorWiseCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseCommitMainJava result = new TVectorWiseCommitMainJava();
    nl = null;
    return result;
  }
