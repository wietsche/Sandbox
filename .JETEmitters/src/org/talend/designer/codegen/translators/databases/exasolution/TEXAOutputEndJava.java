...
public class TEXAOutputEndJava
{
  ...
  protected final String TEXT_75 = NL + "        }catch (java.sql.BatchUpdateException e){";
  ...
  protected final String TEXT_99 = ".commit();";
  protected final String TEXT_100 = NL + "        conn_";
  protected final String TEXT_101 = " .close();";
  protected final String TEXT_102 = NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_103 = "\", true);";
  protected final String TEXT_104 = NL;
  protected final String TEXT_105 = NL + "\tnb_line_deleted_";
  protected final String TEXT_106 = "=nb_line_deleted_";
  protected final String TEXT_107 = "+ deletedCount_";
  protected final String TEXT_108 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_109 = "=nb_line_update_";
  protected final String TEXT_110 = " + updatedCount_";
  protected final String TEXT_111 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_112 = "=nb_line_inserted_";
  protected final String TEXT_113 = " + insertedCount_";
  protected final String TEXT_114 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_115 = "=nb_line_rejected_";
  protected final String TEXT_116 = " + rejectedCount_";
  protected final String TEXT_117 = ";" + NL + "\t";
  protected final String TEXT_118 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_119 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_120 = "_NB_LINE\",nb_line_";
  protected final String TEXT_121 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_122 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_123 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_124 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_125 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_127 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_128 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_130 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_131 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_132 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_133 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_134 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_137 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_139 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_140 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_142 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_143 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_146 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
