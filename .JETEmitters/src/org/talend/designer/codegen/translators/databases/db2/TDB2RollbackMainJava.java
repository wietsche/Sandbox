...
public class TDB2RollbackMainJava
{
  protected static String nl;
  public static synchronized TDB2RollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDB2RollbackMainJava result = new TDB2RollbackMainJava();
    nl = null;
    return result;
  }
