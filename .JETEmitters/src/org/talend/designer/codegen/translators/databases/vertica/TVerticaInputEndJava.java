...
public class TVerticaInputEndJava
{
  protected static String nl;
  public static synchronized TVerticaInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaInputEndJava result = new TVerticaInputEndJava();
    nl = null;
    return result;
  }
