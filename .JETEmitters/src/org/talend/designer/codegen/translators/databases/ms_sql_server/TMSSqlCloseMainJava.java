...
public class TMSSqlCloseMainJava
{
  protected static String nl;
  public static synchronized TMSSqlCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlCloseMainJava result = new TMSSqlCloseMainJava();
    nl = null;
    return result;
  }
