...
public class TAccessOutputEndJava
{
  ...
  protected final String TEXT_59 = ".commit();";
  protected final String TEXT_60 = NL + "\t";
  protected final String TEXT_61 = NL + "    conn_";
  protected final String TEXT_62 = " .close();";
  protected final String TEXT_63 = NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_64 = "\", true);" + NL + "\t";
  protected final String TEXT_65 = NL + "    int rejectedCount_";
  protected final String TEXT_66 = " = 0;";
  protected final String TEXT_67 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_81 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_82 = "_NB_LINE\",nb_line_";
  protected final String TEXT_83 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_84 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_85 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_86 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_87 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_88 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_89 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_90 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_91 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_92 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_93 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_94 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_95 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_96 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_97 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_98 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_99 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_102 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_103 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_104 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_105 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_106 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_107 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_108 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_112 = "_NB_LINE\",nb_line_";
  ...
  protected final String TEXT_116 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_117 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_118 = "_NB_LINE_DELETED\",nb_line_deleted_";
