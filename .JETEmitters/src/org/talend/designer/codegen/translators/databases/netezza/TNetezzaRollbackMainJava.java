...
public class TNetezzaRollbackMainJava
{
  protected static String nl;
  public static synchronized TNetezzaRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaRollbackMainJava result = new TNetezzaRollbackMainJava();
    nl = null;
    return result;
  }
