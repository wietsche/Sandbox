...
public class TEXAConnectionBeginJava
{
  ...
  protected final String TEXT_129 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_140 = NL + "   // provide the schema for usage in input and output components" + NL + "   // schemas are always in upper case letters" + NL + "\tglobalMap.put(\"schema_\" + \"";
  protected final String TEXT_141 = "\",";
  protected final String TEXT_142 = ");" + NL + "    // provide the connection for further usage in other components" + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_143 = "\",conn_";
  protected final String TEXT_144 = ");" + NL + "\tglobalMap.put(\"host_\" + \"";
  protected final String TEXT_145 = "\", ";
  protected final String TEXT_146 = "); " + NL + "\tglobalMap.put(\"port_\" + \"";
  protected final String TEXT_147 = "\", ";
  protected final String TEXT_148 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_149 = "\", ";
  protected final String TEXT_150 = "); " + NL + "\tglobalMap.put(\"password_\" + \"";
