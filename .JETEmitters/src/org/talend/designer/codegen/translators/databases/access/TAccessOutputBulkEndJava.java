...
public class TAccessOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TAccessOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessOutputBulkEndJava result = new TAccessOutputBulkEndJava();
    nl = null;
    return result;
  }
