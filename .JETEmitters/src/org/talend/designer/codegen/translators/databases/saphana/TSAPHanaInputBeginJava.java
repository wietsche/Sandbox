...
public class TSAPHanaInputBeginJava
{
  protected static String nl;
  public static synchronized TSAPHanaInputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaInputBeginJava result = new TSAPHanaInputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_175 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_176 = " + \":\" + ";
  protected final String TEXT_177 = " ;" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_180 = " != null && dbProperties_";
  protected final String TEXT_181 = ".trim().length() > 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_182 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_183 = " + \":\" + ";
  protected final String TEXT_184 = " + \"/?\" + dbProperties_";
