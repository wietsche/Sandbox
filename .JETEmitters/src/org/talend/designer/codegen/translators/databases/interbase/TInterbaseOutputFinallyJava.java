...
public class TInterbaseOutputFinallyJava
{
  protected static String nl;
  public static synchronized TInterbaseOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInterbaseOutputFinallyJava result = new TInterbaseOutputFinallyJava();
    nl = null;
    return result;
  }
