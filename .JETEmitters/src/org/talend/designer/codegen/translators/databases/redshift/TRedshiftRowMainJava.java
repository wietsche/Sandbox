...
public class TRedshiftRowMainJava
{
  protected static String nl;
  public static synchronized TRedshiftRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftRowMainJava result = new TRedshiftRowMainJava();
    nl = null;
    return result;
  }
