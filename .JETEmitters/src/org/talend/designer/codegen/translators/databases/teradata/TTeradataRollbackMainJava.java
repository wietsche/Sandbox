...
public class TTeradataRollbackMainJava
{
  protected static String nl;
  public static synchronized TTeradataRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataRollbackMainJava result = new TTeradataRollbackMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_112 = NL + "java.sql.Connection conn_";
  protected final String TEXT_113 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_114 = "\");" + NL + "" + NL + "if(conn_";
  protected final String TEXT_115 = " != null && !conn_";
  protected final String TEXT_116 = ".isClosed()) {";
  protected final String TEXT_117 = NL + "        try{";
  protected final String TEXT_118 = NL + "        }finally{";
  protected final String TEXT_119 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_120 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_121 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_122 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_123 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_124 = ");" + NL + "                           }catch(Exception e){" + NL + "                               System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_125 = NL + "             }catch(Exception e){";
  protected final String TEXT_126 = NL + "                    System.err.println(e.getMessage());" + NL + "             }";
