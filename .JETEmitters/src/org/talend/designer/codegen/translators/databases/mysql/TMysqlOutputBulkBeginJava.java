...
public class TMysqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_44 = ";" + NL + "\t\tString fieldSeparator_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";" + NL + "\t\tchar escapeChar_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "\t\tchar textEnclosure_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\t\tescapeChar_";
  protected final String TEXT_52 = " = '\\\\';";
  protected final String TEXT_53 = NL + "\t\tint escape_mode_";
  protected final String TEXT_54 = " = 0;  // 0: double quotes; 1: backslash" + NL + "\t\tif(escapeChar_";
  protected final String TEXT_55 = "=='\\\\'){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_56 = " = 1;" + NL + "\t\t}else if(escapeChar_";
  protected final String TEXT_57 = " == textEnclosure_";
  protected final String TEXT_58 = "){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_59 = " = 0;" + NL + "\t\t}else {" + NL + "\t\t\tthrow new RuntimeException(\"The escape mode only support the '\\\\' or double text enclosure.\");" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_60 = " = new java.io.File(";
  protected final String TEXT_61 = ");\t\t" + NL + "" + NL + "\t\t";
  protected final String TEXT_62 = NL + "        java.io.File parentFile_";
  protected final String TEXT_63 = " = file_";
  protected final String TEXT_64 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_65 = " != null && !parentFile_";
  protected final String TEXT_66 = ".exists()){" + NL + "            String absolutePath_";
  protected final String TEXT_67 = " = parentFile_";
  protected final String TEXT_68 = ".getAbsolutePath();";
  protected final String TEXT_69 = NL + "            if(parentFile_";
  protected final String TEXT_70 = ".mkdirs()){";
  protected final String TEXT_71 = NL + "                System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_72 = "+\"' has been created successfully.\");" + NL + "            }else{";
  protected final String TEXT_73 = NL + "                System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_74 = "+\"'.\");" + NL + "            }" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\t" + NL + "\t\tjava.io.BufferedWriter csvWriter_";
  ...
  protected final String TEXT_79 = "));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_80 = "\", csvWriter_";
  protected final String TEXT_81 = "); ";
  protected final String TEXT_82 = NL + "      \tlong diskSpace_";
