...
public class TNetezzaCommitMainJava
{
  protected static String nl;
  public static synchronized TNetezzaCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaCommitMainJava result = new TNetezzaCommitMainJava();
    nl = null;
    return result;
  }
