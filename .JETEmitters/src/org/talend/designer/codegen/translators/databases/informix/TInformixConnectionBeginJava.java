...
public class TInformixConnectionBeginJava
{
  ...
  protected final String TEXT_30 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_31 = " + \":\" + ";
  protected final String TEXT_32 = " + \"/\" + ";
  protected final String TEXT_33 = " + \":informixserver=\" + ";
  protected final String TEXT_34 = ";";
  protected final String TEXT_35 = NL + "\t\t        String url_";
  protected final String TEXT_36 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_37 = " + \":\" + ";
  protected final String TEXT_38 = " + \"/\" + ";
  protected final String TEXT_39 = " + \":informixserver=\" + ";
  protected final String TEXT_40 = " + \";\" + ";
  protected final String TEXT_41 = ";";
  protected final String TEXT_42 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_43 = " - Connection is set auto commit to '";
  protected final String TEXT_44 = "'.\");";
  protected final String TEXT_45 = NL + "\t\t\tconn_";
  protected final String TEXT_46 = ".setAutoCommit(";
  protected final String TEXT_47 = ");";
  protected final String TEXT_48 = NL + "\t\t\tglobalMap.put(\"dbserver_";
  protected final String TEXT_49 = "\",";
  protected final String TEXT_50 = ");" + NL + "\t\t\tglobalMap.put(\"dbname_";
  ...
  protected final String TEXT_142 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_155 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
