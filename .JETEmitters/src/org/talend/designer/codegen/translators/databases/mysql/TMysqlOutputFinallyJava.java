...
public class TMysqlOutputFinallyJava
{
  protected static String nl;
  public static synchronized TMysqlOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlOutputFinallyJava result = new TMysqlOutputFinallyJava();
    nl = null;
    return result;
  }
