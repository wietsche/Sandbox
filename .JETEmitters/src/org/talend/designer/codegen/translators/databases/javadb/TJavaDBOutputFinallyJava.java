...
public class TJavaDBOutputFinallyJava
{
  ...
  protected final String TEXT_44 = "\")==null){" + NL + "\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_45 = "\")!=null){" + NL + "\t\t\ttry" + NL + "\t    \t{" + NL + "\t    \t\t";
  protected final String TEXT_46 = NL + "\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_47 = "\")).close();" + NL + "\t\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\t";
  protected final String TEXT_49 = NL + "\t    \t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t    \t}" + NL + "\t    \tcatch(java.sql.SQLException sqlEx_";
  protected final String TEXT_51 = ")" + NL + "\t    \t{" + NL + "\t    \t\tString errorMessage_";
  protected final String TEXT_52 = " = \"failed to close the connection in ";
  protected final String TEXT_53 = " :\" + sqlEx_";
