...
public class TInformixRowBeginJava
{
  ...
  protected final String TEXT_123 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_124 = " + \":\" + ";
  protected final String TEXT_125 = " + \"/\" + ";
  protected final String TEXT_126 = " + \":informixserver=\" + ";
  protected final String TEXT_127 = ";" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tString url_";
  protected final String TEXT_129 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_130 = " + \":\" + ";
  protected final String TEXT_131 = " + \"/\" + ";
  protected final String TEXT_132 = " + \":informixserver=\" + ";
  protected final String TEXT_133 = " + \";\" + ";
  protected final String TEXT_134 = ";" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_136 = " = null;" + NL + "\tString query_";
  protected final String TEXT_137 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_138 = " = false;";
  protected final String TEXT_139 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_140 = " = conn_";
  protected final String TEXT_141 = ".prepareStatement(";
  protected final String TEXT_142 = ");\t" + NL + "\t";
  protected final String TEXT_143 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "\t";
