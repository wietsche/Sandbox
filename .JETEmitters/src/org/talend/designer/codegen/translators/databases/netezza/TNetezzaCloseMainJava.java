...
public class TNetezzaCloseMainJava
{
  protected static String nl;
  public static synchronized TNetezzaCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNetezzaCloseMainJava result = new TNetezzaCloseMainJava();
    nl = null;
    return result;
  }
