...
public class TParAccelConnectionBeginJava
{
  ...
  protected final String TEXT_29 = " = \"jdbc:paraccel://\"+";
  ...
  protected final String TEXT_122 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_123 = ")) {";
  protected final String TEXT_124 = NL + "\t\t";
  protected final String TEXT_125 = NL + "\t\t";
  protected final String TEXT_126 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_127 = "\", conn_";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "\t}";
  protected final String TEXT_130 = NL + "\tif (null != conn_";
  protected final String TEXT_131 = ") {" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t}";
  protected final String TEXT_133 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
  protected final String TEXT_134 = "\",";
  protected final String TEXT_135 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_\" + \"";
