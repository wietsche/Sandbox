...
public class TIngresOutputFinallyJava
{
  protected static String nl;
  public static synchronized TIngresOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresOutputFinallyJava result = new TIngresOutputFinallyJava();
    nl = null;
    return result;
  }
