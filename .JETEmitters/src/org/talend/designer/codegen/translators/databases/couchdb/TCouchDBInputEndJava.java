...
public class TCouchDBInputEndJava
{
  protected static String nl;
  public static synchronized TCouchDBInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCouchDBInputEndJava result = new TCouchDBInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_32 = NL + "\t\tif(client_";
  protected final String TEXT_33 = " != null){" + NL + "\t\t\t";
  protected final String TEXT_34 = NL + "\t\t\t\tif(replications_";
  protected final String TEXT_35 = " != null && replications_";
  protected final String TEXT_36 = ".size()>0){" + NL + "\t\t\t\t\tfor(org.lightcouch.Replication replication_";
  protected final String TEXT_37 = " : replications_";
  protected final String TEXT_38 = "){" + NL + "\t\t\t\t\t\treplication_";
  protected final String TEXT_39 = ".trigger();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\tclient_";
  protected final String TEXT_41 = ".shutdown();" + NL + "\t\t}" + NL + "\t";
