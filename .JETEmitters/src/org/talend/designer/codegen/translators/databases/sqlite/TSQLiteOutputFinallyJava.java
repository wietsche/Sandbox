...
public class TSQLiteOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSQLiteOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSQLiteOutputFinallyJava result = new TSQLiteOutputFinallyJava();
    nl = null;
    return result;
  }
