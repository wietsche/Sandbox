...
public class TVerticaCommitMainJava
{
  protected static String nl;
  public static synchronized TVerticaCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaCommitMainJava result = new TVerticaCommitMainJava();
    nl = null;
    return result;
  }
