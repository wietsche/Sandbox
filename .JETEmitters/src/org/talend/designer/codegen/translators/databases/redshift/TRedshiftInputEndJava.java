...
public class TRedshiftInputEndJava
{
  protected static String nl;
  public static synchronized TRedshiftInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftInputEndJava result = new TRedshiftInputEndJava();
    nl = null;
    return result;
  }
