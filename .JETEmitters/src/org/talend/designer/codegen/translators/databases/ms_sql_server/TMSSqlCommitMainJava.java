...
public class TMSSqlCommitMainJava
{
  protected static String nl;
  public static synchronized TMSSqlCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlCommitMainJava result = new TMSSqlCommitMainJava();
    nl = null;
    return result;
  }
