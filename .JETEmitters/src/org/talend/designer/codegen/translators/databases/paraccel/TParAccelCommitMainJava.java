...
public class TParAccelCommitMainJava
{
  protected static String nl;
  public static synchronized TParAccelCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelCommitMainJava result = new TParAccelCommitMainJava();
    nl = null;
    return result;
  }
