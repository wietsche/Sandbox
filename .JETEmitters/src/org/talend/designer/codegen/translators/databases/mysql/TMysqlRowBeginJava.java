...
public class TMysqlRowBeginJava
{
  ...
  protected final String TEXT_127 = NL + "\t\t\t\tString url_";
  ...
  protected final String TEXT_135 = " = null;" + NL + "\tString query_";
  protected final String TEXT_136 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_137 = " = false;";
  protected final String TEXT_138 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = ".prepareStatement(";
  protected final String TEXT_141 = ");\t" + NL + "\t";
  protected final String TEXT_142 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_143 = " = conn_";
  protected final String TEXT_144 = ".createStatement();" + NL + "\t";
