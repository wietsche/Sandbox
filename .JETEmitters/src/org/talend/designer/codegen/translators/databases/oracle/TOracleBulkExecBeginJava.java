...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_628 = NL + NL + "String command_";
  ...
  protected final String TEXT_635 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_636 = " = conn_";
  protected final String TEXT_637 = ".createStatement();";
  protected final String TEXT_638 = NL + "        log.info(\"";
  protected final String TEXT_639 = " - Creating temp table ";
  protected final String TEXT_640 = "\" + tableName_";
  protected final String TEXT_641 = " + \"";
  protected final String TEXT_642 = ".\" );";
  protected final String TEXT_643 = NL + "    stmtCreateTmp_";
  protected final String TEXT_644 = ".execute(\"";
  protected final String TEXT_645 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_646 = ".close();";
  protected final String TEXT_647 = NL + "        log.info(\"";
  protected final String TEXT_648 = " - Create temp table ";
  protected final String TEXT_649 = "\" + tableName_";
  protected final String TEXT_650 = " + \"";
  protected final String TEXT_651 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_652 = " - Executing command:'\" + command_";
  protected final String TEXT_653 = " + \"'.\");";
  protected final String TEXT_654 = NL + "    final Process process_";
  protected final String TEXT_655 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_656 = ");";
  protected final String TEXT_657 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_658 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_659 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_660 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_661 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_662 = NL + "        envParam_";
  protected final String TEXT_663 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_664 = "\");";
  protected final String TEXT_665 = NL + "        envParam_";
  protected final String TEXT_666 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_667 = "\");";
  protected final String TEXT_668 = NL + "            envParam_";
  protected final String TEXT_669 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_670 = "\");";
  protected final String TEXT_671 = NL + "        envParam_";
  protected final String TEXT_672 = ".add(\"";
  protected final String TEXT_673 = "=";
  protected final String TEXT_674 = "\");";
  protected final String TEXT_675 = NL + "        log.info(\"";
  protected final String TEXT_676 = " - Executing command:'\" + command_";
  protected final String TEXT_677 = " + \"'.\");";
  protected final String TEXT_678 = NL + "    final Process process_";
  protected final String TEXT_679 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_680 = ",envParam_";
  protected final String TEXT_681 = ".toArray(new String[0]));";
  protected final String TEXT_682 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_683 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_684 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_685 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_686 = NL + "                        System.out.println(line);";
  protected final String TEXT_687 = NL + "                        globalMap.put(\"";
  protected final String TEXT_688 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_689 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_690 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_691 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_692 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_693 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_694 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_695 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_696 = NL + "                       System.err.println(line);";
  protected final String TEXT_697 = NL + "                       globalMap.put(\"";
  protected final String TEXT_698 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_699 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_700 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_701 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_702 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_703 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_704 = " = process_";
  protected final String TEXT_705 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_706 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_707 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_708 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_709 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_710 = NL + "    log.info(\"";
  protected final String TEXT_711 = " - Excute command: '\" + command_";
  protected final String TEXT_712 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_713 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_714 = " + \"'.\");";
  protected final String TEXT_715 = NL + "java.io.BufferedReader lr_";
  protected final String TEXT_716 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_717 = "));" + NL + "int nb_line_data_";
  protected final String TEXT_718 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_719 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_720 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_721 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_722 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_723 = " =0;//log file lines count" + NL + "//1" + NL + "class LogUtil_";
  protected final String TEXT_724 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "}" + NL + "int lastTableLine_";
  protected final String TEXT_725 = " = 0;//Line Number of the last table name" + NL + "while ((tempLine_";
  protected final String TEXT_726 = " = lr_";
  protected final String TEXT_727 = ".readLine() )!= null) {" + NL + "    countLines_";
  protected final String TEXT_728 = "++;" + NL + "    if(tempLine_";
  protected final String TEXT_729 = ".toUpperCase().indexOf(\"TABLE \"+(tableName_";
  protected final String TEXT_730 = ").toUpperCase())>-1){" + NL + "        lastTableLine_";
  protected final String TEXT_731 = " = countLines_";
  protected final String TEXT_732 = ";" + NL + "    }" + NL + "}" + NL + "lr_";
  protected final String TEXT_733 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_734 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_735 = "));" + NL + "for (int i_";
  protected final String TEXT_736 = "=0; i_";
  protected final String TEXT_737 = "<= lastTableLine_";
  protected final String TEXT_738 = "; i_";
  protected final String TEXT_739 = "++) {" + NL + "    lr_";
  protected final String TEXT_740 = ".readLine();" + NL + "}" + NL + "    boolean isNumber_";
  protected final String TEXT_741 = "=false;" + NL + "    tempLine_";
  protected final String TEXT_742 = " = lr_";
  protected final String TEXT_743 = ".readLine();" + NL + "    int emptyLineNum_";
  protected final String TEXT_744 = " =0;//The number of empty block" + NL + "    boolean isFirstEmptyLine_";
  protected final String TEXT_745 = " = false;//Is the first empty line of empty block" + NL + "for (int i_";
  protected final String TEXT_746 = "=lastTableLine_";
  protected final String TEXT_747 = "+2; i_";
  protected final String TEXT_748 = "<= countLines_";
  protected final String TEXT_749 = "; i_";
  protected final String TEXT_750 = "++) {" + NL + "    tempLine_";
  protected final String TEXT_751 = " = lr_";
  protected final String TEXT_752 = ".readLine();" + NL + "    if(tempLine_";
  protected final String TEXT_753 = "!=null && tempLine_";
  protected final String TEXT_754 = ".trim().length()>0){" + NL + "        if(emptyLineNum_";
  protected final String TEXT_755 = "==2){" + NL + "            break;" + NL + "        }" + NL + "        isFirstEmptyLine_";
  protected final String TEXT_756 = " = false;" + NL + "        continue;//skip rows now empty" + NL + "    }else if (!isFirstEmptyLine_";
  protected final String TEXT_757 = "){//skip empty rows" + NL + "        isFirstEmptyLine_";
  protected final String TEXT_758 = " = true;" + NL + "        emptyLineNum_";
  protected final String TEXT_759 = "++;" + NL + "    }" + NL + "}" + NL + "    LogUtil_";
  protected final String TEXT_760 = " lu_";
  protected final String TEXT_761 = " = new LogUtil_";
  protected final String TEXT_762 = "();" + NL + "    nb_line_data_";
  protected final String TEXT_763 = " = lu_";
  protected final String TEXT_764 = ".getNumber(lr_";
  protected final String TEXT_765 = ");//get the number of data line" + NL + "    nb_line_bad_";
  protected final String TEXT_766 = " = lu_";
  protected final String TEXT_767 = ".getNumber(lr_";
  protected final String TEXT_768 = ");//get the number of reject data line" + NL + "    nb_line_discarded_";
  protected final String TEXT_769 = " = lu_";
  protected final String TEXT_770 = ".getNumber(lr_";
  protected final String TEXT_771 = ");//get the number of discarded data line" + NL + "    nb_line_inserted_";
  protected final String TEXT_772 = " = nb_line_data_";
  protected final String TEXT_773 = " - nb_line_bad_";
  protected final String TEXT_774 = " - nb_line_discarded_";
  protected final String TEXT_775 = ";" + NL + "lr_";
  protected final String TEXT_776 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_777 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_778 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_779 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_780 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_781 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_782 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_783 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_784 = ");";
  protected final String TEXT_785 = NL + "    log.info(\"";
  protected final String TEXT_786 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_787 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_788 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_789 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_790 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_791 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_792 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_793 = " + \"' finish.\");";
