...
public class TSybaseConnectionBeginJava
{
  ...
  protected final String TEXT_29 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_30 = " + \":\" + ";
  protected final String TEXT_31 = " + \"/\" + ";
  protected final String TEXT_32 = "; ";
  protected final String TEXT_33 = NL + "\t\tString url_";
  protected final String TEXT_34 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_139 = NL + "\t" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_140 = "\", conn_";
  protected final String TEXT_141 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_142 = "\", ";
  protected final String TEXT_143 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_144 = "\", ";
  protected final String TEXT_145 = ");" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_146 = "\", ";
  protected final String TEXT_147 = ");" + NL + "\tglobalMap.put(\"user_";
  protected final String TEXT_148 = "\", ";
  protected final String TEXT_149 = ");" + NL + "\tglobalMap.put(\"pass_";
  protected final String TEXT_150 = "\", dbPwd_";
  protected final String TEXT_151 = ");" + NL + "\tglobalMap.put(\"dbschema_";
