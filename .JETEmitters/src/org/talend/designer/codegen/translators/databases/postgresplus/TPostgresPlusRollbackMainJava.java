...
public class TPostgresPlusRollbackMainJava
{
  protected static String nl;
  public static synchronized TPostgresPlusRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusRollbackMainJava result = new TPostgresPlusRollbackMainJava();
    nl = null;
    return result;
  }
