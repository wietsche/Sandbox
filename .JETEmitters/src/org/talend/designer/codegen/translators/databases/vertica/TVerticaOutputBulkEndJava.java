...
public class TVerticaOutputBulkEndJava
{
  protected static String nl;
  public static synchronized TVerticaOutputBulkEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaOutputBulkEndJava result = new TVerticaOutputBulkEndJava();
    nl = null;
    return result;
  }
