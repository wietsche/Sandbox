...
public class TMysqlSPBeginJava
{
  ...
  protected final String TEXT_46 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_47 = "\");";
  protected final String TEXT_48 = " " + NL + "\t\tif (null == connection_";
  protected final String TEXT_49 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_50 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconnection_";
  protected final String TEXT_51 = " = dataSources_";
  protected final String TEXT_52 = ".get(";
  protected final String TEXT_53 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_54 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_55 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_56 = ") {" + NL + "\t\t\tconnection_";
  protected final String TEXT_57 = " = dataSources_";
  protected final String TEXT_58 = ".get(";
  protected final String TEXT_59 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_60 = NL + "    String dbProperties_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "    String connectionString_";
  protected final String TEXT_63 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_64 = " == null || dbProperties_";
  protected final String TEXT_65 = ".trim().length() == 0) {" + NL + "        connectionString_";
  protected final String TEXT_66 = " = \"";
  protected final String TEXT_67 = "://\" + ";
  protected final String TEXT_68 = " + \":\" + ";
  protected final String TEXT_69 = " + \"/\" + ";
  protected final String TEXT_70 = ";" + NL + "    } else {" + NL + "        connectionString_";
  protected final String TEXT_71 = " = \"";
  protected final String TEXT_72 = "://\" + ";
  protected final String TEXT_73 = " + \":\" + ";
  protected final String TEXT_74 = " + \"/\" + ";
  protected final String TEXT_75 = " + \"?\" + dbProperties_";
  protected final String TEXT_76 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_88 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_89 = "\");";
  protected final String TEXT_90 = NL + "    connection_";
  protected final String TEXT_91 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_92 = ", dbUser_";
  protected final String TEXT_93 = ", dbPwd_";
  protected final String TEXT_94 = ");";
  protected final String TEXT_95 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_96 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_97 = " = connection_";
  protected final String TEXT_98 = ".prepareCall(\"{";
  protected final String TEXT_99 = "call \" + ";
  protected final String TEXT_100 = " + \"(";
  protected final String TEXT_101 = "?";
  protected final String TEXT_102 = ",?";
  protected final String TEXT_103 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_104 = ";" + NL + "String tmpString_";
