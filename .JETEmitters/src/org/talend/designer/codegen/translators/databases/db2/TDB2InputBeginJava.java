...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_176 = " + \":\" + ";
  protected final String TEXT_177 = " + \"/\" + ";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "\t\t\tString url_";
  protected final String TEXT_180 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_187 = " = routines.system.JDBCUtil.getDoubleObject(rs_";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = "column_index_";
  protected final String TEXT_190 = ");";
  protected final String TEXT_191 = NL + "\t\t\t\t";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = " = routines.system.JDBCUtil.getDouble(rs_";
  protected final String TEXT_194 = ", ";
  protected final String TEXT_195 = "column_index_";
  protected final String TEXT_196 = ");";
  protected final String TEXT_197 = NL + "\t\t\t\t";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = " = routines.system.JDBCUtil.getBooleanObject(rs_";
  protected final String TEXT_200 = ", ";
  protected final String TEXT_201 = "column_index_";
  protected final String TEXT_202 = ");";
  protected final String TEXT_203 = NL + "\t\t\t\t";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = routines.system.JDBCUtil.getBoolean(rs_";
  protected final String TEXT_206 = ", ";
  protected final String TEXT_207 = "column_index_";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "    " + NL + "\t";
  protected final String TEXT_210 = NL + "\t\t    int nb_line_";
  protected final String TEXT_211 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_212 = " = null;";
  protected final String TEXT_213 = NL + "\t\t        conn_";
  protected final String TEXT_214 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_215 = "\");";
  protected final String TEXT_216 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_217 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_218 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_219 = " = dataSources_";
  protected final String TEXT_220 = ".get(";
  protected final String TEXT_221 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_222 = "\", conn_";
  protected final String TEXT_223 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_224 = NL + "\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\t";
  protected final String TEXT_226 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_227 = " =  conn_";
  protected final String TEXT_228 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_229 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_230 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_231 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_232 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_233 = NL + "                 conn_";
  protected final String TEXT_234 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_235 = NL + "               ";
  protected final String TEXT_236 = " + \"=\" + ";
  protected final String TEXT_237 = " + \";\" +";
  protected final String TEXT_238 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_239 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_240 = ");";
  protected final String TEXT_241 = NL + "\t\t    ";
  protected final String TEXT_242 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_243 = " = ";
  protected final String TEXT_244 = ";" + NL + "\t\t\t";
  protected final String TEXT_245 = NL + "                log.info(\"";
  protected final String TEXT_246 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_255 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_256 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_257 = " = stmt_";
  protected final String TEXT_258 = ".executeQuery(dbquery_";
  protected final String TEXT_259 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_260 = " = rs_";
  protected final String TEXT_261 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_262 = " = rsmd_";
  protected final String TEXT_263 = ".getColumnCount();" + NL;
  protected final String TEXT_264 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_265 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_266 = ".setDbmsId(\"";
  protected final String TEXT_267 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_268 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_269 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_270 = ".add(\"";
  protected final String TEXT_271 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_272 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_273 = " = ";
  protected final String TEXT_274 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_275 = "; i <= rsmd_";
  protected final String TEXT_276 = ".getColumnCount()-";
  protected final String TEXT_277 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_278 = ".contains(rsmd_";
  protected final String TEXT_279 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_280 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setName(rsmd_";
  protected final String TEXT_282 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setDbName(rsmd_";
  protected final String TEXT_284 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_286 = "\", rsmd_";
  protected final String TEXT_287 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_288 = ".getPrecision(i), rsmd_";
  protected final String TEXT_289 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_290 = ".setDbType(rsmd_";
  protected final String TEXT_291 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_292 = ".setDbTypeId(rsmd_";
  protected final String TEXT_293 = ".getColumnType(i));";
  protected final String TEXT_294 = NL + "                \tdcm_";
  protected final String TEXT_295 = ".setFormat(";
  protected final String TEXT_296 = ");";
  protected final String TEXT_297 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_298 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_299 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_300 = ".setLength(rsmd_";
  protected final String TEXT_301 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_302 = ".setLength(rsmd_";
  protected final String TEXT_303 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_304 = NL + "\t\t\tdcm_";
  protected final String TEXT_305 = ".setLength(rsmd_";
  protected final String TEXT_306 = ".getPrecision(i));";
  protected final String TEXT_307 = NL + "                \tdcm_";
  protected final String TEXT_308 = ".setPrecision(rsmd_";
  protected final String TEXT_309 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setNullable(rsmd_";
  protected final String TEXT_311 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_312 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_313 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_314 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_315 = ".metadatas.add(dcm_";
  protected final String TEXT_316 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_317 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_318 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_319 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_320 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_321 = NL + "\t\t    ";
  protected final String TEXT_322 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_323 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_324 = NL + "\t\t    while (rs_";
  protected final String TEXT_325 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_326 = "++;" + NL + "\t\t        ";
  protected final String TEXT_327 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_328 = " = ";
  protected final String TEXT_329 = " + dcg_";
  protected final String TEXT_330 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_332 = " = ";
  protected final String TEXT_333 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_347 = " = (List)rs_";
  ...
  protected final String TEXT_354 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_355 = ".getObject(";
  protected final String TEXT_356 = "column_index_";
  protected final String TEXT_357 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_358 = NL + "                                    ";
  protected final String TEXT_359 = ".";
  protected final String TEXT_360 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_376 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_377 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_378 = " = ";
  protected final String TEXT_379 = "; i_";
  protected final String TEXT_380 = "  <= rsmd_";
  protected final String TEXT_381 = ".getColumnCount(); i_";
  protected final String TEXT_382 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_383 = ".getColumnTypeName(i_";
  protected final String TEXT_384 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_385 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_386 = ".getClob(i_";
  protected final String TEXT_387 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_388 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_389 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_390 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_391 = ".add(tNTextImpl_";
  protected final String TEXT_392 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_393 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = ", rs_";
  protected final String TEXT_396 = ", fixedColumnCount_";
  protected final String TEXT_397 = ",list_";
  protected final String TEXT_398 = ",";
  protected final String TEXT_399 = ");";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_401 = ".";
  protected final String TEXT_402 = ", rs_";
  protected final String TEXT_403 = ", fixedColumnCount_";
  protected final String TEXT_404 = ",";
  protected final String TEXT_405 = ");";
  protected final String TEXT_406 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_407 = ".";
  protected final String TEXT_408 = ", rs_";
  protected final String TEXT_409 = ", fixedColumnCount_";
  protected final String TEXT_410 = ",";
  protected final String TEXT_411 = ");";
  protected final String TEXT_412 = NL + "                                  Object geom = rs_";
  protected final String TEXT_413 = ".getObject(";
  protected final String TEXT_414 = "column_index_";
  protected final String TEXT_415 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_418 = ".";
  protected final String TEXT_419 = " = null;" + NL + "                                  }";
  protected final String TEXT_420 = NL + "\t\t                          ";
  protected final String TEXT_421 = NL + "\t\t                    }";
  protected final String TEXT_422 = NL + "\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_424 = " - Retrieving the record \" + nb_line_";
