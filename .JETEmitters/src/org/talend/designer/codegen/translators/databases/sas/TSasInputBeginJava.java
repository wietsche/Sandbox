...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:sasiom://\"+";
  protected final String TEXT_176 = "+\":\"+";
  protected final String TEXT_177 = ";";
  protected final String TEXT_178 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_179 = " = \"";
  protected final String TEXT_180 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_181 = ");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  ...
  protected final String TEXT_193 = ";" + NL + "" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_194 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\tString librefs_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";" + NL + "\t\t\t\tproperty_";
  protected final String TEXT_198 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_199 = ");" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\tproperty_";
  protected final String TEXT_201 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_202 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_203 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_204 = ");" + NL + "\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\tproperty_";
  protected final String TEXT_206 = ".setProperty(String.valueOf(";
  protected final String TEXT_207 = "), String.valueOf(";
  protected final String TEXT_208 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\tconn_";
  protected final String TEXT_212 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_213 = ", property_";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "\t\t\tif(rs_";
  protected final String TEXT_216 = ".getString(";
  protected final String TEXT_217 = "column_index_";
  protected final String TEXT_218 = ")!=null&&(rs_";
  protected final String TEXT_219 = ".getString(";
  protected final String TEXT_220 = "column_index_";
  protected final String TEXT_221 = ")).length()>0){" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_226 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  ...
  protected final String TEXT_232 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_235 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_236 = ".getString(";
  protected final String TEXT_237 = "column_index_";
  protected final String TEXT_238 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_239 = ".";
  protected final String TEXT_240 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_241 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  protected final String TEXT_242 = NL + "\t\t\t  " + NL + "\t\t\t}\t\t";
  protected final String TEXT_243 = NL + "    " + NL + "\t";
  protected final String TEXT_244 = NL + "\t\t    int nb_line_";
  protected final String TEXT_245 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_246 = " = null;";
  protected final String TEXT_247 = NL + "\t\t        conn_";
  protected final String TEXT_248 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_249 = "\");";
  protected final String TEXT_250 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_251 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_252 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_253 = " = dataSources_";
  protected final String TEXT_254 = ".get(";
  protected final String TEXT_255 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_289 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_290 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  ...
  protected final String TEXT_416 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_417 = ".getColumnTypeName(i_";
  protected final String TEXT_418 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_419 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_420 = ".getClob(i_";
  protected final String TEXT_421 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_422 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_423 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_424 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_425 = ".add(tNTextImpl_";
  protected final String TEXT_426 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_427 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_428 = ".";
  protected final String TEXT_429 = ", rs_";
  protected final String TEXT_430 = ", fixedColumnCount_";
  protected final String TEXT_431 = ",list_";
  protected final String TEXT_432 = ",";
  protected final String TEXT_433 = ");";
  protected final String TEXT_434 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = ", rs_";
  protected final String TEXT_437 = ", fixedColumnCount_";
  protected final String TEXT_438 = ",";
  protected final String TEXT_439 = ");";
  protected final String TEXT_440 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = ", rs_";
  protected final String TEXT_443 = ", fixedColumnCount_";
  protected final String TEXT_444 = ",";
  protected final String TEXT_445 = ");";
  protected final String TEXT_446 = NL + "                                  Object geom = rs_";
  protected final String TEXT_447 = ".getObject(";
  protected final String TEXT_448 = "column_index_";
  protected final String TEXT_449 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_450 = ".";
  protected final String TEXT_451 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = " = null;" + NL + "                                  }";
