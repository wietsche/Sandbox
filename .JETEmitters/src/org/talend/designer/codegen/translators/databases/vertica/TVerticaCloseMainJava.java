...
public class TVerticaCloseMainJava
{
  protected static String nl;
  public static synchronized TVerticaCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVerticaCloseMainJava result = new TVerticaCloseMainJava();
    nl = null;
    return result;
  }
