...
public class TSybaseOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSybaseOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSybaseOutputFinallyJava result = new TSybaseOutputFinallyJava();
    nl = null;
    return result;
  }
