...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_950 = NL + "\t\tloadingCols_";
  protected final String TEXT_951 = ".append(\"ASCII(\" + ";
  protected final String TEXT_952 = " + \")\");";
  protected final String TEXT_953 = NL + "        \tloadingCols_";
  protected final String TEXT_954 = ".append(\"'\" + ";
  protected final String TEXT_955 = " + \"'\");";
  protected final String TEXT_956 = NL + "    loadingCols_";
  protected final String TEXT_957 = ".append(\")\");";
  protected final String TEXT_958 = NL + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_959 = "=conn_";
  protected final String TEXT_960 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_961 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "" + NL + "    //stmt_";
  protected final String TEXT_962 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "" + NL + "    String strSQL_";
  protected final String TEXT_963 = " = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_964 = " + loadingCols_";
  protected final String TEXT_965 = ".toString() ;";
  protected final String TEXT_966 = NL + "\t\tstrSQL_";
  protected final String TEXT_967 = " +=\" from '\" + ";
  protected final String TEXT_968 = " + \"' \";";
  protected final String TEXT_969 = NL + "\t\tstrSQL_";
  protected final String TEXT_970 = " +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_971 = " + \"' \";";
  protected final String TEXT_972 = NL;
  protected final String TEXT_973 = NL + "     strSQL_";
  protected final String TEXT_974 = " = strSQL_";
  protected final String TEXT_975 = " + \" row delimited by '\" + ";
  protected final String TEXT_976 = " + \"'\";" + NL + "\t strSQL_";
  protected final String TEXT_977 = "=strSQL_";
  protected final String TEXT_978 = " + \" quotes off\";";
  protected final String TEXT_979 = NL + "\tstrSQL_";
  protected final String TEXT_980 = "=strSQL_";
  protected final String TEXT_981 = " + \" quotes on \";";
  protected final String TEXT_982 = NL + "\tstrSQL_";
  protected final String TEXT_983 = "=strSQL_";
  protected final String TEXT_984 = " + \" quotes off \";";
  protected final String TEXT_985 = NL + "    strSQL_";
  protected final String TEXT_986 = " =strSQL_";
  protected final String TEXT_987 = " + \" escapes off \";" + NL;
  protected final String TEXT_988 = NL + "\tstrSQL_";
  protected final String TEXT_989 = " =strSQL_";
  protected final String TEXT_990 = " + \" skip 1 \";";
  protected final String TEXT_991 = NL + "\t\tlog.info(\"";
  protected final String TEXT_992 = " - Bulk load SQL:\"+strSQL_";
  protected final String TEXT_993 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_994 = " - Bulk loading data into ";
  protected final String TEXT_995 = "\" + tableName_";
  protected final String TEXT_996 = " + \"";
  protected final String TEXT_997 = ".\" );" + NL + "\t";
  protected final String TEXT_998 = NL + NL + "    stmt_";
  protected final String TEXT_999 = ".execute(strSQL_";
  protected final String TEXT_1000 = ");" + NL;
  protected final String TEXT_1001 = NL + "    if(conn_";
  protected final String TEXT_1002 = " != null && !conn_";
  protected final String TEXT_1003 = ".isClosed()) {";
