...
public class TPostgresPlusOutputFinallyJava
{
  protected static String nl;
  public static synchronized TPostgresPlusOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusOutputFinallyJava result = new TPostgresPlusOutputFinallyJava();
    nl = null;
    return result;
  }
