...
public class THSQLDbRowBeginJava
{
  ...
  protected final String TEXT_125 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_126 = " + \":\" + ";
  protected final String TEXT_127 = " + \"/\" + ";
  protected final String TEXT_128 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_130 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_131 = " + \":\" + ";
  protected final String TEXT_132 = " + \"/\" + ";
  protected final String TEXT_133 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_135 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_136 = " + \":\" + ";
  protected final String TEXT_137 = " + \"/\" + ";
  protected final String TEXT_138 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\turl_";
  protected final String TEXT_140 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_141 = " + \":\" + ";
  protected final String TEXT_142 = " + \"/\" + ";
  protected final String TEXT_143 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\turl_";
  protected final String TEXT_145 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_146 = " + \"/\" + ";
  protected final String TEXT_147 = " ;" + NL + "\t\t\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\turl_";
  protected final String TEXT_149 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_150 = " ;" + NL + "\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\turl_";
  protected final String TEXT_152 = " += \";\" + ";
  protected final String TEXT_153 = ";" + NL + "\t\t\t";
  protected final String TEXT_154 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_155 = " = null;" + NL + "\tString query_";
  protected final String TEXT_156 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_157 = " = false;";
  protected final String TEXT_158 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_159 = " = conn_";
  protected final String TEXT_160 = ".prepareStatement(";
  protected final String TEXT_161 = ");\t" + NL + "\t";
  protected final String TEXT_162 = NL + "\t\tjava.sql.Statement stmt_";
