...
public class TMysqlLastInsertIdBeginJava
{
  protected static String nl;
  public static synchronized TMysqlLastInsertIdBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlLastInsertIdBeginJava result = new TMysqlLastInsertIdBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_75 = ".prepareStatement(\"SELECT LAST_INSERT_ID()\");" + NL + "" + NL + "int nb_line_";
...
log4jCodeGenerateUtil.logInfo(node,"info",cid + " - Query:'SELECT LAST_INSERT_ID()'");
