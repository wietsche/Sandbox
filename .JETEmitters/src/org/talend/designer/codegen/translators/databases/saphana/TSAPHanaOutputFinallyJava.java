...
public class TSAPHanaOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSAPHanaOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaOutputFinallyJava result = new TSAPHanaOutputFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_44 = NL + "\t\tif(resourceMap.get(\"finish_";
  protected final String TEXT_45 = "\")==null){" + NL + "\t\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_46 = "\")!=null){" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_48 = "\")).close();" + NL + "\t\t\t\t\t";
  protected final String TEXT_49 = NL + "\t\t\t\t} catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_50 = ") {" + NL + "\t\t\t\t\tString errorMessage_";
  protected final String TEXT_51 = " = \"failed to close the connection in ";
  protected final String TEXT_52 = " :\" + sqlEx_";
  protected final String TEXT_53 = ".getMessage();" + NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t\tSystem.err.println(errorMessage_";
