...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_144 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_145 = "\", ";
  protected final String TEXT_146 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_147 = "\",  ";
  protected final String TEXT_148 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_149 = "\",conn_";
  protected final String TEXT_150 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
