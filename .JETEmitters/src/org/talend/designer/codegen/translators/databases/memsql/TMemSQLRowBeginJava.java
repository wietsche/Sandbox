...
public class TMemSQLRowBeginJava
{
  protected static String nl;
  public static synchronized TMemSQLRowBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLRowBeginJava result = new TMemSQLRowBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_123 = " =\"jdbc:mysql://\" + ";
