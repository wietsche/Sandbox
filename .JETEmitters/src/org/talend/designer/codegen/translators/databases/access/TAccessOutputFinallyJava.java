...
public class TAccessOutputFinallyJava
{
  protected static String nl;
  public static synchronized TAccessOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessOutputFinallyJava result = new TAccessOutputFinallyJava();
    nl = null;
    return result;
  }
