...
public class TMemSQLConnectionBeginJava
{
  protected static String nl;
  public static synchronized TMemSQLConnectionBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLConnectionBeginJava result = new TMemSQLConnectionBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_127 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_135 = NL + "\tif (null != conn_";
  protected final String TEXT_136 = ") {" + NL + "\t\t";
  protected final String TEXT_137 = NL + "\t}";
  protected final String TEXT_138 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
