...
public class TVectorWiseRowMainJava
{
  protected static String nl;
  public static synchronized TVectorWiseRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TVectorWiseRowMainJava result = new TVectorWiseRowMainJava();
    nl = null;
    return result;
  }
