...
public class TParAccelRowEndJava
{
  protected static String nl;
  public static synchronized TParAccelRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelRowEndJava result = new TParAccelRowEndJava();
    nl = null;
    return result;
  }
