...
public class TPostgresPlusCloseMainJava
{
  protected static String nl;
  public static synchronized TPostgresPlusCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresPlusCloseMainJava result = new TPostgresPlusCloseMainJava();
    nl = null;
    return result;
  }
