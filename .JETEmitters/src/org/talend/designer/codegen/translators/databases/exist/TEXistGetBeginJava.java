...
public class TEXistGetBeginJava
{
  protected static String nl;
  public static synchronized TEXistGetBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXistGetBeginJava result = new TEXistGetBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_83 = "\t" + NL + "" + NL + "\t\tString localdir_";
  protected final String TEXT_84 = "  = ";
  protected final String TEXT_85 = ";\t" + NL + "\t\tfor(java.util.Map<String, String> map_";
