...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_43 = NL + "String dbschema_";
  protected final String TEXT_44 = " =\"\";";
  protected final String TEXT_45 = NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_52 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_56 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\tconn_";
  protected final String TEXT_57 = " = dataSources_";
  protected final String TEXT_58 = ".get(";
  protected final String TEXT_59 = ").getConnection();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_60 = NL + "\t";
  protected final String TEXT_61 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_62 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_63 = ") {" + NL + "\t\t\tconn_";
  protected final String TEXT_64 = " = dataSources_";
  protected final String TEXT_65 = ".get(";
  protected final String TEXT_66 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_67 = NL + "    dbschema_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "    String driverClass_";
  protected final String TEXT_70 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "\t";
  protected final String TEXT_71 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_72 = ");" + NL + "    String port_";
  protected final String TEXT_73 = " = ";
  protected final String TEXT_74 = ";" + NL + "    String dbname_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = " ;" + NL + "    String url_";
  protected final String TEXT_77 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_78 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_79 = ")) {" + NL + "    \turl_";
  protected final String TEXT_80 = " += \":\" + ";
  protected final String TEXT_81 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_82 = ")) {" + NL + "    \turl_";
  protected final String TEXT_83 = " += \"//\" + ";
  protected final String TEXT_84 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_85 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_86 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_108 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_109 = ".execute(\"SET NOCOUNT ON\");" + NL + "" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_110 = " = conn_";
  protected final String TEXT_111 = ".prepareCall(\"{";
  protected final String TEXT_112 = "call \" + ";
  protected final String TEXT_113 = " + \"(";
  protected final String TEXT_114 = ")}\"";
  protected final String TEXT_115 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_116 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_117 = ";" + NL + "String tmpString_";
