...
public class TFirebirdRollbackMainJava
{
  protected static String nl;
  public static synchronized TFirebirdRollbackMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFirebirdRollbackMainJava result = new TFirebirdRollbackMainJava();
    nl = null;
    return result;
  }
