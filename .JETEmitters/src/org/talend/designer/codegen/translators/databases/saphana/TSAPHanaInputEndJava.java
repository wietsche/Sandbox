...
public class TSAPHanaInputEndJava
{
  protected static String nl;
  public static synchronized TSAPHanaInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaInputEndJava result = new TSAPHanaInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_70 = NL + "\t}" + NL + "}finally{" + NL + "\tstmt_";
  ...
  protected final String TEXT_74 = ".isClosed()) {";
