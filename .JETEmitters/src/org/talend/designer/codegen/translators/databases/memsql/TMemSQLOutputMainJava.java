...
public class TMemSQLOutputMainJava {
  protected static String nl;
  public static synchronized TMemSQLOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLOutputMainJava result = new TMemSQLOutputMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_54 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_55 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_56 = "++;";
  protected final String TEXT_57 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_61 = ".executeUpdate();";
  protected final String TEXT_62 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_79 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_84 = "_QUERY\", query_";
  protected final String TEXT_85 = ".toString().trim());";
  ...
  protected final String TEXT_96 = NL + "                        query_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "                    pstmt_";
  protected final String TEXT_100 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_101 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_102 = "++;";
  protected final String TEXT_103 = NL + NL + "           try {" + NL + "                nb_line_";
  protected final String TEXT_104 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_105 = " = updatedCount_";
  protected final String TEXT_106 = " + pstmt_";
  protected final String TEXT_107 = ".executeUpdate();";
  protected final String TEXT_108 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_119 = NL + "                        rejectedCount_";
  protected final String TEXT_120 = " = rejectedCount_";
  protected final String TEXT_121 = " + 1;";
  protected final String TEXT_122 = NL + "                        ";
  protected final String TEXT_123 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_130 = "_QUERY\", query_";
  protected final String TEXT_131 = ".toString().trim());";
  ...
  protected final String TEXT_139 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  ...
  protected final String TEXT_144 = NL + "                            query_";
  ...
  protected final String TEXT_158 = "_QUERY\", query_";
  protected final String TEXT_159 = ".toString().trim());";
  protected final String TEXT_160 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_161 = " = updatedCount_";
  protected final String TEXT_162 = " + pstmtUpdate_";
  protected final String TEXT_163 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_164 = "++;";
  protected final String TEXT_165 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_178 = NL + "                            rejectedCount_";
  protected final String TEXT_179 = " = rejectedCount_";
  ...
  protected final String TEXT_187 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_213 = NL + "                            rejectedCount_";
  protected final String TEXT_214 = " = rejectedCount_";
  protected final String TEXT_215 = " + 1;";
  protected final String TEXT_216 = NL + "                            ";
  protected final String TEXT_217 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_218 = NL + "                            ";
  protected final String TEXT_219 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_220 = ";";
  protected final String TEXT_221 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_222 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_223 = NL + "    \t    int updateFlag_";
  protected final String TEXT_224 = "=0;" + NL + "    \t    ";
  protected final String TEXT_225 = NL + "                    ";
  protected final String TEXT_226 = NL + "                        query_";
  ...
  protected final String TEXT_240 = "_QUERY\", query_";
  protected final String TEXT_241 = ".toString().trim());";
  protected final String TEXT_242 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_243 = "=pstmtUpdate_";
  protected final String TEXT_244 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_245 = " = updatedCount_";
  protected final String TEXT_246 = " + updateFlag_";
  protected final String TEXT_247 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_248 = " == 0) {" + NL + "            \t";
  protected final String TEXT_249 = NL + "\t\t\t\tquery_";
  protected final String TEXT_250 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_258 = NL + "                \tinsertedCount_";
  protected final String TEXT_259 = " = insertedCount_";
  protected final String TEXT_260 = " + pstmtInsert_";
  protected final String TEXT_261 = ".executeUpdate();" + NL + "                     nb_line_";
  protected final String TEXT_262 = "++;";
  protected final String TEXT_263 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_264 = "++;";
  protected final String TEXT_265 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_266 = " = true;";
  protected final String TEXT_267 = NL + "                        throw(e);";
  protected final String TEXT_268 = NL + "                       nb_line_";
  ...
  protected final String TEXT_278 = NL + "                            rejectedCount_";
  protected final String TEXT_279 = " = rejectedCount_";
  protected final String TEXT_280 = " + 1;";
  protected final String TEXT_281 = NL + "                            ";
  protected final String TEXT_282 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_283 = NL + "                            ";
  protected final String TEXT_284 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_285 = ";";
  protected final String TEXT_286 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_287 = NL + "                }";
  protected final String TEXT_288 = NL + "\t\t\t\t\t";
  protected final String TEXT_289 = NL + "                    \t";
  protected final String TEXT_290 = NL + "\t                        query_";
  ...
  protected final String TEXT_299 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_300 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_301 = "++;";
  protected final String TEXT_302 = NL + "        try {" + NL + "                deletedCount_";
  protected final String TEXT_303 = " = deletedCount_";
  protected final String TEXT_304 = " + pstmt_";
  protected final String TEXT_305 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_306 = "++;";
  protected final String TEXT_307 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_308 = " = true;";
  protected final String TEXT_309 = NL + "                    throw(e);";
  ...
  protected final String TEXT_320 = NL + "                        rejectedCount_";
  protected final String TEXT_321 = " = rejectedCount_";
  protected final String TEXT_322 = " + 1;";
  protected final String TEXT_323 = NL + "                        ";
  protected final String TEXT_324 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_331 = "_QUERY\", query_";
  protected final String TEXT_332 = ".toString().trim());";
  protected final String TEXT_333 = NL + "                if ( batchSize_";
  protected final String TEXT_334 = " == batchSizeCounter_";
  protected final String TEXT_335 = ") {" + NL + "                    long countSum_";
  protected final String TEXT_336 = " = 0;" + NL + "                    int[] resultStatus = {};" + NL + "                    try {";
  protected final String TEXT_337 = NL + "                        resultStatus = pstmt_";
  protected final String TEXT_338 = ".executeBatch();";
  protected final String TEXT_339 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_340 = "){";
  protected final String TEXT_341 = NL + "                        throw(e_";
  protected final String TEXT_342 = ");";
  protected final String TEXT_343 = NL + "                        System.err.println(e_";
  protected final String TEXT_344 = ".getMessage());" + NL + "                        for(int countEach_";
  protected final String TEXT_345 = ": e_";
  protected final String TEXT_346 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_347 = " += (countEach_";
  protected final String TEXT_348 = " < 0 ? 0 : countEach_";
  protected final String TEXT_349 = ");" + NL + "                        }";
  protected final String TEXT_350 = NL + "                    }" + NL + "" + NL + "                    long tmp_batchUpdateCount_";
  protected final String TEXT_351 = " = 0;" + NL + "                    for(int i : resultStatus){" + NL + "                          if(i==-3){//EXECUTE_FAILED ";
  protected final String TEXT_352 = NL + "                                System.err.println(\"Query failed to execute.\");" + NL + "                          }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_353 = NL + "                                System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                          }else{" + NL + "                               tmp_batchUpdateCount_";
  protected final String TEXT_354 = " += (i<0 ? 0 : i);" + NL + "                          }" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_355 = " += countSum_";
  protected final String TEXT_356 = ";";
  protected final String TEXT_357 = NL + "                        insertedCount_";
  protected final String TEXT_358 = NL + "                        updatedCount_";
  protected final String TEXT_359 = NL + "                        deletedCount_";
  protected final String TEXT_360 = NL + "                    += tmp_batchUpdateCount_";
  protected final String TEXT_361 = ";" + NL + "                    batchSizeCounter_";
  protected final String TEXT_362 = " = 0;" + NL + "                }";
  protected final String TEXT_363 = NL + "            if(!whetherReject_";
  protected final String TEXT_364 = ") {";
  protected final String TEXT_365 = NL + "                            ";
  protected final String TEXT_366 = " = new ";
  protected final String TEXT_367 = "Struct();";
