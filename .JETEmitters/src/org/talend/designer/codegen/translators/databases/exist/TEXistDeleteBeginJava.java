...
public class TEXistDeleteBeginJava
{
  protected static String nl;
  public static synchronized TEXistDeleteBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TEXistDeleteBeginJava result = new TEXistDeleteBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_71 = " = 0;" + NL + "\torg.xmldb.api.modules.CollectionManagementService mgtService_";
  protected final String TEXT_72 = " = (org.xmldb.api.modules.CollectionManagementService) col_";
  protected final String TEXT_73 = ".getService(\"CollectionManagementService\",\"1.0\");" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_74 = " = new java.util.ArrayList<java.util.Map<String,String>>();";
  protected final String TEXT_75 = NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_76 = "_";
  protected final String TEXT_77 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_78 = "_";
  protected final String TEXT_79 = ".put(";
  protected final String TEXT_80 = ",";
  protected final String TEXT_81 = ");\t\t" + NL + " \t\tlist_";
  protected final String TEXT_82 = ".add(map_";
  protected final String TEXT_83 = "_";
  protected final String TEXT_84 = ");";
  protected final String TEXT_85 = NL + NL + "\t\tfor(java.util.Map<String, String> map_";
  protected final String TEXT_86 = " : list_";
