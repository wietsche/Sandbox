...
public class TOracleOutputFinallyJava
{
  protected static String nl;
  public static synchronized TOracleOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleOutputFinallyJava result = new TOracleOutputFinallyJava();
    nl = null;
    return result;
  }
