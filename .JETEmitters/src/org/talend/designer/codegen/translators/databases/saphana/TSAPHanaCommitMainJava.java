...
public class TSAPHanaCommitMainJava
{
  protected static String nl;
  public static synchronized TSAPHanaCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPHanaCommitMainJava result = new TSAPHanaCommitMainJava();
    nl = null;
    return result;
  }
