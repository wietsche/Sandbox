...
public class TInformixOutputFinallyJava
{
  protected static String nl;
  public static synchronized TInformixOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInformixOutputFinallyJava result = new TInformixOutputFinallyJava();
    nl = null;
    return result;
  }
