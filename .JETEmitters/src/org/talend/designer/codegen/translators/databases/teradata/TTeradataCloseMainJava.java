...
public class TTeradataCloseMainJava
{
  protected static String nl;
  public static synchronized TTeradataCloseMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataCloseMainJava result = new TTeradataCloseMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_117 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_118 = ".setAutoCommit(true);" + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_119 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");";
  protected final String TEXT_120 = NL + "                             try{" + NL + "                                 conn_";
  protected final String TEXT_121 = ".createStatement().execute(\"END QUERY LOGGING ON \" + ";
  protected final String TEXT_122 = ");" + NL + "                             }catch(Exception e){" + NL + "                                   System.err.println(e.getMessage());" + NL + "                             }";
  protected final String TEXT_123 = NL + "             }catch(Exception e){";
  protected final String TEXT_124 = NL + "                 System.err.println(e.getMessage());" + NL + "             }" + NL;
