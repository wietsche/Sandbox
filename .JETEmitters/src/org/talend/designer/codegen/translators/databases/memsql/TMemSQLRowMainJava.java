...
public class TMemSQLRowMainJava
{
  protected static String nl;
  public static synchronized TMemSQLRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMemSQLRowMainJava result = new TMemSQLRowMainJava();
    nl = null;
    return result;
  }
