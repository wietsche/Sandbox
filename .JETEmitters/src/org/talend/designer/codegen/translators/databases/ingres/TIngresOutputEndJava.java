...
public class TIngresOutputEndJava
{
  protected static String nl;
  public static synchronized TIngresOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresOutputEndJava result = new TIngresOutputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_61 = NL + "                int[] status_";
  protected final String TEXT_62 = " = null;" + NL + "                int countSum_";
  protected final String TEXT_63 = " = 0;" + NL + "                try {" + NL + "                    if(pstmt_";
  protected final String TEXT_64 = "!=null && batchSizeCounter_";
  protected final String TEXT_65 = " > 0 ){";
  protected final String TEXT_66 = NL + "                        status_";
  protected final String TEXT_67 = " = pstmt_";
  protected final String TEXT_68 = ".executeBatch();";
  protected final String TEXT_69 = NL + "                        for(int countEach_";
  protected final String TEXT_70 = ": status_";
  protected final String TEXT_71 = ") {" + NL + "                            countSum_";
  protected final String TEXT_72 = " += (countEach_";
  protected final String TEXT_73 = " < 0 ? 0 : countEach_";
  protected final String TEXT_74 = ");" + NL + "                        }" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_75 = NL + "                        throw(e);";
  protected final String TEXT_76 = NL + "                    for(int countEach_";
  protected final String TEXT_77 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_78 = " += (countEach_";
  protected final String TEXT_79 = " < 0 ? 0 : countEach_";
  protected final String TEXT_80 = ");" + NL + "                    }" + NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_81 = NL + "                }" + NL + "                if(pstmt_";
  protected final String TEXT_82 = "!=null && batchSizeCounter_";
  protected final String TEXT_83 = " > 0 ){" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_84 = " = pstmt_";
  protected final String TEXT_85 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){" + NL + "" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_86 = " = tmp_batchUpdateCount_";
  protected final String TEXT_87 = " > countSum_";
  protected final String TEXT_88 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_89 = " : countSum_";
  protected final String TEXT_90 = ";";
  protected final String TEXT_91 = NL + "                        insertedCount_";
  protected final String TEXT_92 = " += tmp_batchUpdateCount_";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "                        updatedCount_";
  protected final String TEXT_95 = " += tmp_batchUpdateCount_";
  protected final String TEXT_96 = ";";
  protected final String TEXT_97 = NL + "                        deletedCount_";
  protected final String TEXT_98 = " += tmp_batchUpdateCount_";
  protected final String TEXT_99 = ";";
  protected final String TEXT_100 = NL + "                }";
  protected final String TEXT_101 = NL + "        if (commitCounter_";
  protected final String TEXT_102 = " > 0) {";
  protected final String TEXT_103 = NL + "            conn_";
  protected final String TEXT_104 = ".commit();";
  ...
  protected final String TEXT_113 = NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_114 = "\", true);";
  protected final String TEXT_115 = NL;
  protected final String TEXT_116 = NL + "\tnb_line_deleted_";
  protected final String TEXT_117 = "=nb_line_deleted_";
  protected final String TEXT_118 = "+ deletedCount_";
  protected final String TEXT_119 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_120 = "=nb_line_update_";
  protected final String TEXT_121 = " + updatedCount_";
  protected final String TEXT_122 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_123 = "=nb_line_inserted_";
  protected final String TEXT_124 = " + insertedCount_";
  protected final String TEXT_125 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_126 = "=nb_line_rejected_";
  protected final String TEXT_127 = " + rejectedCount_";
  protected final String TEXT_128 = ";" + NL + "\t";
  protected final String TEXT_129 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_130 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_131 = "_NB_LINE\",nb_line_";
  protected final String TEXT_132 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_133 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_134 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_135 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_136 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_137 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_138 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_139 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_140 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_141 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_142 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_143 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_144 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_145 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_146 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_147 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_148 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_151 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_152 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_153 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_154 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_155 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_156 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_157 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_158 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_159 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_160 = NL + "        globalMap.put(\"";
  protected final String TEXT_161 = "_NB_LINE\",nb_line_";
  protected final String TEXT_162 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_163 = "_NB_LINE_UPDATED\",nb_line_update_";
