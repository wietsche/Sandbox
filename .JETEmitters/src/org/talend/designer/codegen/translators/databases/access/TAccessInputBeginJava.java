...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_176 = ";";
  protected final String TEXT_177 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_178 = " = \"";
  protected final String TEXT_179 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_191 = NL + "\t\t   \t" + NL + "\t        String dbPwd_";
  ...
  protected final String TEXT_196 = ",dbUser_";
  protected final String TEXT_197 = ",dbPwd_";
  protected final String TEXT_198 = ");";
  protected final String TEXT_199 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_202 = " = atnParams_";
  protected final String TEXT_203 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_204 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_205 = ".put(\"user\",dbUser_";
  protected final String TEXT_206 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_207 = ".put(\"password\",dbPwd_";
  protected final String TEXT_208 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_209 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_210 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_211 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_212 = ", atnParamsPrope_";
  protected final String TEXT_213 = ");";
  protected final String TEXT_214 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_215 = " = rs_";
  protected final String TEXT_216 = ".getTimestamp(";
  protected final String TEXT_217 = "column_index_";
  protected final String TEXT_218 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_219 = " != null) {";
  protected final String TEXT_220 = NL + "                ";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = " = new java.util.Date(timestamp_";
  protected final String TEXT_223 = ".getTime());" + NL + "            } else {";
  ...
  protected final String TEXT_229 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_230 = " = null;";
  protected final String TEXT_231 = NL + "\t\t        conn_";
  protected final String TEXT_232 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_233 = "\");";
  protected final String TEXT_234 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_235 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_236 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_237 = " = dataSources_";
  protected final String TEXT_238 = ".get(";
  protected final String TEXT_239 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_240 = "\", conn_";
  protected final String TEXT_241 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_242 = NL + "\t\t\t\t";
  protected final String TEXT_243 = NL + "\t\t\t\t";
  protected final String TEXT_244 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_245 = " =  conn_";
  protected final String TEXT_246 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_247 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_248 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_249 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_250 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_251 = NL + "                 conn_";
  protected final String TEXT_252 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_253 = NL + "               ";
  protected final String TEXT_254 = " + \"=\" + ";
  protected final String TEXT_255 = " + \";\" +";
  protected final String TEXT_256 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_257 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_258 = ");";
  protected final String TEXT_259 = NL + "\t\t    ";
  protected final String TEXT_260 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_261 = " = ";
  protected final String TEXT_262 = ";" + NL + "\t\t\t";
  protected final String TEXT_263 = NL + "                log.info(\"";
  protected final String TEXT_264 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_265 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_266 = NL;
  protected final String TEXT_267 = NL + "                       globalMap.put(\"";
  protected final String TEXT_268 = "_QUERY\",dbquery_";
  protected final String TEXT_269 = ");";
  protected final String TEXT_270 = NL + "                       globalMap.put(\"";
  protected final String TEXT_271 = "_QUERY\",dbquery_";
  protected final String TEXT_272 = ");";
  protected final String TEXT_273 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_274 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_275 = " = stmt_";
  protected final String TEXT_276 = ".executeQuery(dbquery_";
  protected final String TEXT_277 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_278 = " = rs_";
  protected final String TEXT_279 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_280 = " = rsmd_";
  protected final String TEXT_281 = ".getColumnCount();" + NL;
  protected final String TEXT_282 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_283 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_284 = ".setDbmsId(\"";
  protected final String TEXT_285 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_286 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_287 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_288 = ".add(\"";
  protected final String TEXT_289 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_290 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_291 = " = ";
  protected final String TEXT_292 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_293 = "; i <= rsmd_";
  protected final String TEXT_294 = ".getColumnCount()-";
  protected final String TEXT_295 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_296 = ".contains(rsmd_";
  protected final String TEXT_297 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_298 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_299 = ".setName(rsmd_";
  protected final String TEXT_300 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_301 = ".setDbName(rsmd_";
  protected final String TEXT_302 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_303 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_304 = "\", rsmd_";
  protected final String TEXT_305 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_306 = ".getPrecision(i), rsmd_";
  protected final String TEXT_307 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_308 = ".setDbType(rsmd_";
  protected final String TEXT_309 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_310 = ".setDbTypeId(rsmd_";
  protected final String TEXT_311 = ".getColumnType(i));";
  protected final String TEXT_312 = NL + "                \tdcm_";
  protected final String TEXT_313 = ".setFormat(";
  protected final String TEXT_314 = ");";
  protected final String TEXT_315 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_316 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_317 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_318 = ".setLength(rsmd_";
  protected final String TEXT_319 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_320 = ".setLength(rsmd_";
  protected final String TEXT_321 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_322 = NL + "\t\t\tdcm_";
  protected final String TEXT_323 = ".setLength(rsmd_";
  protected final String TEXT_324 = ".getPrecision(i));";
  protected final String TEXT_325 = NL + "                \tdcm_";
  protected final String TEXT_326 = ".setPrecision(rsmd_";
  protected final String TEXT_327 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_328 = ".setNullable(rsmd_";
  protected final String TEXT_329 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_330 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_331 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_332 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_333 = ".metadatas.add(dcm_";
  protected final String TEXT_334 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_335 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_336 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_337 = NL + "\t\t    \tint column_index_";
  ...
  protected final String TEXT_353 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_365 = " = (List)rs_";
