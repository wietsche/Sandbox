...
public class TParAccelRowMainJava
{
  protected static String nl;
  public static synchronized TParAccelRowMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TParAccelRowMainJava result = new TParAccelRowMainJava();
    nl = null;
    return result;
  }
