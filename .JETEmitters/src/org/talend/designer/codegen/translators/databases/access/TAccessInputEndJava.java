...
public class TAccessInputEndJava
{
  protected static String nl;
  public static synchronized TAccessInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAccessInputEndJava result = new TAccessInputEndJava();
    nl = null;
    return result;
  }
