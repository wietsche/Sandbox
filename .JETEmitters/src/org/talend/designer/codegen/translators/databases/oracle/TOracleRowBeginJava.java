...
public class TOracleRowBeginJava
{
  ...
  protected final String TEXT_142 = NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_143 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_144 = ".put(\"user\",dbUser_";
  protected final String TEXT_145 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_146 = ".put(\"password\",dbPwd_";
  protected final String TEXT_147 = ");" + NL + "\t            if(";
  protected final String TEXT_148 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_149 = ") && !\"\".equals(";
  protected final String TEXT_150 = ")){" + NL + "                    atnParamsPrope_";
  protected final String TEXT_151 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_152 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                }" + NL + "\t\t\t\tconn_";
  protected final String TEXT_153 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_154 = ", atnParamsPrope_";
  protected final String TEXT_155 = ");" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_157 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_159 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t\tint nb_line_deleted_";
  protected final String TEXT_161 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_162 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_163 = " = null;" + NL + "\tString query_";
  protected final String TEXT_164 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_168 = ".prepareStatement(";
  protected final String TEXT_169 = ");\t" + NL + "\t";
  protected final String TEXT_170 = NL + "\t\tjava.sql.Statement stmt_";
