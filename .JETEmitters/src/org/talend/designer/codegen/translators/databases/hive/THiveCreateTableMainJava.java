...
public class THiveCreateTableMainJava
{
  ...
  protected final String TEXT_576 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_577 = " = conn_";
  protected final String TEXT_578 = ".createStatement();";
  protected final String TEXT_579 = NL + "    String query_";
  protected final String TEXT_580 = " = \"\";" + NL + "    String tableName_";
  protected final String TEXT_581 = " = ";
  protected final String TEXT_582 = ";";
  protected final String TEXT_583 = NL + "    String likeTableName_";
  protected final String TEXT_584 = " = ";
  protected final String TEXT_585 = ";";
  protected final String TEXT_586 = NL + "        String location_";
  protected final String TEXT_587 = " = ";
  protected final String TEXT_588 = ";";
  protected final String TEXT_589 = NL + "    String querySQL_";
  protected final String TEXT_590 = " = \"";
  protected final String TEXT_591 = "\";";
  protected final String TEXT_592 = NL + "    try {" + NL + "        stmt_";
  protected final String TEXT_593 = ".execute(querySQL_";
  protected final String TEXT_594 = ");" + NL + "    } catch(java.sql.SQLException e_";
  protected final String TEXT_595 = ") {";
  protected final String TEXT_596 = NL + "            throw(e_";
  protected final String TEXT_597 = ");";
  protected final String TEXT_598 = NL + "            System.err.println(e_";
  protected final String TEXT_599 = ".getMessage());";
  protected final String TEXT_600 = NL + "    }" + NL + "    stmt_";
  protected final String TEXT_601 = ".close();" + NL + "    globalMap.put(\"";
  protected final String TEXT_602 = "_QUERY\", querySQL_";
  protected final String TEXT_603 = ");" + NL + "" + NL + "    String currentClientPathSeparator_";
  protected final String TEXT_604 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "    if(currentClientPathSeparator_";
  protected final String TEXT_605 = "!=null) {" + NL + "        System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_606 = ");" + NL + "        globalMap.put(\"current_client_path_separator\", null);" + NL + "    }";
  protected final String TEXT_607 = NL + "        conn_";
  protected final String TEXT_608 = ".close();";
  protected final String TEXT_609 = NL + "            bw_";
  protected final String TEXT_610 = ".write(querySQL_";
  protected final String TEXT_611 = " + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_612 = "_QUERY\", querySQL_";
  protected final String TEXT_613 = ");" + NL + "" + NL + "            bw_";
  protected final String TEXT_614 = ".close();" + NL + "" + NL + "            if(libjars_";
  protected final String TEXT_615 = ".length() > 0) {" + NL + "                instance_";
  protected final String TEXT_616 = ".setLibJars(libjars_";
  protected final String TEXT_617 = ".toString().substring(0, libjars_";
  protected final String TEXT_618 = ".length()-1));" + NL + "            }" + NL + "            instance_";
  protected final String TEXT_619 = ".callWS(instance_";
  protected final String TEXT_620 = ".sendFiles());" + NL + "            int exitCode_";
  protected final String TEXT_621 = " = instance_";
  protected final String TEXT_622 = ".execute();" + NL + "            if(exitCode_";
  protected final String TEXT_623 = " > 0) {" + NL;
  protected final String TEXT_624 = NL + "                    throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_625 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_626 = NL + "                        log.error(\"";
  protected final String TEXT_627 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_628 = NL + "            }";
  protected final String TEXT_629 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_630 = "_";
  protected final String TEXT_631 = "_";
  protected final String TEXT_632 = " = ";
  protected final String TEXT_633 = ";";
  protected final String TEXT_634 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_635 = "_";
  protected final String TEXT_636 = "_";
  protected final String TEXT_637 = " = ";
  protected final String TEXT_638 = ";";
  protected final String TEXT_639 = NL + "\t\t\t\t\tString key_";
  protected final String TEXT_640 = "_";
  protected final String TEXT_641 = "_";
  protected final String TEXT_642 = " = ";
  protected final String TEXT_643 = ";" + NL + "\t\t\t\t\tString value_";
  protected final String TEXT_644 = "_";
  protected final String TEXT_645 = "_";
  protected final String TEXT_646 = " = ";
  protected final String TEXT_647 = ";";
  protected final String TEXT_648 = NL + "    String tableComment_";
  protected final String TEXT_649 = " = ";
  protected final String TEXT_650 = ";";
  protected final String TEXT_651 = NL + "    String clustededOrSkewed_";
  protected final String TEXT_652 = " = ";
  protected final String TEXT_653 = ";";
  protected final String TEXT_654 = NL + "            String fieldChar_";
  protected final String TEXT_655 = " = ";
  protected final String TEXT_656 = ";";
  protected final String TEXT_657 = NL + "                String escapeChar_";
  protected final String TEXT_658 = " = ";
  protected final String TEXT_659 = ";";
  protected final String TEXT_660 = NL + "            String collectionChar_";
  protected final String TEXT_661 = " = ";
  protected final String TEXT_662 = ";";
  protected final String TEXT_663 = NL + "            String mapChar_";
  protected final String TEXT_664 = " = ";
  protected final String TEXT_665 = ";";
  protected final String TEXT_666 = NL + "            String lineChar_";
  protected final String TEXT_667 = " = ";
  protected final String TEXT_668 = ";";
  protected final String TEXT_669 = NL + "        String serdeName_";
  protected final String TEXT_670 = " = ";
  protected final String TEXT_671 = ";";
  protected final String TEXT_672 = NL + "        String inputClass_";
  protected final String TEXT_673 = " = ";
  protected final String TEXT_674 = ";" + NL + "        String outputClass_";
  protected final String TEXT_675 = " = ";
  protected final String TEXT_676 = ";";
  protected final String TEXT_677 = NL + "    String storageClass_";
  protected final String TEXT_678 = " = ";
  protected final String TEXT_679 = ";";
  protected final String TEXT_680 = NL + "            String decryptedS3Password_";
  protected final String TEXT_681 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_682 = ");";
  protected final String TEXT_683 = NL + "            String decryptedS3Password_";
  protected final String TEXT_684 = " = ";
  protected final String TEXT_685 = ";";
  protected final String TEXT_686 = NL + "        String location_";
  protected final String TEXT_687 = " = \"s3n://\" + ";
  protected final String TEXT_688 = " +\":\" + decryptedS3Password_";
  protected final String TEXT_689 = " + \"@\" + ";
  protected final String TEXT_690 = ";";
  protected final String TEXT_691 = NL + "    String location_";
  protected final String TEXT_692 = " = ";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "    String select_";
  protected final String TEXT_695 = " = ";
  protected final String TEXT_696 = ";";
  protected final String TEXT_697 = NL + "String querySQL_";
  protected final String TEXT_698 = " = \"";
  protected final String TEXT_699 = "\";";
  protected final String TEXT_700 = NL + "try {" + NL + "    stmt_";
  protected final String TEXT_701 = ".execute(querySQL_";
  protected final String TEXT_702 = ");" + NL + "} catch(java.sql.SQLException e_";
  protected final String TEXT_703 = ") {";
  protected final String TEXT_704 = NL + "        throw(e_";
  protected final String TEXT_705 = ");";
  protected final String TEXT_706 = NL + "        System.err.println(e_";
  protected final String TEXT_707 = ".getMessage());";
  protected final String TEXT_708 = NL + "        }" + NL + "stmt_";
  protected final String TEXT_709 = ".close();";
  protected final String TEXT_710 = NL + "    conn_";
  protected final String TEXT_711 = ".close();";
  protected final String TEXT_712 = NL + "globalMap.put(\"";
  protected final String TEXT_713 = "_QUERY\", querySQL_";
  protected final String TEXT_714 = ");" + NL + "" + NL + "String currentClientPathSeparator_";
  protected final String TEXT_715 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_716 = "!=null) {" + NL + "    System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_717 = ");" + NL + "    globalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String currentClientUsername_";
  protected final String TEXT_718 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "if(currentClientUsername_";
  protected final String TEXT_719 = "!=null) {" + NL + "    System.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_720 = ");" + NL + "    globalMap.put(\"current_client_user_name\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_721 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_722 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_723 = "!=null) {" + NL + "    System.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_724 = ");" + NL + "    globalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_725 = "\", null);" + NL + "} else {" + NL + "    System.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
  protected final String TEXT_726 = NL + "        bw_";
  protected final String TEXT_727 = ".write(querySQL_";
  protected final String TEXT_728 = " + \";\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_729 = "_QUERY\", querySQL_";
  protected final String TEXT_730 = ");" + NL + "" + NL + "        bw_";
  protected final String TEXT_731 = ".close();" + NL + "" + NL + "        if(libjars_";
  protected final String TEXT_732 = ".length() > 0) {" + NL + "            instance_";
  protected final String TEXT_733 = ".setLibJars(libjars_";
  protected final String TEXT_734 = ".toString().substring(0, libjars_";
  protected final String TEXT_735 = ".length()-1));" + NL + "        }" + NL + "        instance_";
  protected final String TEXT_736 = ".callWS(instance_";
  protected final String TEXT_737 = ".sendFiles());" + NL + "        int exitCode_";
  protected final String TEXT_738 = " = instance_";
  protected final String TEXT_739 = ".execute();" + NL + "        if(exitCode_";
  protected final String TEXT_740 = " > 0) {" + NL;
  protected final String TEXT_741 = NL + "                throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_742 = NL + "                System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_743 = NL + "                    log.error(\"";
  protected final String TEXT_744 = " - The Hive job failed. Please read the logs for more details\");";
