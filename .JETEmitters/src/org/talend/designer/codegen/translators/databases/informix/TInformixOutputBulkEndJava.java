...
public class TInformixOutputBulkEndJava
{
  ...
  protected final String TEXT_29 = NL + "\tif(csvWriter_";
  protected final String TEXT_30 = "!=null) {" + NL + "\t\tcsvWriter_";
  protected final String TEXT_31 = ".close();" + NL + "\t}" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_32 = "\", true); " + NL + "\tglobalMap.put(\"";
