...
public class TIngresCommitMainJava
{
  protected static String nl;
  public static synchronized TIngresCommitMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TIngresCommitMainJava result = new TIngresCommitMainJava();
    nl = null;
    return result;
  }
