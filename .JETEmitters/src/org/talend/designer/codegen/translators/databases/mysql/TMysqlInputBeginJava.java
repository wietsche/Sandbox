...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_192 = NL + "\t\t        ((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_193 = ").enableStreamingResults();";
  protected final String TEXT_194 = NL + "\t        if(rs_";
  protected final String TEXT_195 = ".getString(";
  protected final String TEXT_196 = "column_index_";
  protected final String TEXT_197 = ") != null) {" + NL + "\t            String dateString_";
  protected final String TEXT_198 = " = rs_";
  protected final String TEXT_199 = ".getString(";
  protected final String TEXT_200 = "column_index_";
  protected final String TEXT_201 = ");" + NL + "\t            if (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_202 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
