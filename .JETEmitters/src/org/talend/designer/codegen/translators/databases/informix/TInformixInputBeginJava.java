...
public class TInformixInputBeginJava
{
  ...
  protected final String TEXT_175 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_176 = " + \":\" + ";
  protected final String TEXT_177 = " + \"/\" + ";
  protected final String TEXT_178 = " + \":informixserver=\" + ";
  protected final String TEXT_179 = ";";
  protected final String TEXT_180 = NL + "\t\t        String url_";
  protected final String TEXT_181 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_182 = " + \":\" + ";
  protected final String TEXT_183 = " + \"/\" + ";
  protected final String TEXT_184 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_262 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_332 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_333 = ".getObject(";
  protected final String TEXT_334 = "column_index_";
  protected final String TEXT_335 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_336 = NL + "                                    ";
  protected final String TEXT_337 = ".";
  protected final String TEXT_338 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_347 = ".setEPSG(";
  protected final String TEXT_348 = ");" + NL + "                                        }";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_350 = NL + "                                  ";
  protected final String TEXT_351 = ".";
  protected final String TEXT_352 = "=dcg_";
  protected final String TEXT_353 = ";";
  protected final String TEXT_354 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_355 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_356 = " = ";
  protected final String TEXT_357 = "; i_";
  protected final String TEXT_358 = "  <= rsmd_";
  protected final String TEXT_359 = ".getColumnCount(); i_";
  protected final String TEXT_360 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_361 = ".getColumnTypeName(i_";
  protected final String TEXT_362 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_363 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_364 = ".getClob(i_";
  protected final String TEXT_365 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_366 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_367 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_368 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_369 = ".add(tNTextImpl_";
  protected final String TEXT_370 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_371 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = ", rs_";
  protected final String TEXT_374 = ", fixedColumnCount_";
  protected final String TEXT_375 = ",list_";
  protected final String TEXT_376 = ",";
  protected final String TEXT_377 = ");";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_390 = NL + "                                  Object geom = rs_";
  protected final String TEXT_391 = ".getObject(";
  protected final String TEXT_392 = "column_index_";
  protected final String TEXT_393 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_394 = ".";
  protected final String TEXT_395 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_396 = ".";
  protected final String TEXT_397 = " = null;" + NL + "                                  }";
  protected final String TEXT_398 = NL + "\t\t                          ";
  protected final String TEXT_399 = NL + "\t\t                    }";
  protected final String TEXT_400 = NL + "\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_402 = " - Retrieving the record \" + nb_line_";
