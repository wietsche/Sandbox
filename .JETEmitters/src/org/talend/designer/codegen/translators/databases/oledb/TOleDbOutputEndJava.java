...
public class TOleDbOutputEndJava
{
  ...
  protected final String TEXT_45 = ".invoke(\"Close\");" + NL + "\t";
  protected final String TEXT_46 = NL + "\t";
  protected final String TEXT_47 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_60 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_61 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_62 = "_NB_LINE\",nb_line_";
  protected final String TEXT_63 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_64 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_65 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_66 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_67 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_68 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_69 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_70 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_71 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_72 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_73 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_74 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_75 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_76 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_77 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_78 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_79 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_80 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_81 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_82 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_83 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_84 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_85 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_86 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_87 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_88 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_100 = "_NB_LINE_REJECTED\", nb_line_rejected_";
