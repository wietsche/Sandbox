...
public class TPostgresqlOutputFinallyJava
{
  protected static String nl;
  public static synchronized TPostgresqlOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPostgresqlOutputFinallyJava result = new TPostgresqlOutputFinallyJava();
    nl = null;
    return result;
  }
