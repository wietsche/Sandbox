...
public class TContextDumpBeginJava
{
  ...
  protected final String TEXT_6 = NL + "        for( java.util.Enumeration<?> en_";
  ...
  protected final String TEXT_23 = "\").equals(key_";
  protected final String TEXT_24 = ".toString())){" + NL + "\t\t\t                    ";
  protected final String TEXT_25 = ".";
  protected final String TEXT_26 = " = value_";
  protected final String TEXT_27 = ".toString().replaceAll(\".\",\"*\");" + NL + "\t\t\t                }" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_28 = NL + "\t\t\t\t\t\t\tif((\"";
  protected final String TEXT_29 = "\").equals(key_";
  protected final String TEXT_30 = ".toString())){" + NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_31 = ".toString().indexOf(\";\")>-1){" + NL + "\t\t\t                    \t";
  protected final String TEXT_32 = ".";
  protected final String TEXT_33 = " = value_";
  protected final String TEXT_34 = ".toString().substring(value_";
  protected final String TEXT_35 = ".toString().indexOf(\";\")+1);" + NL + "\t\t\t                    }" + NL + "\t\t\t                }" + NL + "\t\t\t\t\t\t";
